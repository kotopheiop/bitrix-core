...
if (
    ...
    COption::SetOptionString(
        ...
        $_POST["redirect_referer_check"] === "Y" ? "Y" : "N"
    );
    COption::SetOptionString(
        "security",
        "redirect_referer_site_check",
        $_POST["redirect_referer_site_check"] === "Y" ? "Y" : "N"
    );
    ...
    if ($_REQUEST["save"] != "" && $_GET["return_url"] != "") {
        ...
        LocalRedirect(
            "/bitrix/admin/security_redirect.php?lang=" . LANGUAGE_ID . $returnUrl . "&" . $tabControl->ActiveTabParam()
        );
    }
}
    ...
    <form method="POST" action="security_redirect.php?lang=<?= LANGUAGE_ID ?><?= htmlspecialcharsbx($returnUrl) ?>"
        ...
        <? if (CSecurityRedirect::IsActive()): ?>
            <tr>
                <td colspan="2" align="left">
                    ...
                    <input type="submit" name="redirect_button" value="<? echo GetMessage(
                        "SEC_REDIRECT_BUTTON_OFF"
            ...
            <td width="60%">
                <div class="adm-list">
                    <div class="adm-list-item">
                        ...
                        <div class="adm-list-label"><label for="redirect_referer_check"><? echo GetMessage(
                                    "SEC_REDIRECT_REFERER_CHECK"
                                ) ?></label></div>
                    </div>
                    <div class="adm-list-item">
                        ...
                        <div class="adm-list-label"><label for="redirect_referer_site_check"><? echo GetMessage(
                                    "SEC_REDIRECT_REFERER_SITE_CHECK"
                                ) ?></label></div>
                    </div>
                    <div class="adm-list-item">
                        ...
                        <div class="adm-list-label"><label for="redirect_href_sign"><? echo GetMessage(
                                    "SEC_REDIRECT_HREF_SIGN"
                                ) ?></label></div>
                    </div>
                </div>
            </td>
                        ...
                        <tr>
                            <td nowrap style="padding-bottom: 3px;">
                                <? echo GetMessage("SEC_REDIRECT_URL") ?>&nbsp;<input type="text" size="35"
                                                                                      ...
                                                                                      disabled>&nbsp;<? echo GetMessage(
                                    "SEC_REDIRECT_PARAMETER_NAME"
                    ...
                    <? foreach ($arUsrUrls as $i => $arUrl): ?>
                        <tr>
                            <td nowrap style="padding-bottom: 3px;">
                                <? echo GetMessage("SEC_REDIRECT_URL") ?>&nbsp;<input type="text" size="35"
                                                                                      name="URLS[<? echo $i ?>][URL]"
                                                                                      value="<? echo $arUrl["URL"] ?>">&nbsp;<? echo GetMessage(
                                    "SEC_REDIRECT_PARAMETER_NAME"
                                ) ?>&nbsp;<input type="text" size="15" name="URLS[<? echo $i ?>][PARAMETER_NAME]"
        ...
        <tr>
            ...
            <td width="60%">
				...
				><?
                                    $mess = trim(
                                        COption::GetOptionString("security", "redirect_message_warning_" . $ar["LID"])
                                    );
                                    if ($mess == '') {
                ...
                <label><input type="radio" name="redirect_action" id="redirect_force_url"
                              value="force_url" <? if (COption::GetOptionString(
                            "security",
                            "redirect_action"
                        ) == "force_url") {
                        echo "checked";
                        ...
                        <td>
                            <input
                                    ...
                                    value="<? echo htmlspecialcharsbx(
                                        COption::GetOptionString("security", "redirect_url")
                                    ) ?>"
                                    size="45"
        ...
        <tr>
            ...
            <td width="60%">
                <input type="checkbox" name="redirect_log" id="redirect_log" value="Y" <? if (COption::GetOptionString(
                        "security",
                        "redirect_log"
                    ) == "Y") {
                    echo "checked";
