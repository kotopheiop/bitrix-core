...
?>
    ...
    <form method="POST" action="security_session.php?lang=<?= LANGUAGE_ID ?><?= $returnUrl ?>"
        ...
        <tr>
            ...
            <td width="60%"><input type="text" name="sessid_ttl" size="6"
                                   value="<? echo COption::GetOptionInt("main", "session_id_ttl", 60) ?>"></td>
        </tr>
        <tr>
            <td colspan="2">
