...
?>
    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>" enctype="multipart/form-data" name="editform">
        ...
        <tr>
            ...
            <td width="60%"><input type="checkbox" name="ADMIN_SECTION"
                                   value="Y"<? if ($str_ADMIN_SECTION == "Y") echo " checked" ?>></td>
        </tr>
        <tr>
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbINCL_IPS">
                    ...
                    foreach ($arIPs as $i => $ip):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="30" value="<? echo htmlspecialcharsbx($ip) ?>"
                                       name="INCL_IPS[<? echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    if (!$bVarsFromForm):?>
                    ...
                    <tr>
                        <td>
                            <input type="button" id="add-button-incl-ips"
                                   value="<? echo GetMessage("SEC_IP_EDIT_ROW_ADD") ?>">
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="adm-detail-valign-top" style="padding-top:12px;"><? echo GetMessage("SEC_IP_EDIT_EXCL_IPS") ?>:
            </td>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbEXCL_IPS">
                    ...
                    foreach ($arIPs as $i => $ip):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="30" value="<? echo htmlspecialcharsbx($ip) ?>"
                                       name="EXCL_IPS[<? echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    if (!$bVarsFromForm):?>
                    ...
                    <tr>
                        <td>
                            <input type="button" id="add-button-excl-ips"
                                   value="<? echo GetMessage("SEC_IP_EDIT_ROW_ADD") ?>">
                        </td>
                    </tr>
                </table>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbINCL_PATH">
                    ...
                    foreach ($arMasks as $i => $mask):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="45" value="<? echo htmlspecialcharsbx($mask) ?>"
                                       name="INCL_MASKS[<? echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    if (!$bVarsFromForm):?>
                    ...
                    <tr>
                        <td>
                            <input type="button" id="add-button-incl-masks"
                                   value="<? echo GetMessage("SEC_IP_EDIT_ROW_ADD") ?>">
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td class="adm-detail-valign-top" style="padding-top:12px;"><? echo GetMessage("SEC_IP_EDIT_EXCL_MASKS") ?>
                :
            </td>
            <td>
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbEXCL_PATH">
                    ...
                    foreach ($arMasks as $i => $mask):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="45" value="<? echo htmlspecialcharsbx($mask) ?>"
                                       name="EXCL_MASKS[<? echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    if (!$bVarsFromForm):?>
                    ...
                    <tr>
                        <td>
                            <input type="button" id="add-button-excl-masks"
                                   value="<? echo GetMessage("SEC_IP_EDIT_ROW_ADD") ?>">
                        </td>
                    </tr>
                </table>
