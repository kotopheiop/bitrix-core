                    ...
                    foreach ($arIPs as $i => $ip):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                ...
                                echo htmlspecialcharsbx($ip) ?>" name="INCL_IPS[<?
                                echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    if (!$bVarsFromForm):?>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbEXCL_IPS">
                    ...
                    foreach ($arIPs as $i => $ip):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="30" value="<?
                                echo htmlspecialcharsbx($ip) ?>" name="EXCL_IPS[<?
                                echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                    ...
                    foreach ($arMasks as $i => $mask):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                ...
                                echo htmlspecialcharsbx($mask) ?>" name="INCL_MASKS[<?
                                echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="nopadding" width="100%" id="tbEXCL_PATH">
                    ...
                    foreach ($arMasks as $i => $mask):?>
                        <tr>
                            <td style="padding-bottom: 3px;">
                                <input type="text" size="45" value="<?
                                echo htmlspecialcharsbx($mask) ?>" name="EXCL_MASKS[<?
                                echo htmlspecialcharsbx($i) ?>]">
                            </td>
                        </tr>
                    <?endforeach;
