                ...
                <div id="connect-by-qr">
                    <div class="input-type">
                        <span class="current"><?= GetMessage('SEC_OTP_MOBILE_SCAN_QR') ?></span><span
                                ...
                                href="#"
                                id="connect-mobile-manual-input"><?= GetMessage('SEC_OTP_MOBILE_MANUAL_INPUT') ?></a>
                    </div>
                ...
                <div id="connect-by-manual-input" style="display: none;">
                    <div class="input-type">
                        <a href="#" id="connect-mobile-scan-qr"><?= GetMessage('SEC_OTP_MOBILE_SCAN_QR') ?></a><span
                                class="separator"><?= GetMessage('SEC_OTP_MOBILE_INPUT_METHODS_SEPARATOR') ?></span><span
                                class="current"><?= GetMessage('SEC_OTP_MOBILE_MANUAL_INPUT') ?></span>
                    </div>
                    <div style="margin-bottom: 20px">
                        <?= GetMessage('SEC_OTP_CONNECT_MOBILE_MANUAL_INPUT') ?>
                        <span class="type-title"
                              data-show-type="hotp"><?= GetMessage('SEC_OTP_CONNECT_MOBILE_MANUAL_INPUT_HOTP') ?></span>
                        <span class="type-title"
                              data-show-type="totp"><?= GetMessage('SEC_OTP_CONNECT_MOBILE_MANUAL_INPUT_TOTP') ?></span>
                        .
                    </div>
                    <div>
                        <div class="input-wrapper">
    ...
    <tr>
        <? if ($otp->isInitialized()): ?>
            ...
            <td style="text-align: right;">
                <a class="adm-btn-save adm-btn adm-btn-menu"
                   id="otp-connect-device"><?= GetMessage('SEC_OTP_CONNECT_DEVICE') ?></a>
...
<? else: ?>
    ...
    <tr>
        <td style="text-align: left;">
            ...
            <? endif; ?>
            <? if (Otp::isRecoveryCodesEnabled()): ?>
                <span class="otp-link-button"
                      id="otp-show-recovery-codes"><?= GetMessage('SEC_OTP_RECOVERY_CODES_BUTTON') ?></span>
            <? endif; ?>
        ...
        <td style="text-align: right;">
            <a class="adm-btn-save adm-btn adm-btn-menu"
               id="otp-connect-device"><?= GetMessage('SEC_OTP_CONNECT_NEW_DEVICE') ?></a>
            <a class="adm-btn-save adm-btn adm-btn-menu" id="otp-connect-mobile"
