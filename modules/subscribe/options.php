...
if ($POST_RIGHT >= "R") :
    ...
    $arAllOptions = array(
        ...
        array(
            ...
            GetMessage("opt_template_method"),
            array(
                "selectbox",
                array("agent" => GetMessage("opt_method_agent"), "cron" => GetMessage("opt_method_cron"))
            )
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    if ($type[0] == "checkbox") {
                        ...
                        $aVal = explode(",", $val);
                        foreach ($aVal as $val) {
                            ?><input type="text" size="<? echo $type[2] ?>" value="<? echo htmlspecialcharsbx($val) ?>"
                        ...
                        foreach ($type[1] as $optionValue => $optionDisplay) {
                            ?>
                            <option value="<? echo $optionValue ?>"<? if ($val == $optionValue) echo " selected" ?>><? echo htmlspecialcharsbx(
                                $optionDisplay
                            ) ?></option><?
                        }
                        ?></select><?
