...
while ($arRes = $rsData->NavNext(true, "f_")):
    ...
    switch ($f_STATUS) :
        ...
        case "P":
            ...
            break;
        case "E":
            $strStatus = '[E] ' . GetMessage("POST_STATUS_ERROR");
            break;
        case "D":
            $strStatus = '[D] ' . GetMessage("POST_STATUS_DRAFT");
            break;
        case "W":
            $strStatus = '[W] ' . GetMessage("POST_STATUS_WAIT");
            break;
    endswitch;
    if ($f_STATUS != "D") {
...
<form name="find_form" method="get" action="<? echo $APPLICATION->GetCurPage(); ?>">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="find_status" size="47"
                   value="<? echo htmlspecialcharsbx($find_status) ?>">&nbsp;<?= ShowFilterLogicHelp() ?><br>
            <?
            $arr = array(
                "reference" => array(
    ...
    <tr>
        ...
        <td><input type="text" name="find_from" size="47"
                   value="<? echo htmlspecialcharsbx($find_from) ?>">&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("POST_F_TO") ?>:</td>
        <td><input type="text" name="find_to" size="47"
                   value="<? echo htmlspecialcharsbx($find_to) ?>">&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("POST_F_SUBJECT") ?>:</td>
        <td><input type="text" name="find_subject" size="47"
                   value="<? echo htmlspecialcharsbx($find_subject) ?>">&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="find_body" size="47"
                   value="<? echo htmlspecialcharsbx($find_body) ?>"><?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
