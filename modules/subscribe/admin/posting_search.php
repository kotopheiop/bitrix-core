    ...
    <form method="GET" action="posting_search.php" name="post_form">
            ...
            <td width="60%">
                <div class="adm-list">
                    <div class="adm-list-item">
                        ...
                        <div class="adm-list-label"><label for="RUB_ID_ALL"><? echo GetMessage("MAIN_ALL") ?></label>
                        </div>
                    </div>
                    <?
                    if (!is_array($RUB_ID))
        ...
        <tr>
            ...
            <td>
                <div class="adm-list">
                    <div class="adm-list-item">
                        <div class="adm-list-control"><input type="checkbox" id="GROUP_ID_ALL" name="GROUP_ID_ALL"
                                                             value="Y" OnClick="CheckAll('GROUP_ID', true)"></div>
        ...
        <tr>
            ...
            <td><input type="text" name="EMAIL_FILTER" value="<? echo htmlspecialcharsbx($EMAIL_FILTER) ?>" size="30"
                       maxlength="255"></td>
        </tr>
        <?
        $tabControl->Buttons();
        ...
        if (count($aEmail) > 0):?>
            <h2><?
                echo GetMessage("post_result") ?></h2>
            <p class="subscribe_border">
                <?
                echo implode(", ", $aEmail) ?>
            </p>
            <p><?
            echo GetMessage("post_total") ?> <b><?
                echo count($aEmail); ?></b></p><?
        else:
        ...
        <input title="<? echo GetMessage("post_search_set_title") ?> (<? echo count($aEmail); ?>)" type="button"
               name="Set" value="<? echo GetMessage("post_set") ?>" OnClick="SetValues()" class="adm-btn-save">
