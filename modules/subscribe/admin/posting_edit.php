...
<form method="POST" Action="<? echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form">
        ...
        <td>
            <div class="adm-list">
                <div class="adm-list-item">
                    <div class="adm-list-control"><input type="checkbox" id="RUB_ID_ALL" name="RUB_ID_ALL" value="Y"
                                                         OnClick="CheckAll('RUB_ID', true)"></div>
    ...
    <tr>
        ...
        <td>
            <div class="adm-list">
                <div class="adm-list-item">
                    <div class="adm-list-control"><input type="checkbox" id="GROUP_ID_ALL" name="GROUP_ID_ALL" value="Y"
                                                         OnClick="CheckAll('GROUP_ID', true)"></div>
                    <div class="adm-list-label"><label for="GROUP_ID_ALL"><? echo GetMessage("MAIN_ALL") ?></label>
                    </div>
                </div>
                ...
                while ($ar = $group->GetNext()):
                    ?>
                    <div class="adm-list-item">
                        <div class="adm-list-control"><input type="checkbox" id="GROUP_ID_<?
                            echo $ar["ID"] ?>" name="GROUP_ID[]" value="<?
                            echo $ar["ID"] ?>"<?
                            if (in_array($ar["ID"], ($bVarsFromForm ? $GROUP_ID : $aPostGrp))) echo " checked" ?>
                                                             OnClick="CheckAll('GROUP_ID')"></div>
                        <div class="adm-list-label"><label for="GROUP_ID_<?
                            echo $ar["ID"] ?>"><?
                                echo $ar["NAME"] ?>&nbsp;[<a href="/bitrix/admin/group_edit.php?ID=<?
                                echo $ar["ID"] ?>&amp;lang=<?
                                echo LANGUAGE_ID ?>"><?
                                    echo $ar["ID"] ?></a>]</label></div>
                    </div>
                    <?
                    $n++;
                endwhile;
    ...
    <tr>
        ...
        <td><input type="text" name="EMAIL_FILTER" id="EMAIL_FILTER" value="<? echo $str_EMAIL_FILTER ?>" size="30"
                   maxlength="255"></td>
    </tr>
    <tr>
        <td colspan="2" align="center">
            ...
            [ <a class="tablebodylink" title="<? echo GetMessage("post_list_title") ?>"
                 href="javascript:ShowEMails()"><? echo GetMessage("post_filter_list") ?></a> ]
        </td>
    </tr>
    <tr class="heading">
    ...
    <tr>
        <td align="center" colspan="2"><textarea name="BCC_FIELD" cols="50" rows="7"
                                                 style="width:100%"><? echo $str_BCC_FIELD ?></textarea></td>
    </tr>
    <?
    //********************
    //Attachments
            ...
            <tr>
                ...
                <td width="60%">
                    <table border="0" cellspacing="0" cellpadding="0" class="internal">
                        <tr class="heading">
                            <td align="center"><?
                                echo GetMessage("post_file") ?></td>
                            <td align="center"><?
                                echo GetMessage("post_size") ?></td>
                        </tr>
                        <?
                        foreach ($tools->aMatches as $attachment):
                            ...
                            <tr>
                                <td><a href="<?
                                    echo $attachment["SRC"] ?>" target=_blank><?
                                        echo $attachment["DEST"] ?></a></td>
                                <td align="right"><?
                                    echo filesize($attachment["PATH"]) ?></td>
                            </tr>
                        <?endforeach; ?>
                    </table>
                </td>
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="internal">
                    ...
                    do {
                        ...
                        <tr>
                            <td>
                                <a href="posting_attachment.php?POSTING_ID=<? echo $ID ?>&amp;FILE_ID=<? echo $arFile["ID"] ?>"><? echo $arFile["ORIGINAL_NAME"] ?>
                                    <a></td>
                            ...
                            <td align="center">
                                ...
                                <? if ($bCopy):?>
                                    <input type="hidden" name="FILES[<? echo $arFile["ID"] ?>]"
                                           value="<? echo $arFile["ID"] ?>">
                                <? endif ?>
                            </td>
                        </tr>
    ...
    <tr>
        ...
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td><? echo CFile::InputFile("NEW_FILE[n0]", 40, 0) ?><br><br></td>
                </tr>
                <tr>
                    <td><? echo CFile::InputFile("NEW_FILE[n1]", 40, 0) ?><br><br></td>
                </tr>
                <tr>
                    <td><? echo CFile::InputFile("NEW_FILE[n2]", 40, 0) ?><br><br></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td width="60%">
            <select class="typeselect" name="CHARSET">
                ...
                foreach ($aCharset as $strCharset):
                    ?>
                    <option value="<?
                    echo htmlspecialcharsbx($strCharset) ?>"<?
    ...
    <? if ($str_STATUS == "D" || $str_STATUS == "W"): ?>
        <tr>
            ...
            <td>
                <input type="checkbox" name="AUTO_SEND_FLAG"
                       value="Y"<? if ($str_AUTO_SEND_FLAG == "Y") echo " checked" ?> OnClick="EnableAutoSend()">
            </td>
        </tr>
        <tr>
