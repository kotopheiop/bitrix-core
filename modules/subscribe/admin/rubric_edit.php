...
?>
    ...
    <tr>
        ...
        <td><textarea class="typearea" name="DESCRIPTION" cols="45" rows="5" wrap="VIRTUAL"
                      style="width:100%"><? echo $str_DESCRIPTION; ?></textarea></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
        ...
        <td><input class="typeinput" type="text" name="DAYS_OF_MONTH" value="<? echo $str_DAYS_OF_MONTH; ?>" size="30"
                   maxlength="100"></td>
    </tr>
    <tr>
        ...
        <td>
            <table>
                ...
                foreach ($arTemplates as $strTemplate):
                    ...
                    ?>
                    <tr>
                        <td class="adm-detail-valign-top"><input type="radio" id="TEMPLATE<?= $i ?>" name="TEMPLATE"
                                                                 value="<?= $arTemplate["PATH"] ?>"<? if ($str_TEMPLATE == $arTemplate["PATH"]) echo "checked" ?>>
                        </td>
                        <td>
