...
<? if ($arRubric): ?>
    <form method="POST" Action="<? echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form">
        ...
        <input <? if ($POST_RIGHT < "W") echo "disabled" ?> type="submit" name="Test"
                                                            value="<? echo GetMessage("rub_action") ?>"
                                                            title="<? echo GetMessage("rub_action_title") ?>"
                                                            class="adm-btn-save">
        <?
        $tabControl->End();
        ?>
    ...
    <? endif ?>
        ...
        <form method="post" action="posting_edit.php" ENCTYPE="multipart/form-data" name="add_form">
                ...
                foreach ($arFields["FILES"] as $i => $arFile) {
                    ...
                    if (is_array($arFile)) {
                        foreach ($arFile as $key => $value) {
                            ...
                            ?><input type="hidden" name="FILES[<? echo $i ?>][<? echo $key ?>]"
                                     value="<? echo $value ?>"><?
                        }
                    }
                }
            ...
            <input <? if ($POST_RIGHT < "W") echo "disabled" ?> type="submit" name="apply"
                                                                value="<?= GetMessage("rub_add_issue") ?>"
                                                                title="<?= GetMessage("rub_add_issue_act") ?>">
        </form>
    <? endif ?>
<? endif ?>
