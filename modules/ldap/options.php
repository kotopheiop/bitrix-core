...
echo $APPLICATION->GetCurPage() ?>?mid=<?= htmlspecialcharsbx($mid) ?>&lang=<?= LANGUAGE_ID ?>" name="ldap_settings">
    <?
    ...
    echo GetMessage("LDAP_OPTIONS_SAVE") ?>">
    <input type="reset" name="reset" value="<?
    echo GetMessage("LDAP_OPTIONS_RESET") ?>">
