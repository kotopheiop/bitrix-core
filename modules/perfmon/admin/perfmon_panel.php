...
//		COption::RemoveOption("perfmon", "total_mark_duration");
    ...
    <form method="POST" Action="<? echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form1">
        ...
        <p>
            ...
            <input type="submit" name="total_calc"
                   value="<? echo GetMessage("PERFMON_PANEL_BTN_START") ?>" <? if ($RIGHT < "W") echo "disabled" ?>>
    ...
    <form method="POST" Action="<? echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form">
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                    ...
                    ?>
                    <tr>
                        <td nowrap><? echo GetMessage("PERFMON_PANEL_SESSION") ?>
        ...
        <tr>
            ...
            <td width="60%"><input type="text" size="3"
                                   value="<? echo COption::GetOptionInt("perfmon", "test_threads_from") ?>"
                                   id="threads_from"></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_TO") ?></td>
            <td><input type="text" size="3" value="<? echo COption::GetOptionInt("perfmon", "test_threads_to") ?>"
                       id="threads_to"></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_STEP") ?></td>
            <td><input type="text" size="3" value="<? echo COption::GetOptionInt("perfmon", "test_threads_step") ?>"
                       id="threads_step"></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("PERFMON_PANEL_CLUSTER_SERVER_NAME") ?></td>
            <td><input type="text" size="35"
                       value="<? echo htmlspecialcharsbx(COption::GetOptionString("perfmon", "test_server_name")) ?>"
                       id="server_name"></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("PERFMON_PANEL_CLUSTER_SERVER_URL") ?></td>
            <td><input type="text" size="35"
                       value="<? echo htmlspecialcharsbx(COption::GetOptionString("perfmon", "test_server_url")) ?>"
                       id="server_url"></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_DURATION") ?></td>
            <td><input type="text" size="3" value="<? echo COption::GetOptionInt("perfmon", "test_threads_duration") ?>"
                       id="threads_duration"></td>
        </tr>
        <tr>
            <td colspan="2"><input type="button" id="threads_button"
                                   value="<? echo GetMessage("PERFMON_PANEL_CLUSTER_START") ?>" onclick="ThreadsTest()">
            </td>
        </tr>
        <tr class="heading">
