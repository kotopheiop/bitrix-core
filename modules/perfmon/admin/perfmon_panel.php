    ...
    if (
        ...
        <div style="text-align:center;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                <tr class="heading">
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_NN") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_CONCURRENCY") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_HITS") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_ERRORS") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_PAGES_PER_SECOND") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_PAGE_EXEC_TIME") ?></td>
                    <td align="center"><?
                        echo GetMessage("PERFMON_PANEL_CLUSTER_PAGE_RESP_TIME") ?></td>
                </tr>
                <?
                $i = 0;
                ...
                while ($ar = $rsData->Fetch()):
                    ...
                    <tr>
                        <td class="bx-digit-cell"><?
                            echo $i ?></td>
                        <td class="bx-digit-cell"><?
                            echo intval($ar["THREADS"]) ?></td>
                        <td class="bx-digit-cell"><?
                            echo intval($ar["HITS"]) ?></td>
                        <td class="bx-digit-cell"><?
                            echo intval($ar["ERRORS"]) ?></td>
                        <td class="bx-digit-cell"><?
                            echo number_format($ar["PAGES_PER_SECOND"], 2, ".", " ") ?></td>
                        <td class="bx-digit-cell"><?
                            echo number_format($ar["PAGE_EXEC_TIME"], 6, ".", " ") ?></td>
                        <td class="bx-digit-cell"><?
                            echo number_format($ar["PAGE_RESP_TIME"], 6, ".", " ") ?></td>
                    </tr>
                <?endwhile; ?>
                <?
                if (!$bFinish):?>
                    <tr>
                        <td colspan="7" id="measure_message"><?
                            echo GetMessage("PERFMON_PANEL_MEASURE") ?></td>
                    </tr>
                <?endif; ?>
            </table>
        </div>
        ...
        switch ($_REQUEST["test"]) {
            ...
            case "monitor":
                ...
                if (CPerfomanceKeeper::IsActive() || $duration > 0):
                    ...
                    echo GetMessage("PERFMON_PANEL_BTN_STOP") ?>" OnClick="javascript:StopTest()">
                    <script>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                        <tr class="heading">
                            <td width="40%" align="center"><?
                                echo GetMessage("PERFMON_PANEL_DEV_SCRIPT_NAME") ?></td>
                            <td width="0%" align="center"><?
                                echo GetMessage("PERFMON_PANEL_DEV_WARNINGS"), "<span class=\"required\"><sup>2</sup></span>" ?></td>
                            <td width="20%" align="center"><?
                                echo GetMessage("PERFMON_PANEL_DEV_PERCENT") ?></td>
                            <td width="20%" align="center"><?
                                echo GetMessage("PERFMON_PANEL_DEV_COUNT") ?></td>
                            <td width="20%" align="center"><?
                                echo GetMessage("PERFMON_PANEL_DEV_AVG_PAGE_TIME") ?></td>
                        </tr>
                        <?
                        $cData = new CPerfomanceHit;
                        ...
                        while (($ar = $rsData->Fetch()) && ($i > 0)):
                            ...
                            <tr>
                                <td><a href="<?
                                    echo htmlspecialcharsbx("perfmon_hit_list.php?lang=" . LANGUAGE_ID . "&set_filter=Y&find_script_name=" . urlencode($ar["SCRIPT_NAME"])) ?>"><?
                                        echo htmlspecialcharsEx($ar["SCRIPT_NAME"]) ?></a></td>
                                <td class="bx-digit-cell" id="err_count_<?
                                echo $i ?>"><?
                                    ...
                                    <?
                                    if ($err_count):?>
                                        <a href="javascript:void(0)" id="a_err_count_<?
                                        echo $i ?>"><?
                                            echo $err_count ?></a>
                                        <script>
                                ...
                                <td class="bx-digit-cell"><?
                                    echo number_format($ar["PERCENT"], 2) ?>%
                                </td>
                                <td class="bx-digit-cell"><?
                                    echo number_format($ar["COUNT"], 0, ".", " ") ?></td>
                                <td class="bx-digit-cell"><?
                                    echo number_format($ar["AVG_PAGE_TIME"], 4, ".", " ") ?></td>
                            </tr>
                        <?endwhile; ?>
                    </table>
                    <br/>
                    <a href="perfmon_hit_grouped.php?find_is_admin=N&amp;set_filter=Y&amp;lang=<?
                    echo LANGUAGE_ID ?>"><?
                        echo GetMessage("PERFMON_PANEL_DEV_GROUPED_HIT_LIST") ?></a>
                    <script>
                        CloseWaitWindow();
...
//		COption::RemoveOption("perfmon", "total_mark_duration");
    ...
    echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form1">
        ...
        <p>
            ...
            echo LANGUAGE_ID ?>">
            <input type="submit" name="total_calc" value="<?
            echo GetMessage("PERFMON_PANEL_BTN_START") ?>" <?
            ...
            &nbsp;<select name="total_duration">
                ...
                ?>
                <option value="60" <?
                if ($total_duration == 60) echo "selected" ?>><?
                    echo GetMessage("PERFMON_PANEL_INTERVAL_60_SEC") ?></option>
                <option value="300" <?
                if ($total_duration == 300) echo "selected" ?>><?
                    echo GetMessage("PERFMON_PANEL_INTERVAL_300_SEC") ?></option>
                <option value="600" <?
                if ($total_duration == 600) echo "selected" ?>><?
                    echo GetMessage("PERFMON_PANEL_INTERVAL_600_SEC") ?></option>
                <option value="1800" <?
                if ($total_duration == 1800) echo "selected" ?>><?
                    echo GetMessage("PERFMON_PANEL_INTERVAL_1800_SEC") ?></option>
                <option value="3600" <?
                if ($total_duration == 3600) echo "selected" ?>><?
                    echo GetMessage("PERFMON_PANEL_INTERVAL_3600_SEC") ?></option>
            </select>
        </p>
        <?
    ...
    <form method="POST" Action="<?
    echo $APPLICATION->GetCurPage() ?>" ENCTYPE="multipart/form-data" name="post_form">
        <?
        $tabControl->Begin(); ?>
        <?
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                    <tr class="heading">
                        <td width="20%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_PERF_PARAMETER") ?></td>
                        <td width="20%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_PERF_SCORE") ?></td>
                        <td width="20%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_PERF_SAMPLE") ?></td>
                        <td width="40%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_PERF_VALUE") ?></td>
                    </tr>
                    <?
                    $mark_value = COption::GetOptionString("perfmon", "mark_php_page_rate", "");
                    ?>
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_PAGE_RATE") ?></td>
                        <?
                        if ($mark_value == "measure"):?>
                            <td class="bx-digit-cell"><b>
                                    ...
                                    <div id="page_rate_result"><?
                                        echo GetMessage("PERFMON_PANEL_MEASURE") ?></div>
                                </b></td>
                        <? elseif (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell"><b><?
                                    echo $mark_value ?></b></td>
                        <? else:?>
                            <td class="bx-digit-cell"><b><?
                                    echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></b></td>
                        <?endif ?>
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_PAGE_TIME") ?></td>
                        <?
                        if ($mark_value == "measure"):?>
                            <td class="bx-digit-cell" id="page_time_result"><?
                                echo GetMessage("PERFMON_PANEL_MEASURE") ?></td>
                        <? elseif (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="page_time_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="page_time_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        <?endif ?>
                        <td class="bx-digit-cell">0.0330</td>
                        <td><?
                            echo GetMessage("PERFMON_PANEL_PAGE_TIME_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_CPU") ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_php_cpu_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_php_cpu_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_CPU_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_FILES") ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_php_files_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_php_files_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_FILES_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_MAIL") ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_php_mail_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_php_mail_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_MAIL_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_SESSION") ?>
                            <div id="session_time_result_hidden" style="display:none"></div>
                        </td>
                        <?
                        if ($mark_value == -1):?>
                            <td class="bx-digit-cell" id="session_time_result"><?
                                echo GetMessage("PERFMON_PANEL_SESSION_ERR") ?><span class="required"><sup>3</sup></td>
                        <? elseif (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="session_time_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_SESSION_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_PHP") ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_php_is_good_result"><?
                                echo($mark_value == "N" ? "<span class=\"errortext\">" . GetMessage("PERFMON_PANEL_MARK_PHP_IS_NO_GOOD") . "</span>" : GetMessage("PERFMON_PANEL_MARK_PHP_IS_GOOD")) ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_php_is_good_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        <?endif ?>
                        <td class="bx-digit-cell"><?
                            echo GetMessage("PERFMON_PANEL_MARK_PHP_IS_GOOD") ?></td>
                        <td><a href="perfmon_php.php?lang=<?
                            echo LANGUAGE_ID ?>"><?
                                echo GetMessage("PERFMON_PANEL_PHP_REC") ?></a></td>
                    </tr>
                    <?
                    if ($DB->type == "MYSQL")
                        $db_type = "MySQL";
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_INSERT_VALUE", array("#database_type#" => $db_type)) ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_db_insert_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_db_insert_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_INSERT_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_READ_VALUE", array("#database_type#" => $db_type)) ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_db_read_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_db_read_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_READ_UNITS") ?></td>
                    </tr>
                    <?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_UPDATE_VALUE", array("#database_type#" => $db_type)) ?></td>
                        <?
                        if (strlen($mark_value) > 0):?>
                            <td class="bx-digit-cell" id="mark_db_update_value_result"><?
                                echo $mark_value ?></td>
                        <? else:?>
                            <td class="bx-digit-cell" id="mark_db_update_value_result"><?
                                echo GetMessage("PERFMON_PANEL_UNKNOWN") ?></td>
                        ...
                        <td><?
                            echo GetMessage("PERFMON_PANEL_MARK_DB_UPDATE_UNITS") ?></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="hidden" name="lang" value="<?
                echo LANGUAGE_ID ?>">
                <input type="submit" name="calc" id="calc" value="<?
                echo GetMessage("PERFMON_PANEL_BTN_TEST") ?>" <?
                if ($RIGHT < "W" || COption::GetOptionString("perfmon", "total_mark_value") == "measure") echo "disabled" ?>
                       class="adm-btn-save">
            </td>
        </tr>
        <?
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                    <tr class="heading">
                        <td width="40%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_BITRIX_PARAMETER") ?></td>
                        <td width="30%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_BITRIX_VALUE") ?></td>
                        <td width="30%" align="center"><?
                            echo GetMessage("PERFMON_PANEL_BITRIX_RECOMMENDATION") ?></td>
                    </tr>
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_COMPONENT_CACHE") ?></td>
                        <?
                        if ($bComponentCache):?>
                            <td class="bx-digit-cell"><?
                                echo GetMessage("PERFMON_PANEL_COMPONENT_CACHE_ON") ?></td>
                            <td>&nbsp;</td>
                        <? else:?>
                            <td class="bx-digit-cell"><?
                                echo GetMessage("PERFMON_PANEL_COMPONENT_CACHE_OFF") ?></td>
                            <td><a href="cache.php?lang=<?
                                echo LANGUAGE_ID ?>"><?
                                    echo GetMessage("PERFMON_PANEL_COMPONENT_CACHE_REC") ?></a></td>
                        <?endif ?>
                    </tr>
                    <?
                    if (IsModuleInstalled('statistic')):?>
                        <tr>
                            <td nowrap><?
                                echo GetMessage("PERFMON_PANEL_STAT_SAVE_PATH") ?></td>
                            <?
                            if ($statistic_path):?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_STAT_SAVE_PATH_ON") ?></td>
                                <td><a href="settings.php?lang=<?
                                    echo LANGUAGE_ID ?>&amp;mid=statistic&amp;tabControl_active_tab=edit2&amp;back_url_settings=<?
                                    echo urlencode($APPLICATION->GetCurPageParam("tabControl_active_tab=bitrix", array("tabControl_active_tab"))) ?>"><?
                                        echo GetMessage("PERFMON_PANEL_STAT_SAVE_PATH_REC") ?></a></td>
                            <? else:?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_STAT_SAVE_PATH_OFF") ?></td>
                                <td>&nbsp;</td>
                            <?endif ?>
                        </tr>
                    <?endif ?>
                    ...
                    if (IsModuleInstalled('advertising')):?>
                        <tr>
                            <td nowrap><?
                                echo GetMessage("PERFMON_PANEL_ADV_BANNERS_FIX_SHOWS") ?></td>
                            <?
                            if ($adv_banners_fix_shows):?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_ADV_BANNERS_FIX_SHOWS_ON") ?></td>
                                <td><a href="settings.php?lang=<?
                                    echo LANGUAGE_ID ?>&amp;mid=advertising&amp;back_url_settings=<?
                                    echo urlencode($APPLICATION->GetCurPageParam("tabControl_active_tab=bitrix", array("tabControl_active_tab"))) ?>"><?
                                        echo GetMessage("PERFMON_PANEL_ADV_BANNERS_FIX_SHOWS_REC") ?></a></td>
                            <? else:?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_ADV_BANNERS_FIX_SHOWS_OFF") ?></td>
                                <td>&nbsp;</td>
                            <?endif ?>
                        </tr>
                    <?endif ?>
                    ...
                    if (IsModuleInstalled('search')):?>
                        <tr>
                            <td nowrap><?
                                echo GetMessage("PERFMON_PANEL_SEARCH_STEM") ?></td>
                            <?
                            if ($search_is_ok):?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_SEARCH_STEM_ON") ?></td>
                                <td>&nbsp;</td>
                            <? else:?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_SEARCH_STEM_OFF") ?></td>
                                <td><a href="settings.php?lang=<?
                                    echo LANGUAGE_ID ?>&amp;mid=search&amp;back_url_settings=<?
                                    echo urlencode($APPLICATION->GetCurPageParam("tabControl_active_tab=bitrix", array("tabControl_active_tab"))) ?>"><?
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_CACHE_STORAGE") ?></td>
                        <?
                        ...
                        <td class="bx-digit-cell"><?
                            echo $cache_type ?></td>
                        <td><?
                            echo GetMessage("PERFMON_PANEL_CACHE_STORAGE_REC"); ?></td>
                    </tr>
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_MANAGED_CACHE") ?></td>
                        <?
                        if ($bManagedCache):?>
                            <td class="bx-digit-cell"><?
                                echo GetMessage("PERFMON_PANEL_MANAGED_CACHE_ON") ?></td>
                            <td>&nbsp;</td>
                        <? else:?>
                            <td class="bx-digit-cell"><a href="javascript:void()"
                                                         OnClick="BX('managed_cache_details').style.display='block';return false;"><?
                                    echo GetMessage("PERFMON_PANEL_MANAGED_CACHE_OFF") ?></a>
                                <div id="managed_cache_details" style="display:none"><?
                                    echo implode("<br>", $arConstants) ?></div>
                            </td>
                            <td><?
                                echo GetMessage("PERFMON_PANEL_MANAGED_CACHE_REC", array(
                                    "#file#" => (
                    ...
                    <tr>
                        <td nowrap><?
                            echo GetMessage("PERFMON_PANEL_ENC_MODULES") ?></td>
                        <?
                        if ($bEncodedModules):?>
                            <td class="bx-digit-cell"><?
                                echo GetMessage("PERFMON_PANEL_ENC_MODULES_OFF") ?></td>
                            <td>&nbsp;</td>
                        <? else:?>
                            <td class="bx-digit-cell"><a href="javascript:void()"
                                                         OnClick="BX('encoded_modules_details').style.display='block';return false;"><?
                                    echo GetMessage("PERFMON_PANEL_ENC_MODULES_ON") ?></a>
                                <div id="encoded_modules_details" style="display:none"><?
                                    echo implode("<br>", $arEncodedModules) ?></div>
                            </td>
                            <td><?
                                echo GetMessage("PERFMON_PANEL_ENC_MODULES_REC"); ?></td>
                        <?endif ?>
                    </tr>
                    <?
                    if ($DB->type == "MYSQL"):?>
                        <tr>
                            <td nowrap><?
                                echo GetMessage("PERFMON_PANEL_DB_OPTIMIZE") ?></td>
                            <?
                            if ($bOptimized):?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_DB_OPTIMIZE_IS_OK") ?></td>
                                <td>&nbsp;</td>
                            <? else:?>
                                <td class="bx-digit-cell"><?
                                    echo GetMessage("PERFMON_PANEL_DB_OPTIMIZE_NEEDED") ?></td>
                                <td><a href="repair_db.php?lang=<?
                                    echo LANGUAGE_ID ?>&amp;optimize_tables=Y"><?
                                        echo GetMessage("PERFMON_PANEL_DB_OPTIMIZE_REC") ?></a></td>
                            <?endif ?>
                        </tr>
                    <?endif ?>
                </table>
        ...
        <tr>
            <td nowrap width="40%"><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_FROM") ?></td>
            <td width="60%"><input type="text" size="3" value="<?
                echo COption::GetOptionInt("perfmon", "test_threads_from") ?>" id="threads_from"></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_TO") ?></td>
            <td><input type="text" size="3" value="<?
                echo COption::GetOptionInt("perfmon", "test_threads_to") ?>" id="threads_to"></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_STEP") ?></td>
            <td><input type="text" size="3" value="<?
                echo COption::GetOptionInt("perfmon", "test_threads_step") ?>" id="threads_step"></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_SERVER_NAME") ?></td>
            <td><input type="text" size="35" value="<?
                echo htmlspecialcharsbx(COption::GetOptionString("perfmon", "test_server_name")) ?>" id="server_name">
            </td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_SERVER_URL") ?></td>
            <td><input type="text" size="35" value="<?
                echo htmlspecialcharsbx(COption::GetOptionString("perfmon", "test_server_url")) ?>" id="server_url">
            </td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_THREADS_DURATION") ?></td>
            <td><input type="text" size="3" value="<?
                echo COption::GetOptionInt("perfmon", "test_threads_duration") ?>" id="threads_duration"></td>
        </tr>
        <tr>
            <td colspan="2"><input type="button" id="threads_button" value="<?
                echo GetMessage("PERFMON_PANEL_CLUSTER_START") ?>" onclick="ThreadsTest()"></td>
        </tr>
        <tr class="heading">
            <td colspan="2"><?
                echo GetMessage("PERFMON_PANEL_CLUSTER_RESULTS") ?></td>
        </tr>
        ...
        <tr>
                ...
                <div style="text-align:center;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="internal" width="100%">
                        ...
                        if ($i == 0):?>
                            <tr>
                                <td colspan="7"><?
                                    echo GetMessage('admin_lib_no_data') ?></td>
                            </tr>
                        <?endif; ?>
                    </table>
                </div>
            ...
            $height = 200; ?>
            <td width="<?
            echo $width ?>" align="center" class="adm-detail-valign-top">
                <div id="img_PAGES_PER_SECOND">
                    <?
                    echo GetMessage("PERFMON_PANEL_CLUSTER_PAGES_PER_SECOND") ?><br>
                    <img class="graph"
                         src="/bitrix/admin/perfmon_cluster_graph.php?rand=<?= rand() ?>&amp;find_data_type=PAGES_PER_SECOND&amp;width=<?
                         echo $width ?>&amp;height=<?
                         echo $height ?>&amp;lang=<?
                         echo LANGUAGE_ID ?>" width="<?
                    echo $width ?>" height="<?
                    echo $height ?>">
                </div>
                <br/>
                <div id="img_PAGE_EXEC_TIME">
                    ...
                    <img class="graph"
                         src="/bitrix/admin/perfmon_cluster_graph.php?rand=<?= rand() ?>&amp;find_data_type=PAGE_EXEC_TIME&amp;width=<?
                         echo $width ?>&amp;height=<?
                         echo $height ?>&amp;lang=<?
                         echo LANGUAGE_ID ?>" width="<?
                    echo $width ?>" height="<?
