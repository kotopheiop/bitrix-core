...
class CPerfmonListColumnRequestUri extends CAdminListColumn
{
    ...
    function getRowView($arRes)
    {
        ...
        return '<a href="' . htmlspecialcharsbx($url) . '" title="' . htmlspecialcharsbx(
                $url
            ) . '">&gt;&gt;</a>&nbsp;<a href="perfmon_sql_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=' . urlencode(
                $arRes["ID"]
            ) . '" title="' . urlencode($arRes["REQUEST_URI"]) . '">' . (mb_strlen(
                $arRes["REQUEST_URI"]
            ) > $this->max_display_url ? mb_substr(
                    $arRes["REQUEST_URI"],
                    0,
                    $this->max_display_url
                ) . "..." : $arRes["REQUEST_URI"]) . '</a> ';
    }
}
...
$page = new CPerfmonHitList(
    GetMessage("PERFMON_HIT_TITLE"),
    "tbl_perfmon_hit_list",
    array("PAGE_TIME" => "desc"),
    GetMessage("PERFMON_HIT_PAGE")
);

$page->addColumn(
    new CAdminListColumn(
        "ID", array(
...
$page->addColumn(
    new CPerfmonHitListColumnFullDate(
        "DATE_HIT", array(
...
$page->addColumn(
    new CPerfmonListColumnRequestUri(
        "REQUEST_URI", array(
...
$page->addColumn(
    new CPerfmonListColumnTemplate(
        "COMPONENTS",
        array(
        ...
        0,
        '<a href="perfmon_comp_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=#ID#">#COMPONENTS#</a>'
    )
);

$page->addColumn(
    new CAdminListColumnNumber(
        "COMPONENTS_TIME", array(
...
$page->addColumn(
    new CPerfmonListColumnTemplate(
        ...
        0,
        '<a href="perfmon_cache_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=#ID#">#CACHE_COUNT#</a>'
    )
);
...
$page->addColumn(
    new CPerfmonListColumnTemplate(
        ...
        0,
        '<a href="perfmon_cache_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=#ID#&amp;find_op_mode=R">#CACHE_COUNT_R#</a>'
    )
);
...
$page->addColumn(
    new CPerfmonListColumnTemplate(
        ...
        0,
        '<a href="perfmon_cache_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=#ID#&amp;find_op_mode=W">#CACHE_COUNT_W#</a>'
    )
);
...
$page->addColumn(
    new CPerfmonListColumnTemplate(
        ...
        0,
        '<a href="perfmon_cache_list.php?lang=' . LANGUAGE_ID . '&amp;set_filter=Y&amp;find_hit_id=#ID#&amp;find_op_mode=C">#CACHE_COUNT_C#</a>'
    )
);
