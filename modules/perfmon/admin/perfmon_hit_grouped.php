...
<form name="find_form" method="get" action="<? echo $APPLICATION->GetCurPage(); ?>">
    ...
    <tr>
        ...
        <td><input type="text" name="find_count_from" size="7" value="<? echo htmlspecialcharsbx($find_count_from) ?>">...<input
                    type="text" name="find_count_to" size="7" value="<? echo htmlspecialcharsbx($find_count_to) ?>">
        </td>
    </tr>
    <?
