        ...
        <? if ($isAdmin) {
            ...
            <tr>
                ...
                <td valign="middle">
                    ...
                    echo GetMessage("PERFMON_IDETAIL_CREATE_INDEX") ?>" name="create_index" class="adm-btn-green">
                    <span style="line-height:27px"><?
                        echo GetMessage("PERFMON_IDETAIL_OR") ?></span>
                    <input type="submit" value="<?
                    echo GetMessage("PERFMON_IDETAIL_BAN_INDEX") ?>" name="ban_index">
                </td>
            </tr>
        <?
        }
    ...
    <? else: ?>
        ...
        <? if ($isAdmin) {
            ...
            <tr>
                ...
                <td>
                    <input type="submit" value="<?
                    echo GetMessage("PERFMON_IDETAIL_DROP_INDEX") ?>" name="drop_index">
                </td>
            </tr>
        <?
        }
        ...
        if ($ratio > 1) {
            ...
            <tr>
                ...
                <td><span class="notetext"><?
                        echo perfmon_NumberFormat($ratio * 100, 2), "%" ?></span></td>
            </tr>
        <?
        }
        ?>
