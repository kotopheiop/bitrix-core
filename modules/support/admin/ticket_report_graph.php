                                ...
                                <table cellpadding="1" cellspacing="0" border="0">
                                    <tr>
                                        <td valign="center" nowrap><img
                                                    src="/bitrix/admin/ticket_graph.php?<?= GetFilterParams($arFilterFields) ?>&width=<?= $width ?>&height=<?= $height ?>&lang=<?
                                                    echo LANG ?>" width="<?= $width ?>" height="<?= $height ?>"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td valign="center">
                                    <table cellspacing=0 cellpadding=0>
                                        <tr>
                                            <td style="background-color: <?= "#" . $color ?>"><img
                                                        src="/bitrix/images/1.gif" width="12" height="12" border=0></td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        while (list($key, $counter) = each($arrMess)) :
                            ...
                            <tr>
                                ...
                                <td nowrap><img src="/bitrix/images/1.gif" width="3" height="1"><a
                                            href="/bitrix/admin/ticket_list.php?<?= GetFilterParams($FilterArr1) ?>&find_close=Y&lang=<?= LANG ?>&<?
                                            echo $f ?>&set_filter=Y"><?= $counter ?></a></td>
                                <td nowrap><?
                                    echo GetMessage("SUP_DIAGRAM_MESS_" . $key); ?></td>
                            </tr>
                        <?endwhile; ?>
                    </table>
                </td>
