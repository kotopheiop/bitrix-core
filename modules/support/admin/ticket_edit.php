                                                                            ...
                                                                            <td <?= $headerbackcolor ?>
                                                                                ...
                                                                                foreach ($ALL_TICKET_FILES[$arM["ID"]] as $arFile) {
                                                                                    if (in_array(strtolower(GetFileExtension($arFile["NAME"])), $aImg)):
                                                                                        ...
                                                                                        target="_blank"
                                                                                        href="/bitrix/tools/ticket_show_file.php?hash=<?
                                                                                        echo $arFile["HASH"] ?>&lang=<?= LANGUAGE_ID ?>"><?
                                                                                        echo htmlspecialcharsbx($arFile["NAME"]) ?></a>
                                                                                    <? else:?>
                                                                                        <?
																		...
																		echo round($size,2)." ".$a[$pos];*/
                                                                            ...
                                                                            <td <?= $headerbackcolor ?>
                                                                                ...
                                                                                foreach ($ALL_TICKET_FILES[$arM["ID"]] as $arFile) {
                                                                                    ...
                                                                                    ?>&nbsp;[<a title="<?= $alt ?>"
                                                                                                href="/bitrix/tools/ticket_show_file.php?hash=<?
                                                                                                echo $arFile["HASH"] ?>&lang=<?= LANGUAGE_ID ?>&action=download"><?
                                                                                        echo GetMessage("SUP_DOWNLOAD") ?></a>]
                                                                                    <br><?
                                                                                }
                                                                                ?></td>
                                                                        </tr>
            ...
            <td style="padding:0px" nowrap id="edit_9">
                ...
                <table cellspacing=0 cellpadding=0 border=0 id="files_table">
                    ...
                    if (isset($arFiles)) {
						...
						echo round($size,2)." ".$a[$pos];*/
                                    echo CFile::FormatSize($arFile["FILE_SIZE"]);
                                    ?>)&nbsp;&nbsp;[&nbsp;<a href="/bitrix/tools/ticket_show_file.php?hash=<?
                                    echo $arFile["HASH"] ?>&lang=<?= LANG ?>&action=download"><?
                                        echo GetMessage("SUP_DOWNLOAD") ?></a>&nbsp;]&nbsp;&nbsp;<input type="checkbox"
                                                                                                        name="ATTACH_FILE[]"
                                                                                                        value="<?= $arFile["ID"] ?>"
                                                                                                        checked>
                                </td>
