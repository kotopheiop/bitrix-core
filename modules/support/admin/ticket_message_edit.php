...
?>
    <form name="form1" method="POST"
          action="<?= $APPLICATION->GetCurPage() ?>?ID=<?= $ID ?>&TICKET_ID=<?= $TICKET_ID ?>&lang=<?= LANG ?>"
            ...
            <td align="left" width="80%"><?= $str_DATE_CREATE ?>&nbsp;&nbsp;&nbsp;<?
                if (strlen($str_CREATED_MODULE_NAME) <= 0 || $str_CREATED_MODULE_NAME == "support") :
                    ?>[<a title="<?= GetMessage("SUP_USER_PROFILE") ?>"
                          href="/bitrix/admin/user_edit.php?lang=<?= LANG ?>&ID=<?= $str_CREATED_USER_ID ?>"><?
                    echo $str_CREATED_USER_ID ?></a>] (<?= $str_CREATED_LOGIN ?>) <?= $str_CREATED_NAME ?><?
                            ...
                            <tr>
                                <td><?
                                    ...
                                    echo $arFile["HASH"] ?>&lang=<?= LANG ?>&action=download"><?
                                        echo GetMessage("SUP_DOWNLOAD") ?></a>&nbsp;]&nbsp;&nbsp;<?= GetMessage("SUP_DELETE") ?>
        ...
        <tr>
            ...
            <td><input type="text" name="TASK_TIME" id="TASK_TIME" size="7" maxlength="10"
                       value="<?= $str_TASK_TIME ?>"></td>
        </tr>
        <tr valign="top">
            <td><?= GetMessage("SUP_EXTERNAL_FIELD_1") ?></td>
            <td><textarea name="EXTERNAL_FIELD_1" style="width:100%;height:150px;"
                          wrap="virtual"><?= $str_EXTERNAL_FIELD_1 ?></textarea></td>
        </tr>
        <?
