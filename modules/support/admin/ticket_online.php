            ...
            <tr>
                <td valign="top" width="16%"><?
                    if ($is_support == "Y"):
                        if ($ar["CURRENT_MODE"] == "edit"):
                            ?><img src="/bitrix/images/support/sup_write.gif" width="15" height="13" border="0"
                                   alt="<?= GetMessage("SUP_EDIT_MODE_ALT") ?>"><?
                        else:
                            ?><img src="/bitrix/images/support/sup_view.gif" width="17" height="13" border="0"
                                   alt="<?= GetMessage("SUP_VIEW_MODE_ALT") ?>"><?
                        endif;
                    elseif ($is_support == "N"):
                    ?><img src="/bitrix/images/support/client.gif" width="11" height="13" border="0"
                           alt="<?= GetMessage("SUP_CLIENT_MODE_ALT") ?>"><?
                    endif;
                    ?></font></td>
                ...
                <td width="84%" valign="top"><?
                    if (trim($ar["USER_NAME"]) <> ''):
                        ...
                        ?><a title="<?= GetMessage("SUP_USER_PROFILE") ?>" target="_blank"
                             href="/bitrix/admin/user_edit.php?lang=<?= LANGUAGE_ID ?>&ID=<?= $ar["USER_ID"] ?>"><?= $ar["USER_LOGIN"] ?></a>
                    <?
                    endif;
                    ?></td>
            </tr>
...
if ($lamp <> '') {
    ...
    <script type="text/javascript">
        ...
        }, <?=intval($ONLINE_AUTO_REFRESH)?>000);
        <?endif?>
    ...
    <table cellspacing=0 cellpadding=0 class="support-online">
        <tr>
            ...
            <td width="100%">
                <div class="lamp-<?= str_replace("_", "-", $lamp) ?>" title="<?= $lamp_alt ?>">
            </td>
        </tr>
    </table>
<? } ?>
