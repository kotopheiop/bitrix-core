...
class CAllForm extends CForm_old
{
    ...
    public static function GetResultAnswerArray(
        $WEB_FORM_ID,
        &$arrColumns,
        &$arrAnswers,
        &$arrAnswersSID,
        ...
        if (is_array($arFilter)) {
            if ($arFilter["FIELD_SID"] <> '') {
                $arFilter["FIELD_VARNAME"] = $arFilter["FIELD_SID"];
            } elseif ($arFilter["FIELD_VARNAME"] <> '') {
                $arFilter["FIELD_SID"] = $arFilter["FIELD_VARNAME"];
            }
    ...
    public static function GetPermission($form_id, $arGroups = false, $get_from_database = "")
    {
        ...
        if (CForm::IsAdmin() && $get_from_database != "Y") {
            $right = 30;
        } else {
        ...
        $right = intval($right);
        if ($right <= 0 && $get_from_database != "Y") {
            $right = $default_right;
        }
        return $right;
    }
    ...
    public static function GetTextFilter(
        $FID,
        $size = "45",
        $field_text = "class=\"inputtext\"",
        $field_checkbox = "class=\"inputcheckbox\""
    ) {
        $var = "find_" . $FID;
        $var_exec_match = "find_" . $FID . "_exact_match";
        global ${$var}, ${$var_exec_match};
        $checked = (${$var_exec_match} == "Y") ? "checked" : "";
        return '<input ' . $field_text . ' type="text" name="' . $var . '" size="' . $size . '" value="' . htmlspecialcharsbx(
                ${$var}
            ) . '"><input ' . $field_checkbox . ' type="checkbox" value="Y" name="' . $var . '_exact_match" title="' . GetMessage(
                "FORM_EXACT_MATCH"
            ) . '" ' . $checked . '>' . ShowFilterLogicHelp();
    }
    ...
    public static function GetDateFilter(
        ...
        $form_name = "form1",
        $show_select = "Y",
        $field_select = "class=\"inputselect\"",
        $field_input = "class=\"inputtext\""
    ) {
        $var1 = "find_" . $FID . "_1";
        $var2 = "find_" . $FID . "_2";
    ...
    public static function GetNumberFilter($FID, $size = "10", $field = "class=\"inputtext\"")
    {
        ...
        $var2 = "find_" . $FID . "_2";
        global ${$var1}, ${$var2};
        return '<input ' . $field . ' type="text" name="' . $var1 . '" size="' . $size . '" value="' . htmlspecialcharsbx(
                ${$var1}
            ) . '">&nbsp;' . GetMessage(
                "FORM_TILL"
            ) . '&nbsp;<input ' . $field . ' type="text" name="' . $var2 . '" size="' . $size . '" value="' . htmlspecialcharsbx(
                ${$var2}
            ) . '">';
    }
    ...
    public static function GetDropDownFilter($ID, $PARAMETER_NAME, $FID, $field = "class=\"inputselect\"")
    {
        ...
        if ($PARAMETER_NAME == "ANSWER_VALUE") {
            $str = ", VALUE as REFERENCE";
        } else {
            $str = ", MESSAGE as REFERENCE";
        }
        $ID = intval($ID);
        $strSql = "
			SELECT
    ...
    public static function GetTextField($FIELD_NAME, $VALUE = "", $SIZE = "", $PARAM = "")
    {
        ...
        return '<input type="text" ' . $PARAM . ' name="form_text_' . $FIELD_NAME . '" value="' . htmlspecialcharsbx(
                $VALUE
            ) . '"' . $sizeAttr . '>';
    }
    ...
    {
        return "<input type=\"hidden\" " . $PARAM . " name=\"form_hidden_" . $FIELD_NAME . "\" value=\"" . htmlspecialcharsbx(
                $VALUE
            ) . "\" />";
    }
    ...
    public static function GetEmailField($FIELD_NAME, $VALUE = "", $SIZE = "", $PARAM = "")
    {
        ...
        return "<input type=\"text\" " . $PARAM . " name=\"form_email_" . $FIELD_NAME . "\" value=\"" . htmlspecialcharsbx(
                $VALUE
            ) . "\" size=\"" . $SIZE . "\" />";
    }
    ...
    public static function GetUrlField($FIELD_NAME, $VALUE = "", $SIZE = "", $PARAM = "")
    {
        ...
        return "<input type=\"text\" " . $PARAM . " name=\"form_url_" . $FIELD_NAME . "\" value=\"" . htmlspecialcharsbx(
                $VALUE
            ) . "\" size=\"" . $SIZE . "\" />";
    }
    ...
    public static function GetPasswordField($FIELD_NAME, $VALUE = "", $SIZE = "", $PARAM = "")
    {
        ...
        return "<input type=\"password\" " . $PARAM . " name=\"form_password_" . $FIELD_NAME . "\" value=\"" . htmlspecialcharsbx(
                $VALUE
            ) . "\" size=\"" . $SIZE . "\" />";
    }
    ...
    public static function GetDropDownValue($FIELD_NAME, $arDropDown, $arrVALUES = false)
    {
        ...
        if (is_array($arrVALUES) && isset($arrVALUES[$fname])) {
            ...
            if ($c > 0) {
                for ($i = 0; $i <= $c - 1; $i++) {
                    if (mb_strpos(
                            mb_strtolower($arDropDown[$FIELD_NAME]["param"][$i]),
                            "selected"
                        ) !== false || mb_strpos(
                            mb_strtolower($arDropDown[$FIELD_NAME]["param"][$i]),
                            "checked"
    ...
    public static function GetMultiSelectValue($FIELD_NAME, $arMultiSelect, $arrVALUES = false)
    {
        ...
        if (is_array($arrVALUES) && isset($arrVALUES[$fname])) {
            ...
            if ($c > 0) {
                for ($i = 0; $i <= $c - 1; $i++) {
                    if (mb_strpos(
                            mb_strtolower($arMultiSelect[$FIELD_NAME]["param"][$i]),
                            "selected"
                        ) !== false || mb_strpos(
                            mb_strtolower($arMultiSelect[$FIELD_NAME]["param"][$i]),
                            "checked"
    ...
    public static function GetMultiSelectField(
        $FIELD_NAME,
        $arMultiSelect,
        $arSELECTED = array(),
        $HEIGHT = "",
    ...
    public static function GetDateField($FIELD_NAME, $FORM_NAME, $VALUE = "", $FIELD_WIDTH = "", $PARAM = "")
    {
        ...
        $rid = RandString(8);
        $res = "<input type=\"text\" " . $PARAM . " name=\"form_date_" . $FIELD_NAME . "\" id=\"form_date_" . $rid . "\" value=\"" . htmlspecialcharsbx(
                $VALUE
            ) . "\" size=\"" . $FIELD_WIDTH . "\" />";
    ...
    public static function GetCheckBoxValue($FIELD_NAME, $arAnswer, $arrVALUES = false)
    {
        ...
        if (is_array($arrVALUES)) {
            ...
            if ($value <= 0) {
                if (mb_strpos(mb_strtolower($arAnswer["FIELD_PARAM"]), "selected") !== false || mb_strpos(
    ...
    public static function GetTextAreaField($FIELD_NAME, $WIDTH = "", $HEIGHT = "", $PARAM = "", $VALUE = "")
    {
        ...
        return '<textarea name="form_textarea_' . $FIELD_NAME . '"' . $colsAttr . $rowsAttr . $PARAM . ' >' . htmlspecialcharsbx(
                $VALUE
            ) . '</textarea>';
    }
    ...
    public static function GetFileField(
        ...
        return CFile::InputFile(
            "form_" . mb_strtolower($FILE_TYPE) . "_" . $FIELD_NAME,
            $WIDTH,
            $VALUE,
            false,
            $MAX_FILE_SIZE,
    ...
    public static function GetDataByID(
        ...
        if ($arForm = $z->Fetch()) {
            ...
            $u = CFormField::GetList(
                $WEB_FORM_ID,
                $additional,
                "s_c_sort",
                "asc",
                $active == "N" ? array("ACTIVE" => "Y") : array()
            );
            while ($ur = $u->Fetch()) {
                $arQuestions[$ur["SID"]] = $ur;
                $w = CFormAnswer::GetList(
                    $ur["ID"],
                    "s_c_sort",
                    "asc",
                    ($active == "N" ? array("ACTIVE" => "Y") : array())
            ...
            if (is_array($arQuestions) && is_array($arAnswers)) {
                foreach ($arQuestions as $arQ) {
                    ...
                    if (count($arMultiReference) > 0) {
                        $arMultiSelect[$QUESTION_ID] = array(
    ...
    public static function __check_PushError(&$container, $MESSAGE, $key = false)
    {
        if (is_array($container)) {
            ...
            $container .= ($container <> '' ? "<br />" : "") . $MESSAGE;
        }
    }
            ...
            if ($WEB_FORM_ID > 0) {
                ...
                if ($F_RIGHT < 10) {
                                    ...
                                    switch ($FIELD_TYPE) :
                                        ...
                                        case "dropdown":
                                            ...
                                            if ($ANSWER_ID > 0 && $ANSWER_ID == $arAnswer["ID"]) {
                                                if ($FIELD_REQUIRED == "Y" && !preg_match(
                                                        "/" . $NOT_ANSWER . "/i",
                                                        $FIELD_PARAM
                                                    )) {
                                        ...
                                        case "email":
                                            ...
                                            if ($USER_TEXT <> '') {
                                                if (!check_email($USER_TEXT)) {
                                                    CForm::__check_PushError(
                                                        $errors,
                                                        GetMessage('FORM_ERROR_BAD_EMAIL'),
                                                        $FIELD_SID
                                                    );
                                                }
                                                if ($FIELD_REQUIRED == "Y") {
                                                ...
                                                if (!CheckDateTime($USER_DATE)) {
                                                    CForm::__check_PushError(
                                                        ...
                                                        str_replace(
                                                            "#FIELD_NAME#",
                                                            $FIELD_TITLE,
                                                            GetMessage("FORM_INCORRECT_DATE_FORMAT")
                                                        ),
                                                        $FIELD_SID
                                                    );
                                                }
                                                ...
                                                if (CFile::CheckImageFile($arIMAGE) <> '') {
                                                    CForm::__check_PushError(
                                                        ...
                                                        str_replace(
                                                            "#FIELD_NAME#",
                                                            $FIELD_TITLE,
                                                            GetMessage("FORM_INCORRECT_FILE_TYPE")
                                                        ),
                                                        $FIELD_SID
                    ...
                    if (($arForm["USE_CAPTCHA"] == "Y" && !$RESULT_ID && !defined('ADMIN_SECTION'))) {
                        if (!($GLOBALS["APPLICATION"]->CaptchaCheckCode(
                            $arrVALUES["captcha_word"],
                            $arrVALUES["captcha_sid"]
                        ))) {
                        ...
                        foreach ($REQUIRED_FIELDS as $key => $value) {
                            if ($value == "N") {
                                ...
                                } /*elseif (strlen($arQuestions[$key]["FILTER_TITLE"])>0)
								{
                                    ...
                                    $title = ($arQuestions[$key]["TITLE_TYPE"] == "html") ? strip_tags(
                                        $arQuestions[$key]["TITLE"]
                                    ) : $arQuestions[$key]["TITLE"];
                                }
                                if ($RETURN_ARRAY == 'N') {
                                    ...
                                    CForm::__check_PushError(
                                        $errors,
                                        GetMessage("FORM_EMPTY_REQUIRED_FIELDS") . ' ' . $title,
                                        $key
                                    );
                                }
                            }
            ...
            if ($FORM_ID <= 0 || ($FORM_ID > 0 && is_set($arFields, "SID"))) {
                ...
                if (preg_match("/[^A-Za-z_01-9]/", $arFields["SID"])) {
                    ...
                    if ($zr = $z->Fetch()) {
                        ...
                        $strSql = "SELECT ID, ADDITIONAL FROM b_form_field WHERE SID='" . $DB->ForSql(
                                trim($arFields["SID"]),
                                50
                            ) . "'";
                        $z = $DB->Query($strSql, false, $err_mess . __LINE__);
                        if ($zr = $z->Fetch()) {
                            $s = ($zr["ADDITIONAL"] == "Y") ?
                                str_replace(
                                    "#TYPE#",
                                    GetMessage("FORM_TYPE_FIELD"),
                                    GetMessage("FORM_ERROR_WRONG_SID")
                                ) :
                                str_replace(
                                    "#TYPE#",
                                    GetMessage("FORM_TYPE_QUESTION"),
                                    GetMessage("FORM_ERROR_WRONG_SID")
                                );
            ...
            if (CForm::Reset($ID, "N")) {
                ...
                if (trim($qr["MAIL_EVENT_TYPE"]) <> '') {
                    ...
                    $e = $em->GetList(
                        "id",
                        "desc",
                        array("EVENT_NAME" => $qr["MAIL_EVENT_TYPE"], "EVENT_NAME_EXACT_MATCH" => "Y")
                    );
                    while ($er = $e->Fetch()) {
                        $em->Delete($er["ID"]);
                    }
    ...
    public static function SetMailTemplate(
        $WEB_FORM_ID,
        $ADD_NEW_TEMPLATE = "Y",
        $old_SID = "",
        $bReturnFullInfo = false
    ) {
        global $DB, $MESS, $strError;
            ...
            while ($arLang = $z->Fetch()) {
                ...
                while ($wr = $w->Fetch()) {
                    if ($wr["RESULTS_TABLE_TITLE"] <> '') {
                        ...
                        $FIELD_TITLE = $wr["TITLE_TYPE"] == "html" ? htmlspecialcharsback(
                            strip_tags($wr["TITLE"])
                        ) : $wr["TITLE"];
                    } else {
        ...
        if ($arForm = $dbForm->Fetch()) {
            ...
            $arForm['ADMIN_MENU'][] = array(
                ...
                "TITLE" => htmlspecialcharsbx(
                    str_replace("#NAME#", $arForm["NAME"], GetMessage("FORM_MENU_EDIT_TITLE"))
                )
            );
            ...
            $arForm['ADMIN_MENU'][] = array(
                ...
                "TITLE" => htmlspecialcharsbx(
                    str_replace("#NAME#", $arForm["NAME"], GetMessage("FORM_MENU_RESULTS_TITLE"))
                )
            );
            ...
            $arForm['ADMIN_MENU'][] = array(
                ...
                "TITLE" => htmlspecialcharsbx(
                    str_replace("#NAME#", $arForm["NAME"], GetMessage("FORM_MENU_QUESTIONS_TITLE"))
                )
            );
            ...
            if (!$bSimple) {
                $arForm['ADMIN_MENU'][] = array(
                    ...
                    "TITLE" => htmlspecialcharsbx(
                        str_replace("#NAME#", $arForm["NAME"], GetMessage("FORM_MENU_FIELDS_TITLE"))
                    )
                );
                ...
                $arForm['ADMIN_MENU'][] = array(
                    ...
                    "TITLE" => htmlspecialcharsbx(
                        str_replace("#NAME#", $arForm["NAME"], GetMessage("FORM_MENU_STATUSES_TITLE"))
                    )
                );
            }
