...
class CFormValidatorNumSelected
{
    public static function GetDescription()
    {
        return array(
            ...
            "DESCRIPTION" => GetMessage('FORM_VALIDATOR_VAL_NUM_SELECTED_DESCRIPTION'),
            // validator description
            "TYPES" => array("checkbox", "multiselect"),
            //  list of types validator can be applied.
            "SETTINGS" => array("CFormValidatorNumSelected", "GetSettings"),
            // method returning array of validator settings, optional
            "CONVERT_TO_DB" => array("CFormValidatorNumSelected", "ToDB"),
            // method, processing validator settings to string to put to db, optional
            "CONVERT_FROM_DB" => array("CFormValidatorNumSelected", "FromDB"),
            // method, processing validator settings from string from db, optional
            "HANDLER" => array("CFormValidatorNumSelected", "DoValidate")
    ...
    public static function ToDB($arParams)
    {
        ...
        if ($arParams["NUMBER_FROM"] < 0) {
            $arParams["NUMBER_FROM"] = 0;
        }
        if ($arParams["NUMBER_TO"] < 0) {
            $arParams["NUMBER_TO"] = 0;
        }
