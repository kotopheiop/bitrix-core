...
if (Loader::includeModule('sender')) {
    class SenderConnectorForm extends \Bitrix\Sender\Connector
    {
        ...
        public function getForm()
        {
            ...
            */
            $formInput = '<select name="' . $this->getFieldName('FORM') . '" id="' . $this->getFieldId(
                    'FORM'
                ) . '" onChange="FormSelect' . $this->getFieldId('FORM') . '()">';
            foreach ($formList as $form) {
            ...
            */
            $formPropertyNameInput = '<select name="' . $this->getFieldName(
                    'PROPERTY_NAME'
            ...
            */
            $formPropertyEmailInput = '<select name="' . $this->getFieldName(
                    'PROPERTY_EMAIL'
