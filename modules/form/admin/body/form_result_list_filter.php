...
<? if ($F_RIGHT >= 25) : ?>
    <tr>
        <td valign="center" nowrap colspan="2" class="selectedbody"><img src="/bitrix/images/1.gif" width="1" height="7"
                                                                         border=0 alt=""><br><font
                    class="tableheadtext"><b>&nbsp;<?= GetMessage("FORM_ENTERED_BY_GUEST") ?></b></font><br><img
                    src="/bitrix/images/1.gif" width="1" height="7" border=0 alt=""><br></td>
    </tr>
<?endif; ?>
    <?
    endif;
    ...
    <tr>
        <td colspan="2" align="right" nowrap class="tablebody">
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td width="0%"><font class="tablebodytext"><input type="hidden" name="set_filter" value="Y"><input
                                    class="button" type="submit" name="set_filter"
                                    value="<? echo GetMessage("FORM_F_SET_FILTER") ?>"></font></td>
