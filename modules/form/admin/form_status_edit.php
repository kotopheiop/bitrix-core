...
<form method="POST"
    ...
    <? if ($ID > 0) : ?>
        <tr>
            ...
            <td><a title="<?= GetMessage("FORM_RESULTS_TITLE") ?>"
                   href="form_result_list.php?lang=<?= LANGUAGE_ID ?>&WEB_FORM_ID=<?= $WEB_FORM_ID ?>&find_status=<? echo $ID ?>&set_filter=Y"><? echo intval($str_RESULTS) ?></a>
            </td>
        </tr>
    <? endif; ?>
    <tr>
            ...
            foreach ($arrMAIL as $mail_id => $mail_name):
                ...
                <tr id="ft_<?= htmlspecialcharsbx($mail_id) ?>">
                    <td nowrap style="padding:0px"><input type="checkbox" name="arMAIL_TEMPLATE[]"
                        ...
                        &nbsp;<label
                                for="<?= htmlspecialcharsbx($mail_id) ?>"><?= htmlspecialcharsbx($mail_name) ?></label>
                    </td>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan=2 style="padding:0px"><?
                        ...
                        if (count($arrMAIL) > 0):
                            ?>&nbsp;&nbsp;&nbsp;[&nbsp;<a
                                href="/bitrix/admin/message_admin.php?find_type_id=FORM_STATUS_CHANGE_<?= $arForm['SID'] ?>_<?= $ID ?>&set_filter=Y"><?
    ...
    ?>
    <tr>
        <td><?= GetMessage('FORM_MOVE_RIGHTS') . " [MOVE]"; ?><br><img src="/bitrix/images/form/mouse.gif" width="44"
    ...
    <tr>
        <td><? echo GetMessage('FORM_VIEW_RIGHTS') . " [VIEW]" ?><br><img src="/bitrix/images/form/mouse.gif" width="44"
                                                                          height="21" border=0 alt=""></td>
        <td><?
    ...
    <tr>
        <td><? echo GetMessage('FORM_EDIT_RIGHTS') . " [EDIT]" ?><br><img src="/bitrix/images/form/mouse.gif" width="44"
                                                                          height="21" border=0 alt=""></td>
        <td><?
