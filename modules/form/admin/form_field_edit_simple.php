...
<? endif; ?>
                ...
                <table class="internal" id="tbl_answers">
                    ...
                    if (is_array($arRows)) {
                        foreach ($arRows AS $arRow):
                            ...
                            <tr id="row<?= $i ?>">
                                <td><input type="hidden" name="ANSWER[]" value="<?= $arRow['ID'] ?>"/><input type="text"
                                                                                                             name="MESSAGE[]"
                                                                                                             value="<?= $arRow['MESSAGE'] ?>"/>
                                </td>
                                ...
                                <td><input name="DEF[]" type="hidden" value="<?= $arRow['DEF_HIDDEN'] ?>"
                                           id="row<?= $i ?>_def_hidden"/><input OnClick="ClearAll('row<?= $i ?>')"
                                                                                ...
                                                                                id="row<?= $i ?>_def"
                                                                                name="row<?= $i ?>_def"/></td>
                                <td id="row<?= $i ?>_del" <? if (count($arRows) < 2) print 'style="visibility:hidden"' ?>>
                                    <div onclick="RowDelete('row<?= $i ?>',1)" title="<?= GetMessage("FORM_ANS_DEL") ?>"
                        ...
                        <tr id="row1">
                            ...
                            <td><input name="DEF[]" type="hidden" id="row1_def_hidden"/><input
                                        OnClick="ClearAll('row1')" type="checkbox" id="row1_def" name="row1_def"/></td>
    ...
    ?>
    <tr>
        <td colspan="2" align="center"><textarea name="COMMENTS" cols="80" rows="5"><? echo $str_COMMENTS ?></textarea>
        </td>
    </tr>
    <?
    $tabControl->EndTab();
