...
//********************
        ...
        <tr>
            ...
            <td><? echo CFile::InputFile("IMAGE_ID", 20, $str_IMAGE_ID); ?><? if ($str_IMAGE_ID > 0):?>
                    <br/><? echo CFile::ShowImage($str_IMAGE_ID, 200, 200, "border=0", "", true) ?><?endif; ?>
            </td>
        </tr>
    <?
    ...
    <? else: ?>
        ...
        <tr>
            <td align="center" colspan="2"><textarea name="TITLE" style="width:100%"
                                                     rows="23"><? echo $str_TITLE ?></textarea></td>
        </tr>
    <?endif;
    ?>
    <?
            ...
            <td colspan="2" style="padding:0px;">
                ...
                <table border="0" cellspacing="1" cellpadding="0" width="100%" id="answers_table">
                    ...
                    <tr class="heading">
                        ...
                        <td nowrap="nowrap" width="100%"><? echo GetMessage("FORM_MESSAGE") ?><span
                                    class="required"><sup>1</sup></span><br/>[&nbsp;ANSWER_TEXT&nbsp;]
                        </td>
                        <td nowrap="nowrap"><? echo GetMessage("FORM_FIELD_VALUE") ?><sup>&nbsp;</sup><br/>[&nbsp;ANSWER_VALUE&nbsp;]
                        </td>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                <input <? if ($p_FIELD_TYPE != "text" && $p_FIELD_TYPE != "textarea" && $p_FIELD_TYPE != "image" && $p_FIELD_TYPE != "date" && $p_FIELD_TYPE != 'email') echo "disabled" ?>
                                        ...
                                        value="<? if (intval($p_FIELD_WIDTH) > 0) echo $p_FIELD_WIDTH ?>" size="3"/>
                            </td>
                            <td nowrap="nowrap">
                                <input <? if ($p_FIELD_TYPE != "textarea" && $p_FIELD_TYPE != "multiselect") echo "disabled" ?>
                                        type="text" id="FIELD_HEIGHT_<?= $i ?>" name="FIELD_HEIGHT_<?= $i ?>"
                                        value="<? if (intval($p_FIELD_HEIGHT) > 0) echo $p_FIELD_HEIGHT ?>" size="3"/>
                            </td>
                    ...
                    while ($i <= $count) :
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                <input <? if ($ftype != "textarea" && $ftype != "multiselect") echo "disabled" ?>
                                        type="text" id="FIELD_HEIGHT_<?= $i ?>" name="FIELD_HEIGHT_<?= $i ?>"
                                        value="<?= $height ?>" size="3"/></td>
