...
if (strlen($FILTER_RESULT_TEMPLATE) > 0 && file_exists($_SERVER["DOCUMENT_ROOT"] . $FILTER_RESULT_TEMPLATE)) {
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("FORM_F_DATE_CREATE") . " (" . CSite::GetDateFormat("SHORT") . "):" ?></td>
            <td width="0%"
                nowrap><?= CForm::GetDateFilter("date_create", "form1", "Y", "class=\"typeselect\"", "class=\"inputtype\"") ?></td>
        </tr>
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("FORM_F_TIMESTAMP") . " (" . CSite::GetDateFormat("SHORT") . "):" ?></td>
            <td width="0%"
                nowrap><?= CForm::GetDateFilter("timestamp", "form1", "Y", "class=\"typeselect\"", "class=\"inputtype\"") ?></td>
        </tr>
        <?
        if ($F_RIGHT >= 20):?>
            <tr>
            ...
            <tr>
                <td><?
                    echo GetMessage("FORM_F_AUTH") ?></td>
                <td><?
                    $arr = array("reference" => array(GetMessage("FORM_YES"), GetMessage("FORM_NO")), "reference_id" => array("Y", "N"));
            ...
            <tr>
                <td><?
                    echo GetMessage("FORM_F_USER") ?></td>
            ...
            if (CModule::IncludeModule("statistic")) :?>
                <tr>
                    <td><?
                        echo GetMessage("FORM_F_GUEST") ?></td>
                    <td><?= CForm::GetTextFilter("guest_id") ?></td>
                </tr>
                <tr>
                    <td><?
                        echo GetMessage("FORM_F_SESSION") ?></td>
            ...
            if (!$bSimple):?>
                <tr>
                    <td><?
                        echo GetMessage("FORM_F_STATUS") ?></td>
                    <td><?
            ...
            if (is_array($arFormCrmLink)):?>
                <tr>
                    <td><?
                        echo GetMessage("FORM_FL_SENT_TO_CRM") ?></td>
