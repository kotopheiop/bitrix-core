...
?>
    <div align="center"><?= ShowNote($strNote) ?>
        <font class="tablebodytext">[&nbsp;<a target="_blank"
                                              href="/bitrix/admin/message_admin.php?lang=<?= LANGUAGE_ID ?>&find_type_id=<?= htmlspecialcharsbx($arrForm["MAIL_EVENT_TYPE"]) ?>&set_filter=Y"
                                              class="tablebodylink"><?= GetMessage("FORM_VIEW_TEMPLATE") ?></a>&nbsp;]</font><br>
