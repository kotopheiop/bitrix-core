            ...
            <td align="center">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="internal" align="center" id="tblRULES">
                    ...
                    foreach ($arRules as $rule) {
                        ?>
                        <tr>
                            <td><input name="MODULE[]" type="text"
                                       value="<? echo htmlspecialcharsbx($rule["MODULE"]) ?>" style="width:100%"></td>
                            <td><input name="EXTENSION[]" type="text"
                                       value="<? echo htmlspecialcharsbx($rule["EXTENSION"]) ?>" style="width:100%">
                            </td>
                            <td><input name="SIZE[]" type="text" value="<? echo htmlspecialcharsbx($rule["SIZE"]) ?>"
                                       style="width:100%"></td>
        ...
        if (CCloudFailover::IsEnabled()) {
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <input type="checkbox" name="FAILOVER_ACTIVE"
                           value="Y"<? if ($arRes["FAILOVER_ACTIVE"] === "Y") echo " checked" ?>>
                </td>
            </tr>
            <tr valign="top">
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <input type="checkbox" name="FAILOVER_COPY"
                           value="Y"<? if ($arRes["FAILOVER_COPY"] === "Y") echo " checked" ?>>
                </td>
            </tr>
            <tr>
                ...
                <td width="60%">
                    ...
                    <input type="checkbox" name="FAILOVER_DELETE"
                           value="Y"<? if ($arRes["FAILOVER_DELETE"] === "Y") echo " checked" ?>>
                </td>
            </tr>
            <tr>
