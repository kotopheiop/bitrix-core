...
if ($USER->CanDoOperation("clouds_upload")):
    ...
    <div id="upload_form" style="display:none;height:200px;">
        ...
        echo htmlspecialcharsbx($APPLICATION->GetCurPageParam()) ?>" enctype="multipart/form-data" name="editform"
            ...
            <tr>
                <td width="40%"><?
                    echo GetMessage("CLO_STORAGE_FILE_PATH_INPUT") ?>:
                </td>
                <td width="60%"><input type="text" id="path_to_upload" name="path_to_upload" size="45" value="<?
                    echo htmlspecialcharsbx($path) ?>"></td>
            </tr>
            <tr>
                <td><?
                    echo GetMessage("CLO_STORAGE_FILE_UPLOAD_INPUT") ?>:
                </td>
            ...
            echo LANGUAGE_ID ?>">
            <input type="button" id="start_upload_button" onclick="start_upload();" value="<?
            echo GetMessage("CLO_STORAGE_FILE_UPLOAD_BTN") ?>" class="adm-btn-save">
            <input type="button" value="<?
            echo GetMessage("CLO_STORAGE_FILE_CANCEL_BTN") ?>" onclick="hide_upload_form()">
            <?
            $tabControl->End();
            ?>
        </form>
