    ...
    public static function getUserList($params = [])
    {
        ...
        while ($fields = $res->fetch()) {
            ...
            if ((int)$fields['USER_PERSONAL_PHOTO'] <= 0) {
                ...
                $fields['USER_PERSONAL_PHOTO'] = Option::get(
                    'socialnetwork',
            ...
            $userList[$fields['USER_ID']] = [
                ...
                'DATE_VIEW' => $dateView,
                'DATE_VIEW_FORMATTED' => (!empty($dateView) ? \CComponentUtil::getDateTimeFormatted(
    ...
    public static function deleteNoDemand($userId = 0)
    {
        ...
        try {
            \Bitrix\Main\Application::getConnection()->queryExecute(
                "DELETE FROM " . UserContentViewTable::getTableName() . " WHERE USER_ID = " . $userId
            );
