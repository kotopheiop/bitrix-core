        ...
        ) // new
        {
            ...
            if (isset($cacheData[$messageId])) {
                ...
                if (
                    ...
                    try {
                        $messageParams = Json::decode(
                            !empty($commentData['SERVICE_DATA']) ? $commentData['SERVICE_DATA'] : $commentData['POST_MESSAGE']
                        );
                    ...
                    if (
                        ...
                        while (
                            ...
                            try {
                                $messageParams = Json::decode(
                                    !empty($forumMessageFields['SERVICE_DATA']) ? $forumMessageFields['SERVICE_DATA'] : $forumMessageFields['POST_MESSAGE']
                                );
                                if (!is_array($messageParams)) {
                                    $messageParams = [];
                                }
        ...
        if (
            ...
            if (!empty($params)) {
                ...
                if ($followValue !== "N") {
                    ...
                    $ratingVoteParams["ENTITY_TITLE"] = $ratingVoteParams["ENTITY_MESSAGE"] = strip_tags(
                        str_replace('<br>', ' ', $CBXSanitizer->sanitizeHtml($this->getText()))
                    );
