        ...
        if (in_array($arLog["ENTITY_TYPE"], array(SONET_SUBSCRIBE_ENTITY_GROUP, SONET_SUBSCRIBE_ENTITY_USER))) {
            if ($arLog["ENTITY_TYPE"] == SONET_SUBSCRIBE_ENTITY_GROUP && $arLog["EVENT_ID"] == "system") {
                CSocNetLogRights::Add(
                    ...
                    array(
                        "SA",
                        "SG" . $arLog["ENTITY_ID"] . "_" . SONET_ROLES_OWNER,
                        "SG" . $arLog["ENTITY_ID"] . "_" . SONET_ROLES_MODERATOR,
                        "SG" . $arLog["ENTITY_ID"] . "_" . SONET_ROLES_USER
                    )
                );
            } elseif ($arLog["ENTITY_TYPE"] == SONET_SUBSCRIBE_ENTITY_USER && in_array(
                    $arLog["EVENT_ID"],
                    array(
                        "system",
                        "system_groups",
