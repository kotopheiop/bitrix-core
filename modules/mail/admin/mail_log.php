...
?>
    ...
    <form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td nowrap><input type="text" name="find_message_subject"
                              value="<? echo htmlspecialcharsbx($find_message_subject) ?>"
            ...
            <td nowrap>
                <select name="find_filter_id">
                    ...
                    while ($l->ExtractFields("mf_")):
                        ...
                        <option value="<?
                        echo $mf_ID ?>"<?
                        if ($find_filter_id == $mf_ID) echo " selected" ?>><?
                        echo $mf_NAME ?></option><?
                    endwhile;
                    ?>
                </select><br><input type="hidden" name="find_show_filt" value="N"><input type="checkbox"
                                                                                         name="find_show_filt"
                                                                                         value="Y"<? if ($find_show_filt == "Y") echo " checked" ?>
                                                                                         id="find_show_filt"> <label
                        for="find_show_filt"><? echo GetMessage("MAIL_LOG_FILT_SHOW_COLUMN") ?></label>
