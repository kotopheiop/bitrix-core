...
<form method="POST" action="<?= $APPLICATION->GetCurPage(); ?>?lang=<?= LANG; ?>&ID=<?= $ID; ?>" name="form1"
    ...
    <tr id="el0" class="imap">
        ...
        <td><input type="text" name="SERVER" size="42" maxlength="255" value="<?= $str_SERVER; ?>">:<input type="text"
                                                                                                           id="PORT_PORT"
                                                                                                           name="PORT"
                                                                                                           size="4"
                                                                                                           maxlength="5"
    ...
    <tr id="el4" class="domain crdomain">
        ...
        <td><input type="checkbox" name="ENCRYPTION"
                   value="N"<? if (!$ID || $str_ENCRYPTION == 'N') { ?> checked<? } ?>></td>
    </tr>
