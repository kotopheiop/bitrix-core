...
<form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?lang=<?= LANG ?>&ID=<?= $ID ?>" name="form1">
    ...
    <tr>
        ...
        <td width="60%">
            ...
            <? } else { ?>
                <select id="mailbox_site_id"
                        name="LID"<? if ($mailbox_type == 'user') { ?> onchange="changeServicesList();"<? } ?>>
        ...
        <td>
            ...
            <div class="adm-list">
                <div class="adm-list-item">
                    <div class="adm-list-control"><input type="checkbox" id="s2" name="RELAY" onclick="chrelay()"
                                                         value="Y"<? if ($str_RELAY == "Y") echo " checked" ?>></div>
                    <div class="adm-list-label"><label for="s2" id="s4"><? echo GetMessage("MAIL_MBOX_RELAY") ?></label>
                    </div>
                </div>
                <div class="adm-list-item">
    ...
    <tr id="el8" class="pop3 imap">
        ...
        <td><input type="checkbox" name="USE_TLS" id="USE_TLS"
    ...
    <tr id="el10" class="pop3 imap adm-detail-required-field">
        ...
        <td><input type="password" name="PASSWORD" size="53" maxlength="255"
                   value="<?= ($MOD_RIGHT >= 'W' && $str_USER_ID == 0 ? $str_PASSWORD : ''); ?>"></td>
    </tr>
    ...
    <tr id="el14" class="pop3">
        ...
        <td><input type="checkbox" name="DELETE_MESSAGES"
                   value="Y"<? if ($str_DELETE_MESSAGES == "Y") echo " checked" ?>></td>
    </tr>
    <tr id="el15" class="pop3">
        <td><?= GetMessage("MAIL_MBOX_EDT_PERIOD"); ?></td>
        <td><input type="text" name="PERIOD_CHECK" size="5" maxlength="18"
                   value="<? echo $str_PERIOD_CHECK ?>"> <? echo GetMessage("MAIL_MBOX_EDT_PERIOD_MIN") ?></td>
    </tr>
        ...
        <tr id="el17" class="pop3 smtp">
            <td align="center" colspan="2" class="adm-detail-valign-top">
                <select name="filter_type">
                    ...
                    <? } ?>
                </select>&nbsp;<input type="submit" <? if ($MOD_RIGHT < "W") echo "disabled" ?> name="save_ext"
                                      value="<? echo GetMessage("MAIL_MBOX_EDT_ADD") ?>">
            </td>
        </tr>
    ...
    <? if (in_array($str_SERVER_TYPE, array('pop3', 'smtp'))) { ?>
        ...
        <tr id="el21" class="pop3 smtp">
            ...
            <td><input type="text" name="MAX_KEEP_DAYS" size="5" maxlength="18"
                       value="<? echo intval($str_MAX_KEEP_DAYS) ?>"> <? echo GetMessage("MAIL_MBOX_EDT_KEEP_DAYS_D") ?>
            </td>
        </tr>
