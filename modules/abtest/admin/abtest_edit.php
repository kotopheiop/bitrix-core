...
?>
    ...
    <form method="POST" action="<?= $APPLICATION->GetCurPage(); ?>?lang=<?= LANG; ?>&amp;ID=<?= $ID; ?>" name="form1"
            ...
            <td style="width: 60%; ">
                <select id="site_id" name="SITE" onchange="ABTestParams.Site.handle(this); " style="width: 200px; ">
                    ...
                    <? if (!empty($abtest['SITE_ID']) && !$siteDefined) : ?>
                        <option value="<?= htmlspecialcharsbx($abtest['SITE_ID']); ?>" selected>
                            * <?= htmlspecialcharsbx($abtest['SITE_ID']); ?></option>
                    <? endif; ?>
                </select>
            </td>
        </tr>
        ...
        <tr class="adm-detail-required-field">
            <td><?= getMessage('ABTEST_DURATION_FIELD'); ?><span class="required"
                                                                 style="font-weight: normal; "><sup>1</sup></span>:
            </td>
            <td>
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <select id="portion" name="PORTION" onchange="ABTestParams.Portion.handle(this); "
                        style="width: 200px; ">
                    ...
                    <? if (!empty($abtest['TEST_DATA']['list']) && is_array($abtest['TEST_DATA']['list'])) : ?>
                        ...
                        <? foreach ($abtest['TEST_DATA']['list'] as $k => $item) : ?>
                            ...
                            <table class="internal test-item" style="width: 100%; margin-bottom: 10px; ">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="TEST_DATA[type][]"
                                               value="<?= htmlspecialcharsbx($item['type']); ?>">
                                        <table style="width: 400px; float: right; ">
                                            <tr>
                                                <td style="width: 20px; background: #498ec5; text-shadow: none; color: #ffffff !important; font-weight: bold; text-align: center; padding: 10px !important;">
                                                    A
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    style="background: rgb(236, 239, 241); padding-left: 41px !important; ">
                                                    <? switch ($item['type']) :
                                                        case 'template': ?>
                                                            ...
                                                            <? break;
                                                        case 'page': ?>
                                                            <input class="value-input old-value-input" type="text"
                                                                   onchange="ABTestList.Item.handle(this); "
                                    ...
                                    <td>
                                        <table style="width: 400px; ">
                                            <tr>
                                                <td style="width: 20px; background: rgb(255, 118, 36); text-shadow: none; color: #ffffff !important; font-weight: bold; text-align: center; padding: 10px !important;">
                                                    B
                                                </td>
                                                ...
                                                <td colspan="2"
                                                    ...
                                                    <? switch ($item['type']) :
                                                        case 'template': ?>
                                                            ...
                                                            <? break;
                                                        case 'page': ?>
                                                            <input class="value-input new-value-input" type="text"
                                                                   onchange="ABTestList.Item.handle(this); "
                                                                   oninput="ABTestList.Item.handle(this); "
                                                                   name="TEST_DATA[new_value][]"
                                                                   data-value="<?= htmlspecialcharsbx($item['new_value']); ?>"
        ...
        <? if (!$ID || in_array($abtest['ENABLED'], array('T', 'Y'))) : ?>
            <tr>
                <td colspan="2">
                    <a id="new_test_button" href="#" hidefocus="true"
                       class="adm-btn adm-btn-add adm-btn-save adm-btn-menu"
                       title="<?= getMessage('ABTEST_TEST_ADD'); ?>"><?= getMessage('ABTEST_TEST_ADD'); ?></a>
                </td>
            </tr>
        <? endif; ?>
    ...
    <table id="abtest_sample_template" class="internal test-item"
           style="width: 100%; display: none; margin-bottom: 10px; ">
        <tr class="heading">
            <td colspan="2" style="text-align: left !important; ">
                <div style="float: right; cursor: pointer; "
                     onclick="BX.remove(BX.findParent(this, {'tag': 'table', 'class': 'test-item'}));">x
                </div>
            ...
            <td>
                ...
                <table style="width: 400px; float: right; ">
                    ...
                    <tr>
                        <td colspan="2" style="background: rgb(236, 239, 241); padding-left: 41px !important; ">
                            <input class="value-input old-value-input" type="text"
                                   onchange="ABTestList.Item.handle(this); " oninput="ABTestList.Item.handle(this); "
                                   name="TEST_DATA[old_value][]" style="width: 230px; ">
                            <input type="button" onclick="ABTestList.Item.select(this); " value="..."
                                   title="<?= getMessage('ABTEST_TEST_SELECT_PAGE'); ?>">
                            <input class="copy-value-btn" type="button" onclick="ABTestList.Item.copy(this); "
                                   value="&gt;" title="<?= getMessage('ABTEST_TEST_COPY_PAGE'); ?>" disabled>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table style="width: 400px; ">
                    ...
                    <tr>
                        <td colspan="2" style="background: rgb(236, 239, 241); padding-left: 41px !important; ">
                            <input class="value-input new-value-input" type="text"
                                   onchange="ABTestList.Item.handle(this); " oninput="ABTestList.Item.handle(this); "
                                   name="TEST_DATA[new_value][]" style="width: 230px; ">
                            <input type="button" onclick="ABTestList.Item.select(this); " value="..."
                                   title="<?= getMessage('ABTEST_TEST_SELECT_PAGE'); ?>">
                            <span class="edit-value-btn adm-btn adm-btn-disabled" onclick="ABTestList.Item.edit(this); "
                                  title="<?= getMessage('ABTEST_TEST_EDIT_PAGE'); ?>">&nbsp;</span>
                        </td>
                    </tr>
                </table>
    ...
    <script type="text/javascript">
        ...
        BX('new_test_button').onclick = function () {
            ...
            BX.adminShowMenu(this, [
                {
                    'TEXT': '<?=CUtil::JSEscape($test_form_msg['template']['title']); ?>',
                    'ONCLICK': 'ABTestList.add(\'template\');'
                },
                {
                    'TEXT': '<?=CUtil::JSEscape($test_form_msg['page']['title']); ?>',
                    'ONCLICK': 'ABTestList.add(\'page\');'
                }
