                ...
                'GET_VALUES' => function (array $ids) {
                    ...
                    while ($abtest = $result->fetch()) {
                        if (empty($abtest['NAME'])) {
                            $abtest['NAME'] = str_replace(
                                '#ID#',
                                $abtest['ID'],
                                Localization\Loc::getMessage('ABTEST_CONV_TEST_TITLE')
                            );
                        }
            ...
            if ($context = Helper::getContext()) {
                ...
                $APPLICATION->addPanelButton(
                    array(
                        ...
                        'TEXT' => str_replace(
                            '#ID#',
                            intval($context['abtest']),
                            Localization\Loc::getMessage('ABTEST_PANEL_MENU_BTN')
                        ),
                        'TYPE' => 'BIG',
                        'MAIN_SORT' => 900,
                        'SORT' => 10,
