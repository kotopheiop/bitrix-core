            ...
            <div class="connector-newbtx">
                <div class="connector-nebtx-inner">
                    <? if (Connection::isExist()): ?>
                        ...
                        <? if ($moduleAccess > "R"): ?>
                            <a href="javascript:void(0)" onclick="if(confirm('<?= Loc::getMessage(
                                'B24C_B24C_DEL_CONFIRM'
                            ) ?>')) window.location.href='?lang=<?= LANGUAGE_ID ?>&action=delete_connection&<?= bitrix_sessid_get(
                            ) ?>';" class="connector-newbtx-link"><?= Loc::getMessage('B24C_B24C_DEL') ?></a>
                        <? endif; ?>
                    <? else: ?>
                        <a href="https://www.bitrix24.<? if (LANGUAGE_ID == "ru") {
                            echo "ru";
                ...
                <div class="connector-newbtx__item connector-newbtx__item-1"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM1'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-2"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM2'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-3"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM3'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-4"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM4'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-5"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM5'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-6"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM6'
                        ) ?></span></div>
                <div class="connector-newbtx__item connector-newbtx__item-7"><span><?= Loc::getMessage(
                            'B24C_B24C_ITEM7'
                        ) ?></span></div>
            </div>
        </div>
