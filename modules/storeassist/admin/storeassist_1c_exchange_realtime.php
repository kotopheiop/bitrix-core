...
$docUrl = CStoreAssist::getDocumentationLink("storeassist_1c_exchange_realtime");
...
?>
    <div class="adm-detail-content-wrap">
        <div class="adm-detail-content">
            ...
            <br/>
            <a href="/bitrix/admin/storeassist.php?lang=<?= LANGUAGE_ID ?>" class="adm-detail-toolbar-btn"><span
                        class="adm-detail-toolbar-btn-l"></span><span
                        class="adm-detail-toolbar-btn-text"><?= GetMessage("STOREAS_WIZARD") ?></span><span
