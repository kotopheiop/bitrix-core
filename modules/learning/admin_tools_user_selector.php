...
class Learning_CIBlockPropertyUserID
{
    function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        ?><select id="SELECT<?= htmlspecialcharsbx($strHTMLControlName["VALUE"]) ?>"
                  name="SELECT<?= htmlspecialcharsbx($strHTMLControlName["VALUE"]) ?>"
        ...
        <option value="none"<?
        if ($select == "none") echo " selected" ?>><?= GetMessage("LEARNING_USER_SELECTOR_NONE") ?></option>
        <option value="CU"<?
        if ($select == "CU") echo " selected" ?>><?= GetMessage("LEARNING_USER_SELECTOR_CURRENT") ?></option>
        <option value="SU"<?
        if ($select == "SU") echo " selected" ?>><?= GetMessage("LEARNING_USER_SELECTOR_OTHER") ?></option>
        </select>&nbsp;
        <?
