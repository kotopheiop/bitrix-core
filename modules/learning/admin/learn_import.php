...
?>
    ...
    <form method="post" enctype="multipart/form-data"
          action="<? echo $APPLICATION->GetCurPage() ?>?lang=<? echo LANG ?>" name="form1">
        ...
        if ($STEP == 1):
            ...
            <tr class="adm-detail-required-field">
                <td><?
                    echo GetMessage("LEARNING_DATA_FILE") ?>:
                </td>
                <td>
                    <input type="text" name="URL_DATA_FILE" size="30">
                    <input type="button" value="<?
                    echo GetMessage("LEARNING_OPEN") ?>" OnClick="BtnClick()">
                    <?
            ...
            <tr class="adm-detail-required-field">
                <td class="adm-detail-valign-top"><?
                    echo GetMessage("LEARNING_SITE_ID") ?>:
                </td>
            ...
            <tr>
                <td><?
                    echo GetMessage("LEARNING_IF_SCORM") ?>:
                </td>
        ...
        <? else: ?>
            <input type="submit" class="adm-btn-green" value="<?= GetMessage("LEARNING_NEXT_STEP_F") ?> &gt;&gt;"
                   name="submit_btn">
        <? endif ?>
        <? $tabControl->End(); ?>
    </form>
