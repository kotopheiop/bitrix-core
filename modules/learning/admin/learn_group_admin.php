...
?>
    ...
    <form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>"
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="filter_course_title"
                       value="<? echo htmlspecialcharsex($filter_course_title) ?>" size="30">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="filter_course_lesson_id"
                       value="<? echo htmlspecialcharsex($filter_course_lesson_id); ?>" size="30">
            </td>
        </tr>
