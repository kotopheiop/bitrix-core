...
?>
    ...
    <form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>"
        ...
        <tr>
            ...
            <td><input type="text" name="filter_user" value="<? echo htmlspecialcharsbx($filter_user) ?>" size="47">
            </td>
        </tr>
            ...
            <td>
                <select name="filter_course_id">
                    ...
                    while ($l->ExtractFields("l_")):
                        ...
                        <option value="<?
                        echo $l_ID ?>"<?
                        if ($filter_course_id == $l_ID) echo " selected" ?>><?
                        echo $l_NAME ?></option><?
                    endwhile;
                    ?>
                </select>
        ...
        <tr>
            ...
            <td nowrap>
                <input type="text" name="filter_summary_from" size="10"
                       value="<? echo htmlspecialcharsex($filter_summary_from) ?>">
                ...
                <input type="text" name="filter_summary_to" size="10"
                       value="<? echo htmlspecialcharsex($filter_summary_to) ?>">
            </td>
        </tr>
