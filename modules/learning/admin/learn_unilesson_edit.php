    ...
    <tr>
        ...
        <td><?php
            if ($bContentReadOnly) {
                ...
                if ($str_ACTIVE == "Y") echo " checked" ?>><?php
            }
            ?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            if ($bContentReadOnly)
                ...
                ?>
                <input type="text" name="KEYWORDS" size="50" maxlength="255" value="<?
                echo $str_KEYWORDS ?>">
                <?php
            }
            ?>
...
// PUBLISH_PROHIBITED - Only in context of most top course
    ...
    <? else:?>
        <tr>
            ...
            <td>
                <input type="radio" <?php if ($bContentReadOnly) echo ' disabled="disabled" '; ?>
                       name="PREVIEW_TEXT_TYPE" value="text"<?
                if ($str_PREVIEW_TEXT_TYPE != "html") echo " checked" ?>> <?
                echo GetMessage("LEARNING_DESC_TYPE_TEXT") ?> /
                <input type="radio" <?php if ($bContentReadOnly) echo ' disabled="disabled" '; ?>
                       name="PREVIEW_TEXT_TYPE" value="html"<?
                if ($str_PREVIEW_TEXT_TYPE == "html") echo " checked" ?>> <?
                echo GetMessage("LEARNING_DESC_TYPE_HTML") ?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                ...
                if ($bContentReadOnly) {
                    ...
                    ?>
                    <textarea style="width:100%; height:200px;" name="PREVIEW_TEXT" wrap="virtual"><?
    ...
    <tr>
        <td valign="top" width="50%" align="right"><?
            echo GetMessage("LEARNING_CONTENT_SOURCE") ?>:
        </td>
        <td valign="top" width="50%">
            <label><input onClick="toggleSource()" <?php if ($bContentReadOnly) echo ' disabled="disabled" '; ?>
                          type="radio" name="CONTENT_SOURCE"
                          value="field"<?php echo $str_DETAIL_TEXT_TYPE != "file" ? " checked" : "" ?>>&nbsp;<?
                echo GetMessage("LEARNING_CONTENT_SOURCE_FIELD") ?></label><br/>
            <label><input onClick="toggleSource()" <?php if ($bContentReadOnly) echo ' disabled="disabled" '; ?>
                          type="radio" name="CONTENT_SOURCE"
                          value="file"<?php echo $str_DETAIL_TEXT_TYPE == "file" ? " checked" : "" ?>>&nbsp;<?
                echo GetMessage("LEARNING_CONTENT_SOURCE_FILE") ?> (pdf, html, text, jpg, png)</label>
        </td>
    </tr>
    <?
    if (COption::GetOptionString("learning", "use_htmledit", "Y") == "Y" && CModule::IncludeModule("fileman")):
        ...
        <tr id="source_field[1]">
            <td valign="top" align="center" colspan="2">
                ...
                if ($bContentReadOnly) {
                    ...
                    ?>
                    <textarea style="width:100%; height:200px;" name="DETAIL_TEXT" wrap="virtual"><?
    ...
    <tr id="source_file">
        ...
        <td valign="top">
            ...
            if ($bContentReadOnly)
                ...
                ?>
                <input type="text" name="LAUNCH" size="50" maxlength="255" value="<?
                echo $str_LAUNCH ?>">
                <?php
            }
            ?>
