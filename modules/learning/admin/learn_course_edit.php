...
if ($Perm >= "G"):?>
    ...
    <!-- 	<tr class="heading">
		<td colspan="2"><?
    echo GetMessage("LEARNING_ELEMENT_PREVIEW") ?></td>
	</tr> -->
    ...
    <? else:?>
        <tr>
            ...
            <td>
                <input type="radio" name="PREVIEW_TEXT_TYPE" value="text"<?
                if ($str_PREVIEW_TEXT_TYPE != "html") echo " checked" ?>> <?
                echo GetMessage("LEARNING_DESC_TYPE_TEXT") ?> / <input type="radio" name="PREVIEW_TEXT_TYPE"
                                                                       value="html"<?
                if ($str_PREVIEW_TEXT_TYPE == "html") echo " checked" ?>> <?
    ...
    <!-- <tr class="heading">
		<td colspan="2"><?
    echo GetMessage("LEARNING_ELEMENT_DETAIL") ?></td>
	</tr> -->
    ...
    <? else:?>
        <tr>
            ...
            <td>
                <input type="radio" name="DETAIL_TEXT_TYPE" value="text"<?
                if ($str_DETAIL_TEXT_TYPE != "html") echo " checked" ?>> <?
                echo GetMessage("LEARNING_DESC_TYPE_TEXT") ?>
                <input type="radio" name="DETAIL_TEXT_TYPE" value="html"<?
                if ($str_DETAIL_TEXT_TYPE == "html") echo " checked" ?>> <?
                echo GetMessage("LEARNING_DESC_TYPE_HTML") ?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <textarea style="width:100%; height:250px;" name="DETAIL_TEXT" wrap="off"><?
