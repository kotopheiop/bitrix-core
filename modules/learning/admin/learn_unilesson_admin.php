...
class CLearnRenderAdminUnilessonList
{
    ...
    protected function ShowFilter()
    {
        ...
        <form name="form1" method="GET" action="<?php echo $APPLICATION->GetCurPage(); ?>"
            ...
            <tr>
                <td>ID:</b></td>
                <td><input type="text" name="filter_uid" value="<?php echo htmlspecialcharsbx($filter_uid); ?>"
                           size="47"></td>
            </tr>

            <tr>
                <td><?php echo GetMessage('LEARNING_COURSE_ADM_CREATED2'); ?>:</b></td>
                <td><input type="text" name="filter_creator_id"
                           value="<?php echo htmlspecialcharsbx($filter_creator_id); ?>" size="47"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="filter_keywords"
                           value="<?php echo htmlspecialcharsbx($filter_keywords); ?>" size="47"></td>
            </tr>
