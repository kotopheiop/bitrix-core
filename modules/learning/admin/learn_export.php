                ...
                <td>
                    <select name="COURSE_ID" style="width:300px;">
                        ...
                        while ($course->ExtractFields("f_")) {
                            ?>
                            <option
                            value="<? echo $f_ID ?>" <? if (IntVal($f_ID) == $COURSE_ID) echo "selected"; ?>><? echo $f_NAME ?></option><?
                        }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td valign="top">
                    <input type="text" name="DATA_FILE_NAME" size="40"
                           value="<? echo (strlen($DATA_FILE_NAME) > 0) ? htmlspecialcharsbx($DATA_FILE_NAME) : "package" . $COURSE_ID . ".tar.gz" ?>"><br>
