...
class CAllSitePath
{
        ...
        if ((is_set($arFields, "SITE_ID") || $ACTION == "ADD") && $arFields["SITE_ID"] == '') {
            ...
            if (!$dbResult->Fetch()) {
                $GLOBALS["APPLICATION"]->ThrowException(
                    str_replace("#ID#", $arFields["SITE_ID"], GetMessage("LRN_GSP_ERROR_NO_SITE")),
                    "ERROR_NO_SITE"
                );
                return false;
            }
    ...
    public static function GetByID($ID)
    {
        ...
        if (isset($GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH_CACHE_" . $ID]) && is_array(
                $GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH_CACHE_" . $ID]
            ) && is_set($GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH_CACHE_" . $ID], "ID")) {
    ...
    public static function GetBySiteID($siteID)
    {
        ...
        if (isset($GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH1_CACHE_" . $siteID]) && is_array(
                $GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH1_CACHE_" . $siteID]
            ) && is_set($GLOBALS["LEARNING_SITE_PATH"]["LEARNING_SITE_PATH1_CACHE_" . $siteID], "ID")) {
