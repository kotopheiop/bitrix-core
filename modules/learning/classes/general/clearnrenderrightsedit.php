    ...
    protected static function LearningShowRights($lessonId, $variable_name, $arBaseRights, $arPossibleRights, $arActualRights, $arSelected = array(), $arHighLight = array(), $readOnly)
    {
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <table width="100%" cellpadding="0" cellspacing="10" border="0" id="<?
                        ...
                        ></span><?php
                            ...
                            <td align="left">
                                ...
                                if ($readOnly) {
                                    ...
                                    ?>
                                    <input type="hidden" name="<?php echo $html_var_name; ?>[][GROUP_CODE]"
                                           value="<?php echo htmlspecialcharsbx($symbol); ?>">
                                    <div style="min-width:720px;">
                                        <select name="<?php echo $html_var_name; ?>[][TASK_ID]"
                        ...
                        <tr>
                            ...
                            <td width="60%" align="left">
                                ...
                                echo htmlspecialcharsbx($href_id) ?>" class="bx-action-href"><?
                                    echo GetMessage("LEARNING_RIGHTS_ADD") ?></a>
                            </td>
                        </tr>
                        <?php
                    }
