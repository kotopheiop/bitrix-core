    ...
    <form method="post"
            ...
            <td valign="top" colspan="2">
                <table border="0" cellspacing="0" cellpadding="0" class="internal" align="center" id="tblRIGHTS">
                    ...
                    if ($i == 0) {
                        ...
                        <tr>
                            <td><?
                                echo SelectBoxFromArray("group_right[n" . $i . "]", $arGroups, $group, GetMessage("LISTS_OPTIONS_CHOOSE_GROUP")) ?></td>
                            <td><?
                                echo SelectBoxFromArray("type_right[n" . $i . "]", $arIBTypes, $type_id, GetMessage("LISTS_OPTIONS_CHOOSE_TYPE")) ?></td>
                        </tr>
                        <?
                    }
                    ?>
                    <tr>
                        <td colspan="2" style="border:none">
                            <input type="button" value="<? echo GetMessage("LISTS_OPTIONS_ADD_RIGHT") ?>"
        ...
        if (IsModuleInstalled('socialnetwork')) {
            ...
            <tr>
                ...
                <td width="70%"><input type="checkbox" name="socnet_enable" <?
                    if ($socnet_enable) echo "checked" ?> value="Y"></td>
            </tr>
            <tr>
                <td width="30%"><?
                    echo GetMessage("LISTS_OPTIONS_SOCNET_IBLOCK_TYPE") ?>:
                </td>
                <td width="70%"><?
                    echo SelectBoxFromArray("socnet_iblock_type_id", $arIBTypes, $socnet_iblock_type_id, GetMessage("MAIN_NO")) ?></td>
            </tr>
            <?
        }
        ...
        <tr>
            ...
            <td width="70%">
                <input type="text" name="livefeed_url" id="livefeed_url"
                       value="<?= htmlspecialcharsbx($livefeed_url); ?>">
            </td>
        </tr>
        <?
