    ...
    <form method="POST" action="<?= POST_FORM_ACTION_URI ?>" name="robots_form" onsubmit="window.seoParser.compile();">
                        ...
                        <table width="70%">
                            <tr>
                                <td width="70%" valign="top">
                                    <pre id="rules_<?= $key ?>_<?= $i ?>" class="seo-robots-content"
                                         style="text-align: left;"></pre>
                                </td>
                                <td width="30%" valign="top">
                                    <div id="rules_buttons_<?= $key ?>_<?= $i ?>"></div>
                                </td>
                            </tr>
                        </table>
                        <script>
        ...
        <tr>
            <td colspan="2">
                ...
                <textarea style="width: 100%" rows="30" id="robots_text"
                          name="ROBOTS[TEXT]"><?= Converter::getHtmlConverter()->encode($fileContent) ?></textarea>
            </td>
        </tr>
        <tr>
            <td colspan="2"><? echo BeginNote() . Loc::getMessage('SEO_ROBOTS_HINT' . (!$bVendor ? '' : '_1C')) . EndNote();
