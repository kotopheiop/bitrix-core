                                ...
                                foreach ($arrLegend as $keyL => $arrL):
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="nowrap">[<a
                                                    ...
                                                    href="/bitrix/admin/searcher_dynamic_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_searcher_id=<?= $keyL ?>&amp;find_date1=<? echo $arFilter["DATE1"] ?>&amp;find_date2=<?= $arFilter["DATE2"] ?>&amp;set_filter=Y"><?= $arrL["NAME"] ?></a>
                                        </td>
                                    </tr>
                                <?
                                endforeach;
