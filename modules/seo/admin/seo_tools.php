    ...
    switch ($_REQUEST['loadtab']) {
        case 'indexing':
            ...
            if (count($arSearchers) <= 0):
                ...
                <table width="100%">
                    <tr>
                        <td><?
                            echo BeginNote(), GetMessage('SEO_PAGE_ERROR_NO_SEARCHERS'), EndNote() ?></td>
                    </tr>
                </table>
            <?
            else:
                ...
                <tr class="heading">
                    <td colspan="2"><?
                        echo str_replace('#COUNT#', $days_count, GetMessage('SEO_PAGE_STATS_INDEX')) ?></td>
                </tr>
                <?
                if ($total > 0):
                        ...
                        if ($count > 0):
                            ...
                            <tr>
                                <td width="50%" align="right"><?
                                    echo HtmlFilter::encode($arSearchers[$key]['NAME']) ?>:&nbsp;&nbsp;
                                </td>
                                <td width="50%"><?
                                    echo $count; ?></td>
                            </tr>
                ...
                <tr class="heading">
                    <td colspan="2"><?
                        echo GetMessage('SEO_PAGE_STATS_SITE_INDEX') ?></td>
                </tr>
                <?
                if (count($arrLegend) > 0 && count($arrDays) > 1):
                    ?>
                    <tr>
                        <td colspan="2"><img src="/bitrix/admin/searcher_graph.php?&lang=<?
                            echo LANGUAGE_ID ?>&find_date1_DAYS_TO_BACK=90<?
                            foreach ($arSearchers as $key => $ar) echo '&find_searchers[]=' . $key; ?>&mode=list&find_summa=N&width=576&height=300"
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" class="legend">
                                ...
                                foreach ($arrLegend as $keyL => $arrL):
                                    ...
                                    ?>
                                    <tr>
                                        <td><img src="/bitrix/admin/graph_legend.php?color=<?= $color ?>" width="45"
                                                 height="2"></td>
                                        <td nowrap="nowrap">[<a
                                                    href="/bitrix/admin/searcher_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<?= $keyL ?>&amp;set_filter=Y"><?= $keyL ?></a>]&nbsp;<a
                                                    href="/bitrix/admin/searcher_dynamic_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_searcher_id=<?= $keyL ?>&amp;find_date1=<?
                                                    echo $arFilter["DATE1"] ?>&amp;find_date2=<?= $arFilter["DATE2"] ?>&amp;set_filter=Y"><?= $arrL["NAME"] ?></a>
                                        </td>
                                    </tr>
                                <?
                                endforeach;
        ...
        case 'words':
            ...
            <?
                ...
                if ($total > 0) {
                        ...
                        foreach ($arWords as $word => $arData) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:left !important;">
                                    <div style="height: 15px; border: solid 1px #<?
                                    echo $color = GetNextRGB($color, $cnt) ?> !important; width: 100%; position: relative; text-align: left !important;"
                                         class="bx-seo-words-table-link-element">
                                        <div style="float: left; height: 15px; width: <?
                                        echo $percent ?>%; background-color: #<?
                                        echo $color; ?>; white-space: nowrap; position: absolute;">
                                            <?
                    ...
                    <div>
                        <a href="/bitrix/admin/phrase_list.php?lang=<?
                        echo LANGUAGE_ID ?>"><?
                            echo GetMessage('SEO_PAGE_GOTO_CP') ?></a>
                    </div>
                    <?
                } else {
                    ?>
        ...
        case 'referers':
            ...
            if ($total > 0):?>
                ...
                <div>
                    <a href="/bitrix/admin/referer_list.php?lang=<?
                    echo LANGUAGE_ID ?>"><?
                        echo GetMessage('SEO_PAGE_GOTO_CP') ?></a>
                </div>
            <?
...
?>
    <form name="seo_form" method="POST" action="/bitrix/admin/public_seo_tools.php" enctype="multipart/form-data">
        ...
        ?>
        <style type="text/css">
            div#bx_admin_form table.edit-table tr#bx_keywords_stats table.bx-seo-words-table tr td {
            ...
            div#bx_page_extended_data a {
                text-decoration: none;
            }

            div#bx_admin_form table.edit-table table tr td {
                padding: 4px;
            }
            ...
            table.phrases-table, table.referers-table {
                width: 85%;
            }

            table.phrases-table tr.bx-th td, table.referers-table tr.bx-th td {
                text-align: center;
                font-weight: bold !important;
            }

            table.phrases-table td div, table.referers-table td div {
                color: black !important;
                white-space: nowrap;
            }

            table.phrases-table td div div, table.referers-table td div div {
            ...
            table.phrases-table td table, table.referers-table td table {
                width: 90%;
            }

            .bx-seo-words-table-link-element {
                margin-bottom: 6px;
            }

            div#bx_page_extended_data div {
                height: 140px;
                width: 99%;
                overflow: auto;
                margin-right: 5px;
                border: solid 1px #E0E4F1;
            }

            #bx_page_errors ol li {
                margin: 5px 0px;
            }
        ...
        <table id="bx_stats_loading_notify" class="edit-table">
            <tr>
                <td align="center"><? echo BeginNote(), GetMessage('SEO_TOOLS_LOADING'), EndNote(); ?></td>
            </tr>
        </table>
        <table id="bx_stats_loading_error" class="edit-table">
            <tr>
                <td align="center" id="bx_seo_error_text"></td>
            </tr>
        </table>
        <table id="bx_stats_table" class="edit-table" cellspacing="0" cellpadding="0" border="0" style="display: none;">
                    ...
                    <div id="bx_page_extended_data">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="33%">
                                    <a href="javascript: void(0)" id="bx_seo_link_HEADERS"
                                       onclick="BXShowExtendedStat('HEADERS');">HTTP HEADERS</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_TITLE"
                                       onclick="BXShowExtendedStat('TITLE')">HTML TITLE (&lt;TITLE&gt;)</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_H" onclick="BXShowExtendedStat('H')">HTML
                                        HEADING(&lt;H1&gt;-&lt;H6&gt;)</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_META_DESCRIPTION"
                                       onclick="BXShowExtendedStat('META_DESCRIPTION')">META DESCRIPTION</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_META_KEYWORDS"
                                       onclick="BXShowExtendedStat('META_KEYWORDS')">META KEYWORDS</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_BOLD"
                                       onclick="BXShowExtendedStat('BOLD')">BOLD (&lt;B&gt;, &lt;STRONG&gt;)</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_ITALIC"
                                       onclick="BXShowExtendedStat('ITALIC')">ITALIC (&lt;I&gt;, &lt;EM&gt;)</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_LINK"
                                       onclick="BXShowExtendedStat('LINK')">LINK</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_LINK_EXTERNAL"
                                       onclick="BXShowExtendedStat('LINK_EXTERNAL')">LINK (EXT)</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_NOINDEX"
                                       onclick="BXShowExtendedStat('NOINDEX')">NOINDEX</a><br/>
                                    <a href="javascript: void(0)" id="bx_seo_link_NOFOLLOW"
                                       onclick="BXShowExtendedStat('NOFOLLOW')">NOFOLLOW</a><br/>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            if ($propertyCode = COption::GetOptionString('seo', 'property_internal_keywords', 'keywords_inner')):
                ...
                <tr id="bx_keywords_stats_loading_notify">
                    <td align="center"><?
                        echo BeginNote(), GetMessage('SEO_TOOLS_LOADING'), EndNote(); ?></td>
                </tr>
                <tr id="bx_keywords_stats" style="display: none;">
                    <td colspan="2">
                        ...
                        <table width="100%" class="bx-seo-words-table" id="bx_seo_words_table">
                            ...
                            <tr class="heading">
                                <td style="text-align:left !important;"><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_WORD'); ?></td>
                                <td><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_ALL_CONTRAST'); ?></td>
                                <td><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_HEADERS'); ?></td>
                                <td><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_BOLD_ITALIC'); ?></td>
                                <td><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_DESCR_KEYWORDS'); ?></td>
                                <td><?
                                    echo GetMessage('SEO_TOOLS_INTERNAL_KEYWORDS_LINKS'); ?></td>
                            </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
            ...
            <? else: ?>
                ...
                if ($titleFinal != $pageTitle):
                    ...
                    <tr>
                        <td valign="top"><?
                            echo GetMessage('SEO_PAGE_CURRENT_TITLE') ?>: <?
                            echo SeoShowHelp('current_title') ?></td>
                        <td valign="top">
                            <script>
                                window.jsPopup_subdialog = new JCPopup({
                                    'suffix': 'subdialog',
                                    'zIndex': parseInt(jsPopup.zIndex) + 20
                                });
                            </script>
                            <?
                            if ($titleChangerLink) {
                            ...
                            ?>
                            <b><?
                                echo htmlspecialcharsEx($titleFinal) ?></b>&nbsp;<?
                            if ($titleChangerName != ''):?>(<?
                                echo HtmlFilter::encode($titleChangerName) ?>)&nbsp;<?endif; ?><?
                            if ($titleChangerLink):?><br/><a href="<?
                            echo HtmlFilter::encode($titleChangerLink, ENT_QUOTES); ?>"><?
                ...
                if ($propertyCode = COption::GetOptionString('seo', 'property_window_title', 'title')):
                    ...
                    <tr>
                        <td><?
                            echo $arFilemanProperties[$propertyCode] ? $arFilemanProperties[$propertyCode] : GetMessage('SEO_PAGE_PROPERTY_WINDOW_TITLE') ?>
                            (&lt;TITLE&gt;): <?
                            echo SeoShowHelp('property_window_title') ?></td>
                        <td><input type="text" name="property_<?
                            echo HtmlFilter::encode($propertyCode) ?>" value="<?= HtmlFilter::encode($value) ?>"
                                   size="50"/></td>
                    </tr>
                    <?
                    if ($value != $titleWinFinal):
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                ...
                                ?>
                                <b><?
                                    echo htmlspecialcharsEx($titleWinFinal) ?></b>&nbsp;<?
                                if ($titleWinChangerName != ''):?>(<?
                                    echo HtmlFilter::encode($titleWinChangerName) ?>)&nbsp;<?endif; ?><?
                                if ($titleWinChangerLink):?><br/><a href="<?
                                echo HtmlFilter::encode($titleWinChangerLink, ENT_QUOTES) ?>"><?
                                    echo GetMessage('SEO_PAGE_CURRENT_TITLE_EDIT') ?></a><?endif; ?>
                        </tr>
                    <?
                    endif;
                ...
                foreach ($arEditProperties as $propertyCode):
                    ...
                    <tr>
                        <td><?
                            echo $arFilemanProperties[$propertyCode] ?>: <?
                        ...
                        <td><input type="hidden" name="PROPERTY[<?= HtmlFilter::encode($propertyCode) ?>][CODE]"
                            ...
                            if (strlen($value) <= 0):
                                ...
                                <div id="bx_view_property_<?= HtmlFilter::encode($propertyCode) ?>"
                                     ...
                                     onclick="BXEditProperty('<?= $propertyCode ?>')"
                                ...
                                <div id="bx_edit_property_<?= HtmlFilter::encode($propertyCode) ?>"
                                     style="display:none;"></div>
                            <?
                            else:
                            ?>
                            <input type="text" name="PROPERTY[<?= HtmlFilter::encode($propertyCode) ?>][VALUE]"
            ...
            if (!$bStatsIncluded):
                ...
                <tr>
                    <td><?
                        ShowError(GetMessage('SEO_PAGE_ERROR_NO_STATS')); ?></td>
                </tr>
            <?
            elseif (!$bStatsRights):
                ?>
                <tr>
                    <td><?
                        ShowError(GetMessage('SEO_PAGE_ERROR_NO_STATS_RIGHTS')); ?></td>
                </tr>
            <?
            else:
                ?>
                <tr>
                    <td align="center">
                        <div id="bx_seo_tab_indexing"><?
                            echo BeginNote(), GetMessage('SEO_TOOLS_LOADING'), EndNote() ?></div>
                    </td>
                </tr>
            <?
            endif;
            ...
            <?
                ...
                <tr>
                    <td align="center">
                        <div id="bx_seo_tab_referers" align="center"><?
                        echo BeginNote(), GetMessage('SEO_TOOLS_LOADING'), EndNote() ?></td>
                </tr>
            <?
            endif;
