<?
$MESS["SALE_SHIPMENT_ITEM_BARCODE_MORE_ITEM_QUANTITY"] = "Штрих-кодов больше чем количества товара";
$MESS["SALE_SHIPMENT_ITEM_SHIPMENT_ALREADY_SHIPPED_CANNOT_EDIT"] = "Отгрузка уже отправлена. Изменения невозможны.";
$MESS["SALE_SHIPMENT_ITEM_SHIPMENT_ALREADY_SHIPPED_CANNOT_DELETE"] = "Отгрузка уже отправлена. Удаление товара \"#PRODUCT_NAME#\" невозможно.";
