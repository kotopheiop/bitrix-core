...
if (CSalePaySystemAction::GetParamValue("SELLER_PHONE", false)) {
    ...
    $pdf->Write(
        15,
        CSalePdf::prepareToPdf(sprintf("Tel.: %s", CSalePaySystemAction::GetParamValue("SELLER_PHONE", false)))
    );
    $pdf->Ln();
}
...
if (CSalePaySystemAction::GetParamValue("SELLER_DIR_POS", false)) {
    if (CSalePaySystemAction::GetParamValue("SELLER_DIR", false) || CSalePaySystemAction::GetParamValue(
            "SELLER_DIR_SIGN",
            false
        )) {
        $isDirSign = false;
...
if (CSalePaySystemAction::GetParamValue("SELLER_ACC_POS", false)) {
    if (CSalePaySystemAction::GetParamValue("SELLER_ACC", false) || CSalePaySystemAction::GetParamValue(
            "SELLER_ACC_SIGN",
            false
        )) {
        $isAccSign = false;
