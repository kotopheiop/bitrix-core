    ...
    public static function GetList(
        ...
        $arFields = array(
            ...
            "MIN_PLAN_SUM" => array(
                ...
                "TYPE" => "double",
                "WHERE" => array("CSaleAffiliatePlan", "PrepareCurrency4Where")
            ),

            "SECTION_ID" => array(
                "FIELD" => "APS.ID",
                "TYPE" => "int",
                "FROM" => "LEFT JOIN b_sale_affiliate_plan_section APS ON (AP.ID = APS.PLAN_ID)"
            ),
            "SECTION_MODULE_ID" => array(
                "FIELD" => "APS.MODULE_ID",
                "TYPE" => "string",
                "FROM" => "LEFT JOIN b_sale_affiliate_plan_section APS ON (AP.ID = APS.PLAN_ID)"
            ),
            "SECTION_SECTION_ID" => array(
                "FIELD" => "APS.SECTION_ID",
                "TYPE" => "string",
                "FROM" => "LEFT JOIN b_sale_affiliate_plan_section APS ON (AP.ID = APS.PLAN_ID)"
            ),
            "SECTION_RATE" => array(
            ...
            "SECTION_RATE_TYPE" => array(
                "FIELD" => "APS.RATE_TYPE",
                "TYPE" => "char",
                "FROM" => "LEFT JOIN b_sale_affiliate_plan_section APS ON (AP.ID = APS.PLAN_ID)"
            ),
            "SECTION_RATE_CURRENCY" => array(
                "FIELD" => "APS.RATE_CURRENCY",
                "TYPE" => "string",
                "FROM" => "LEFT JOIN b_sale_affiliate_plan_section APS ON (AP.ID = APS.PLAN_ID)"
            ),
        );
