...
<div class="mb-4" id="paysystem-qiwi">
    ...
    <form id="paysystem-qiwi-form">
        <fieldset class="form-group">
            <input type="text" name="NEW_PHONE" style="max-width: 300px;" value="+7" placeholder="+7"
                   class="form-control js-paysystem-qiwi-input-phone"/>
        </fieldset>
        <input type="submit" class="btn btn-lg btn-success pl-4 pr-4" style="border-radius: 32px;" name="SET_NEW_PHONE"
