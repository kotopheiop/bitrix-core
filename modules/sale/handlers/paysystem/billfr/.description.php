...
$data = array(
    ...
    'CODES' => array(
        ...
        "BILLFR_COLUMN_NUMBER_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_NUMBER_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 3300,
        ...
        "BILLFR_COLUMN_NAME_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_NAME_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 3500,
        ...
        "BILLFR_COLUMN_QUANTITY_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_QUANTITY_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 3700,
        ...
        "BILLFR_COLUMN_MEASURE_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_MEASURE_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 3900,
        ...
        "BILLFR_COLUMN_PRICE_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_PRICE_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 4100,
        ...
        "BILLFR_COLUMN_VAT_RATE_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_VAT_RATE_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 4300,
        ...
        "BILLFR_COLUMN_SUM_TITLE" => array(
            "NAME" => Loc::getMessage("SALE_HPS_BILL_FR_COLUMN_TITLE") . '"' . Loc::getMessage(
                    "SALE_HPS_BILL_FR_COLUMN_SUM_VALUE",
                    null,
                    'fr'
                ) . '"',
            'SORT' => 4500,
