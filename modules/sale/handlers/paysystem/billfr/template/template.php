...
<div style="margin: 0pt; padding: <?= join(
    ...
    <? if ($params['BILLFR_HEADER']): ?>
        <div style="text-align: center; font-size: 2em"><b><?= htmlspecialcharsbx($params['BILLFR_HEADER']); ?></b>
        </div>
        ...
        <tr>
            ...
            <td align="right">
                <? if ($params['BILLFR_PAYER_SHOW'] === 'Y'): ?>
                    <table class="inv">
                        <tr align="right">
                            <td><b><?= htmlspecialcharsbx($params['BILLFR_HEADER']); ?> <?= Loc::getMessage(
                        ...
                        <tr align="right">
                            <td><b><?= Loc::getMessage('SALE_HPS_BILLFR_DATE_INSERT', null, $billLang) ?>:&nbsp;</b>
                            </td>
                            <td><?= htmlspecialcharsbx($params["DATE_INSERT"]); ?></td>
                        </tr>
                        <? if ($params["DATE_PAY_BEFORE"]) { ?>
                            <tr align="right">
                                <td><b><?= Loc::getMessage('SALE_HPS_BILLFR_DATE_PAY_BEFORE', null, $billLang) ?>
                                        :&nbsp;</b></td>
                                <td><?= (
            ...
            foreach ($arCols as $columnId => $col) {
                ...
                switch ($columnId) {
                    ...
                    case 'MEASURE':
                        ...
                        ) : Loc::getMessage('SALE_HPS_BILLFR_MEASURE', null, $billLang);
                        break;
                    case 'PRICE':
            ...
            <td style="width: 50%; ">
                ...
                <? if ($bankAccNo && $bankRouteNo && $bankSwift) { ?>
                    ...
                    <? if ($params["SELLER_COMPANY_NAME"]) { ?>
                        <?= Loc::getMessage('SALE_HPS_BILLFR_COMPANY_NAME', null, $billLang) ?>: <?= htmlspecialcharsbx(
                    ...
                    <? if ($bank || $bankAddr || $bankPhone) { ?>
                        <?= Loc::getMessage(
                            'SALE_HPS_BILLFR_COMPANY_BANK_2',
                            null,
                            $billLang
                    ...
                    <?= Loc::getMessage(
                    'SALE_HPS_BILLFR_COMPANY_BANK_ROUTE_NO',
                    null,
                    $billLang
                    ...
                    <?= Loc::getMessage(
                    'SALE_HPS_BILLFR_COMPANY_BANK_SWIFT',
                    null,
                    $billLang
