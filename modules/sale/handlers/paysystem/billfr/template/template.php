        ...
        <tr>
            ...
            <td>
                ...
                <? if ($params["SELLER_COMPANY_PHONE"]) { ?>
                    <b><?= sprintf(Loc::getMessage('SALE_HPS_BILLFR_COMPANY_PHONE') . ": %s", $params["SELLER_COMPANY_PHONE"]); ?></b>
                    <br>
                <? } ?>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="right">
                <? if ($params['BILLFR_PAYER_SHOW'] === 'Y'): ?>
                    <table class="inv">
                        <tr align="right">
                            <td><b><?= $params['BILLFR_HEADER']; ?> <?= Loc::getMessage('SALE_HPS_BILLFR_NUMBER') ?>:&nbsp;</b>
                            </td>
