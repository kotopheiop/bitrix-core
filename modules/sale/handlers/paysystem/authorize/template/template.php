...
<form action="" method="post">
    ...
    <div class="form-group row">
        <label for="ccardDate1"
               class="col-sm-6 col-form-label text-sm-right"><?= Loc::getMessage("AN_CC_DATE") ?></label>
        <div class="col-auto">
    ...
    <div class="form-group row">
        <label for="ccardCode"
               class="col-sm-6 col-form-label text-sm-right"><?= Loc::getMessage("AN_CC_CVV2") ?></label>
        <div class="col-auto">
    ...
    <div class="form-group row">
        ...
        <div class="col-auto">
            ...
            <input type="submit" value="<?= Loc::getMessage("AN_CC_BUTTON") ?>"
                   class="inputbutton btn btn-primary pl-4 pr-4">
        </div>
    </div>
</form>