...
<div class="mb-4" id="paysystem-authorize">
    <form id="paysystem-authorize-form">
        <div class="form-group row">
            <label for="ccardNumber" class="col-sm-6 col-form-label text-sm-right"><?= Loc::getMessage(
                    "AN_CC"
                ) ?></label>
            <div class="col-sm-6">
        ...
        <div class="form-group row">
            <label for="ccardDate1" class="col-sm-6 col-form-label text-sm-right"><?= Loc::getMessage(
                    "AN_CC_DATE"
                ) ?></label>
            <div class="col-auto">
        ...
        <div class="form-group row">
            <label for="ccardCode" class="col-sm-6 col-form-label text-sm-right"><?= Loc::getMessage(
                    "AN_CC_CVV2"
                ) ?></label>
            <div class="col-auto">
        ...
        <div class="form-group row">
            ...
            <div class="col-auto">
                ...
                <input type="submit" value="<?= Loc::getMessage("AN_CC_BUTTON") ?>"
                       class="inputbutton btn btn-lg btn-success pl-4 pr-4" style="border-radius: 32px;">
            </div>
        </div>
    </form>
</div>
