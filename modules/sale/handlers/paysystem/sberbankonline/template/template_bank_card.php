...
?>
<div class="mb-4">
    <p><?= Loc::getMessage('SALE_HANDLERS_PAY_SYSTEM_SBERBANK_DESCRIPTION') . " " . SaleFormatCurrency(
            $params['SUM'],
            $params['CURRENCY']
        ); ?></p>
    <form action="<?= $params['URL']; ?>" method="GET">
        ...
        <div class="d-flex align-items-center mb-3">
            <div class="col-auto pl-0">
                <input class="btn btn-lg btn-success pl-4 pr-4" style="border-radius: 32px;"
                       value="<?= Loc::getMessage('SALE_HANDLERS_PAY_SYSTEM_SBERBANK_BUTTON_PAID'); ?>" type="submit">
            </div>
