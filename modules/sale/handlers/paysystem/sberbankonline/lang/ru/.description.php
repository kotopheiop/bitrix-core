...
$MESS["SALE_HPS_SBERBANK_RETURN_SUCCESS_URL_DESC"] = "Адрес должен быть указан полностью, включая используемый протокол";
$MESS["SALE_HPS_SBERBANK_RETURN_FAIL_URL"] = "Адрес, на который требуется перенаправить пользователя в случае неуспешной оплаты";
$MESS["SALE_HPS_SBERBANK_RETURN_FAIL_URL_DESC"] = "Адрес должен быть указан полностью, включая используемый протокол";
