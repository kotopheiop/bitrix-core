...
<div class="mb-4">
    ...
    <p><?= Loc::getMessage(
            'SALE_HANDLERS_PAY_SYSTEM_TEMPLATE_BEPAID_WIDGET_SUM',
            [
    ...
    <div class="d-flex align-items-center mb-3">
        <div class="col-auto pl-0">
            <a class="btn btn-lg btn-success pl-4 pr-4" style="border-radius: 32px;" id="paysystem-bepaid-button-pay"
               href="#"><?= Loc::getMessage('SALE_HANDLERS_PAY_SYSTEM_TEMPLATE_BEPAID_WIDGET_BUTTON_PAID') ?></a>
        </div>
    </div>
