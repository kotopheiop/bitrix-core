...
$res = \Bitrix\Sale\Location\ExternalTable::getList(
    array(
...
<tr>
    ...
    <td width="60%"><input type="button"
                           value="<?= \Bitrix\Main\Localization\Loc::getMessage('SALE_DLVRS_ADDL_LOC_TAB_B_COMP') ?>"
                           onclick="BX.Sale.Handler.Delivery.Additional.startLocationsCompare();"><br></td>
</tr>
<script language="JavaScript">
    BX.message({
        SALE_DLVRS_ADD_LOC_COMP_TITLE: '<?=\Bitrix\Main\Localization\Loc::getMessage(
            "SALE_DLVRS_ADD_LOC_COMP_TITLE"
        )?>',
        SALE_DLVRS_ADD_LOC_COMP_CLOSE: '<?=\Bitrix\Main\Localization\Loc::getMessage(
            "SALE_DLVRS_ADD_LOC_COMP_CLOSE"
        )?>',
        SALE_DLVRS_ADD_LOC_COMP_AJAX_ERROR: '<?=\Bitrix\Main\Localization\Loc::getMessage(
            "SALE_DLVRS_ADD_LOC_COMP_AJAX_ERROR"
        )?>',
        SALE_DLVRS_ADD_LOC_COMP_PREPARE: '<?=\Bitrix\Main\Localization\Loc::getMessage(
            "SALE_DLVRS_ADD_LOC_COMP_PREPARE"
        )?>',
        SALE_DLVRS_ADD_SP_SAVE: '<?=\Bitrix\Main\Localization\Loc::getMessage("SALE_DLVRS_ADD_SP_SAVE")?>',
        SALE_DLVRS_ADD_SP_CHOOSE_TITLE: '<?=\Bitrix\Main\Localization\Loc::getMessage(
