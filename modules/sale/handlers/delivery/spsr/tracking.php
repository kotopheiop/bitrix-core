...
class SpsrTracking extends \Bitrix\Sale\Delivery\Tracking\Base
{
    ...
    public function requestStatuses($sid, $icn, $trackingNumbers)
    {
        ...
        if ($reqRes->isSuccess()) {
            ...
            if (!empty($invoicesInfo['root']['#']['Invoices'][0]['#']['Invoice']) && is_array(
                    $invoicesInfo['root']['#']['Invoices'][0]['#']['Invoice']
                )) {
                foreach ($invoicesInfo['root']['#']['Invoices'][0]['#']['Invoice'] as $invoice) {
                    ...
                    if (!empty($invoice['#']['events'][0]['#']['event']) && is_array(
                            $invoice['#']['events'][0]['#']['event']
                        )) {
            ...
            } elseif (!empty($invoicesInfo['root']['#']['NotFound'][0]['#']['Invoice']) && is_array(
                    $invoicesInfo['root']['#']['NotFound'][0]['#']['Invoice']
                )) {
