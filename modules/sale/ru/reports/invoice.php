...
<div class=Section1>
    ...
    <p><b>���� N:</b> <? echo $arOrder["ACCOUNT_NUMBER"] ?> �� <? echo $arOrder["DATE_INSERT_FORMAT"] ?></p>
    ...
    <table border="0" cellspacing="0" cellpadding="2" width="100%">
        <tr bgcolor="#E2E2E2">
            ...
            <td nowrap align="center" style="border: 1pt solid #000000; border-right:none;">����,<?= $currency; ?></td>
            <td nowrap align="center" style="border: 1pt solid #000000;">�����,<?= $currency; ?></td>
        </tr>
        <?
        $n = 1;
        $sum = 0.00;
        ...
        foreach ($arBasketOrder as $arBasket) {
            ...
            <tr valign="top">
                ...
                <td align="right" bgcolor="#ffffff"
                    style="border: 1pt solid #000000; border-right:none; border-top:none;">
        ...
        <? if (false && DoubleVal($arOrder["DISCOUNT_VALUE"]) > 0): ?>
            <tr>
                ...
                <td valign="top" align="right" bgcolor="#ffffff"
                    style="border: 1pt solid #000000; border-right:none; border-top:none;">1
                </td>
                <td align="right" bgcolor="#ffffff"
                    style="border: 1pt solid #000000; border-right:none; border-top:none;">
    ...
    <p><font size="2">� ������ ������������� ������� �� ��������� ���� �������� � ������� ����
            ...
            ������������ ��������� ���� ������ � <?= $contextCurrency; ?> ��������������� ��������� ����� �������
            � ��������� ���� �� �������.<br><br>
            � ��������� ��������� ����������� ������� - "������ �� ����� � <? echo $arOrder["ACCOUNT_NUMBER"] ?>
            �� <? echo $arOrder["DATE_INSERT_FORMAT"] ?>".<br><br>
            ��������� ������ ������ ����� ������� ����� �� ��������� ���� ��������.
        </font></p>
    <!-- END REPORT BODY -->
