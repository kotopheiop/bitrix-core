...
width:86pt'>
	...
	colspan;'>����-������� �
            <input size="25" style="border:0px solid #000000;font-size:16px;font-style:bold;" type="text"
                   value="_____ �� '__' _______ ">
        </td>
    </tr>
    ...
    <tr class=xl50 height=19 style='mso-height-source:userset;height:14.25pt'>
        <td height=19 class=xl47 style='height:14.25pt'>��������</td>
    ...
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
        ...
        <td class=xl50 colspan=10
            style='mso-ignore:colspan'><? echo $arParams["COUNTRY"] . ", " . $arParams["INDEX"] . ", �. " . $arParams["CITY"] . ", " . $arParams["ADDRESS"]; ?></td>
    </tr>
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
        <td height=18 class=xl50 style='height:13.5pt'>���/��� ��������</td>
    ...
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
        <td height=18 class=xl50 style='height:13.5pt'>���������������� � ��� �����</td>
        <td colspan=10 class=xl50><?= $arParams["COMPANY_NAME"] ?>, <?= $arParams["COUNTRY"] ?>
            , <?= $arParams["INDEX"] ?>, �. <?= $arParams["CITY"] ?>, <?= $arParams["ADDRESS"] ?></td>
    </tr>
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
        <td height=18 class=xl50 style='height:13.5pt'>��������������� � ��� �����</td>
        <td class=xl64 colspan=10 style='mso-ignore:colspan'>
            <? if (empty($arParams)) { ?>
                ...
                ?>
                <?= $buyerName; ?>, <?= $arParams["BUYER_COUNTRY"] ?>, <?= $arParams["BUYER_INDEX"] ?>, �. <?= $arParams["BUYER_CITY"] ?>, <?= $arParams["BUYER_ADDRESS"] ?>
                <?
            }
            ?>
        </td>
    ...
    <tr class=xl50 height=19 style='mso-height-source:userset;height:14.25pt'>
        ...
        <td colspan=10 class=xl64 style='mso-ignore:colspan'>
            <input size="50" style="border:0px solid #000000;" type="text" value="�_______ �� _______________">
        </td>
    </tr>
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
    ...
    <tr class=xl50 height=18 style='mso-height-source:userset;height:13.5pt'>
        ...
        <td colspan=10 class=xl50 style='mso-ignore:colspan'>
            <? if (empty($arParams)) {
                ...
                echo $arParams["BUYER_COUNTRY"] . ", " . $arParams["BUYER_INDEX"] . ", �. " . $arParams["BUYER_CITY"] . ", " . $arParams["BUYER_ADDRESS"];
            } ?>
    ...
    <tr class=xl50 height=19 style='mso-height-source:userset;height:14.25pt'>
        <td height=19 class=xl50 style='height:14.25pt;mso-ignore:colspan'>������: ������������, ���</td>
        <td colspan=6 class=xl50 style='mso-ignore:colspan'><input size="50" style="border:0px solid #000000;"
                                                                   type="text" value="__________________________"></td>
    </tr>
        ...
        <td colspan="11">
            <table cellpadding=0 cellspacing=0 width=987 style='border-collapse:collapse;table-layout:fixed;width:100%'>
                <tr class=xl37 height=44 style='mso-height-source:userset;height:33.6pt'>
                    <td rowspan="2" class="xl54" style='width:150pt'>������������ ������ (�������� <br>�����������
                        �����, ��������� �����), <br>�������������� �����
                    </td>
                    <td colspan="2" class="xl54" style='width:80pt'>������� ���������</td>
                    <td rowspan="2" class="xl54" style='width:30pt'>����-<br>������<br>(�����)</td>
                    <td rowspan="2" class="xl54" style='width:60pt'>����<br>(�����)<br>�� �������<br>���������</td>
                    <td rowspan="2" class="xl54" style='width:60pt'>��������� ������� (�����, �����), ������������� ����
                        ��� ������ - �����
                    </td>
                    <td rowspan="2" class="xl54" style='width:30pt'>� ��� ����� ����� ������</td>
                    <td rowspan="2" class="xl54" style='width:40pt'>���������<br>������</td>
                    <td rowspan="2" class="xl54" style='width:60pt'>����� ������, �������-������ ����������</td>
                    <td rowspan="2" class="xl54" style='width:60pt'>��������� ������� (�����, �����), ������������� ����
                        � ������� - �����
                    </td>
                    <td colspan="2" class="xl54" style='width:70pt'>������ ������������� ������</td>
                    <td rowspan="2" class="xl56" style='width:40pt'>����� ���������� ����������</td>
                </tr>
                <tr>
                    <td class="xl56" style='width:20pt'>���</td>
                    <td class="xl56" style='width:60pt'>�������� ����������� (���������<br>���)</td>
                    <td class="xl56">�������� ���</td>
                    <td class="xl56">������� ���������<br>���</td>
                </tr>
                <tr>
                ...
                foreach ($arBasketOrder as $arBasket):
                    ...
                    <tr class=xl39>
                        ...
                        <td class=xl41 style='border-top:none;border-left:none'><?
                            echo Bitrix\Sale\BasketItem::formatQuantity($arQuantities[$mi]); ?></td>
	...
	width:32pt'><?= ($taxRate > 0 || count($arTaxList) > 0) ? $taxRate . "%" : "��� ���"; ?></td>
	...
	width:62pt' x:num>
                        ...
                        <td class=xl46><input size="5"
                                              style="border:0px solid #000000;font-size:14px;font-style:bold;text-align:center;"
                                              type="text" value="---"></td>
                        <td class=xl46><input size="5"
                                              style="border:0px solid #000000;font-size:14px;font-style:bold;text-align:center;"
                                              type="text" value="---"></td>
	...
	width:32pt'><?= ($taxRate > 0 || count($arTaxList) > 0) ? $taxRate . "%" : "��� ���"; ?></td>
                        <td class=xl45 align=right width=78 style='border-top:none;border-left:none;
	width:59pt' x:num><?= CCurrencyLang::CurrencyFormat($nds_val, $arOrder["CURRENCY"], false);
                            $total_nds += $nds_val; ?></td>
                        <td class=xl45 align=right width=83 style='border-top:none;border-left:none;
	width:62pt' x:num><?= CCurrencyLang::CurrencyFormat($nds_val + $item_price, $arOrder["CURRENCY"], false);
                            $total_sum += $nds_val + $item_price ?></td>
                        <td class=xl46><input size="5"
                                              style="border:0px solid #000000;font-size:14px;font-style:bold;text-align:center;"
                                              type="text" value="---"></td>
                        <td class=xl46><input size="5"
                ...
                <tr>
                    ...
                    <td class=xl59>&nbsp;</td>
                    <td class=xl59>&nbsp;</td>
                    <td class=xl60 align=right width=80 style='border-top:none;width:60pt'
                        x:num><?= CCurrencyLang::CurrencyFormat($total_price, $arOrder["CURRENCY"], false); ?></td>
                    <td class=xl61 style='border-left:none'>&nbsp;</td>
                    <td class=xl61 style='border-left:none'>&nbsp;</td>
                    <td class=xl62 align=right width=78 style='border-top:none;width:59pt'
                        x:num><?= CCurrencyLang::CurrencyFormat($total_nds, $arOrder["CURRENCY"], false); ?></td>
                    <td class=xl63 align=right width=83 style='border-top:none;width:62pt;white-space:nowrap'
                        x:num><?= CCurrencyLang::CurrencyFormat($total_sum, $arOrder["CURRENCY"], false); ?></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td colspan=6 class=xl32 style='mso-ignore:colspan'>������� ���������<br> ��� ���� ��������������
                        ���� _______________ <input size="16"
                                                    style="border:0px solid #000000;font-size:14px;font-style:bold;"
                                                    type="text"
                ...
                <tr height=22 style='mso-height-source:userset;height:16.5pt'>
                    <td height=22 colspan=5 class=xl32 style='height:16.5pt;mso-ignore:colspan'>��������������
                        ��������������� _____________ / <input size="16"
                                                               style="border:0px solid #000000;font-size:14px;font-style:bold;"
                                                               type="text" value="_______________"> /
                    </td>
                    <td height=22 colspan=1 class=xl32 style='height:16.5pt;mso-ignore:colspan'></td>
                    <td colspan=5 class=xl36><input size="40"
                                                    style="border:0px solid #000000;font-size:14px;font-style:bold;"
                                                    type="text" value="_____________________________________"></td>
                </tr>
                <tr height=20 style='mso-height-source:userset;height:15.0pt'>
                    ...
                    <td class=xl33 colspan=5 style='mso-ignore:colspan' align="center">(��������� ������������� �
                        ��������������� �����������<br>
                        ��������������� ���������������)
                    </td>
                </tr>
