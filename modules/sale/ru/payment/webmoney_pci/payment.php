...
$strPayPath = "";
$strPayPath .= "url=" . urlencode(
        "http://" . $SERVER_NAME_tmp . (CSalePaySystemAction::GetParamValue("PATH_TO_RESULT")) . "?ORDER_ID=" . intval(
...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            ���� �� ����������� <strong>WMKeeper Classic</strong>, ��������� ��� ������ ������ �� ��������� ������: <a
                    class="" href="wmk:paylink?<?= $strPayPath ?>"><strong>�������� �����</strong></a>
        </div>
    </div>

    <div class="row">
        <div class="col">
            ���� �� ����������� <strong>WMKeeper Light</strong>, ��������� ��� ������ ������ �� ��������� ������: <a
                    class="" href="https://light.webmoney.ru/pci.aspx?<?= $strPayPath ?>"><strong>��������
                    �����</strong></a>
        </div>
    </div>
</div>