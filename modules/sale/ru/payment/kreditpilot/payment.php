...
<form method=post action=http://www.kreditpilot.com/servlets/com.kreditpilot.server.FirstStep target="_blank">
    ...
    <p>����� � ������ ��
        �����: <? echo SaleFormatCurrency(CSalePaySystemAction::GetParamValue("SHOULD_PAY"), CSalePaySystemAction::GetParamValue("CURRENCY")) ?></p>
    ...
    <input type=hidden name=BillCurrency
           value="<? echo(CSalePaySystemAction::GetParamValue("CURRENCY") == "RUR" ? "���." : "") ?>">
