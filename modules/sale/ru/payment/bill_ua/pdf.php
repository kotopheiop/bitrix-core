...
$pdf->Cell($title_width, 15, CSalePdf::prepareToPdf('��������: '));
...
if ($buyerPhone || $buyerFax) {
    ...
    if ($buyerPhone) {
        $pdf->Write(15, CSalePdf::prepareToPdf(sprintf('���.: %s', $buyerPhone)));
        if ($buyerFax) {
    ...
    if ($buyerFax) {
        $pdf->Write(15, CSalePdf::prepareToPdf(sprintf('����: %s', $buyerFax)));
    }
...
if ($arBasket = $dbBasket->Fetch()) {
    ...
    */
    ...
    $arColsCaption = array(
        ...
        CSalePdf::prepareToPdf('�����/�������'),
        CSalePdf::prepareToPdf('ʳ�-���'),
        CSalePdf::prepareToPdf('��.'),
        CSalePdf::prepareToPdf(($vat <= 0 ? 'ֳ�� ��� ���, ' : 'ֳ�� � ���, ') . $currency),
        CSalePdf::prepareToPdf('������ ���'),
        CSalePdf::prepareToPdf(($vat <= 0 ? '���� ��� ���, ' : '���� � ���, ') . $currency)
    );
    for ($i = 1; $i <= 7; $i++) {
