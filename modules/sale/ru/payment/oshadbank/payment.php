...
<table class="b_kvit">
    <? for ($i = 0; $i < 2; $i++): ?>
        <tr>
            ...
            <td class="content">
                <div class="form">������� �61 �.3</div>

                <div class="text">���������
                    �������<span><?= (CSalePaySystemAction::GetParamValue("RECIPIENT_NAME")) ?></span></div>
                ...
                <div class="text">���� ����������� <b><input type="text" value="<?= date("d.m.Y") ?>"></b></div>
                ...
                <div class="text fio">
                    ...
                    if (strlen(CSalePaySystemAction::GetParamValue("PAYER_TOWN")) > 0)
                        $adres .= ($adres <> "" ? ", " : "") . "�." . CSalePaySystemAction::GetParamValue("PAYER_TOWN");
                ...
                <table>
                    <tr>
                        <td class="list">����������� �������</td>
                        <td class="list val">������ ������ � <?= (CSalePaySystemAction::GetParamValue("ORDER_ID")) ?>
                            �� <?= (CSalePaySystemAction::GetParamValue("ORDER_DATE")) ?></td>
                    </tr>
                    <tr>
                        <td class="list">����� �������</td>
                ...
                <table>
                    <tr>
                        <td rowspan="3" class="singuar">
                            <div class="text">ϳ���� ��������<span>&nbsp;</span></div>
                        </td>
                        <td class="sum_title">����</td>
                        <td class="summa"><?= (CSalePaySystemAction::GetParamValue("SHOULD_PAY")) ?> ���.</td>
                    </tr>
                    <tr>
                        <td class="sum_title">����</td>
                        <td class="summa">&nbsp;</td>
