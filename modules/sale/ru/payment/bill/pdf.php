...
if (CSalePaySystemAction::GetParamValue("SELLER_PHONE", false)) {
    $pdf->SetX($pdf->GetX() + $logoWidth);
    $pdf->Write(15, CSalePdf::prepareToPdf(sprintf("���.: %s", CSalePaySystemAction::GetParamValue("SELLER_PHONE", false))));
    $pdf->Ln();
}
...
if (CSalePaySystemAction::GetParamValue("BUYER_NAME", false)) {
    ...
    if (CSalePaySystemAction::GetParamValue("BUYER_INN", false))
        $pdf->Write(15, CSalePdf::prepareToPdf(sprintf(" ��� %s", CSalePaySystemAction::GetParamValue("BUYER_INN", false))));
