...
abstract class BasketItemBase extends Internals\CollectableEntity
{
    ...
    public function delete()
    {
        ...
        $event = new Main\Event(
            'sale', "OnBeforeSaleBasketItemEntityDeleted", [
            'ENTITY' => $this,
        ...
        /** @var Main\Event $event */
        $event = new Main\Event(
            'sale', "OnSaleBasketItemEntityDeleted", [
            'ENTITY' => $this,
            'VALUES' => $oldEntityValues,
        ]
        );
    ...
    protected function onFieldModify($name, $oldValue, $value)
    {
        ...
        if ($name == "QUANTITY") {
            ...
            if ($value != 0
                && (($deltaQuantity > 0) && (roundEx($availableQuantity, SALE_VALUE_PRECISION) < roundEx(
                            $value,
    ...
    protected function callEventSaleBasketItemBeforeSaved($isNewEntity)
    {
        ...
        /** @var Main\Event $event */
        $event = new Main\Event(
            'sale', EventActions::EVENT_ON_BASKET_ITEM_BEFORE_SAVED, [
            'ENTITY' => $this,
            'IS_NEW' => $isNewEntity,
            'VALUES' => $oldEntityValues,
        ]
