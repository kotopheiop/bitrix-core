...
class OrderStatus extends \Bitrix\Sale\Helpers\Admin\Blocks\OrderStatus
{
    ...
    {
        return '<a href="/bitrix/admin/user_edit.php?lang=' . LANGUAGE_ID . '&ID=' . $data["CREATOR_USER_ID"] . '" target="_blank">' . htmlspecialcharsbx(
    ...
    {
        return '<a href="/bitrix/admin/user_edit.php?lang=' . LANGUAGE_ID . '&ID=' . $data["EMP_CANCELED_ID"] . '" target="_blank">' . htmlspecialcharsbx(
