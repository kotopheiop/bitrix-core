    ...
    implements ISettingsExport
{
    ...
    static protected function loadCurrentSettings()
    {
        if (self::$currentSettings === null) {
            ...
            self::$currentSettings['payed'][EntityType::INVOICE_NAME] = Option::get(
                "sale",
            ...
            self::$currentSettings['allow_delivery'][EntityType::ORDER_NAME] = Option::get(
                "sale",
            ...
            self::$currentSettings['allow_delivery'][EntityType::INVOICE_NAME] = Option::get(
                "sale",
                "1C_EXPORT_ALLOW_DELIVERY_ORDERS",
                ""
            );
            ...
            self::$currentSettings['accountNumberPrefix'][EntityType::ORDER_NAME] = Option::get(
                "sale",
            ...
            self::$currentSettings['accountNumberPrefix'][EntityType::INVOICE_NAME] = Option::get(
                "sale",
                "1C_SALE_ACCOUNT_NUMBER_SHOP_PREFIX",
                ""
            );
            ...
            self::$currentSettings['finalStatus'][EntityType::ORDER_NAME] = Option::get(
                "sale",
            ...
            self::$currentSettings['finalStatus'][EntityType::INVOICE_NAME] = Option::get(
                "sale",
                "1C_EXPORT_FINAL_ORDERS",
                ""
            );
            ...
            self::$currentSettings['groupPermission'][EntityType::ORDER_NAME] = Option::get(
                "sale",
            ...
            self::$currentSettings['groupPermission'][EntityType::INVOICE_NAME] = Option::get(
                "sale",
                "1C_SALE_GROUP_PERMISSIONS"
            );
