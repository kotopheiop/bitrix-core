...
class OrderBasketSettings
{
    ...
    public function getScripts()
    {
        ...
        if (!static::$jsInited) {
            ...
            $result .= '
					BX.message({
						SALE_ORDER_BASKET_JS_SETTINGS_TITLE: "' . \CUtil::JSEscape(
                    Loc::getMessage("SALE_ORDER_BASKET_JS_SETTINGS_TITLE")
                ) . '",
						SALE_ORDER_BASKET_JS_SETTINGS_APPLY: "' . \CUtil::JSEscape(
                    Loc::getMessage("SALE_ORDER_BASKET_JS_SETTINGS_APPLY")
                ) . '"
					});
			';
        ...
        $settingsTemplate = '
			<div id="' . $this->idPrefix . 'columns_form">
							...
							<table>
								<tr>
									<td style="background-image:none" nowrap>
										<div style="margin-bottom:5px">' . Loc::getMessage(
                "SALE_ORDER_BASKET_SETTINGS_AVAILABLE_COLUMNS"
									...
									<td style="background-image:none">
										<div style="margin-bottom:5px">
											<input type="button" name="add_btn" value="&gt;" title="' . Loc::getMessage(
                "SALE_ORDER_BASKET_SETTINGS_ADD_COLUMN"
										...
										<div style="margin-bottom:5px">
											<input type="button" name="del_btn" value="&lt;" title="' . Loc::getMessage(
                ...
                "SALE_ORDER_BASKET_SETTINGS_SELECTED_COLUMNS"
									...
									<td style="background-image:none">
										<div style="margin-bottom:5px"><input type="button" name="up_btn" value="' . Loc::getMessage(
                "SALE_ORDER_BASKET_SETTINGS_UP"
            ) . '" title="' . Loc::getMessage("SALE_ORDER_BASKET_SETTINGS_MOVE_UP") . '" class="bx-grid-btn" style="width:60px;" disabled onclick="jsSelectUtils.moveOptionsUp(this.form.columns)"></div>
										<div style="margin-bottom:5px"><input type="button" name="down_btn" value="' . Loc::getMessage(
                "SALE_ORDER_BASKET_SETTINGS_DOWN"
            ) . '" title="' . Loc::getMessage("SALE_ORDER_BASKET_SETTINGS_MOVE_DOWN") . '" class="bx-grid-btn" style="width:60px;" disabled onclick="jsSelectUtils.moveOptionsDown(this.form.columns)"></div>
									</td>
								</tr>
							</table>
						</td>
