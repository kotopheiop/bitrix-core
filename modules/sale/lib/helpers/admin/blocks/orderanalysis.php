            ...
            <table class="adm-s-order-table-ddi-table adm-s-bus-ordertable-option" style="width: 100%;">
                ...
                foreach ($items as $item):
                    ...
                    <tr class="bdb-line">
                        ...
                        <td style="text-align: left;"><a class="fwb"
                                                         href="<?= htmlspecialcharsbx($item['EDIT_PAGE_URL']); ?>"><?= htmlspecialcharsEx($item['NAME']); ?></a>
                        </td>
                        <td class="tac"><?= $properties; ?></td>
                        <td class="tac"
                            style="text-align: right !important;"><?= $quantity . ' ' . htmlspecialcharsEx($item['MEASURE_TEXT']) ?></td>
                        <td class="tac"
                            style="text-align: right !important;;"><?= $shippedQuantity . ' ' . htmlspecialcharsEx($item['MEASURE_TEXT']) ?></td>
                        <td class="tac"
                            style="text-align: right !important;;"><?= ($quantity - $shippedQuantity) . ' ' . htmlspecialcharsEx($item['MEASURE_TEXT']) ?></td>
                    </tr>
                <?endforeach ?>
                <tr>
                    ...
                    <div class="adm-bus-orderdocs-threelist-block-top<?= $selectPayment === null ? ' adm-bus-orderdocs-threelist-block-children-open' : '' ?>">
                        ...
                        <div class="adm-bus-orderdocs-threelist-block-content">
                            <div class="adm-bus-orderdocs-threelist-block-title">
                                <a class="adm-bus-orderdocs-threelist-block-title-link fwb"
                                   href="/bitrix/admin/sale_order_edit.php?lang=ru&ID=<?= $orderId; ?>">
                            ...
                            <div class="adm-bus-orderdocs-threelist-block-content">
                                <div class="adm-bus-orderdocs-threelist-block-title">
                                    ...
                                    if ($isPayment):
                                        ...
                                        <?endif ?>
                                        <? if ($isAllowCompany): ?>
                                        <a href="/bitrix/admin/sale_order_payment_edit.php?order_id=<?= $orderId ?>&payment_id=<?= $documentId ?>"
    ...
    private static function printDeliveryRequestBlock($shipmentId)
    {
        ...
        if (intval($request['REQUEST_ID']) > 0) {
            ...
            <div class="adm-bus-orderdocs-threelist-block-children" style="padding-left: 60px;">
                ...
                <div class="adm-bus-orderdocs-threelist-block-content">
                    <div class="adm-bus-orderdocs-threelist-block-title">
                        <a href="/bitrix/admin/sale_delivery_request_view.php?lang=<?= LANGUAGE_ID ?>&ID=<?= $request['REQUEST_ID'] ?>"
                           class="adm-bus-orderdocs-threelist-block-title-link">
