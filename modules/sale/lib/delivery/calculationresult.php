...
class CalculationResult extends Sale\ResultSerializable
{
    ...
    {
        $this->extraServicesPrice = $price;
    }

    /**    @return float */
    public function getPrice()
    {
        return $this->deliveryPrice + $this->extraServicesPrice;
    }
    ...
    {
        $this->periodFrom = intval($periodFrom);
    }
