...
class CSaleCondCtrlBasketGroup extends CSaleCondCtrlGroup
{
        ...
        foreach ($controls as &$oneControl) {
            ...
            switch ($oneControl['ID']) {
                ...
                default:
                    ...
                    $row['control'] = (empty($row['control']) ? $oneControl['ATOMS'] : array_merge(
                        $row['control'],
                        $oneControl['ATOMS']
                    ));
                    break;
                    ...
                    if (!empty($currency)) {
                        if ($oneControl['ID'] == 'CondCumulativeGroup' && $row['control'][2]['id'] === 'Value') {
                            ...
                            array_splice(
                                ...
                                4,
                                0,
                                Loc::getMessage('BT_SALE_COND_GROUP_CUMULATIVE_BEFORE_CONDITION')
                            );
    ...
    public static function Generate($arOneCondition, $arParams, $arControl, $arSubs = false)
    {
        ...
        if (!$boolError) {
            switch ($arControl['ID']) {
                case 'CondBsktCntGroup':
                    $mxResult = self::__GetCntGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                    ...
                    break;
                case 'CondBsktAmtGroup':
                    $mxResult = self::__GetAmtGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                    ...
                    break;
                case 'CondBsktAmtBaseGroup':
                    $mxResult = self::__GetAmtBaseGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                    ...
                    break;
                case 'CondBsktProductGroup':
                    $mxResult = self::__GetProductGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                    ...
                    break;
                case 'CondBsktRowGroup':
                    $mxResult = self::__GetRowGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                ...
                case 'CondBsktSubGroup':
                    $mxResult = self::__GetSubGroupCond(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
                ...
                case 'CondCumulativeGroup':
                    $mxResult = self::getCodeForCumulativeGroupCondition(
                        $arOneCondition,
                        $arValues['values'],
                        $arParams,
                        $arControl,
    ...
    private static function getCodeForCumulativeGroupCondition($oneCondition, $values, $params, $control, $subs)
    {
        ...
        return str_replace(
            array('#FIELD#', '#VALUE#'),
            array(
                "\CSaleCondCumulativeCtrl::getCumulativeValue({$params['ORDER']}, {$dataSumConfiguration}) ",
                $values['Value']
            ),
            $logic['OP']['N']
        );
        ...
        if (!isset($arLogic['OP']['N']) || empty($arLogic['OP']['N'])) {
            ...
            if (!empty($arSubs)) {
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::RowFilter(' . $arParams['ORDER'] . ', ' . $strFuncName . ')',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
        ...
        if (!isset($arLogic['OP']['N']) || empty($arLogic['OP']['N'])) {
            ...
            if (!empty($arSubs)) {
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::AmountFilter(' . $arParams['ORDER'] . ', ' . $strFuncName . ')',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::AmountFilter(' . $arParams['ORDER'] . ', "")',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
        ...
        if (!isset($arLogic['OP']['N']) || empty($arLogic['OP']['N'])) {
            ...
            if (!empty($arSubs)) {
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::AmountBaseFilter(' . $arParams['ORDER'] . ', ' . $strFuncName . ')',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::AmountBaseFilter(' . $arParams['ORDER'] . ', "")',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
        ...
        if (!isset($arLogic['OP']['N']) || empty($arLogic['OP']['N'])) {
            ...
            if (!empty($arSubs)) {
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::CountFilter(' . $arParams['ORDER'] . ', ' . $strFuncName . ')',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
                ...
                $strCond = str_replace(
                    array('#FIELD#', '#VALUE#'),
                    array(
                        'CSaleBasketFilter::CountFilter(' . $arParams['ORDER'] . ', "")',
                        $arValues['Value']
                    ),
                    $arLogic['OP']['N']
                );
                ...
                if ($arOneControl['ID'] == 'CondBsktFldPrice' || $arOneControl['ID'] == 'CondBsktFldSumm') {
                    ...
                    if (static::$boolInit) {
                        if (isset(static::$arInitParams['CURRENCY'])) {
                            ...
                            $strCurrency = Sale\Internals\SiteCurrencyTable::getSiteCurrency(
            ...
            if (!isset($arLogic['OP'][$arControl['MULTIPLE']]) || empty($arLogic['OP'][$arControl['MULTIPLE']])) {
                ...
                switch ($arControl['FIELD_TYPE']) {
                    ...
                    case 'text':
                        $strResult = str_replace(
                            array('#FIELD#', '#VALUE#'),
                            array($valueField, '"' . EscapePHPString($arValues['value']) . '"'),
                            $arLogic['OP'][$arControl['MULTIPLE']]
                        );
                        break;
                    case 'date':
                    ...
                    case 'double':
                        if (!$boolMulti) {
                            ...
                            foreach ($arValues['value'] as &$mxValue) {
                                $arResult[] = str_replace(
                                    array('#FIELD#', '#VALUE#'),
                                    array($strField, $mxValue),
                                    $arLogic['OP'][$arControl['MULTIPLE']]
                                );
                            }
                            if (isset($mxValue)) {
                    ...
                    case 'text':
                        if (!$boolMulti) {
                            ...
                            foreach ($arValues['value'] as &$mxValue) {
                                $arResult[] = str_replace(
                                    array('#FIELD#', '#VALUE#'),
                                    array($strField, '"' . EscapePHPString($mxValue) . '"'),
                                    $arLogic['OP'][$arControl['MULTIPLE']]
                                );
                            }
                            if (isset($mxValue)) {
    ...
    public static function GetControls($strControlID = false)
    {
        ...
        if (!empty($deliveryList)) {
            Main\Type\Collection::sortByColumn(
                $deliveryList,
                array('SORT' => SORT_ASC, 'TITLE' => SORT_ASC, 'ID' => SORT_ASC)
            );
