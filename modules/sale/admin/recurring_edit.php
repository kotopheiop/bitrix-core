...
if (strlen($errorMessage) > 0)
    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="frecurring_edit">
                ...
                <? else: ?>
                    <select name="MODULE" OnChange="ModuleChange()">
                        ...
                        while ($arModuleList = $dbModuleList->Fetch()) {
                            ?>
                            <option value="<?= $arModuleList["ID"] ?>"<?
                            if ($str_MODULE == $arModuleList["ID"]) echo " selected"; ?>><?= htmlspecialcharsEx($arModuleList["ID"]) ?></option><?
                        }
                        ?>
                    </select>
                <? endif; ?>
        ...
        <? if (!$bSimpleForm): ?>
            <? if ($saleModulePermissions >= "W"): ?>
                <tr class="adm-detail-required-field">
                    ...
                    <td><input type="text" name="CALLBACK_FUNC" size="30" maxlength="30"
                               value="<?= $str_CALLBACK_FUNC ?>"></td>
                </tr>
                <tr>
                ...
                <tr class="adm-detail-required-field">
                    ...
                    <td><input type="text" name="PRODUCT_PROVIDER_CLASS" size="30" maxlength="30"
                               value="<?= $str_PRODUCT_PROVIDER_CLASS ?>"></td>
                </tr>
            <? endif; ?>
        <? endif; ?>
        <tr class="adm-detail-required-field">
            ...
            <td>
                <? if ($saleModulePermissions >= "W"): ?>
                    ...
                    <input name="PRODUCT_ID" value="<?= $str_PRODUCT_ID ?>" size="5" type="text">&nbsp;<input
                            type="button" value="..." id="cat_prod_button" onClick="showProductSearchDialog()">
                    <script type="text/javascript">
                        ModuleChange();
                    </script>
                <? else: ?>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="SUCCESS_PAYMENT"
                       value="Y"<? if ($str_SUCCESS_PAYMENT == "Y") echo " checked" ?>>
            </td>
        </tr>
        <tr>
            <td><? echo GetMessage("SRE_STEPS") ?></td>
            <td>
                <input type="text" name="REMAINING_ATTEMPTS" size="5" maxlength="5"
                       value="<?= $str_REMAINING_ATTEMPTS ?>">
            </td>
        </tr>
        <tr class="adm-detail-required-field">
