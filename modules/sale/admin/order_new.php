    ...
    <div id="form_content">
                ...
                if ($dbStatusList->GetNext()) {
                    ...
                    <select name="STATUS_ID" id="STATUS_ID">
                        ...
                        while ($arStatusListTmp = $dbStatusListTmp->GetNext()) {
                            ?>
                            <option value="<?
                            echo $arStatusListTmp["ID"] ?>"<?
                            if ($arStatusListTmp["ID"] == $str_STATUS_ID) echo " selected" ?>><?
                            echo $arStatusListTmp["NAME"] ?> [<?
        ...
        if ($ID > 0) {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="checkbox"<?
                    if (!$bUserCanCancelOrder) echo " disabled"; ?> name="CANCELED" id="CANCELED" value="Y"<?
                    if ($str_CANCELED == "Y") echo " checked"; ?>>&nbsp;<label
            ...
            <tr>
                ...
                <td width="60%" valign="top">
                    ...
                    if (!$bUserCanCancelOrder) echo " disabled"; ?> rows="2"
            ...
            <tr>
                <td width="40%" align="right">
                    <a onClick="fButtonCurrent('btnBuyerNew')" href="javascript:void(0);" id="btnBuyerNew"
                       class="adm-btn<?
                       if ($_REQUEST["btnTypeBuyer"] == 'btnBuyerNew' || !isset($_REQUEST["btnTypeBuyer"])) echo ' adm-btn-active'; ?>"><?= GetMessage("NEWO_BUYER_NEW") ?></a>
                </td>
        ...
        if ($ID > 0) {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="checkbox" name="ALLOW_DELIVERY" id="ALLOW_DELIVERY"<?
                    if (!$bUserCanDeliverOrder) echo " disabled"; ?> value="Y"<?
                    if ($str_ALLOW_DELIVERY == "Y") echo " checked"; ?>>&nbsp;<label
        ...
        if ($ID > 0) {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="checkbox"<?
                    if (!$bUserCanPayOrder) echo " disabled"; ?> name="PAYED" id="PAYED" value="Y"<?
                    if ($str_PAYED == "Y") echo " checked"; ?> onchange="BX.show(BX('ORDER_PAYED_MORE'))">&nbsp;<label
                    ...
                    if ($PAY_CURRENT_ACCOUNT == "Y") echo " checked"; ?><?
                    if (!$bUserCanPayOrder) echo " disabled"; ?>/>&nbsp;<label
        ...
        if ($ID > 0) {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="checkbox"<?
                    if (!$bUserCanMarkOrder) echo " disabled"; ?> onclick="fShowReasonMarkedBlock(this.checked);"
                           name="MARKED" id="MARKED" value="Y"<?
                    if ($str_MARKED == "Y") echo " checked"; ?>>&nbsp;<label
            ...
            <tr id="reason_marked_block"
                ...
                <td width="60%" valign="top">
                    <textarea id="REASON_MARKED" name="REASON_MARKED"<?
                    if (!$bUserCanMarkOrder) echo " disabled"; ?> rows="5"
        ...
        ?>
            <tr>
                ...
                <td width="60%">
                    <input name="DEDUCTED" id="DEDUCTED" type="checkbox" <?
                    if (!$bUserCanDeductOrder) echo "disabled"; ?> value="<?= ($str_DEDUCTED == "Y") ? "Y" : "N" ?>" <?
                    if ($str_DEDUCTED == "Y") echo "checked"; ?>
            ...
            <tr id="reason_undo_deducted_area"
                ...
                <td width="60%" valign="top">
                    <textarea name="REASON_UNDO_DEDUCTED" <?
                    if (!$bUserCanDeductOrder) echo " disabled" ?> rows="2"
                                ...
                                if ($columnCode == "COLUMN_NAME") {
                                    ...
                                    <td class="COLUMN_NAME">
                                        <div id="product_name_<?= $val["ID"] ?>">
                                            ...
                                            <a href="<?
                                            echo $val["EDIT_PAGE_URL"] ?>" target="_blank"
