...
$arHeaders = array(
    ...
    array(
        "id" => "DATE_CREATE",
        "content" => GetMessage("SAS1_DATE_CREATE"),
        "sort" => "DATE_CREATE",
        "default" => true
    ),
    ...
    array(
        "id" => "PENDING_SUM",
        "content" => GetMessage("SAS1_PENDING_SUM"),
        "sort" => "PENDING_SUM",
        "default" => false
    ),
    array(
        "id" => "LAST_CALCULATE",
        "content" => GetMessage("SAS1_LAST_CALC"),
        "sort" => "LAST_CALCULATE",
        "default" => false
    ),
...
while ($arItems = $dbResultList->NavNext(true, "f_")) {
    ...
    $fieldValue = "[<a href=\"/bitrix/admin/user_edit.php?ID=" . $f_USER_ID . "&lang=" . LANG . "\" target=\"_blank\" title=\"" . GetMessage(
            "SAS1_GOTO_USER"
        ) . "\">" . $f_USER_ID . "</a>] ";
    ...
    $row->AddField(
        "ACT",
        "<a href=\"javascript:void(0)\" onClick=\"SelEl(" . $f_ID . ")\">" . GetMessage(
            "SAS1_SELECT"
        ) . "</a>"
    );
    $arActions = array();
