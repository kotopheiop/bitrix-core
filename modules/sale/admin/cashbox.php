        ...
        <? if (!$publicMode): ?>
            ...
            <div class="adm-cashbox-container adm-plug-block adm-button-container">
                <span class="adm-button adm-button-blue adm-button-main"
                      onclick="BX.Sale.Cashbox.connectToKKM(this);"><?= Loc::getMessage('SALE_CASHBOX_CONNECT_TO_ESHOP') ?></span>
            </div><!--adm-cashbox-container-->
            ...
            <div class="adm-cashbox-container adm-cashbox-container-connect-instruction" id="container-instruction">
                ...
                <div style="margin-bottom: 50px;">
                    <ul class="adm-cashbox-list2 adm-cashbox-inner">
                        <li class="adm-cashbox-list-item cashbox-list-item-1"><?= Loc::getMessage('SALE_CASHBOX_CONNECT_INSTRUCTION_APP_STEP_1') ?>
