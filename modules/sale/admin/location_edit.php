    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="fform">
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="COUNTRY_NAME_<?= $arSysLangs[$i] ?>" value="<? echo $str_COUNTRY_NAME ?>"
                           size="30">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="COUNTRY_SHORT_NAME_<?= $arSysLangs[$i] ?>"
                           value="<? echo $str_COUNTRY_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="REGION_NAME_<?= $arSysLangs[$i] ?>" value="<? echo $str_REGION_NAME ?>"
                           size="30">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="REGION_SHORT_NAME_<?= $arSysLangs[$i] ?>"
                           value="<? echo $str_REGION_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="CITY_NAME_<?= $arSysLangs[$i] ?>" value="<? echo $str_CITY_NAME ?>"
                           size="30">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="CITY_SHORT_NAME_<?= $arSysLangs[$i] ?>"
                           value="<? echo $str_CITY_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
