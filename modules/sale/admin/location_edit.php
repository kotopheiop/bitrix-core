    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="fform">
            ...
            <td>
                ...
                <select name="COUNTRY_ID" OnChange="SetContact()">
                    ...
                    while ($arContList = $db_contList->Fetch()) {
                        ...
                        <option value="<?
                        echo $arContList["ID"] ?>"<?
                        if (IntVal($arContList["ID"]) == IntVal($str_COUNTRY_ID)) echo " selected"; ?>><?
                        echo htmlspecialcharsbx($arContList["NAME_ORIG"]) ?> [<?
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="COUNTRY_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_COUNTRY_NAME ?>" size="30">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="COUNTRY_SHORT_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_COUNTRY_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
            ...
            <td>
                <select name="REGION_ID" id="REGION_ID" OnChange="ResetRegion()">
                    ...
                    while ($arRegionList = $dbRegionList->Fetch()) {
                        ...
                        if (IntVal($arRegionList["ID"]) == IntVal($str_REGION_ID)) echo " selected"; ?>><?
                        echo htmlspecialcharsbx($arRegionList["NAME_ORIG"]) ?> [<?
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="REGION_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_REGION_NAME ?>" size="30">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="REGION_SHORT_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_REGION_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
        ...
        for ($i = 0, $max = count($arSysLangs); $i < $max; $i++):
            ...
            <tr class="adm-detail-required-field">
                ...
                <td>
                    <input type="text" name="CITY_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_CITY_NAME ?>" size="30">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="CITY_SHORT_NAME_<?= $arSysLangs[$i] ?>" value="<?
                    echo $str_CITY_SHORT_NAME ?>" size="30">
                </td>
            </tr>
        <?
        endfor;
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                ...
                <div id="zip_list"><?
                    ...
                    for ($i = 0; $i < $cnt; $i++):
                        ?>
                        <input type="text" name="ZIP[]" value="<?= htmlspecialcharsbx($arZipList[$i]["ZIP"]) ?>"
                               size="10"/><br/>
                    <?
                    endfor;
                    ?>
