            ...
            <div id="ib_external_values_<?= $randTag ?>">
                    ...
                    <? if (is_array($formData['LOCATION'])):?>
                        ...
                        <? foreach ($formData['LOCATION'] as $location):?>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="element[LOCATION][<?= $i ?>][SORT]"
                                           value="<?= intval($location['SORT']) ?>" size="7"/>
                                </td>
                ...
                <div style="width: 100%; text-align: center; margin: 10px 0;">
                    <input class="adm-btn-big bx-ui-dynamiclist-addmore" type="button"
                           value="<?= Loc::getMessage('SALE_LOCATION_E_HEADER_LOC_MORE') ?>"
                           title="<?= Loc::getMessage('SALE_LOCATION_E_HEADER_LOC_MORE') ?>">
                </div>
