...
if (!$bUserCanViewOrder) {
    ...
    echo $APPLICATION->GetCurPage() ?>?" name="order_print">
        <?
        ...
        <tr>
            <td><?
                echo GetMessage("SALE_PR_ORDER_N") ?>:
            </td>
            <td><?
                echo $str_ACCOUNT_NUMBER ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("P_ORDER_DATE") ?>:
            </td>
            <td><?
                echo $str_DATE_INSERT_FORMAT ?></td>
        </tr>
        <tr>
            <td><?
        ...
        <tr>
            <td colspan="2">
                <table border="0" cellspacing="1" cellpadding="3" width="100%" class="internal">
                    <tr class="heading">
                        <td><?
                            echo GetMessage("SALE_PR_INCLUDE") ?></td>
                        <td><?
                            echo GetMessage("SALE_PR_NAME") ?></td>
                        <td><?
                            echo GetMessage("SALE_PR_QUANTITY") ?></td>
                        <td><?
                            echo GetMessage("SALE_PR_PRICE") ?></td>
                        <td><?
                            echo GetMessage("SALE_PR_SUM") ?></td>
                    </tr>
                    <?
                    ...
                    while ($arBasket = $db_basket->GetNext()) {
                        ...
                        <tr>
                            <td valign="top" style="text-align:center;">
                                <input type="checkbox" checked name="BASKET_IDS[]" value="<?
                                echo $arBasket["ID"] ?>">
                            </td>
                            <td valign="top">
                                <?
                            ...
                            <td valign="top" style="text-align:right;">
                                <input type="text" size="3" name="QUANTITY_<?
                                echo $arBasket["ID"] ?>" value="<?
        ...
        <tr>
            <td align="right" valign="top"><?
                echo GetMessage("SALE_PR_SHABLON") ?>:
            </td>
            <td>
                <select size="5" multiple name="REPORT_ID[]">
                    ...
                    foreach ($arReports as $file => $title):?>
                        <option value="<?
                        echo substr($file, 0, strlen($file) - 4); ?>"><?= $title; ?></option>
                    <?endforeach; ?>
                </select>
            </td>
        </tr>
