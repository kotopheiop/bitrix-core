        ...
        if (array_key_exists($EXPORT_FORMAT, $arAvailableExports)) {
            ...
            if ($exportFilePath <> '') {
                ...
                if ($filter_date_update_from <> '') {
                    ...
                    $filter_date_update_from_DAYS_TO_BACK = \Bitrix\Main\Config\Option::get(
                        "sale",
                        "order_list_date",
                        30
                    );
                    $filter_date_update_from = GetTime(
                        time() - 86400 * \Bitrix\Main\Config\Option::get("sale", "order_list_date", 30)
                    );
                ...
                $shownFieldsList = COption::GetOptionString(
                    "sale",
                    "order_list_fields",
