                ...
                <form method="POST" name="task-filter-form" id="task-filter-form" action="<?= POST_FORM_ACTION_URI ?>">
                    ...
                    <table cellspacing="0" class="report-table">
						...
						<span name="report-filter-value-control-LID">
							...
							<select class="report-filter-select sale-report-site-dependent" name="value"
                                    tid="PersonType">
								<option value=""><?= GetMessage('REPORT_IGNORE_FILTER_VALUE') ?></option>
							...
							<select class="report-filter-select" name="value" tid="Section" multiple="multiple"
                                ...
                                <? endforeach; ?>
                                    ...
                                    <style type="text/css">
                                        ...
                                        .report-filter-compare-\\Bitrix\\Main\\User {
                                            display: none;
                                        }

                                        .report-filter-compare-\\Bitrix\\Main\\Group {
                                            display: none;
                                        }

                                        .report-filter-compare-USER\.UserGroup\:USER\.GROUP {
                                            display: none;
                                        }
                                        ...
                                        .report-filter-compare-UserGroup\:USER\.GROUP {
                                            display: none;
                                        }

                                        .report-filter-compare-FUSER\.USER\.UserGroup\:USER\.GROUP {
                                            display: none;
                                        }

                                        .report-filter-value-control-Basket\:PRODUCT\.FUSER\.USER {
                                            display: none;
                                        }
                                    </style>
