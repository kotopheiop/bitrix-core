                ...
                <div class="adm-zreport-list-frame-table">
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="adm-zreport-list-frame-td-small-text">
                                    <?= Loc::getMessage("SALE_ZREPORT_FRAME_RETURN") ?>: <span
                                            id="adm-zreport-cash-return"><?= $blockData['CASH']['FORMATED_RETURN_SUM'] ?></span>
                                </div>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <div class="adm-zreport-list-frame-td-small-text">
                                    <?= Loc::getMessage("SALE_ZREPORT_FRAME_RETURN") ?>: <span
                                            id="adm-zreport-cashless-return"><?= $blockData['CASHLESS']['FORMATED_RETURN_SUM'] ?></span>
                                </div>
