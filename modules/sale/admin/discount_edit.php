...
?>
    <tr id="tr_PRIORITY">
        <td width="40%"><span id="tr_HELP_notice"></span>&nbsp;<? echo $control->GetCustomLabelHTML(); ?>
            <br/><? echo GetMessage('BT_SALE_DISCOUNT_EDIT_FIELDS_PRIORITY_DESCR'); ?></td>
        <td width="60%">
            <input type="text" name="PRIORITY" size="20" maxlength="20"
...
?>
    <tr id="tr_SORT">
        <td width="40%"><span id="tr_HELP_notice2"></span>&nbsp;<? echo $control->GetCustomLabelHTML(); ?>
            <br/><? echo GetMessage('BT_SALE_DISCOUNT_EDIT_FIELDS_SORT_DESCR'); ?></td>
        <td width="60%">
...
if ($discountID > 0 && !$copy) {
    ...
    <td width="60%">
        ...
        <input type="checkbox" value="Y" name="COUPON_ADD"
               id="COUPON_ADD_Y" <? echo($coupons['COUPON_ADD'] == 'Y' ? 'checked' : ''); ?>>
    </td>
    </tr>
    <tr id="tr_COUPON_COUNT" class="adm-detail-required-field"
        style="display: <? echo($coupons['COUPON_ADD'] == 'Y' ? 'table-row' : 'none'); ?>;">
...
<tr id="tr_COUPON_MAX_USE" style="display: <? echo($coupons['COUPON_ADD'] == 'Y' ? 'table-row' : 'none'); ?>;">
    ...
    <td width="60%"><input type="text" name="COUPON[MAX_USE]"
                           value="<? echo($coupons['COUPON_MAX_USE'] > 0 ? $coupons['COUPON_MAX_USE'] : ''); ?>"></td>
    </tr><?
}
