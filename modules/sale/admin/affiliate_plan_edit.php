...
<? if (strlen($errorMessage) > 0)
    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="form1">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <input type="text" name="BASE_RATE" size="10" maxlength="10"
                ...
                <table cellpadding="3" cellspacing="1" border="0" width="100%" class="internal" id="SECTIONS_TABLE">
                    <tr class="heading">
                        ...
                        if ($simpleForm != "Y") {
                            ?>
                            <td><?
                            echo GetMessage("SAPE1_MODULE") ?></td><?
                        }
                        ?>
        ...
        <tr>
            <td colspan="2"><input type="button" value="<? echo GetMessage("SAPE1_ADD1") ?>"
                                   OnClick="AffAddSectionRow(-1);"></td>
        </tr>
