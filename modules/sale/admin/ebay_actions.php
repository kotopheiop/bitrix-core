...
if (isset($_REQUEST["action"])) {
    switch ($_REQUEST["action"]) {
        case "SHOW_TOKEN_SFTP":
            ...
            ?>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_SFTP_TOKEN") ?>:</td>
                <td><textarea id="SALE_EBAY_SETTINGS_SFTP_TOKEN" value="" readonly rows="10" cols="100"></textarea></td>
            </tr>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_SFTP_TOKEN_EXP") ?>:</td>
                <td><input type="text" id="SALE_EBAY_SETTINGS_SFTP_TOKEN_EXP" value="" readonly></td>
            </tr>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_SFTP_USER_NAME") ?>:</td>
                <td><input type="text" id="SALE_EBAY_SETTINGS_SFTP_USER_NAME" value="" readonly></td>
            </tr>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_SFTP_ACCOUNT_STATE") ?>:</td>
                <td><input type="text" id="SALE_EBAY_SETTINGS_SFTP_ACCOUNT_STATE" value="" readonly></td>
            </tr>
            <?
            $tabControl->EndTab();
            $tabControl->Buttons();
        ...
        case "SHOW_TOKEN":
            ...
            ?>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_TOKEN") ?>:</td>
                <td><textarea id="SALE_EBAY_SETTINGS_API_TOKEN" value="" readonly rows="10" cols="100"></textarea></td>
            </tr>
            <tr>
                <td><?= Loc::getMessage("SALE_EBAY_YOUR_TOKEN_EXP") ?>:</td>
                <td><input type="text" id="SALE_EBAY_SETTINGS_API_TOKEN_EXP" value="" readonly></td>
            </tr>
            <?
            $tabControl->EndTab();
            $tabControl->Buttons();
