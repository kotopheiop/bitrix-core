        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="filter_price_delivery_from"
                       value="<?= ($filter_price_delivery_from != 0) ? htmlspecialcharsbx($filter_price_delivery_from) : ''; ?>"
                       size="3">

                <? echo GetMessage("PRICE_DELIVERY_TO"); ?>
                <input type="text" name="filter_price_delivery_to"
                       value="<?= ($filter_price_delivery_to != 0) ? htmlspecialcharsbx($filter_price_delivery_to) : ''; ?>"
                       size="3">
            </td>
        </tr>
        <tr>
            ...
            <td valign="top">
                <select name="filter_status[]" multiple size="3">
                    ...
                    foreach ($statusesList as $statusCode) {
                        ...
                        [<?= htmlspecialcharsbx($statusCode) ?>] <?= htmlspecialcharsEx($statusName) ?></option><?
                    }
                    ?>
                </select>
            </td>
