...
namespace Bitrix\Sale\Company\AdminPage\CompanyRules {
    ...
    $header = array(
        ...
        array(
            'id' => 'SORT',
            'content' => Loc::getMessage('SALE_COMPANY_RULE_COL_SORT'),
            "sort" => "",
            'default' => true
        ),
        array(
            'id' => 'CLASS_NAME',
            'content' => Loc::getMessage('SALE_COMPANY_RULE_COL_CLASS_NAME'),
            "sort" => "",
            'default' => true
        ),
        array(
            'id' => 'PARAMS',
            'content' => Loc::getMessage('SALE_COMPANY_RULE_COL_PARAMS'),
            "sort" => "",
            'default' => true
        ),
    );
        ...
        if ($saleModulePermissions >= "W") {
            ...
            $arActions[] = array(
                ...
                "ACTION" => "javascript:if(confirm('" . Loc::getMessage(
                        "SALE_COMPANY_RULES_DEL_MESSAGE"
                    ) . "')) BX.Sale.Company.deleteRule(" . $record["ID"] . "," . $id . ");"
            );
