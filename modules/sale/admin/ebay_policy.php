...
?>
    <form method="post" action="<?= $APPLICATION->GetCurPage() ?>?lang=<?= LANGUAGE_ID ?>"
        ...
        <tr>
            <td width="40%"><span
                        class="adm-required-field"><?= Loc::getMessage("SALE_EBAY_TAB_POLICY_RETURN") ?>:</span></td>
            <td width="60%">
                <? $hiddenPolicyFields = ""; ?>
        ...
        <tr>
            <td width="40%"><span
                        class="adm-required-field"><?= Loc::getMessage("SALE_EBAY_TAB_POLICY_SHIPPING") ?>:</span></td>
            <td width="60%">
                <? $hiddenPolicyFields = ""; ?>
        ...
        <tr>
            <td width="40%"><span
                        class="adm-required-field"><?= Loc::getMessage("SALE_EBAY_TAB_POLICY_PAYMENT") ?>:</span></td>
            <td width="60%">
                <? $hiddenPolicyFields = ""; ?>
