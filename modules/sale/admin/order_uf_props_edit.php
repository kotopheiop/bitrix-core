...
CAdminMessage::ShowMessage($strError); ?>
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="form1">
        ...
        <tr>
            ...
            <td width="60%">
                [<? echo $arPersonType["ID"] ?>] <? echo htmlspecialcharsEx($arPersonType["NAME"]) ?>
                (<? echo htmlspecialcharsEx($arPersonType["LID"]) ?>)
            </td>
        </tr>
            ...
            <td width="60%">
                <select name="PROPS_GROUP_ID">
                    ...
                    while ($l->ExtractFields("l_")):
                        ...
                        <option value="<?
                        echo $l_ID ?>"<?
                        if (IntVal($str_PROPS_GROUP_ID) == IntVal($l_ID)) echo " selected" ?>>[<?
                        echo $l_ID ?>] <?
                        echo $l_NAME ?></option><?
                    endwhile;
                    ?>
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                <input type="checkbox" name="IS_LOCATION"
                       value="Y" <? if ($str_IS_LOCATION == "Y") echo "checked" ?>><br>
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                <input type="checkbox" name="IS_LOCATION4TAX"
                       value="Y" <? if ($str_IS_LOCATION4TAX == "Y") echo "checked" ?>><br>
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                <input type="checkbox" name="IS_PROFILE_NAME"
                       value="Y" <? if ($str_IS_PROFILE_NAME == "Y") echo "checked" ?>><br>
        ...
        <tr>
            ...
            <td width="60%" valign="top">
                <input type="checkbox" name="IS_FILTERED"
                       value="Y" <? if ($str_IS_FILTERED == "Y") echo "checked" ?>><br>
                        ...
                        while ($db_propsVars->ExtractFields("f_")) {
                            ...
                            <tr>
                                <td>
                                    ...
                                    echo $ind; ?>" value="<?
                                    echo $f_ID; ?>">
                                    <input type="text" name="VALUE_<?
                                    echo $ind; ?>" value="<?
                                    echo htmlspecialcharsbx($f_VALUE); ?>" size="5">
                                </td>
                                <td>
                                    <input type="text" name="NAME_<?
                                    echo $ind; ?>" value="<?
                                    echo htmlspecialcharsbx($f_NAME); ?>" size="30">
                                </td>
                                <td>
                                    <input type="text" name="SORT_<?
                                    echo $ind; ?>" value="<?
                                    echo IntVal($f_SORT); ?>" size="3">
                                </td>
                                <td>
                                    <input type="text" name="DESCRIPTION_<?
                                    echo $ind; ?>" value="<?
                                    echo htmlspecialcharsbx($f_DESCRIPTION); ?>" size="30">
                                </td>
                                <td>
                                    <input type="checkbox" name="DELETE_<?
                                    echo $ind; ?>" value="Y"<?
                                    if (${"DELETE_" . $ind} == "Y") echo " checked" ?>>
                                </td>
                            </tr>
                            <?
                        }
                        ...
                        for ($i = 0; $i < 5; $i++) {
                            ...
                            <tr>
                                <td>
                                    ...
                                    echo $ind; ?>" value="new">
                                    <input type="text" name="VALUE_<?
                                    echo $ind; ?>" value="" size="5">
                                </td>
                                <td>
                                    <input type="text" name="NAME_<?
                                    echo $ind; ?>" value="" size="30">
                                </td>
                                <td>
                                    <input type="text" name="SORT_<?
                                    echo $ind; ?>" value="" size="3">
                                </td>
                                <td>
                                    <input type="text" name="DESCRIPTION_<?
                                    echo $ind; ?>" value="" size="30">
                        ...
                        <tr>
                            <td colspan="4" align="right">
                                ...
                                <input type="submit" name="propeditmore"
                                       value="<? echo GetMessage("SALE_VARIANTS_MORE") ?>">
                            </td>
                            <td align="right">
                                &nbsp;
                            </td>
