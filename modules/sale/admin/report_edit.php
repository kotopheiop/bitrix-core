                    ...
                    foreach ($arFieldsShop as $key => $val) {
                        ...
                        <tr>
                            ...
                            <td><select name="TYPE_<?= $key ?>" id="TYPE_<?= $key ?>"
                                    ...
                                    <option value="USER"<?
                                    if ($val["TYPE"] == "USER") echo " selected"; ?>><?= GetMessage("SRE_PARAM_PROP_TYPE_2") ?></option>
                                    <option value="ORDER"<?
                                    if ($val["TYPE"] == "ORDER") echo " selected"; ?>><?= GetMessage("SRE_PARAM_PROP_TYPE_3") ?></option>
                                    <option value="PROPERTY"<?
                                    if ($val["TYPE"] == "PROPERTY") echo " selected"; ?>><?= GetMessage("SRE_PARAM_PROP_TYPE_4") ?></option>
                                </select>
                            </td>
                            <td>
                                ...
                                <input type="text" name="VALUE2_<?= $key ?>" id="VALUE2_<?= $key ?>" value="<?
                                if (strlen($val["TYPE"]) <= 0) echo htmlspecialcharsbx($val["VALUE"]) ?>" size="40">
                                <?
