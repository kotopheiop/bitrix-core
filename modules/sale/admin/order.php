...
if (!$publicMode && \Bitrix\Sale\Update\CrmEntityCreatorStepper::isNeedStub()) {
    ...
    <form name="find_form" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="filter_universal" value="<? echo htmlspecialcharsbx($filter_universal) ?>"
                       size="40">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="filter_tracking_number"
                       value="<? echo htmlspecialcharsbx($filter_tracking_number) ?>" size="40">
            </td>
        </tr>
        <tr>
