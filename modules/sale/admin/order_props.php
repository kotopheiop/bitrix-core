            ...
            <td>
                <select name="filter_person_type_id">
                    ...
                    foreach ($arPersonTypeList as $val) {
                        ...
                        <option value="<?
                        echo $val["ID"] ?>"<?
                        if (IntVal($filter_person_type_id) == IntVal($val["ID"])) echo " selected" ?>>[<?
                        echo $val["ID"] ?>] <?
                        echo $val["NAME"] ?> (<?
            ...
            <td>
                <select name="filter_type">
                    ...
                    foreach ($inputTypes as $name => $type):
                        ?>
                        <option value="<?= $name ?>"<?= $filter_type == $name ? ' selected' : '' ?>>[<?= $name ?>
                        ] <?= $type['NAME'] ?></option><?
                    endforeach;
                    ?>
                </select>
            ...
            <td>
                <select name="filter_group">
                    ...
                    while ($arL = $l->Fetch()):
                        ...
                        <option value="<?
                        echo $arL["ID"] ?>"<?
                        if (IntVal($filter_group) == IntVal($arL["ID"])) echo " selected" ?>>[<?
                        echo $arL["ID"] ?>] <?
                        echo htmlspecialcharsbx($arL["NAME"]) ?><?
                        if (!empty($arPersonTypeList[$arL["PERSON_TYPE_ID"]])) echo "(" . $arPersonTypeList[$arL["PERSON_TYPE_ID"]]["NAME"] . " (" . htmlspecialcharsEx($arPersonTypeList[$arL["PERSON_TYPE_ID"]]["LID"]) . ")" . ")"; ?></option><?
                    endwhile;
                    ?>
                </select>
            </td>
