...
if ($CAT_RIGHT >= "R") :
    ...
    $arAllOptions = array(
        ...
        array(
            ...
            GetMessage("SALE_1C_SALE_ACCOUNT_NUMBER_SHOP_PREFIX"),
            "",
            Array("text"),
            array("note" => GetMessage("SALE_1C_SALE_ACCOUNT_NUMBER_SHOP_PREFIX_NOTE")),
            ""
        ),
        ...
        array(
            ...
            GetMessage("SALE_1C_CHANGE_STATUS_FROM_1C"),
            "",
            Array("checkbox"),
            array(),
            ""
        ...
        array(
            ...
            GetMessage("SALE_1C_EXPORT_FINAL_ORDERS"),
            "",
        ...
        array(
            "1C_REPLACE_CURRENCY",
            GetMessage("SALE_1C_REPLACE_CURRENCY"),
            GetMessage("SALE_1C_RUB"),
            Array("text"),
            array(),
            ""
        ),
        array(
            ...
            GetMessage("SALE_1C_IMPORT_DEFAULT_PS_C"),
            "",
            Array("list", $arPaySystems),
            array(),
            ""
        ),
        array(
            "1C_IMPORT_DEFAULT_PS_B",
            GetMessage("SALE_1C_IMPORT_DEFAULT_PS_B"),
            "",
            Array("list", $arPaySystems),
            array(),
            ""
        ...
        array(
            ...
            GetMessage("SALE_1C_IMPORT_DEFAULT_PS_A"),
            "",
            Array("list", $arPaySystems),
            array(),
            ""
        ...
        array(
            "1C_IMPORT_DEFAULT_PS_ORDER_PAID",
            GetMessage("SALE_1C_IMPORT_DEFAULT_PS_ORDER_PAID"),
            "",
            Array("list", $arPaySystemsWithoutInner),
            array(),
            ""
        ),
        array(
            "1C_IMPORT_DEFAULT_SHIPMENT_SERVICE",
            GetMessage("SALE_1C_IMPORT_DEFAULT_SHIPMENT_SERVICE"),
            "",
            Array("list", $shipmentServices),
            array(),
            ""
        ),
        array(
            "1C_IMPORT_UPDATE_BASKET_QUANTITY",
            GetMessage("SALE_1C_IMPORT_UPDATE_BASKET_QUANTITY"),
            "",
            Array("checkbox"),
            array(),
            ""
        ...
        array(
            ...
            GetMessage("SALE_1C_IMPORT_NEW_ORDER_NEW_SHIPMENT"),
            "",
            Array("checkbox"),
            array(),
            ""
        ...
        array(
            "SALE_EXCHANGE_DEBUG_INTERVAL_DAY",
            GetMessage("SALE_EXCHANGE_DEBUG_INTERVAL_DAY"),
            1,
            Array("text", 20),
            array(),
            function () use (&$val) {
        ...
        array(
            "EXCHANGE_DEBUG_DURATION",
            GetMessage("SALE_EXCHANGE_DEBUG_END_TIME"),
            0,
            Array("text", 20),
            array(),
            function ($val) {
                    ...
                    <select name="<? echo htmlspecialcharsbx($Option[0]) ?>">
                        <? foreach ($type[1] as $key => $value):?>
                            <option value="<? echo htmlspecialcharsbx(
                                $key
                            ) ?>" <? if ($val == $key) echo "selected" ?>><? echo htmlspecialcharsbx($value) ?></option>
                        <?endforeach ?>
                    </select>
                <?
                elseif ($type[0] == "mlist"):
