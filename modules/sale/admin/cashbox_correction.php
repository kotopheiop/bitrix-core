...
$jsData = [
    'ADD_CHECK_CORRECTION_URL' => getLocalPath(
        'components' . \CComponentEngine::makeComponentPath('bitrix:crm.check.correction.details') . '/slider.php'
    )
];
...
?>
    <script type="text/javascript">
        ...
        function getSelectedIds() {
            return BX.Main.gridManager.getInstanceById(<?= CUtil::PhpToJSObject(
                $tableId
            ) ?>).getRows().getSelectedIds();
        }
        ...
        function addCorrectionCheck() {
            var url = '<?= getLocalPath(
                'components' . \CComponentEngine::makeComponentPath(
