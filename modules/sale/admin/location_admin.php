...
?>
    ...
    <form name="find_form" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>?">
            ...
            <td>
                <select name="filter_country">
                    ...
                    while ($arContList = $db_contList->Fetch()) {
                        ...
                        <option value="<?
                        echo $arContList["ID"] ?>"<?
                        if (IntVal($arContList["ID"]) == IntVal($filter_country)) echo " selected"; ?>><?
                        echo htmlspecialcharsbx($arContList["NAME"]) ?> [<?
        ...
        <tr>
            ...
            <td>
                <input type="text" name="filter_region_name" value="<? echo htmlspecialcharsbx($filter_region_name) ?>"
                       size="30"><?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="filter_city_name" value="<? echo htmlspecialcharsbx($filter_city_name) ?>"
                       size="30"><?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <?
