...
if (isConnected() === false) {
    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="sale_synchronizer_settings">
        ...
        <tr>
            ...
            <td align="left"><select name="DEFAULT_SITE_ID"><? foreach ($arSites

                    as $id => $name): ?>
                    <option <?= $instance->getDefaultSiteId() == $id ? 'selected' : '' ?>
                            value="<?= htmlspecialcharsbx($id) ?>"><?= htmlspecialcharsbx($name) ?></option><?endforeach;
                ?></td>
        </tr>
        <tr>
            <td align="right" width="40%"><label for="use-"><span
            ...
            <td align="left"><select name="DEFAULT_PAY_SYSTEM_ID"><? foreach ($arPaySystemsWithoutInner
        ...
        <tr>
            ...
            <td align="left"><select name="DEFAULT_DELIVERY_SYSTEM_ID"><? foreach ($shipmentServices
        ...
        <tr>
            ...
            <td align="left"><select name="DEFAULT_PERSON_TYPE">
                    <option></option><? foreach ($internal['PERSON_TYPE'] as $row): ?>
                    <option <?= $instance->getDefaultPersonTypeId() == $row['ID'] ? 'selected' : '' ?>
                            value="<?= $row['ID'] ?>"><?= '[' . $row['ID'] . '] ' . htmlspecialcharsbx($row['NAME']) ?></option><?endforeach;
                ?></td>
        </tr>
        <tr>
            <td align="right" width="40%"><label for="use-"><span
            ...
            <td align="left"><select name="DEFAULT_ORDER_STATUS">
                    <option></option><? foreach ($internal['ORDER_STATUSES'] as $row): ?>
        ...
        <tr>
            ...
            <td align="left"><select name="DEFAULT_DELIVERY_STATUS">
                    <option></option><? foreach ($internal['DELIVERY_STATUSES'] as $row): ?>
        ...
        <tr>
            ...
            <td align="left"><select name="" multiple size="5" disabled><? foreach ($catalogList as $catalog) {
                        ?>
        ...
        <? if (empty($errorOAuth) && empty($errorConnection)):?>
            ...
            <tr>
                ...
                <td align="left"><select name="" multiple size="5"
                                         disabled><? foreach ($external['SYNCHRONIZER']['CATALOGS'] as $tradeCatalog):?>
            ...
            <tr>
                <td colspan="2"
                    align="center"><? echo BeginNote('align="center"'); ?><?= \Bitrix\Main\Localization\Loc::getMessage('SALE_SYNCHRONIZER_NOTE') ?><? echo EndNote(); ?></td>
            </tr>
            ...
            <tr>
                <td colspan="2"
                    align="center"><? echo BeginNote('align="center"'); ?><?= \Bitrix\Main\Localization\Loc::getMessage('SALE_SYNCHRONIZER_NOTE1') ?><? echo EndNote(); ?></td>
            </tr>
