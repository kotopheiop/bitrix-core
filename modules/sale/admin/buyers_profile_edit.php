            ...
            <tr<? ($shure) ? " class=\"adm-detail-required-field\"" : "" ?>>
                ...
                <td width="60%">
                    ...
                    while ($arVariants = $dbVariants->Fetch()) {
                        ...
                        ?>
                        <input <?
                        echo $selected ?> id="radio_<?
                        echo $arVariants["ID"]; ?>" type="radio" name="CODE_<?
                        echo $arProperties["ID"]; ?>" value="<?
                        echo htmlspecialcharsbx($arVariants["VALUE"]); ?>"/>
                        <label for="radio_<?
                        echo $arVariants["ID"]; ?>"><?
                            echo htmlspecialcharsEx($arVariants["NAME"]) ?></label><br/>
                        <?
                    }
                    ?>
                </td>
