...
if ($multiCoupons) {
    ...
    if ($couponID > 0) {
        ...
        if (!empty($discountList)) {
            ...
            <td width="40%"><? echo $control->GetCustomLabelHTML(); ?></td>
            <td width="60%">
                <? echo Loc::getMessage('BX_SALE_DISCOUNT_COUPON_MESS_DISCOUNT_ABSENT'); ?> <a
                        href="<? echo $discountEditPath ?>"><?
    ...
    <tr id="tr_COUPON" class="adm-detail-required-field">
        ...
        <td width="60%" id="td_COUPON_VALUE">
            ...
            <input type="button" value="<? echo Loc::getMessage('BX_SALE_DISCOUNT_COUPON_FIELD_COUPON_GENERATE'); ?>"
                   id="COUPON_GENERATE">
        </td>
    </tr><?
