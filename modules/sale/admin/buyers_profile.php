...
//	}
    ...
    <tr>
        <td colspan="2">
            <form name="find_form3" method="GET" action="<?
    ...
    <tr>
        <td><?
            echo GetMessage("BUYER_F_DATE_INSERT"); ?>:
        </td>
        <td>
            <?
    ...
    <tr>
        <td><?
            echo GetMessage("BUYER_F_DATE_UPDATE"); ?>:
        </td>
        <td>
            <?
    ...
    <tr>
        <td><?
            echo GetMessage("BUYER_F_PAYED") ?>:
        </td>
        <td>
            <select name="filter_order_payed">
                <option value="">(<?
                    echo GetMessage("BUYERS_PAY_ALL") ?>)
                </option>
                <option value="Y"<?
                if ($filter_order_payed == "Y") echo " selected" ?>><?
                    echo GetMessage("BUYERS_PAY_YES") ?></option>
                <option value="N"<?
                if ($filter_order_payed == "N") echo " selected" ?>><?
                    echo GetMessage("BUYERS_PAY_NO") ?></option>
            </select>
        </td>
    </tr>
    <tr>
        <td><?
            echo GetMessage("BUYER_F_DELIVERY") ?>:
        </td>
        <td>
            <select name="filter_order_delivery">
                ...
                <option value="Y"<?
                if ($filter_order_delivery == "Y") echo " selected" ?>><?
                    echo GetMessage("BUYERS_PAY_YES") ?></option>
                <option value="N"<?
                if ($filter_order_delivery == "N") echo " selected" ?>><?
                    echo GetMessage("BUYERS_PAY_NO") ?></option>
            </select>
        </td>
    </tr>
    ...
    <tr>
        <td><?
            echo GetMessage("BUYER_F_NAME_PRODUCT") ?>:
        </td>
        <td>
    ...
    if (!$adminSidePanelHelper->isPublicSidePanel()) {
        ...
        <tr>
            <td colspan="2">
                <form name="find_form7" method="GET" action="<?
                echo $APPLICATION->GetCurPage() ?>?">
                    <input type="hidden" name="USER_ID" value="<?= $ID ?>">
                    <?
                    $arFilterFieldsTmp = array(
        ...
        <tr>
            <td><?
                echo GetMessage("BUYER_F_DATE_ARCHIVED"); ?>:
            </td>
            <td>
                <?
    ...
    <tr>
        <td colspan="2">
            <form name="find_form4" method="GET" action="<?
            echo $APPLICATION->GetCurPage() ?>?">
                <input type="hidden" name="USER_ID" value="<?= $ID ?>">
                <?
                $arFilterFieldsTmp = array();
    ...
    <tr>
        <td colspan="2">
            <form name="find_form5" method="GET" action="<?
            echo $APPLICATION->GetCurPage() ?>?">
                <input type="hidden" name="USER_ID" value="<?= $ID ?>">
        ...
        <tr>
            ...
            <td>
                <select name="find_active">
                    <option value=""><?= Loc::getMessage('CS_FILTER_ANY') ?></option>
                    <option value="Y"<?
                    if ($find_active == "Y") echo " selected" ?>>
                        <?= Loc::getMessage('CS_FILTER_YES') ?>
                    </option>
                    <option value="N"<?
                    if ($find_active == "N") echo " selected" ?>>
