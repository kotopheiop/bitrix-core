            ...
            ?>
                ...
                <form onsubmit="return checkFields(this)" method="post" action="">
                    ...
                    <table>
                        ...
                        <tr>
                            <th>Cardholder</th>
                            <td><input type="text" maxlength="250" class="inputtext" name="noc"
                                       value="<? echo (strlen($noc) > 0) ? $noc : $noc_def ?>"></td>
                        </tr>
                        <tr>
                            <th>Address</th>
                            <td><input type="text" size="30" maxlength="250" class="inputtext" name="address1"
                                       value="<? echo (strlen($address1) > 0) ? $address1 : $address1_def ?>"></td>
                        </tr>
                        <tr>
                            <th>Zip</th>
                            <td><input type="text" maxlength="10" class="inputtext" name="zipcode"
                                       value="<? echo (strlen($zipcode) > 0) ? $zipcode : $zipcode_def ?>"></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
