        ...
        <td class="but2" align="center">
            ...
            if (!$bNonePay) {
                ...
                <font class="text" color="#009900"><b>
                        ...
                        echo SaleFormatCurrency($AMT, "USD") ?></b>
                </font>
            <?
            }
            else
                ...
                <form onsubmit="return checkFields(this)" method="post" action="">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input class="inputtext" maxlength="16" type="text" name="cardnum"
                                       value="<?= htmlspecialcharsbx($cardnum) ?>" size="35"></td>
                        </tr>
                        <tr>
                            <th><font class="text">CVV2</font></th>
                            <td><input type="text" class="inputtext" maxlength="4" name="cvv2"
                                       value="<?= htmlspecialcharsbx($cvv2) ?>" size="5"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="cardexp1" class="inputselect">
                                    ...
                                    for ($i = 1; $i <= 12; $i++) {
                                        ...
                                        ?>
                                        <option value="<?= $val ?>" <?
                                        if ($cardexp1 == $val) echo "selected=\"selected\""; ?>><?= $val ?></option>
                                        <?
                                    }
                                    ?>
                                </select>
                                <select name="cardexp2" class="inputselect">
                                    ...
                                    for ($i = $curYear; $i <= $curYear + 10; $i++) {
                                        ...
                                        ?>
                                        <option value="<?= $val ?>" <?
                                        if ($cardexp2 == $val) echo "selected"; ?>><?= $fullYear ?></option>
                                        <?
                                    }
                                    ?>
                                </SELECT>
                        ...
                        <tr>
                            <th>Cardholder</th>
                            <td><input type="text" maxlength="250" class="inputtext" name="noc" value="<?
                                echo (strlen($noc) > 0) ? $noc : $noc_def ?>"></td>
                        </tr>
                        <tr>
                            <th>Address</th>
                            <td><input type="text" size="30" maxlength="250" class="inputtext" name="address1" value="<?
                                echo (strlen($address1) > 0) ? $address1 : $address1_def ?>"></td>
                        </tr>
                        <tr>
                            <th>Zip</th>
                            <td><input type="text" maxlength="10" class="inputtext" name="zipcode" value="<?
