    ...
    <table border="0" width="100%" cellpadding="2" cellspacing="2">
        <tr>
            ...
            <td class="tablebody" width="60%">
                <input class="inputtext" type="text" name="cardnum"
                       value="<?= htmlspecialcharsbx($_REQUEST["cardnum"]) ?>" size="35">
            </td>
        </tr>
        <tr>
            <td align="right" class="tablebody" width="40%">
            ...
            <td class="tablebody" width="60%">
                <input type="text" class="inputtext" name="cvv2" value="<?= htmlspecialcharsbx($_REQUEST["cvv2"]) ?>"
                       size="5">
            </td>
        </tr>
        <tr>
            ...
            <td class="tablebody" width="60%">
                <select name="cardexp1" class="inputselect">
                    ...
                    for ($i = 1; $i <= 12; $i++) {
                        ...
                        ?>
                        <option value="<?= $val ?>" <?
                        if ($_REQUEST["cardexp1"] == $val) echo "selected"; ?>><?= $val ?></option>
                        <?
                    }
                    ?>
                </select>
                <select name="cardexp2" class="inputselect">
                    ...
                    for ($i = 4; $i <= 11; $i++) {
                        ...
                        ?>
                        <option value="<?= $val ?>" <?
                        if ($_REQUEST["cardexp2"] == $val) echo "selected"; ?>><?= $val ?></option>
                        <?
                    }
                    ?>
                </SELECT>
        ...
        <tr>
            ...
            <td class="tablebody" width="60%">
                <input type="text" class="inputtext" size="40" name="noc"
                       value="<?= (strlen($_REQUEST["noc"]) > 0) ? htmlspecialcharsbx($_REQUEST["noc"]) : $noc_def ?>">
            </td>
        </tr>
        <tr>
            <td align="right" class="tablebody" width="40%">
