...
if ($bSuccessProcess) {
    ...
    <form action="" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" id="ccardNumber" name="ccard_num" size="30"
                       value="<?= htmlspecialcharsbx($_REQUEST["ccard_num"]) ?>" class="form-control inputtext">
            </div>
        </div>

        <div class="form-group row">
            <label for="ccardDate1" class="col-sm-6 col-form-label text-sm-right"><?= GetMessage(
                    "AN_CC_DATE"
                ) ?></label>
            <div class="col-auto">
        ...
        <div class="form-group row">
            ...
            <div class="col-auto">
                <input type="text" id="ccardCode" name="ccard_code" size="5"
                       value="<?= htmlspecialcharsbx($_REQUEST["ccard_code"]) ?>" class="inputtext form-control">
            </div>
        </div>
