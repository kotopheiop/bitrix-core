    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="tablebody" width="60%">
                <input type="text" class="inputtext" name="ccard_num" size="30"
                       value="<?= htmlspecialcharsbx($_REQUEST["ccard_num"]) ?>">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tablebody" width="60%">
                <input type="text" class="inputtext" name="ccard_code" size="5"
                       value="<?= htmlspecialcharsbx($_REQUEST["ccard_code"]) ?>">
            </td>
        </tr>
    </table>
    <?
