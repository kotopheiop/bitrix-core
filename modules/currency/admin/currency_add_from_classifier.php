...
?>
    ...
    <form method="post" action="<? $APPLICATION->GetCurPage() ?>" name="admin_currency_classifier">
        ...
        <tr>
            ...
            <td width="60%">
                <input id="admin_classifier_currency_needle" name="admin_classifier_currency_needle" type="text"
                       style="width: 300px"
            ...
            <td width="60%" style="padding-left: 1px">
                <table>
                    <tr>
                        <td>
						<span>
							<input id="nominal" name="nominal" type="text" style="width: 100px;"
                                   value="<?= HtmlFilter::encode($lastValues['NOMINAL']); ?>"/>
							<label id="nominal_sym_code" name="nominal_sym_code"
                                   style="width: 30px; display: inline-block"></label>
        ...
        <tr>
            ...
            <td width="60%">
                <input id="sort_index" name="sort_index" type="text" style="width: 300px"
                       value="<?= HtmlFilter::encode($lastValues['SORT_INDEX']); ?>">
            </td>
        </tr>
        <? $tabControl->BeginNextTab();
        foreach ($languages as $key => $value) {
            ...
            <tr>
                ...
                <td width="60%" style="height: 25px">
                    <label id="full_name_<?= HtmlFilter::encode($key); ?>"
                           name="full_name_<?= HtmlFilter::encode($key); ?>"></label>
                </td>
            </tr>
            <tr>
                <td width="40%">
                ...
                <td width="60%" style="height: 25px">
                    <label id="format_string_<?= HtmlFilter::encode($key); ?>"
                           name="format_string_<?= HtmlFilter::encode($key); ?>"></label>
                </td>
            </tr>
            <tr>
                <td width="40%">
                ...
                <td width="60%" style="height: 25px">
                    <label id="dec_point_<?= HtmlFilter::encode($key); ?>"
                           name="dec_point_<?= HtmlFilter::encode($key); ?>"></label>
                </td>
            </tr>
            <tr>
                <td width="40%">
                ...
                <td width="60%" style="height: 25px">
                    <label id="thousands_sep_<?= HtmlFilter::encode($key); ?>"
                           name="thousands_sep_<?= HtmlFilter::encode($key); ?>"></label>
                </td>
            </tr>
            <tr>
                <td width="40%">
                ...
                <td width="60%" style="height: 25px">
                    <label id="decimals_<?= HtmlFilter::encode($key); ?>"
                           name="decimals_<?= HtmlFilter::encode($key); ?>"></label>
                </td>
            </tr>
            <tr>
                <td width="40%">
                ...
                <td width="60%" style="height: 25px">
                    <input id="hide_zero_<?= HtmlFilter::encode($key); ?>"
                           name="hide_zero_<?= HtmlFilter::encode($key); ?>" type="checkbox" checked
