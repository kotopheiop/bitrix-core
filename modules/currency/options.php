...
if ($moduleAccessLevel >= 'R') {
    ...
    <input type="submit" <? if ($moduleAccessLevel < "W" || $baseCurrency === '') echo "disabled" ?> name="recalc"
           value="<? echo Loc::getMessage('CUR_PROCEDURES_BTN_RECALC'); ?>">
    ...
    if (!empty($currencyAgent)) {
        ...
        if ($currencyAgent['LAST_EXEC']) {
            ...
            :</b>&nbsp;<? echo $currencyAgent['LAST_EXEC']; ?><br>
            <? if ($currencyAgent['ACTIVE'] == 'Y') {
                ?><b><? echo Loc::getMessage('CURRENCY_AGENTS_NEXT_EXEC'); ?>
                :</b>&nbsp;<? echo $currencyAgent['NEXT_EXEC']; ?><br>
                <?
            }
        } elseif ($currencyAgent['ACTIVE'] == 'Y') {
            ?><b><? echo Loc::getMessage('CURRENCY_AGENTS_PLANNED_NEXT_EXEC') ?>
            :</b>&nbsp;<? echo $currencyAgent['NEXT_EXEC']; ?><br>
            <?
        }
        if ($currencyAgent['ACTIVE'] != 'Y') {
