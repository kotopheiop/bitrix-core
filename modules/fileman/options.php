                        ...
                        <table cellPadding="2" cellSpacing="2" border="0" width="100%">
                            ...
                            foreach ($armt as $key => $title):
                                if ($USER->CanDoOperation('fileman_edit_menu_types')):
                                    ?>
                                    <tr>
                                        <td style="padding: 2px;"><input type="text" name="menutypes_<?
                                            echo $i ?>_type" value="<?= htmlspecialcharsbx($key) ?>"
                                                                         style="width:100%; -moz-box-sizing: border-box; box-sizing: border-box;">
                                        </td>
                                        <td style="padding: 2px;"><input type="text" name="menutypes_<?
                                            echo $i ?>_name" value="<?= htmlspecialcharsbx($title) ?>"
                                                                         style="width:100%; -moz-box-sizing: border-box; box-sizing: border-box;">
                                        </td>
                                    </tr>
                                <? else:?>
                                    <tr>
                                        <td style="padding-left: 5px">
                                            ...
                                            <input type="hidden" name="menutypes_<?
                                            echo $i ?>_type" value="<?
                        ...
                        <td class="adm-detail-content-cell-r">
                            <table cellPadding="2" cellSpacing="2" border="0" width="100%">
                                ...
                                foreach (CFileMan::GetPropstypes($siteList[$j]["ID"]) as $key => $val) {
                                    ...
                                    <tr>
                                        <td><input type="text"
                                                   name="propstypes_<?= htmlspecialcharsbx($siteList[$j]["ID"]) ?>_<?
                                                   echo $i ?>_type" value="<?= htmlspecialcharsbx($key) ?>"
                                                   style="width:100%; -moz-box-sizing: border-box; box-sizing: border-box;">
                                        </td>
                                        <td><input type="text"
                                                   name="propstypes_<?= htmlspecialcharsbx($siteList[$j]["ID"]) ?>_<?
                                                   echo $i ?>_name" value="<?= htmlspecialcharsbx($val) ?>"
                                                   style="width:100%; -moz-box-sizing: border-box; box-sizing: border-box;">
                                        </td>
                                    </tr>
                                    <?
        ...
        <div class="bx-ml-type" id="type_cont_<?= $type["id"] ?>">
            ...
            <div class="bx-ml-type-params">
                <table border="0" width="100%">
                    <tr<?
                    if (!$type["system"]):?> class="adm-detail-required-field"<?endif; ?>>
                    ...
                    <tr<?
                    if (!$type["system"]):?> class="adm-detail-content-cell-l adm-detail-required-field"<?endif; ?>>
