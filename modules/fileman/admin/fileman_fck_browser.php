...
if ($bUploaded):
    ...
    <img id=hiddenimg style="visibility:hidden; position: absolute; left:-1000; top: -1000px;" onerror="badimg = true;"
         onload="ShowSize(this)">
    <form target="_self" action="fileman_fck_browser.php" method="post" enctype="multipart/form-data"
          name="imageupload">
            ...
            <tr>
                ...
                <? if ($type == "image"):?>
                    ...
                    <td valign="top" width="98%" align="center">
                        <font class="tableheadtext"><?= GetMessage('FILEMAN_PREVIEW') . "<br>" ?>
                            <hr size="1">
                            <img src="/bitrix/images/1.gif" width="100" name="preview">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="right"><font class="tablebodytext"><?= GetMessage('FILEMAN_FILE_SIZE') ?>
                                            &nbsp;</font></td>
                                    <td><input class="typeinput" type="text" size="5" name="fs" readonly></td>
                                </tr>
                                <tr>
                                    <td align="right"><font class="tablebodytext"><?= GetMessage('FILEMAN_WIDTH') ?>
                                            &nbsp;</font></td>
                                    <td><input class="typeinput" type="text" size="5" name="imgwidth" readonly></td>
                                </tr>
                                <tr>
                                    <td align="right"><font class="tablebodytext"><?= GetMessage('FILEMAN_HEIGHT') ?>
                                            &nbsp;</font></td>
                                            ...
                                            while ($zr = $doc_files->GetNext()) :
                                                ...
                                                if ($ftype == "IMAGE") :
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tablebody" align="center" nowrap><font
                                                                    class="tablebodytext"><?= $zr["TIMESTAMP_X"] ?></font>
                                                        </td>
                                                        <td class="tablebody"><font class="tablebodytext">[<a
                                                                        target="_blank" class="tablebodylink"
                                                                        href="user_edit.php?ID=<?
                                                                        echo $zr["MODIFIED_BY"] ?>&lang=<?= LANG ?>"><?
                                                                    echo $zr["MODIFIED_BY"] ?></a>]&nbsp;<?
                                                                echo $zr["USER_NAME"] ?></font></td>
                                                    </tr>
                                                <?
                                                endif;
                                            endwhile;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="100%"><input class="typeinput" type="text" name="url" size="40" value=""><img
                            src="/bitrix/images/1.gif" width="2" height="1" border=0 alt=""><input class="button"
                                                                                                   type="button"
                                                                                                   name="bSelect"
            ...
            <tr>
                <td nowrap align="right"><font class="tablebodytext">&nbsp;<?= GetMessage('FILEMAN_NEW_FILENAME') ?>
                        &nbsp;</font></td>
                <td>
                    <input class="typeinput" type="text" name="newfilename" size="20" onchange="OnNameChange()">
                    <input class="button" type="submit" name="save" value="<?= GetMessage('FILEMAN_UPLOAD') ?>"
                           DISABLED></font></td>
            </tr>
            <tr>
                <td colspan="2" nowrap align="center"><input type="hidden" name="path"
                                                             value="<?= htmlspecialcharsex($path) ?>"></td>
            </tr>
            <tr>
                <td colspan="2" nowrap align="center"><br></td>
            </tr>
            <tr>
                <td colspan="2" nowrap align="center"><input class="button" type="button"
                                                             name="<?= GetMessage('FILEMAN_CANCEL') ?>"
                                                             value="<?= GetMessage('FILEMAN_CLOSE_WINDOW') ?>"
