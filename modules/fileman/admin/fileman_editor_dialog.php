...
<? if ($name == "anchor"): ?>
    <script>
        ...
        function OnSave() {
            ...
            {
                var id = pObj.pMainObj.SetBxTag(false, {
                    tag: "anchor",
                    params: {value: '<a name="' + anchor_value.value + '"></a>'}
                });
    ...
    <div style="padding: 5px;">
        <label for="anchor_value"><?= GetMessage("FILEMAN_ED_ANCHOR_NAME") ?>&nbsp;</label><input type="text" size="25"
                                                                                                  value=""
                                                                                                  id="anchor_value"/>
    </div>
    <? $dialogHTML = ob_get_contents();
    ob_end_flush(); ?>
...
<? elseif ($name == "editlink"): ?>
    ...
    <table class="bx-link-dialog-tbl bx--t1 bx--t2 bx--t3 bx--t4" id="bx_link_dialog_tbl">
        ...
        <tr>
            <td colSpan="2" class="bx-link-sep"></td>
        </tr>
        ...
        <tr class="bx-header">
            <td colSpan="2"><a class="bx-adv-link" onclick="showAddSect(); return false;"
                               href="javascript: void(0);"><?= GetMessage("FILEMAN_ED_ADDITIONAL") ?>
                    <span>(<?= GetMessage("FILEMAN_ED_HIDE") ?>)</span></a></td>
        </tr>
        ...
        <tr class="bx-adv bx-hide-in-t3 bx-hide-in-t4">
            <td class="bx-par-title"><input type="checkbox" value="Y" id="bx_noindex"
                                            onclick="var rel = BX('bx_link_rel'); if (this.checked){rel.value='nofollow'; rel.disabled=true;}else{rel.disabled=false;rel.value='';}"/>
            </td>
    ...
    <table class="bx-image-dialog-tbl">
        ...
        <tr>
            ...
            <td class="bx-par-val">
                ...
                <input type="checkbox" value="Y" checked="checked" id="save_props"/> <label
                        for="save_props"><?= GetMessage("FILEMAN_SAVE_PROPORTIONS") ?></label>
            </td>
        </tr>
        <tr>
            <td valign="top">
                <table class="bx-img-side">
                    ...
                    <tr>
                        <td><label for="bx_hspace"><?= GetMessage("FILEMAN_ED_IMG_HSp") ?></label>
                            <br/>
                            <input type="text" id="bx_hspace" size="10">px
                        </td>
                    </tr>
                    <tr>
                        <td><label for="bx_vspace"><?= GetMessage("FILEMAN_ED_IMG_HVp") ?></label>
                            <br/>
                            <input type="text" id="bx_vspace" size="10">px
                        </td>
                    </tr>
                    <tr>
                        <td><label for="bx_border"><?= GetMessage("FILEMAN_ED_IMG_BORD") ?></label>
                            <br/>
                            <input type="text" id="bx_border" size="10" value="0">px
                        </td>
                    </tr>
                </table>
            </td>
            <td valign="top" style="padding-top: 2px;"><?= GetMessage("FILEMAN_ED_IMG_PREV") ?>
                <div class="bx-preview"><img id="bx_img_preview" style="display:none"/><?= str_repeat('text ', 200) ?>
                </div>
            </td>
        </tr>
    </table>
...
<? elseif ($name == "table"): ?>
    ...
    <table class="bx-dialog-table">
        <tr>
            ...
            <td nowrap><input type="text" size="3" id="bx_width"><select id="width_unit">
        ...
        <tr>
            ...
            <td nowrap><input type="text" size="3" id="bx_height"><select id="height_unit">
                    <option value="px">px</option>
        ...
        <tr>
            ...
            <td colspan="4"><select id='bx_classname'>
                    <option value=""> - <?= GetMessage("FILEMAN_NO_VAL") ?> -</option>
                </select></td>
        </tr>
    </table>
...
<? elseif ($name == "pasteword"): ?>
    ...
    <table class="bx-dialog-pasteword">
        ...
        <tr>
            <td>
                <iframe id="bx_word_text" src="javascript:void(0)"
                        style="width:98%; height:150px; border:1px solid #CCCCCC;"></iframe>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><textarea id="bx_word_sourse" style="width:96%; height:100px; border:1px solid #CCCCCC;"
                          readonly="true"></textarea></td>
        </tr>
        <tr>
            <td>
                <input id="bx_word_removeFonts" type="checkbox" checked="checked"> <label
                        for="bx_word_removeFonts"><?= GetMessage("FILEMAN_ED_REMOVE_FONTS") ?></label><br>
                <input id="bx_word_removeStyles" type="checkbox" checked="checked"> <label
                        for="bx_word_removeStyles"><?= GetMessage("FILEMAN_ED_REMOVE_STYLES") ?></label><br>
                <input id="bx_word_removeIndents" type="checkbox" checked="checked"> <label
                        for="bx_word_removeIndents"><?= GetMessage("FILEMAN_ED_REMOVE_INDENTS") ?></label><br>
                <input id="bx_word_removeSpaces" type="checkbox" checked="checked"> <label
                        for="bx_word_removeSpaces"><?= GetMessage("FILEMAN_ED_REMOVE_SPACES") ?></label><br>
                <input id="bx_word_removeTableAtr" type="checkbox" checked="checked"> <label
                        for="bx_word_removeTableAtr"><?= GetMessage("FILEMAN_ED_REMOVE_TABLE_ATR") ?></label><br>
                <input id="bx_word_removeTrTdAtr" type="checkbox" checked="checked"> <label
                        for="bx_word_removeTrTdAtr"><?= GetMessage("FILEMAN_ED_REMOVE_TR_TD_ATR") ?></label><br>
            </td>
        </tr>
    </table>
    <? $dialogHTML = ob_get_contents();
...
<? elseif ($name == "pageprops"): ?>
    ...
    <script>
        ...
        function OnLoad() {
            ...
            BX("BX_more_prop_but").onclick = function (e) {
                AppendRow('', '');
            };
            var tag_property = "<? if (CModule::IncludeModule("search")) {
                echo htmlspecialcharsbx(COption::GetOptionString("search", "page_tag_property"));
            }?>";
    ...
    <table id="pageprops_t1" class="bx-par-tbl">
        ...
        <tr>
            <td></td>
            <td class="bx-par-val"><input id="BX_more_prop_but" type="button"
                                          value="<?= GetMessage("FILEMAN_DIALOG_MORE_PROP") ?>"></td>
        </tr>
    </table>
            ...
            <table border="0" width="100%" height="100%">
                <tr>
                    <td align="center">
                        ...
                        <br><br>
                        <input id="BX_dialog_butClose" type="button" value="<?= GetMessage("FILEMAN_ED_CLOSE") ?>"
                               style="width:150">
                    </td>
                </tr>
            </table>
        ...
        <div id="BX_dialog_spellResultWin" style="display: none">
            <table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="8"></td>
                    <td width="140" valign="top"><input id="BX_dialog_butSkip" type="button"
                                                        value="<?= GetMessage("FILEMAN_ED_SKIP") ?>"
                                                        style="width:100%;"></td>
                    <td width="8"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td rowspan="9" valign="top"><select id="BX_dialog_suggestionsBox" size="8"
                                                         style="width:100%;"></select></td>
                    <td></td>
                    <td><input id="BX_dialog_butSkipAll" type="button" value="<?= GetMessage("FILEMAN_ED_SKIP_ALL") ?>"
                               style="width:100%;"></td>
                    <td></td>
                </tr>
                <tr height="5">
                ...
                <tr>
                    <td></td>
                    <td><input id="BX_dialog_butReplace" type="button" value="<?= GetMessage("FILEMAN_ED_REPLACE") ?>"
                               style="width:100%;"></td>
                    <td></td>
                </tr>
                <tr height="5">
                ...
                <tr>
                    <td></td>
                    <td><input id="BX_dialog_butReplaceAll" type="button"
                               value="<?= GetMessage("FILEMAN_ED_REPLACE_ALL") ?>" style="width:100%;"></td>
                    <td></td>
                </tr>
                <tr height="5">
                    <td colspan="2" height="5"></td>
                ...
                <tr>
                    <td></td>
                    <td><input id="BX_dialog_butAdd" type="button" value="<?= GetMessage("FILEMAN_ED_ADD") ?>"
                               style="width:100%;"></td>
                    <td></td>
                </tr>
                <tr height="5">
                ...
                <tr>
                    <td></td>
                    <td><input id="BX_dialog_butClose" type="button" value="<?= GetMessage("FILEMAN_ED_CLOSE") ?>"
                               style="width:100%;" onClick="pObj.Close();"></td>
                    <td></td>
                </tr>
            </table>
        </div>
    ...
    <script>
        ...
        function _displayToolbarRow(oTb, toolbarId, _show) {
            ...
            pCh.onchange = function (e) {
                window.temp_arToolbarSettings[this.getAttribute("__bxid")].show = this.checked;
            }
        }
            ...
            if (pObj.pMainObj.allowedTaskbars['BXComponents2Taskbar']) {
                ...
                if (!window.BXComponents2Taskbar || !ar_BXTaskbarS["BXComponents2Taskbar_" + pObj.pMainObj.name]) {
                    ...
                    if (!settings.show || !arTBAdded["BXComponents2Taskbar"]) {
                        _displayTaskbarRow(oTable, {
                            name: 'BXComponents2Taskbar',
                            title: BX_MESS.CompTBTitle
                        }, settings);
        ...
        function _displayRow(pTb, label, id) {
            ...
            BX.adjust(pTr.insertCell(-1), {
                props: {className: "bx-par-val"},
...
<? elseif ($name == "flash"): ?>
    <script>
        ...
        function OnLoad() {
            ...
            BX("flash_src").onchange = function () {
            ...
            pObj.bx_swf_source.onblur = function () {
                ...
                var flash_parser = function (str, attr) {
                    ...
                    for (i = 0, l = _params.length; i < l; i++) {
                        ...
                        attr = attr.replace(re, function (s, b1, value) {
                            arParams[_p] = value;
                        });
                    }
...
<? elseif ($name == "snippets"): ?>
                    ...
                    setTimeout(function () {
                        ...
                        var createGroup = function (name, path) {
                            ...
                            for (var i = 0, l = arBXSnippetsTaskbars.length; i < l; i++)
                                arBXSnippetsTaskbars[i].AddElement({
                                    name: name,
                                    tagname: '',
                                    isGroup: true,
                                    childElements: [],
                                    ...
                                    path: path,
                                    code: ''
                                }, arBXSnippetsTaskbars[i].pCellSnipp, path);
                        };
    ...
    <table id="__bx_temp_sn_location" class="add_snippet">
        ...
        <tr id='_new_group_chck_row'>
            <td align="right"><label for="__create_new_subfolder"><?= GetMessage("FILEMAN_ED_CREATE_SUBGROUP") ?>
                    :</label></td>
    ...
    <table id="__bx_temp_sn_additional_params" class="add_snippet">
        ...
        <tr style="height:0%; display:none;" id="__bx_snd_new_image_chbox_tr">
            <td width="40%" align="right"><label for='__new_image_chbox'><?= GetMessage("FILEMAN_ED_SN_DEL_IMG") ?>
                    :</label></td>
        ...
        <tr id="__bx_snd_new_image_tr">
            ...
            <td>
                <input type="text" size="25" value="" id="thumb_src" style="width: 75%"><input
                        id="OpenFileDialog_button" type="button" value="..." onclick="OpenFileDialog_thumb()"
                        style="width: 10%">
            </td>
        </tr>
        <tr>
...
<? elseif ($name == "edit_hbf"): ?>
    <script>
        function OnLoad() {
            ...
            oDiv.appendChild(BX.create("TEXTAREA", {
                props: {
                    id: "__bx_head_ta",
                    value: pObj.pMainObj._head + pObj.pMainObj._body
                }, style: {width: "99%", height: "280px"}
            }));
            oDiv.appendChild(BX.create("A", {
                props: {
                    href: 'javascript: void("")',
                    title: '<?= GetMessageJS("FILEMAN_ED_INSERT_DEF")?>'
                },
                text: '<?= GetMessageJS("FILEMAN_ED_INSERT_DEF")?>',
                style: {marginTop: '13px', display: 'inline-block'}
            })).onclick = insertDefault_head;

            // TAB #2: Footer
            oDiv = BX("__bx_footer");
            oDiv.appendChild(BX.create("TEXTAREA", {
                props: {id: "__bx_footer_ta", value: pObj.pMainObj._footer},
                style: {width: "99%", height: "280px"}
            }));
            oDiv.appendChild(BX.create("A", {
                props: {
