                ...
                <td>
                    ...
                    <select name="name" onChange="ChType(this)">
                        ...
                        for ($i = 0, $l = count($arTypes); $i < $l; $i++) {
                            $t = $arTypes[$i];
                            ?>
                            <option value="<?= htmlspecialcharsex($t[0]) ?>"<? if ($name == $t[0]) {
                                $bExists = true;
                                echo " selected";
                            } ?>>
                ...
                <td colspan="2">
                    ...
                    if ($bSimple):?>
                        <table border="0" cellpadding="2" cellspacing="1" width="100%" class="internal">
                            ...
                            for ($i = 1, $l = count($aMenuLinksTmp) + 5; $i <= $l; $i++):
                                ...
                                <tr>
                                    <td align="center"><input type="text" size="30" name="text_<?= $i ?>"
                                                              value="<?= htmlspecialcharsex($aMenuLinksItem[0]) ?>">
                                    </td>
                                    <td align="center"><input type="text" size="35" name="link_<?= $i ?>"
                                                              value="<?= htmlspecialcharsex($aMenuLinksItem[1]) ?>">
                                    </td>
                                    <td align="center"><input type="text" size="4" name="sort_<?= $i ?>"
                                                              value="<?= $i * 10 ?>"></td>
                                    <td align="center">
                                        <? if ($i <= count($aMenuLinksTmp)):?>
                    ...
                    <? else:?>
                        ...
                        <table border="0" cellpadding="2" cellspacing="1" width="100%" id="t" class="internal">
                            ...
                            <? if (!$only_edit):?>
                                <tr id="0">
                                    <td colspan="2"><input type="button" onClick="AddMenuItem(this)"
                                                           value="<?= GetMessage("FILEMAN_MENU_EDIT_ADD_ITEM") ?>"></td>
                                </tr>
                            <? endif; ?>
                            <?
                            $itemcnt = 0;
                                            ...
                                            <? if ($number_new_params > 0 || count($aMenuLinksItem[3]) > 0):?>
                                                <tr>
                                                    ...
                                                    <td nowrap valign="top">
                                                        ...
                                                        <input type="hidden" name="param_cnt_<?= $i ?>"
                                                               value="<?= $j ?>">
                                                    </td>
                                                </tr>
