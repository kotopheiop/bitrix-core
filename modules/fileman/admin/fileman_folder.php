                            ...
                            <tr>
                                <td>
                                    ...
                                    if ($bPredefinedProperty):?>
                                        ...
                                        echo $ind; ?>" value="<?
                                        echo htmlspecialcharsbx($f_CODE); ?>">
                                        <input type="text" name="CODE_NAME_<?
                                        echo $ind; ?>" value="<?
                                        echo htmlspecialcharsbx($f_CODE_NAME); ?>" size="30" readonly
                                               style='background-color:#F1F1F1;'>
                                        <!--<?
                                        echo $f_CODE_NAME; ?>-->
                                    <? else:?>
                                        <input type="text" name="CODE_<?
                                        echo $ind; ?>" value="<?
                                        echo htmlspecialcharsbx($f_CODE); ?>" size="30">
                                    <?endif; ?>
                                </td>
                                <td>
                                    <input type="text" name="VALUE_<?
                                    echo $ind; ?>" value="<?
                                    echo htmlspecialcharsbx($f_VALUE); ?>" size="60">
                                </td>
                            </tr>
                            <?
                        }
                    ...
                    if ($bInitVars && $numnewpropsvals > 0) {
                        for ($i = 0; $i < $numnewpropsvals; $i++) {
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="VALUE_<?
                                    echo $ind; ?>" value="<?
                                    echo htmlspecialcharsbx($f_VALUE); ?>" size="60"><?
                                    if ($APPLICATION->GetDirProperty($f_CODE, Array($site, $path)) && strlen($f_VALUE) <= 0) {
                                        ?><br><small><b><?
                                            echo GetMessage("FILEMAN_FOLDER_CURVAL") ?></b> <?
                                        echo htmlspecialcharsbx($APPLICATION->GetDirProperty($f_CODE, Array($site, $path))); ?>
                                        </small><?
                                    }
                                    ?></td>
                            </tr>
