            ...
            switch ($key) {
                ...
                case "TITLE":
                    if ($val == '') {
                        ...
                        $arSqlSearch[] = ($strNegative == "Y" ? " FD." . $key . " IS NULL OR NOT " : "") . "(FD." . $key . " " . $strOperation . " '" . $DB->ForSql(
                                $val
                            ) . "' )";
                    }
                    break;
                case "ID":
                    if ($strOperation != "IN") {
                        if (intval($val) <= 0) {
                            ...
                            $arSqlSearch[] = ($strNegative == "Y" ? " FD.ID IS NULL OR NOT " : "") . "(FD.ID " . $strOperation . " " . intval(
                                    $val
                                ) . " )";
                        }
                    } else {
                        ...
                        $val = implode(', ', $val_int);
                        $arSqlSearch[] = ($strNegative == "Y" ? " NOT " : "") . "(FD.ID IN (" . $DB->ForSql(
                                $val
                            ) . ") )";
                    }
                    break;
            ...
            switch ($key) {
                ...
                case "REPLACEMENT":
                    if ($val == '') {
                        ...
                        $arSqlSearch[] = ($strNegative == "Y" ? " FL." . $key . " IS NULL OR NOT " : "") . "(FL." . $key . " " . $strOperation . " '" . $DB->ForSql(
                                $val
                            ) . "' )";
                    }
                    break;
                ...
                case "ID":
                    if ($strOperation != "IN") {
                        if (intval($val) <= 0) {
                            ...
                            $arSqlSearch[] = ($strNegative == "Y" ? " FL." . $key . " IS NULL OR NOT " : "") . "(FL." . $key . " " . $strOperation . " " . intval(
                                    $val
                                ) . " )";
                        }
                    } else {
                        ...
                        $val = implode(', ', $val_int);
                        $arSqlSearch[] = ($strNegative == "Y" ? " NOT " : "") . "(FL." . $key . " IN (" . $DB->ForSql(
                                $val
                            ) . ") )";
                    }
                    break;
