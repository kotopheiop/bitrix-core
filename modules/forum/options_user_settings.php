...
<?endif; ?>
    ...
    <tr>
        ...
        <td><textarea class="typearea" name="forum_INTERESTS" rows="3"
                      cols="35"><? echo $str_forum_INTERESTS; ?></textarea></td>
    </tr>
    <tr>
        <td class="adm-detail-valign-top"><?= GetMessage("forum_SIGNATURE") ?></td>
        <td><textarea class="typearea" name="forum_SIGNATURE" rows="3"
                      cols="35"><? echo $str_forum_SIGNATURE; ?></textarea></td>
    </tr>
