...
?>
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="forum_edit">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td width="60%">
                <input type="text" name="MIN_NUM_POSTS" value="<?= htmlspecialcharsbx($str_MIN_NUM_POSTS) ?>" size="20"
                       maxlength="18">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="POINTS_PER_POST" value="<?= htmlspecialcharsbx($str_POINTS_PER_POST) ?>"
