...
?>
    <form method="POST" action="<?= $APPLICATION->GetCurPageParam() ?>?" name="forum_edit">
        ...
        <tr>
            ...
            <td width="60%">
                <input type="checkbox" name="ACTIVE" id="ACTIVE"
                       value="Y" <?= ($arForum["ACTIVE"] == "Y" ? "checked='checked'" : "") ?> />
            ...
            <td>
                <select name="FORUM_GROUP_ID" id="FORUM_GROUP_ID">
                    ...
                    foreach ($arGroups as $res) {
                        ?>
                        <option
                        value="<?= $res["ID"] ?>" <?= ($arForum["FORUM_GROUP_ID"] == $res["ID"] ? "selected='selected'" : "") ?>><?
        ...
        <tr class="heading">
            <td colspan="2"><?= GetMessage("FE_SITES_PATHS") ?><span class="required"><sup>1</sup></span><input
                        type="hidden" name="SITES"/></td>
        </tr>
        <?
        foreach ($arSites as $key => $res) {
            ...
            <tr class="adm-detail-required-field">
                <td valign="top">
                    ...
                    <input type="checkbox" name="SITE[<?= $res["LID"] ?>]" id="SITE_<?= $res["LID"] ?>_" value="Y"<?
                    if (array_key_exists($res["LID"], $arForum["SITES"])) echo " checked" ?>
                           OnClick="on_site_checkbox_click('<?= $res["LID"] ?>', '<?= $res["DIR"] ?>')">
                </td>
                <td valign="top">
        ...
        if (IsModuleInstalled("search")) {
            ...
            <tr>
                ...
                <td width="60%">
                    <input type="checkbox" name="INDEXATION" id="INDEXATION"
                           value="Y" <?= ($arForum["INDEXATION"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        <tr>
            ...
            <td width="60%">
                <input type="checkbox" name="MODERATION" id="MODERATION"
                       value="Y" <?= ($arForum["MODERATION"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="DEDUPLICATION" id="DEDUPLICATION"
                       value="Y" <?= ($arForum["DEDUPLICATION"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ALLOW_TOPIC_TITLED" id="ALLOW_TOPIC_TITLED"
                       value="Y" <?= ($arForum["ALLOW_TOPIC_TITLED"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ALLOW_SIGNATURE" id="ALLOW_SIGNATURE"
                       value="Y" <?= ($arForum["ALLOW_SIGNATURE"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="ALLOW_UPLOAD_EXT" size="40" maxlength="255"
                       value="<?= $arForum["ALLOW_UPLOAD_EXT"] ?>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="USE_CAPTCHA" id="USE_CAPTCHA"
                       value="Y" <?= ($arForum["USE_CAPTCHA"] == "Y" ? "checked='checked'" : "") ?> />
        ...
        if (CModule::IncludeModule("statistic")) {
            ...
            <tr>
                <td>event2:</td>
                <td><input type="text" name="EVENT2" maxlength="255" size="30"
                           value="<?= $arForum["EVENT2"] ?>"><br><?= GetMessage("FORUM_EVENT12") ?></td>
            </tr>
            <tr>
                <td>event3:</td>
                <td><input type="text" name="EVENT3" maxlength="255" size="30"
                           value="<?= $arForum["EVENT3"] ?>"><br><?= GetMessage("FORUM_EVENT3") ?></td>
            </tr>
            <?
        }
        ?>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ALLOW_SMILES" id="ALLOW_SMILES"
                       value="Y" <?= ($arForum["ALLOW_SMILES"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ALLOW_HTML" id="ALLOW_HTML"
                       value="Y" <?= ($arForum["ALLOW_HTML"] == "Y" ? "checked='checked'" : "") ?> <?
        ...
        <tr id="forum_allow_nl2br" style="<?= (($arForum["ALLOW_HTML"] == "Y") ? "" : "display:none;color:red;") ?>">
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_NL2BR" id="ALLOW_NL2BR"
                       value="Y" <?= ($arForum["ALLOW_NL2BR"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="ALLOW_ANCHOR" id="ALLOW_ANCHOR"
                       value="Y" <?= ($arForum["ALLOW_ANCHOR"] == "Y" ? "checked='checked'" : "") ?>>
                <label for="ALLOW_ANCHOR"><?= GetMessage("ALLOW_ANCHOR_TITLE") ?>
                    <small>(&lt;a&nbsp;href=...&gt;)</small></label>
            </td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_BIU" id="ALLOW_BIU"
                       value="Y" <?= ($arForum["ALLOW_BIU"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_IMG" id="ALLOW_IMG"
                       value="Y" <?= ($arForum["ALLOW_IMG"] == "Y" ? "checked='checked'" : "") ?>>
                <label for="ALLOW_IMG"><?= GetMessage("ALLOW_IMG_TITLE") ?>
                    <small>(&lt;img&nbsp;src=...&gt;)</small></label>
            </td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_VIDEO" id="ALLOW_VIDEO"
                       value="Y" <?= ($arForum["ALLOW_VIDEO"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_LIST" id="ALLOW_LIST"
                       value="Y" <?= ($arForum["ALLOW_LIST"] == "Y" ? "checked='checked'" : "") ?>>
                <label for="ALLOW_LIST"><?= GetMessage("ALLOW_LIST_TITLE") ?>
                    <small>(&lt;ul&gt;&lt;li&gt;)</small></label>
            </td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_TABLE" id="ALLOW_TABLE"
                       value="Y" <?= ($arForum["ALLOW_TABLE"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_ALIGN" id="ALLOW_ALIGN"
                       value="Y" <?= ($arForum["ALLOW_ALIGN"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_QUOTE" id="ALLOW_QUOTE"
                       value="Y" <?= ($arForum["ALLOW_QUOTE"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_CODE" id="ALLOW_CODE"
                       value="Y" <?= ($arForum["ALLOW_CODE"] == "Y" ? "checked='checked'" : "") ?>>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ALLOW_FONT" id="ALLOW_FONT"
                       value="Y" <?= ($arForum["ALLOW_FONT"] == "Y" ? "checked='checked'" : "") ?>>
                <label for="ALLOW_FONT"><?= GetMessage("ALLOW_FONT_TITLE") ?>
                    <small>(&lt;font&nbsp;color=...&gt;)</small></label>
            </td>
        </tr>
        ...
        while ($res = $db_res->GetNext()) {
            ...
            <tr>
                <td width="40%"><?= $res["NAME"] ?>&nbsp;[<a
                            href="/bitrix/admin/group_edit.php?ID=<?= $res["ID"] ?>&lang=<?= LANGUAGE_ID ?>"><?= $res["ID"] ?></a>]:
                </td>
                <td width="60%">
                    <select name="GROUP[<?= $res["ID"] ?>]">
                        ...
                        foreach ($aForumPermissions["reference_id"] as $fi => $val) {
                            ?>
                            <option value="<?= $aForumPermissions["reference_id"][$fi] ?>"<?
                            if ($strSelected == $aForumPermissions["reference_id"][$fi]) echo " selected" ?>><?
