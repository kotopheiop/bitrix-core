...
if ($ID > 0 && $forumPermissions >= "W") {
    ...
    $aMenu[] = array(
        ...
        "LINK" => "javascript:if(confirm('" . GetMessage(
                "FLTR_DEL_CONFIRM"
            ) . "')) window.location='/bitrix/admin/forum_words.php?DICTIONARY_ID={$arFields["DICTIONARY_ID"]}&lang=" . LANG . "&action_button=delete&ID[]=" . $ID . "&" . bitrix_sessid_get(
            ) . "';",
        "ICON" => "btn_delete",
    );
}
...
$tabControl = new CAdminTabControl(
    "tabControl",
    array(array("DIV" => "edit", "TAB" => $sDocTitle, "ICON" => "forum", "TITLE" => ""))
);
$tabControl->Begin();
...
?>
    <tr class="adm-detail-required-field">
        ...
        <td width="60%"><input type="text" name="WORDS" maxlength="255"
                               value="<?= htmlspecialcharsbx($arFields["WORDS"]) ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?= GetMessage("FLTR_SEARCH_WHAT") ?>:</td>
        <td>
            <?
            $arr = array(
                "reference" => array(
    ...
    <tr>
        <td><?= GetMessage("FLTR_REPLACEMENT") ?>:</td>
        <td><input type="text" name="REPLACEMENT" maxlength="255"
                   value="<?= htmlspecialcharsbx($arFields["REPLACEMENT"]) ?>"></td>
    </tr>
    <tr class="heading">
    ...
    <tr valign="top">
        <td colspan="2" align="center">
            <textarea style="width:60%; height:150px;" name="DESCRIPTION" wrap="VIRTUAL"><?= htmlspecialcharsbx(
