...
<form method="POST" action="<?= $APPLICATION->GetCurPage() ?>" name="forum_edit">
    ...
    <tr class="adm-detail-required-field">
        ...
        <td width="60%"><input type="text" name="WORDS" maxlength="255" value="<?= htmlspecialcharsbx($str_WORDS) ?>">
        </td>
    </tr>
    <tr>
        <td><?= GetMessage("FLTR_USE_IT") ?>:</td>
        <td><input type="checkbox" name="USE_IT" value="Y" <?= $str_USE_IT == "Y" ? "checked" : "" ?>></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="REPLACEMENT" maxlength="255" value="<?= htmlspecialcharsbx($str_REPLACEMENT) ?>">
        </td>
    </tr>
    <tr class="heading">
    ...
    <tr valign="top">
        <td colspan="2" align="center">
            <textarea style="width:60%; height:150px;" name="DESCRIPTION"
                      wrap="VIRTUAL"><?= htmlspecialcharsbx($str_DESCRIPTION) ?></textarea>
        </td>
    </tr>
    <? $tabControl->EndTab(); ?>
    <? $tabControl->Buttons(
