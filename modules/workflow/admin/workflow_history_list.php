...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr valign="center">
            ...
            <td nowrap><input type="text" name="find_modified_user"
                              value="<? echo htmlspecialcharsbx($find_modified_user) ?>"
                              size="47"><?= ShowExactMatchCheckbox("find_modified_user") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
        ...
        <tr valign="center">
            ...
            <td nowrap><input type="text" name="find_filename" value="<? echo htmlspecialcharsbx($find_filename) ?>"
                              size="47"><?= ShowExactMatchCheckbox("find_filename") ?>&nbsp;<?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr valign="center">
            <td nowrap><?= GetMessage("FLOW_F_TITLE") ?>:</td>
            <td nowrap><input type="text" name="find_title" value="<? echo htmlspecialcharsbx($find_title) ?>"
                              size="47"><?= ShowExactMatchCheckbox("find_title") ?>&nbsp;<?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr valign="center">
            <td nowrap><?= GetMessage("FLOW_F_BODY") ?>:</td>
            <td nowrap><input type="text" name="find_body" value="<? echo htmlspecialcharsbx($find_body) ?>"
                              size="47"><?= ShowExactMatchCheckbox("find_body") ?>&nbsp;<?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr valign="center">
