...
<form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>?">
    ...
    <tr>
        ...
        <td><input type="text" name="find_filename" value="<? echo htmlspecialcharsbx($find_filename) ?>"
                   size="47"><?= ShowExactMatchCheckbox("find_filename") ?>&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td><?= GetMessage("FLOW_F_TITLE") ?>:</td>
        <td><input type="text" name="find_title" value="<? echo htmlspecialcharsbx($find_title) ?>"
                   size="47"><?= ShowExactMatchCheckbox("find_title") ?>&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td><?= GetMessage("FLOW_F_BODY") ?>:</td>
        <td><input type="text" name="find_body" value="<? echo htmlspecialcharsbx($find_body) ?>"
                   size="47"><?= ShowExactMatchCheckbox("find_body") ?>&nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
