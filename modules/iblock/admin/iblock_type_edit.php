...
<form method="POST" id="form" name="form" action="iblock_type_edit.php?lang=<? echo LANG ?>">
    ...
    <? else: ?>
        <tr class="adm-detail-required-field">
            <td><? echo GetMessage("IBTYPE_E_ID") ?></td>
            <td><input type="text" name="NEW_ID" size="50" maxlength="50" value="<?= htmlspecialcharsbx($NEW_ID) ?>">
            </td>
        </tr>
    <? endif; ?>
    <script>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" id="SECTIONS" name="SECTIONS"
                               value="Y"<? if ($str_SECTIONS == "Y") echo " checked" ?> onclick="__Chk()"></td>
    </tr>
    <tr class="heading">
        ...
        <td colspan="2" align="center">
            <table border="0" cellspacing="6" class="internal">
                ...
                foreach ($arIBTLang as $ar):
                    ...
                    <tr>
                        <td><? echo $ar["NAME"] ?>:</td>
                        <td><input type="text" name="LANG_FIELDS[<? echo $ar["LID"] ?>][NAME]" size="20" maxlength="255"
                                   value="<? echo $ibtypelang["NAME"] ?>"></td>
                        <td><input type="text" name="LANG_FIELDS[<? echo $ar["LID"] ?>][SECTION_NAME]" size="20"
                                   maxlength="255" value="<? echo $ibtypelang["SECTION_NAME"] ?>"></td>
                        <td><input type="text" name="LANG_FIELDS[<? echo $ar["LID"] ?>][ELEMENT_NAME]" size="20"
                                   maxlength="255" value="<? echo $ibtypelang["ELEMENT_NAME"] ?>"></td>
                    </tr>
                <? endforeach ?>
            </table>
        </td>
    ...
    <tr>
        ...
        <td width="60%"><input type="checkbox" id="IN_RSS" name="IN_RSS"
                               value="Y"<? if ($str_IN_RSS == "Y") echo " checked" ?>></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="EDIT_FILE_BEFORE" size="50" maxlength="255"
    ...
    <tr>
        ...
        <td><input type="text" name="EDIT_FILE_AFTER" size="50" maxlength="255" value="<? echo $str_EDIT_FILE_AFTER ?>">&nbsp;<input
                    type="button" name="browse" value="..." onClick="BtnClick2()"></td>
    </tr>
