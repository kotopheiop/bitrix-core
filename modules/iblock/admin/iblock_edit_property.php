...
?>
    ...
    <form method="POST" name="frm_prop" id="frm_prop" action="<? echo $APPLICATION->GetCurPageParam(); ?>"
        ...
        ?><input type="hidden" id="PROPERTY_PROPERTY_TYPE" name="PROPERTY_PROPERTY_TYPE" value="<?
        echo htmlspecialcharsbx($PROPERTY_TYPE); ?>">
        <?
        if ($bSectionPopup): ?>
            <table class="edit-table" width="100%">
                        ...
                        <select name="PROPERTY_PROPERTY_TYPE" onchange="reloadForm();">
                            ...
                            <optgroup label="<? echo GetMessage('BT_ADM_IEP_PROPERTY_BASE_TYPE_GROUP'); ?>"><?
                                ...
                                foreach ($propertyBaseTypes as $typeId => $typeTitle) {
                                    ?>
                                    <option
                                    value="<?= $typeId; ?>" <?= ($PROPERTY_TYPE == $typeId ? ' selected' : ''); ?>><?= htmlspecialcharsbx($typeTitle); ?></option><?
                                }
                                unset($typeTitle);
                                unset($typeId);
                                if ($boolUserPropExist)
                            ...
                            <optgroup label="<? echo GetMessage('BT_ADM_IEP_PROPERTY_USER_TYPE_GROUP'); ?>"><?
                                ...
                                foreach ($arUserTypeList as $ar) {
                                    ?>
                                    <option
                                    value="<?= htmlspecialcharsbx($ar["PROPERTY_TYPE"] . ":" . $ar["USER_TYPE"]) ?>" <?
                                    if ($PROPERTY_TYPE == $ar["PROPERTY_TYPE"] . ":" . $ar["USER_TYPE"]) echo " selected" ?>><?= htmlspecialcharsbx($ar["DESCRIPTION"]) ?></option>
                                    <?
                                }
                                if ($boolUserPropExist)
                                {
                ...
                <table class="edit-table" width="100%">
                    ...
                    <tr>
                        <td width="40%"><label
                                    for="PROPERTY_ACTIVE_Y"><? echo GetMessage("BT_ADM_IEP_PROP_ACT") ?></label></td>
                        <td width="60%"><input type="hidden" id="PROPERTY_ACTIVE_N" name="PROPERTY_ACTIVE" value="N">
                            <input type="checkbox" id="PROPERTY_ACTIVE_Y" name="PROPERTY_ACTIVE"
                                   value="Y"<? if ('Y' == $arProperty['ACTIVE']) echo ' checked="checked"'; ?>></td>
                    </tr>
                    <tr>
                    ...
                    if (COption::GetOptionString("iblock", "show_xml_id", "N") == "Y") {
                        ...
                        <tr>
                        <td width="40%"><?
                            echo GetMessage("BT_ADM_IEP_PROP_EXTERNAL_CODE") ?></td>
                    ...
                    if ($bShow) {
                        ...
                        <tr>
                        <td width="40%"><label
                                    for="PROPERTY_MULTIPLE_Y"><? echo GetMessage("BT_ADM_IEP_PROP_MULTIPLE") ?></label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td width="40%"><label
                                    for="PROPERTY_IS_REQUIRED_Y"><? echo GetMessage("BT_ADM_IEP_PROP_IS_REQUIRED") ?></label>
                        </td>
                        <td>
                    ...
                    if ($bShow) {
                        ?>
                        <tr>
                        <td width="40%"><label for="PROPERTY_SEARCHABLE_Y"><?
                                echo GetMessage("BT_ADM_IEP_PROP_SEARCHABLE") ?></label></td>
                        <td>
                            <input type="hidden" id="PROPERTY_SEARCHABLE_N" name="PROPERTY_SEARCHABLE" value="N">
                            <input type="checkbox" id="PROPERTY_SEARCHABLE_Y" name="PROPERTY_SEARCHABLE" value="Y" <?
                            if ('Y' == $arProperty['SEARCHABLE']) echo ' checked="checked"'; ?>>
                        </td>
                        </tr><?
                    } elseif (
                    isset($arPropertyFields["SET"]["SEARCHABLE"])
                    ) {
                        ?><input type="hidden" id="PROPERTY_SEARCHABLE_Y" name="PROPERTY_SEARCHABLE" value="<?
                        echo htmlspecialcharsbx($arPropertyFields["SET"]["SEARCHABLE"]) ?>"><?
                    }
                    ...
                    if ($bShow) {
                        ?>
                        <tr>
                        <td width="40%"><label for="PROPERTY_FILTRABLE_Y"><?
                                echo GetMessage("BT_ADM_IEP_PROP_FILTRABLE") ?></label></td>
                        <td>
                            <input type="hidden" id="PROPERTY_FILTRABLE_N" name="PROPERTY_FILTRABLE" value="N">
                            <input type="checkbox" id="PROPERTY_FILTRABLE_Y" name="PROPERTY_FILTRABLE" value="Y" <?
                            if ('Y' == $arProperty['FILTRABLE']) echo ' checked="checked"' ?>>
                        </td>
                        </tr><?
                    } elseif (
                    isset($arPropertyFields["SET"]["FILTRABLE"])
                        ...
                        ?>
                        <input type="hidden" id="PROPERTY_FILTRABLE_Y" name="PROPERTY_FILTRABLE" value="<?
                    ...
                    if ($bShow) {
                        ?>
                        <tr>
                        <td width="40%"><label for="PROPERTY_WITH_DESCRIPTION_Y"><?
                                echo GetMessage("BT_ADM_IEP_PROP_WITH_DESC") ?></label></td>
                        <td>
                            ...
                            <input type="checkbox" id="PROPERTY_WITH_DESCRIPTION_Y" name="PROPERTY_WITH_DESCRIPTION"
                                   value="Y" <?
                            if ('Y' == $arProperty['WITH_DESCRIPTION']) echo " checked" ?>>
                        </td>
                        </tr><?
                    } elseif (
                    isset($arPropertyFields["SET"]["WITH_DESCRIPTION"])
                        ...
                        ?>
                        <input type="hidden" id="PROPERTY_WITH_DESCRIPTION_Y" name="PROPERTY_WITH_DESCRIPTION" value="<?
                        echo htmlspecialcharsbx($arPropertyFields["SET"]["WITH_DESCRIPTION"]) ?>">
                        <?
                    }
                    ...
                    if ($bShow) {
                        ...
                        <tr>
                        <td width="40%"><?
                            echo GetMessage("BT_ADM_IEP_PROP_MULTIPLE_CNT") ?></td>
                        <td><input type="text" id="PROPERTY_MULTIPLE_CNT" name="PROPERTY_MULTIPLE_CNT" value="<?
                            echo intval($arProperty['MULTIPLE_CNT']); ?>" size="3"></td>
                        </tr><?
                    } elseif (
                    isset($arPropertyFields["SET"]["MULTIPLE_CNT"])
                    ) {
                        ?>
                        <input type="hidden" id="PROPERTY_MULTIPLE_CNT" name="PROPERTY_MULTIPLE_CNT" value="<?
                        echo htmlspecialcharsbx($arPropertyFields["SET"]["MULTIPLE_CNT"]) ?>">
                        <?
                    }
                    ...
                    if (!$bSectionPopup):?>
                        <tr>
                            <td width="40%"><label for="PROPERTY_SECTION_PROPERTY_Y"><?
                                    echo GetMessage("BT_ADM_IEP_PROP_SECTION_PROPERTY") ?></label></td>
                            <td>
                                ...
                                <input type="checkbox" id="PROPERTY_SECTION_PROPERTY_Y" name="PROPERTY_SECTION_PROPERTY"
                                       value="Y" <?
                                if ('N' != $arProperty['SECTION_PROPERTY']) echo ' checked="checked"'; ?>>
                            </td>
                        </tr>
                        <?
                        $bShow = true;
                        ...
                        if ($bShow) {
                            ...
                            <tr id="tr_SMART_FILTER"
                                ...
                                <td width="40%"><label for="PROPERTY_SMART_FILTER_Y"><?
                                        echo GetMessage("BT_ADM_IEP_PROP_SMART_FILTER") ?></label></td>
                                <td>
                                    ...
                                    <input type="checkbox" id="PROPERTY_SMART_FILTER_Y" name="PROPERTY_SMART_FILTER"
                                           value="Y" <?
                                    if ('N' != $arProperty['SMART_FILTER']) echo ' checked="checked"'; ?>>
                                </td>
                            </tr>
                            <?
                            ...
                            if ($displayTypes) {
                                ...
                                <tr id="tr_DISPLAY_TYPE"
                                    style="display: <? echo($arProperty['SECTION_PROPERTY'] != 'N' ? 'table-row' : 'none'); ?>">
                                    <td width="40%"><?
                                        echo GetMessage("BT_ADM_IEP_PROP_DISPLAY_TYPE") ?></td>
                                    <td>
                                        <?
                            ...
                            <tr id="tr_DISPLAY_EXPANDED"
                                style="display: <? echo($arProperty['SECTION_PROPERTY'] != 'N' ? 'table-row' : 'none'); ?>">
                                <td width="40%"><label for="PROPERTY_DISPLAY_EXPANDED_Y"><?
                                        echo GetMessage("BT_ADM_IEP_PROP_DISPLAY_EXPANDED") ?></label></td>
                                <td>
                                    ...
                                    <input type="checkbox" id="PROPERTY_DISPLAY_EXPANDED_Y"
                                           name="PROPERTY_DISPLAY_EXPANDED" value="Y" <?
                                    if ($arProperty['DISPLAY_EXPANDED'] == 'Y') echo ' checked="checked"'; ?>>
                                </td>
                            </tr>
                            <tr id="tr_FILTER_HINT" class="adm-detail-valign-top"
                                style="display: <? echo($arProperty['SECTION_PROPERTY'] != 'N' ? 'table-row' : 'none'); ?>">
                                <td width="40%"><?
                                    echo GetMessage("BT_ADM_IEP_PROP_FILTER_HINT") ?></td>
                                <td>
                                    <?
                        ...
                        isset($arPropertyFields["SET"]["SMART_FILTER"])
                            ...
                            ?>
                            <input type="hidden" id="PROPERTY_SMART_FILTER_Y" name="PROPERTY_SMART_FILTER" value="<?
                            echo htmlspecialcharsbx($arPropertyFields["SET"]["FILTRABLE"]) ?>">
                            <?
                        }
                    endif;
                    ...
                    if ('L' == $arProperty['PROPERTY_TYPE']) {
                        ...
                        <tr>
                        <td width="40%"><?
                            echo GetMessage("BT_ADM_IEP_PROP_APPEARANCE") ?></td>
                        <td>
                            <select id="PROPERTY_LIST_TYPE" name="PROPERTY_LIST_TYPE">
                                <option value="L"<?
                                if ($arProperty['LIST_TYPE'] != "C") echo " selected" ?>><?
                                    echo GetMessage("BT_ADM_IEP_PROP_APPEARANCE_LIST") ?></option>
                                <option value="C"<?
                                if ($arProperty['LIST_TYPE'] == "C") echo " selected" ?>><?
                                    echo GetMessage("BT_ADM_IEP_PROP_APPEARANCE_CHECKBOX") ?></option>
                            </select>
                        </td>
                        </tr>
                        <?
                        ...
                        if ($bShow) {
                            ...
                            <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_ROW_CNT") ?></td>
                            <td><input type="text" size="2" maxlength="10" id="PROPERTY_ROW_COUNT"
                                       name="PROPERTY_ROW_COUNT" value="<?
                                echo intval($arProperty['ROW_COUNT']); ?>"></td>
                            </tr><?
                        } elseif (
                        isset($arPropertyFields["SET"]["ROW_COUNT"])
                        ) {
                            ?>
                            <input type="hidden" id="PROPERTY_ROW_COUNT" name="PROPERTY_ROW_COUNT" value="<?
                            echo htmlspecialcharsbx($arPropertyFields["SET"]["ROW_COUNT"]) ?>">
                            <?
                        }
                        ?>
                        <tr class="heading">
                        <td colspan="2"><?
                            echo GetMessage("BT_ADM_IEP_PROP_LIST_VALUES") ?></td></tr>
                        <tr>
                        <td colspan="2" align="center">
                            <table class="internal" id="list-tbl" style="margin: 0 auto;">
                                <tr class="heading">
                                    <td><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_ID") ?></td>
                                    <td><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_XML_ID") ?></td>
                                    <td><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_VALUE") ?></td>
                                    <td><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_SORT") ?></td>
                                    <td><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_DEFAULT") ?></td>
                                </tr>
                                <?
                                if ('Y' != $arProperty['MULTIPLE']) {
                                    ...
                                    <td>&nbsp;</td>
                                    <td colspan="2"><?
                                        echo GetMessage("BT_ADM_IEP_PROP_LIST_DEFAULT_NO") ?></td>
                                    <td style="text-align:center"><input type="radio" name="PROPERTY_VALUES_DEF"
                                                                         value="0" <?
                                        if ($boolDef) echo " checked"; ?>></td>
                                    </tr>
                                    <?
                                }
                                $MAX_NEW_ID = 0;
                            ...
                            <input type="hidden" name="PROPERTY_CNT" id="PROPERTY_CNT" value="<?
                        ...
                        if ($bShow) {
                            ...
                            <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_COL_CNT") ?></td>
                            <td><input type="text" size="2" maxlength="10" name="PROPERTY_COL_COUNT" value="<?
                                echo intval($arProperty['COL_COUNT']) ?>"></td>
                            </tr><?
                        } elseif (
                        isset($arPropertyFields["SET"]["COL_COUNT"])
                        ) {
                            ?>
                            <input type="hidden" name="PROPERTY_COL_COUNT" value="<?
                        ...
                        <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES") ?></td>
                            <td>
                                <input type="text" size="50" maxlength="255" name="PROPERTY_FILE_TYPE" value="<?
                                echo htmlspecialcharsbx($arProperty['FILE_TYPE']); ?>" id="CURRENT_PROPERTY_FILE_TYPE">
                                <select onchange="if(this.selectedIndex!==0) document.getElementById('CURRENT_PROPERTY_FILE_TYPE').value=this[this.selectedIndex].value">
                                    <option value="-"></option>
                                    <option value=""<?
                                    if ('' == $arProperty['FILE_TYPE']) echo " selected" ?>><?
                                        echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_ANY") ?></option>
                                    <option value="jpg, gif, bmp, png, jpeg"<?
                                    if ("jpg, gif, bmp, png, jpeg" == $arProperty['FILE_TYPE']) echo " selected" ?>><?
                                        echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_PIC") ?></option>
                                    <option value="mp3, wav, midi, snd, au, wma"<?
                                    if ("mp3, wav, midi, snd, au, wma" == $arProperty['FILE_TYPE']) echo " selected" ?>><?
                                        echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_SOUND") ?></option>
                                    <option value="mpg, avi, wmv, mpeg, mpe, flv"<?
                                    if ("mpg, avi, wmv, mpeg, mpe, flv" == $arProperty['FILE_TYPE']) echo " selected" ?>><?
                                        echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_VIDEO") ?></option>
                                    <option value="doc, txt, rtf"<?
                                    if ("doc, txt, rtf" == $arProperty['FILE_TYPE']) echo " selected" ?>><?
                                        echo GetMessage("BT_ADM_IEP_PROP_FILE_TYPES_DOCS") ?></option>
                                </select>
                            </td>
                        </tr>
                        <?
                        ...
                        <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_LINK_IBLOCK") ?></td>
                            <td>
                                <?
                    ...
                    <?
                        ...
                        if ($bShow) {
                            ...
                            <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_SIZE") ?></td>
                            <td>
                                <input type="text" size="2" maxlength="10" name="PROPERTY_ROW_COUNT" value="<?
                                echo intval($arProperty['ROW_COUNT']); ?>"> x <input type="text" size="2" maxlength="10"
                                                                                     name="PROPERTY_COL_COUNT" value="<?
                                echo intval($arProperty['COL_COUNT']); ?>">
                            </td>
                            </tr>
                        <?
                        } else {
                            if (isset($arPropertyFields["SET"]["ROW_COUNT"])) {
                                ?><input type="hidden" name="PROPERTY_ROW_COUNT" value="<?
                                echo htmlspecialcharsbx($arPropertyFields["SET"]["ROW_COUNT"]) ?>"><?
                            } else {
                                ?><input type="hidden" name="PROPERTY_ROW_COUNT" value="<?
                                echo intval($arProperty['ROW_COUNT']) ?>"><?
                            }

                            if (isset($arPropertyFields["SET"]["COL_COUNT"])) {
                                ?><input type="hidden" name="PROPERTY_COL_COUNT" value="<?
                                echo htmlspecialcharsbx($arPropertyFields["SET"]["COL_COUNT"]) ?>"><? } else { ?><input
                                type="hidden" name="PROPERTY_COL_COUNT" value="<?
                                echo intval($arProperty['COL_COUNT']); ?>"><? }
                        }
                        ...
                        if ($bShow) {
                            ...
                            <tr>
                            <td width="40%"><?
                                echo GetMessage("BT_ADM_IEP_PROP_DEFAULT") ?></td>
                            <td>
                                <?
                                if (array_key_exists("GetPropertyFieldHtml", $arUserType)) {
                                    ...
                                    ?><input type="text" size="50" maxlength="2000" name="PROPERTY_DEFAULT_VALUE"
                                             value="<?
                                             echo is_string($arProperty['DEFAULT_VALUE']) ? htmlspecialcharsbx($arProperty['DEFAULT_VALUE']) : '' ?>"><?
                                }
                                ?></td>
                            </tr><?
                        }
