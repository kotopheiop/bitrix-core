        ...
        <div class="adm-nav-pages-block">
            ...
            if ($this->NavPageNomer > 1) {
                ...
                <a class="adm-nav-page adm-nav-page-prev"
                   href="javascript:<? echo $this->table_id ?>.<?= $nav_func_name ?>('<? echo $sJSUrlPath . '?PAGEN_' . $this->NavNum . '=' . ($this->NavPageNomer - 1) . '&amp;SIZEN_' . $this->NavNum . '=' . $this->NavPageSize . $sQueryString; ?>');"><span
