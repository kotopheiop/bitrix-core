    ...
    <form method="POST" action="<?= $APPLICATION->GetCurPage(); ?>?lang=<?= LANGUAGE_ID; ?>"
        ...
        if ($STEP == 3) {
            ...
            foreach ($arDataFileFields as $i => $field) {
                ...
                <tr>
                    <td width="40%">
                        <b><? echo GetMessage("IBLOCK_ADM_IMP_FIELD"); ?><? echo $i + 1 ?></b>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="IMAGE_RESIZE" id="IMAGE_RESIZE"
                           value="Y" <? echo($IMAGE_RESIZE === "Y" ? "checked" : ""); ?>>
                </td>
            </tr>
            <tr>
                <td class="adm-detail-valign-top"><? echo GetMessage("IBLOCK_ADM_IMP_PROP_PATH"); ?>:</td>
                <td>
                    <input type="text" name="PATH2PROP_FILES" size="40"
                           value="<? echo htmlspecialcharsbx($PATH2PROP_FILES); ?>"><br>
            ...
            <tr>
                ...
                <td align="left">
                    <input type="text" name="max_execution_time" size="6"
                           value="<? echo htmlspecialcharsbx($max_execution_time); ?>"><br>
