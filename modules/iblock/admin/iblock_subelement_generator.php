...
if ($errorMessage) {
    ...
    echo $APPLICATION->GetCurPage() ?>?" name="iblock_generator_form" id="iblock_generator_form">
        <input type="hidden" name="lang" value="<?
        echo LANGUAGE_ID; ?>">
        <input type="hidden" name="subIBlockId" value="<?
        echo $subIBlockId ?>">
        <input type="hidden" name="subPropValue" value="<?
        echo $subPropValue ?>">
        <input type="hidden" name="iBlockId" value="<?
        echo $iBlockId ?>">
        <input type="hidden" name="findSection" value="<?
        echo $findSection ?>">
        <input type="hidden" name="subTmpId" value="<?
        echo $subTmpId ?>">
        <input type="hidden" name="PRODUCT_NAME_HIDDEN" value="<?
                    ...
                    for (var key in fileProperties) {
                        if (fileProperties.hasOwnProperty(key))
                            options[options.length] = BX.create('OPTION', {
                                    'props': {
                                        'value': fileProperties[key]["ID"],
                                        'selected': (fileProperties[key]["ID"] == 'DETAIL')
                                    },
        ...
        <tr>
            <td colspan="2" class="adm-detail-content-cell">
                        ...
                        <table width="100%" border="0" cellspacing="7" cellpadding="0">
                            <tr>
                                ...
                                <td class="adm-detail-content-cell-r" style="white-space: nowrap !important;">
                                    <input type="text" style="width: 637px;" class="adm-input" id="IB_SEG_TITLE"
                                           name="IB_SEG_TITLE">
                                    <input type="button" id="IB_SEG_ADD_PROP_IN_TITLE" title="..."
                                           value="<?= GetMessage("IB_SEG_SKU_PROPERTIES") ?>">
                                    <input type="button" id="IB_SEG_ADD_PROP_IN_TITLE2" title="..."
                                           value="<?= GetMessage("IB_SEG_PARENT_PROPERTIES") ?>">
                                    <a class="adm-input-help-icon"
                                       onmouseover="BX.hint(this, '<?= GetMessage('IB_SEG_TOOLTIP_TITLE') ?>')"
                                       href="#"></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="adm-detail-content-cell-r">
                                    ...
                                    <input type="text" id="CAT_BASE_LENGTH" name="IB_SEG_BASE_LENGTH"
                                           style="width: 120px;  margin-right: 10px">
                                    <?
                                    echo GetMessage("IB_SEG_BASE_WIDTH") ?>:
                                    <input type="text" id="CAT_BASE_WIDTH" name="IB_SEG_BASE_WIDTH"
                                           style="width: 120px;  margin-right: 10px">
                                    <?
                                    echo GetMessage("IB_SEG_BASE_HEIGHT") ?>:
                                    <input type="text" id="CAT_BASE_HEIGHT" name="IB_SEG_BASE_HEIGHT"
                                           style="width: 120px;">
                                    <a class="adm-input-help-icon"
                                       onmouseover="BX.hint(this, '<?= GetMessage('IB_SEG_TOOLTIP_WEIGHT') ?>')"
                                       href="#"></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="adm-detail-content-cell-r"><?
                                    if (!$useStoreControl) {
                                        ?><input type="text" style="width: 120px; margin-right: 10px" class="adm-input"
                                                 name="IB_SEG_QUANTITY">
                                        <? echo GetMessage('IB_SEG_MEASURE');
                                    }
                                    ?> <span class="adm-select-wrap" style="vertical-align: top;"><select
                ...
                ?>
                            ...
                            <tr>
                                <td class="adm-detail-content-cell-l"><?
                                    echo GetMessage("IB_SEG_VAT_INCLUDED") ?></td>
                                <td class="adm-detail-content-cell-r">
                                    ...
                                    <input class="adm-designed-checkbox" type="checkbox" name="IB_SEG_VAT_INCLUDED"
                                           id="IB_SEG_VAT_INCLUDED" value="Y"/>
            ...
            <td colspan="2" class="adm-detail-content-cell">
                <div class="adm-detail-content-item-block-view-tab">
                    ...
                    <div class="adm-shop-block-wrap">
						...
						<span id="ib_seg_property_add_button_span_click" class="adm-btn adm-btn-add"
                              onclick="addProperty(<?= CUtil::PhpToJSObject($arFileProperties) ?>)"></span>
					</span>
                        </div>
