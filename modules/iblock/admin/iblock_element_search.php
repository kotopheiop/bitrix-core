...
?>
    <form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>">
        ...
        if (!$iblockFix) {
            ...
            <tr>
                <td><b><?
                        echo GetMessage("IBLOCK_ELSEARCH_IBLOCK") ?></b></td>
                <td><?
                ...
                <td><input type="text" name="filter_status_id" value="<? echo htmlspecialcharsbx($filter_status_id) ?>"
                    ...
                    <select name="filter_status">
                        ...
                        while ($arRs = $rs->GetNext()) {
                            ?>
                            <option value="<?= $arRs["REFERENCE_ID"] ?>"<?
                            if ($filter_status == $arRs["~REFERENCE_ID"]) echo " selected" ?>><?= $arRs["REFERENCE"] ?></option><?
                        }
                        ?>
                    </select></td>
            </tr>
                ...
                <td>
                    <select name="filter_section">
                        ...
                        while ($arSection = $bsections->GetNext()):
                            ...
                            <option value="<?
                            echo $arSection["ID"] ?>"<?
                            if ($arSection["ID"] == $filter_section) echo " selected" ?>><?
                    ...
                    <input type="checkbox" name="filter_subsections"
                           value="Y"<? if ($filter_subsections == "Y") echo " checked" ?>> <? echo GetMessage("IBLOCK_ELSEARCH_INCLUDING_SUBSECTIONS") ?>
                ...
                <td>
                    ...
                    elseif ($prop["PROPERTY_TYPE"] == 'L'):?>
                        <select name="find_el_property_<?= $prop["ID"] ?>">
                            <option value=""><?
                                echo GetMessage("IBLOCK_VALUE_ANY") ?></option><?
                            ...
                            while ($arPEnum = $dbrPEnum->GetNext()):
                                ...
                                if (${"find_el_property_" . $prop["ID"]} == $arPEnum["ID"]) echo " selected" ?>><?= $arPEnum["VALUE"] ?></option>
                            <?
                            endwhile;
                            ?></select>
                    <?
                    elseif ($prop["PROPERTY_TYPE"] == 'G'):
                        ...
                        ?>
                        <input type="text" name="find_el_property_<?= $prop["ID"] ?>" value="<?
