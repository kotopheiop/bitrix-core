...
class CIBlockProperty extends CAllIBlockProperty
{
    function _Update($ID, $arFields, $bCheckDescription = false)
    {
        ...
        if (is_set($arFields, "MULTIPLE") && $arFields["MULTIPLE"] != $arProperty["MULTIPLE"]) {//MULTIPLE changed
            if ($arFields["MULTIPLE"] == "Y") {//MULTIPLE=Y
                $strSql = "
        ...
        if (
            ...
            if ($arFields["WITH_DESCRIPTION"] == "Y") {//WITH_DESCRIPTION=Y
