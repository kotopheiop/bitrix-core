...
<form method="post"
    ...
    ?>
    <tr class="heading">
        <td colspan="2"><?= htmlspecialcharsbx(GetMessage("IBLOCK_OPTION_SECTION_TAG_CACHE")); ?></td>
    </tr>
    <tr>
        ...
        <td style="width: 60%">
                ...
                if (!empty($currentValues['iblock_activity_dates'])) {
                    foreach ($currentValues['iblock_activity_dates'] as $iblockId) {
                        ...
                        if ($iblockName !== '') {
                            ...
                            <td>
                                <input type="button"
                                       value="<?= htmlspecialcharsbx(GetMessage("IBLOCK_MESS_DELETE_ENTITY")) ?>"
            ...
            <input type="button" value="<?= htmlspecialcharsbx(GetMessage("IBLOCK_MESS_ADD_ENTITY")); ?>"
                   onClick="jsUtils.OpenWindow('<?= $selfFolderUrl ?>iblock_search.php?lang=<?= LANGUAGE_ID ?>&amp;n=input_IBLOCK_LIST&amp;m=y&amp;iblockfix=y&amp;tableId=iblocksection-<?= $IBLOCK_ID; ?>', 900, 700);">
        </td>
    </tr>
    <tr>
    ...
    <tr id="iblock_activity_dates_period_custom"
        style="display: <?= ($currentValues['iblock_activity_dates_period'] == -1 ? 'table-row' : 'none'); ?>;">
