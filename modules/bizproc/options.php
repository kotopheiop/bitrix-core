...
//	array("name_template", GetMessage("BIZPROC_NAME_TEMPLATE"), "", Array("select", 35))
    ...
    $tabControl->Begin();
    ?>
    <form method="POST" name="bizproc_opt_form"
        ...
        <input type="submit" class="adm-btn-save" <? if ($bizprocPerms < "W") echo "disabled" ?> name="Update"
               value="<? echo GetMessage("MAIN_SAVE") ?>">
        <input type="hidden" name="Update" value="Y">
        <input type="reset" name="reset" value="<? echo GetMessage("MAIN_RESET") ?>">
        <input type="button" <? if ($bizprocPerms < "W") echo "disabled" ?>
