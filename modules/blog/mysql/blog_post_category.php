    ...
    public static function GetList(
        ...
        $arFields = array(
            ...
            "NAME" => array(
                "FIELD" => "CC.NAME",
                "TYPE" => "string",
                "FROM" => "LEFT JOIN b_blog_category CC ON (CC.ID = C.CATEGORY_ID)"
            ),
            "POST_PUBLISH_STATUS" => array(
                "FIELD" => "P.PUBLISH_STATUS",
                "TYPE" => "string",
                "FROM" => "INNER JOIN b_blog_post P ON (P.ID = C.POST_ID)"
            ),
