    ...
    while ($arSite = $dbSites->Fetch()) {
        ...
        <tr>
            ...
            <td valign="middle" width="50%">
                ...
                echo htmlspecialcharsbx($arPaths[$arSite["LID"]]) ?>" name="SITE_PATH_<?= $arSite["LID"] ?>">
            </td>
        </tr>
        <?
    }
