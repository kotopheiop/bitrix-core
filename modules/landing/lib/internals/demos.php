...
class DemosTable extends Entity\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'APP_CODE' => new Entity\StringField(
                'APP_CODE', array(
            ...
            'TPL_TYPE' => new Entity\StringField(
                'TPL_TYPE', array(
                'title' => Loc::getMessage('LANDING_TABLE_FIELD_DEMOS_TPL_TYPE')
            )
            ),
            'SHOW_IN_LIST' => new Entity\StringField(
                'SHOW_IN_LIST', array(
