...
if ($STAT_RIGHT >= "R"):
    ...
    $aTabs = array(
        ...
        array(
            "DIV" => "edit6",
            "TAB" => GetMessage("STAT_OPT_TAB_ADV"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_ADV_TITLE")
        ),
        array(
            "DIV" => "edit7",
            "TAB" => GetMessage("STAT_OPT_TAB_CITY"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_CITY_TITLE")
        ),
        array(
            "DIV" => "edit2",
            "TAB" => GetMessage("STAT_OPT_TAB_STORAGE"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_STORAGE_TITLE")
        ),
        array(
            "DIV" => "edit3",
            "TAB" => GetMessage("STAT_OPT_TAB_TIME"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_TIME_TITLE")
        ),
        array(
            "DIV" => "edit4",
            "TAB" => GetMessage("STAT_OPT_TAB_SKIP"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_SKIP_TITLE")
        ),
        array(
            "DIV" => "edit5",
    ...
    $aTabs = array(
        array(
            "DIV" => "fedit2",
            "TAB" => GetMessage("STAT_OPT_TAB_CLEANUP"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_CLEANUP_TITLE")
        ),
    );
    if (mb_strtolower($statDB->type) == "mysql") {
        $aTabs[] = array(
            "DIV" => "fedit3",
            "TAB" => GetMessage("STAT_OPT_TAB_OPTIMIZE"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_OPTIMIZE_TITLE")
        );
    }
    if ($STAT_RIGHT >= "W" && ($bCheckForDDL = CStatistics::CheckForDDL())) {
        $aTabs[] = array(
            "DIV" => "fedit4",
            "TAB" => GetMessage("STAT_OPT_TAB_INDEX"),
            "ICON" => "statistic_settings",
            "TITLE" => GetMessage("STAT_OPT_TAB_INDEX_TITLE")
        );
    }
    ...
    $arOPTIONS = Array(
        "TAB1" => Array(
            ...
            "STAT_LIST_TOP_SIZE" => Array(
                "STAT_LIST_TOP_SIZE",
                GetMessage("STAT_OPT_STAT_LIST_TOP_SIZE"),
                Array("text", 5)
            ),
            "ADV_DETAIL_TOP_SIZE" => Array(
                "ADV_DETAIL_TOP_SIZE",
                GetMessage("STAT_OPT_ADV_DETAIL_TOP_SIZE"),
                Array("text", 5)
            ),
            "SAVE_SESSION_DATA" => Array(
                "SAVE_SESSION_DATA",
                GetMessage("STAT_OPT_SAVE_SESSION_DATA"),
                Array("checkbox", "Y")
            ),
            "USE_AUTO_OPTIMIZE" => "",
            "BASE_CURRENCY" => "",
        ...
        "TAB2" => Array(
            ...
            "VISIT_DAYS" => Array(
                "VISIT_DAYS",
                GetMessage("STAT_OPT_TIME_VISIT_DAYS"),
                Array("text", 5),
            ...
            "PATH_DAYS" => Array(
                "PATH_DAYS",
                GetMessage("STAT_OPT_TIME_PATH_DAYS"),
                Array("text", 5),
            ...
            "PHRASES_DAYS" => Array(
                "PHRASES_DAYS",
                GetMessage("STAT_OPT_TIME_PHRASES_DAYS"),
                Array("text", 5),
                "CStatistics::CleanUpPhrases();",
                "b_stat_phrase_list"
            ),
            "REFERER_LIST_DAYS" => Array(
                "REFERER_LIST_DAYS",
                GetMessage("STAT_OPT_TIME_REFERER_LIST_DAYS"),
                Array("text", 5),
            ...
            "REFERER_DAYS" => Array(
                "REFERER_DAYS",
                GetMessage("STAT_OPT_TIME_REFERER_DAYS"),
                Array("text", 5),
            ...
            "EVENTS_DAYS" => Array(
                "EVENTS_DAYS",
                GetMessage("STAT_OPT_TIME_EVENTS_DAYS"),
                Array("text", 5),
            ...
            "EVENT_DYNAMIC_DAYS" => Array(
                "EVENT_DYNAMIC_DAYS",
                GetMessage("STAT_OPT_TIME_EVENTS_DYNAMIC_DAYS"),
                Array("text", 5),
            ...
            "ADV_GUEST_DAYS" => Array(
                "ADV_GUEST_DAYS",
                GetMessage("STAT_OPT_TIME_ADV_GUEST_DAYS"),
                Array("text", 5),
            ...
            "ADV_DAYS" => Array(
                "ADV_DAYS",
                GetMessage("STAT_OPT_TIME_ADV_DAYS"),
                Array("text", 5),
            ...
            "SEARCHER_HIT_DAYS" => Array(
                "SEARCHER_HIT_DAYS",
                GetMessage("STAT_OPT_TIME_SEARCHER_HIT_DAYS"),
                Array("text", 5),
            ...
            "SEARCHER_DAYS" => Array(
                "SEARCHER_DAYS",
                GetMessage("STAT_OPT_TIME_SEARCHER_DAYS"),
                Array("text", 5),
            ...
            "CITY_DAYS" => Array(
                "CITY_DAYS",
                GetMessage("STAT_OPT_TIME_CITY_DAYS"),
                Array("text", 5),
            ...
            "COUNTRY_DAYS" => Array(
                "COUNTRY_DAYS",
                GetMessage("STAT_OPT_TIME_COUNTRY_DAYS"),
                Array("text", 5),
            ...
            "GUEST_DAYS" => Array(
                "GUEST_DAYS",
                GetMessage("STAT_OPT_TIME_GUEST_DAYS"),
                Array("text", 5),
            ...
            "SESSION_DAYS" => Array(
                "SESSION_DAYS",
                GetMessage("STAT_OPT_TIME_SESSION_DAYS"),
                Array("text", 5),
            ...
            "HIT_DAYS" => Array(
                "HIT_DAYS",
                GetMessage("STAT_OPT_TIME_HIT_DAYS"),
                Array("text", 5),
        ...
        "TAB3" => Array(
            ...
            "SAVE_PATH_DATA" => Array(
                "SAVE_PATH_DATA",
                GetMessage("STAT_OPT_STORAGE_SAVE_PATH_DATA"),
                Array("checkbox", "Y")
            ),
            "MAX_PATH_STEPS" => Array(
                "MAX_PATH_STEPS",
                GetMessage("STAT_OPT_STORAGE_MAX_PATH_STEPS"),
                Array("text", 5)
            ),
            "IMPORTANT_PAGE_PARAMS" => Array(
                "IMPORTANT_PAGE_PARAMS",
                GetMessage("STAT_OPT_STORAGE_IMPORTANT_PAGE_PARAMS"),
                Array("text", 40)
            ),
            "DIRECTORY_INDEX" => Array(
                "DIRECTORY_INDEX",
                GetMessage("STAT_OPT_STORAGE_DIRECTORY_INDEX"),
                Array("text", 40)
            ),
            ...
            "EVENT_GID_BASE64_ENCODE" => Array(
                "EVENT_GID_BASE64_ENCODE",
                GetMessage("STAT_OPT_STORAGE_EVENT_GID_BASE64_ENCODE"),
                Array("checkbox", "Y")
            ),
            "EVENT_GID_SITE_ID" => Array(
                "EVENT_GID_SITE_ID",
                GetMessage(
                    "STAT_OPT_STORAGE2_EVENT_GID_SITE_ID",
                    array("#HREF#" => '/bitrix/admin/event_edit.php?lang=' . LANGUAGE_ID)
                ),
                Array("text", 20)
            ),
            "USER_EVENTS_LOAD_HANDLERS_PATH" => Array(
        ...
        "TAB5" => Array(
            ...
            "ADV_AUTO_CREATE" => Array(
                "ADV_AUTO_CREATE",
                GetMessage("STAT_OPT_ADV_AUTO_CREATE"),
                Array("checkbox", "Y")
            ),
            "REFERER_CHECK" => Array("REFERER_CHECK", GetMessage("STAT_OPT_REFERER_CHECK2"), Array("checkbox", "Y")),
            "SEARCHER_EVENTS" => Array(
                "SEARCHER_EVENTS",
                GetMessage("STAT_OPT_SEARCHER_EVENTS"),
                Array("checkbox", "Y")
            ),
            ...
            "OPENSTAT_ACTIVE" => Array(
                "OPENSTAT_ACTIVE",
                GetMessage("STAT_OPT_ADV_OPENSTAT_ACTIVE"),
                Array("checkbox", "N")
            ),
            "OPENSTAT_R1_TEMPLATE" => Array(
                "OPENSTAT_R1_TEMPLATE",
                GetMessage("STAT_OPT_ADV_OPENSTAT_R1_TEMPLATE"),
                Array("text", 30)
            ),
            "OPENSTAT_R2_TEMPLATE" => Array(
                "OPENSTAT_R2_TEMPLATE",
                GetMessage("STAT_OPT_ADV_OPENSTAT_R2_TEMPLATE"),
                Array("text", 30)
            ),
        ),
    );
            ...
            if ($SKIP_STATISTIC_WHAT == 'groups' || $SKIP_STATISTIC_WHAT == 'both') {
                if (count($arSKIP_STATISTIC_GROUPS) < 1) {
                    ...
                    COption::SetOptionString(
                        $module_id,
                        "SKIP_STATISTIC_GROUPS",
                        implode(",", $arSKIP_STATISTIC_GROUPS)
                    );
                }
            } else {
    ...
    if ($optimize <> '' && $REQUEST_METHOD == "POST" && $STAT_RIGHT >= "W" && check_bitrix_sessid()) {
        set_time_limit(0);
        ignore_user_abort(true);
        $fname = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/statistic/install/db/" . mb_strtolower(
                $statDB->type
            ) . "/optimize.sql";
    ...
    $tabControl->Begin();
    ?>
    <form name="form_settings" method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?mid=<?= htmlspecialcharsbx(
        $mid
    ) ?>&amp;lang=<?= LANGUAGE_ID ?>">
            ...
            if (!is_array($Option)):
                if ($key == "USE_AUTO_OPTIMIZE" && mb_strtolower($statDB->type) == "mysql"):?>
                    <tr>
                        ...
                        <td nowrap><input type="checkbox" name="<?= $key ?>" id="<?= $key ?>"
                                          value="Y" <? if (${$key} == "Y") {
                                echo "checked";
                            } ?>></td>
                    </tr>
                <? elseif ($key == "BASE_CURRENCY" && CModule::IncludeModule("currency")):?>
                    <tr>
                        ...
                        <td><? echo CCurrency::SelectBox("BASE_CURRENCY", $BASE_CURRENCY, " ", true, "") ?><br>
                            <input type="checkbox" name="recount_base_currency" id="recount_base_currency"
                                   value="Y"><label for="recount_base_currency"><? echo GetMessage(
                                    "STAT_OPT_DO_RECOUNT"
                                ) ?></label></td>
                    </tr>
                <?endif;
                ...
                ?>
                <tr>
                    <td <? if ($type[0] == "textarea") echo 'class="adm-detail-valign-top"' ?>><label
                                for="<? echo htmlspecialcharsbx($Option[0]) ?>"><? echo $Option[1] ?></label></td>
                    <td nowrap>
                        <? if ($type[0] == "checkbox"):?>
        ...
        <? if (CModule::IncludeModule("fileman")):?>
            <tr>
                <td align="center" colspan=2>[ <a
                            href="/bitrix/admin/fileman_file_edit.php?lang=<?= LANGUAGE_ID ?>&amp;full_src=Y&amp;path=%2Fbitrix%2Factivity_limit.php"><? echo GetMessage(
                            "STAT_OPT_GRABBER_EDIT_503_TEMPLATE_LINK"
                        ) ?></a> ]
                </td>
            </tr>
        <? endif; ?>
        <tr>
            ...
            <td><? echo InputType(
                    ...
                    false,
                    "",
                    "OnClick=\"ChangeDefenceSwitch()\" id=\"DEFENCE_ON\""
                ) ?></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("STAT_OPT_DEFENCE_DELAY") ?></td>
            <td><input size="3" type="text" name="DEFENCE_DELAY" id="DEFENCE_DELAY"
                       value="<?= htmlspecialcharsbx($DEFENCE_DELAY) ?>">&nbsp;<? echo GetMessage(
                    "STAT_OPT_DEFENCE_DELAY_MEASURE_SEC"
                ) ?></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("STAT_OPT_DEFENCE_STACK_TIME") ?></td>
            <td><input size="3" type="text" name="DEFENCE_STACK_TIME" id="DEFENCE_STACK_TIME"
                       value="<?= htmlspecialcharsbx($DEFENCE_STACK_TIME) ?>">&nbsp;<? echo GetMessage(
                    "STAT_OPT_DEFENCE_STACK_TIME_MEASURE_SEC"
                ) ?></td>
        </tr>
        <tr>
            <td nowrap><? echo GetMessage("STAT_OPT_DEFENCE_MAX_STACK_HITS") ?></td>
            <td><input size="3" type="text" name="DEFENCE_MAX_STACK_HITS" id="DEFENCE_MAX_STACK_HITS"
                       value="<?= htmlspecialcharsbx($DEFENCE_MAX_STACK_HITS) ?>">&nbsp;<? echo GetMessage(
                    "STAT_OPT_DEFENCE_MAX_STACK_HITS_MEASURE"
                ) ?></td>
        </tr>
        <tr>
            <td nowrap><label for="DEFENCE_LOG"><? echo GetMessage(
                        "STAT_OPT_DEFENCE_LOG",
                        array("#HREF#" => "/bitrix/admin/event_log.php?lang=" . LANGUAGE_ID . "&set_filter=Y&find_type=audit_type_id&find_audit_type[]=STAT_ACTIVITY_LIMIT")
                    ) ?></label></td>
        ...
        foreach ($arOPTIONS["TAB5"] as $key => $Option):
            if (!is_array($Option)):
                    ...
                    <tr>
                        ...
                        <td nowrap width="60%"><?
                            ...
                            echo SelectBoxFromArray(
                                "ADV_EVENTS_DEFAULT",
                                $arr,
                                htmlspecialcharsbx($ADV_EVENTS_DEFAULT)
                            );
                            ?></td>
                    </tr>
                <? else:?>
                ...
                ?>
                <tr>
                    <td width="40%" <? if ($type[0] == "textarea") echo 'class="adm-detail-valign-top"' ?>><label
                                for="<? echo htmlspecialcharsbx($Option[0]) ?>"><? echo $Option[1] ?></label></td>
                    <td nowrap width="60%">
                        <? if ($type[0] == "checkbox"):?>
                            <input type="checkbox" name="<? echo htmlspecialcharsbx($Option[0]) ?>"
                ...
                <table class="internal">
                    ...
                    foreach (GetModuleEvents($module_id, "OnCityLookup", true) as $arEvent):
                        ...
                        <tr>
                            ...
                            <td style="text-align:center"><? echo $arDescr["IS_INSTALLED"] ? GetMessage(
                                    "MAIN_YES"
                                ) : GetMessage("MAIN_NO") ?></td>
                            <td style="text-align:center"><? echo $arDescr["IS_INSTALLED"] ? ($arDescr["CAN_LOOKUP_COUNTRY"] ? GetMessage(
                                    "MAIN_YES"
                                ) : GetMessage("MAIN_NO")) : "-" ?></td>
                            <td style="text-align:center"><? echo $arDescr["IS_INSTALLED"] ? ($arDescr["CAN_LOOKUP_CITY"] ? GetMessage(
                                    "MAIN_YES"
                                ) : GetMessage("MAIN_NO")) : "-" ?></td>
                            <td style="text-align:center"><input type="radio" name="IP_LOOKUP_CLASS"
                                                                 value="<? echo $arDescr["CLASS"] ?>" <? echo($arDescr["CLASS"] == $selected ? "checked" : "") ?>>
                            </td>
                        </tr>
                    <? endforeach ?>
                </table>
        ...
        foreach ($arOPTIONS["TAB3"] as $key => $Option):
            if (!is_array($Option)):
                if ($key == "BROWSERS"):?>
                    <tr>
                        <td class="adm-detail-valign-top" width="40%"><?= GetMessage(
                                "STAT_OPT_STORAGE_BROWSERS"
                            ) ?></td>
                        <td nowrap width="60%"><textarea name="BROWSERS" rows="5" cols="30"><?= htmlspecialcharsbx(
                                    $BROWSERS
                                ) ?></textarea></td>
                    </tr>
                <? else:?>
                ...
                ?>
                <tr>
                    <td <? if ($type[0] == "textarea") echo 'class="adm-detail-valign-top"' ?> width="40%"><label
                                for="<? echo htmlspecialcharsbx($Option[0]) ?>"><? echo $Option[1] ?></label></td>
                    <td nowrap width="60%">
                        <? if ($type[0] == "checkbox"):?>
                            <input type="checkbox" name="<? echo htmlspecialcharsbx($Option[0]) ?>"
                    ...
                    <td nowrap width="60%">
                        <? if ($type[0] == "text"):
                            ...
                            <input type="text" size="<? echo $type[1] ?>" maxlength="255"
                                   ...
                                   name="<? echo htmlspecialcharsbx($Option[0]) ?>"><?
                            if ($Option[3] <> ''):?>
                                &nbsp;<label for="<? echo htmlspecialcharsbx($Option[0]) ?>_clear"><? echo GetMessage(
                                        "STAT_OPT_TIME_CLEAR"
                                    ) ?>:</label>&nbsp;<input type="checkbox"
                                                              name="<? echo htmlspecialcharsbx($Option[0]) ?>_clear"
                                                              id="<? echo htmlspecialcharsbx($Option[0]) ?>_clear"
                                                              value="Y">
                            <?endif; ?>
                            <? if ($Option[4] <> ''):?>
            ...
            if (!is_array($Option)):
                if ($key == "SKIP_STATISTIC_WHAT"):?>
                    <tr>
                        ...
                        <td width="60%">
                            <input type="radio" name="SKIP_STATISTIC_WHAT" id="SKIP_STATISTIC_WHAT_none" value="none"
                                   OnClick="manageSkip('none')"<?= $SKIP_STATISTIC_WHAT == "none" ? " checked" : "" ?>><label
                                    for="SKIP_STATISTIC_WHAT_none"><?= GetMessage("STAT_OPT_SKIP_NONE") ?></label><br>
                            <input type="radio" name="SKIP_STATISTIC_WHAT" id="SKIP_STATISTIC_WHAT_groups"
                                   value="groups"
                                   OnClick="manageSkip('groups')"<?= $SKIP_STATISTIC_WHAT == "groups" ? " checked" : "" ?>><label
                                    for="SKIP_STATISTIC_WHAT_groups"><?= GetMessage(
                                    "STAT_OPT_SKIP_GROUPS"
                                ) ?></label><br>
                            <input type="radio" name="SKIP_STATISTIC_WHAT" id="SKIP_STATISTIC_WHAT_ranges"
                                   value="ranges"
                                   OnClick="manageSkip('ranges')"<?= $SKIP_STATISTIC_WHAT == "ranges" ? " checked" : "" ?>><label
                                    for="SKIP_STATISTIC_WHAT_ranges"><?= GetMessage(
                                    "STAT_OPT_SKIP_RANGES"
                                ) ?></label><br>
                            <input type="radio" name="SKIP_STATISTIC_WHAT" id="SKIP_STATISTIC_WHAT_both" value="both"
                                   OnClick="manageSkip('both')"<?= $SKIP_STATISTIC_WHAT == "both" ? " checked" : "" ?>><label
                                    for="SKIP_STATISTIC_WHAT_both"><?= GetMessage("STAT_OPT_SKIP_BOTH") ?></label><br>
                        </td>
                    </tr>
                <?
                elseif ($key == "SKIP_STATISTIC_GROUPS"):
                    ...
                    ?>
                    <tr>
                        <td class="adm-detail-valign-top" width="40%"><?= GetMessage("STAT_OPT_SKIP_GROUPS_LABEL") ?>
                            :<br><img src="/bitrix/images/statistic/mouse.gif" width="44" height="21" border=0 alt="">
                        </td>
                        <td nowrap width="60%"><?= SelectBoxMFromArray(
                ...
                <? elseif ($key == "SKIP_STATISTIC_IP_RANGES"):?>
                    <tr>
                        <td class="adm-detail-valign-top" width="40%"><?= GetMessage("STAT_OPT_SKIP_RANGES_LABEL") ?>:
                        </td>
                        <td nowrap width="60%"><textarea name="SKIP_STATISTIC_IP_RANGES" rows="5"
                                                         cols="30"><?= htmlspecialcharsbx(
                                    $SKIP_STATISTIC_IP_RANGES
                                ) ?></textarea><br>
        ...
        <? require_once($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/admin/group_rights.php"); ?>
        <? $tabControl->Buttons(); ?>
        <input <? if ($STAT_RIGHT < "W") echo "disabled" ?> type="submit" name="Update"
                                                            value="<?= GetMessage("MAIN_SAVE") ?>"
                                                            title="<?= GetMessage("MAIN_OPT_SAVE_TITLE") ?>"
                                                            class="adm-btn-save">
        <input <? if ($STAT_RIGHT < "W") echo "disabled" ?> type="submit" name="Apply"
                                                            value="<?= GetMessage("MAIN_OPT_APPLY") ?>"
                                                            title="<?= GetMessage("MAIN_OPT_APPLY_TITLE") ?>">
        <? if ($_REQUEST["back_url_settings"] <> ''):?>
            <input <? if ($STAT_RIGHT < "W") echo "disabled" ?> type="button" name="Cancel"
        ...
        <? endif ?>
        <input <? if ($STAT_RIGHT < "W") echo "disabled" ?> type="submit" name="RestoreDefaults"
                                                            title="<? echo GetMessage("MAIN_HINT_RESTORE_DEFAULTS") ?>"
                                                            OnClick="return confirm('<? echo GetMessageJS(
                                                                "MAIN_HINT_RESTORE_DEFAULTS_WARNING"
                                                            ) ?>')"
    ...
    <form name="cleanupform" method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?mid=<?= htmlspecialcharsbx(
        $mid
    ) ?>&amp;lang=<?= LANGUAGE_ID ?>">
        <? $tabControl2->BeginNextTab(); ?>
        <tr>
            <td width="40%" nowrap><? echo GetMessage("STAT_OPT_CLEANUP_DATE2") ?></td>
            <td width="60%"><? echo CalendarDate(
                    "cleanup_date",
                    htmlspecialcharsbx($cleanup_date),
                    "cleanupform",
                    "10"
                ) ?></td>
        </tr>
        <tr>
            <td align="left" colspan="2"><input type="button" <? if ($STAT_RIGHT < "W") echo "disabled" ?>name="cleanup"
                                                value="<? echo GetMessage("STAT_OPT_CLEANUP_BUTTON") ?>"
                                                OnClick="javascript: CleanUpSubmit();"><input type="hidden"
                                                                                              name="cleanup"
                                                                                              value="Y"><input
                        type="hidden" name="lang" value="<?= LANGUAGE_ID ?>"></td>
        </tr>
        <? $tabControl2->EndTab(); ?>
        <script language="JavaScript">
    ...
    <? if (mb_strtolower($statDB->type) == "mysql"):?>
    <form name="optimizeform" method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?mid=<?= htmlspecialcharsbx(
        $mid
    ) ?>&amp;lang=<?= LANGUAGE_ID ?>">
        <? $tabControl2->BeginNextTab(); ?>
        <tr>
            <td align="left" colspan="2">
                <input type="button" <? if ($STAT_RIGHT < "W") echo "disabled" ?> name="cleanup"
                       value="<? echo GetMessage("STAT_OPT_OPTIMIZE_BUTTON") ?>"
                       OnClick="javascript: OptimizeSubmit();"><input type="hidden" name="optimize" value="Y"><input
                        type="hidden" name="lang" value="<?= LANGUAGE_ID ?>">
                <SCRIPT LANGUAGE="JavaScript">
                    function OptimizeSubmit() {
                        if (confirm('<?=GetMessageJS(
                            "STAT_OPT_OPTIMIZE_CONFIRMATION"
                        )?>')) document.optimizeform.submit();
                    }
                </SCRIPT>
            </td>
        </tr>
    ...
    <form name="optimizeform" method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?mid=<?= htmlspecialcharsbx(
        ...
        <tr>
            <td align="left" colspan="2">
                ...
                <span class="required"><? echo GetMessage("STAT_OPT_INDEX_ATTENTION") ?></span> - <? echo GetMessage(
