                ...
                if ($key == "USE_AUTO_OPTIMIZE" && strtolower($statDB->type) == "mysql"):?>
                    <tr>
                        ...
                        <td nowrap><input type="checkbox" name="<?= $key ?>" id="<?= $key ?>"
                                          value="Y" <? if (${$key} == "Y") echo "checked"; ?>></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><? echo CCurrency::SelectBox("BASE_CURRENCY", $BASE_CURRENCY, " ", True, "") ?><br>
                            <input type="checkbox" name="recount_base_currency" id="recount_base_currency"
                                   value="Y"><label
                                    for="recount_base_currency"><? echo GetMessage("STAT_OPT_DO_RECOUNT") ?></label>
                        </td>
                    </tr>
                <?endif;
            else:
                    ...
                    <td nowrap width="60%">
                        <? if ($type[0] == "text"):
                            ...
                            if (strlen($Option[3]) > 0):?>
                                &nbsp;<label
                                        for="<? echo htmlspecialcharsbx($Option[0]) ?>_clear"><? echo GetMessage("STAT_OPT_TIME_CLEAR") ?>
