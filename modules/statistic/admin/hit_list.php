...
$arHeaders[] = array(
    "id" => "GUEST_ID",
    "content" => GetMessage("STAT_GUEST_ID"),
    "sort" => "s_guest_id",
    "default" => false,
);
...
while ($arRes = $rsData->NavNext(true, "f_")) {
    ...
    if ($f_USER_ID > 0) :
        ...
        $str .= ($f_USER_AUTH != "Y" ? "<br><nobr><span class=\"stat_notauth\">" . GetMessage(
                "STAT_NOT_AUTH"
            ) . "</span></nobr>" : "");
    else:
    ...
    $str = "<a title=\"" . GetMessage(
            "STAT_VIEW_SESSION_LIST"
        ) . "\" href=\"guest_list.php?lang=" . LANG . "&amp;find_id=" . $f_GUEST_ID . "&amp;find_id_exact_match=Y&amp;set_filter=Y\">" . $f_GUEST_ID . "</a>";
...
$APPLICATION->SetTitle(
    GetMessage("STAT_RECORDS_LIST", array("#STATISTIC_DAYS#" => COption::GetOptionString("statistic", "HIT_DAYS")))
);
...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td><input type="text" name="find_session_id" size="30"
        ...
        <tr>
            ...
            <td valign="center">
                [&nbsp;<input type="text" name="find_country_id" size="5"
                        ...
                        type="text" name="find_country" size="50"
        ...
        <tr>
            ...
            <td valign="center">
                [&nbsp;<input type="text" name="find_city_id" size="5"
                        ...
                        type="text" name="find_city" size="50"
        ...
        <tr>
            <td>Cookie:</td>
            <td><input type="text" name="find_cookie" size="30"
                       value="<? echo htmlspecialcharsbx($find_cookie) ?>"><?= ShowExactMatchCheckbox("find_cookie") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
