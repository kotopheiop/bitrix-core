...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td><input type="text" name="find_session_id" size="30" value="<?
                echo htmlspecialcharsbx($find_session_id) ?>"><?= ShowExactMatchCheckbox("find_session_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_DATE") . ":" ?></td>
            <td width="0%" nowrap><?
        ...
        <tr>
            <td>Cookie:</td>
            <td><input type="text" name="find_cookie" size="30" value="<?
                echo htmlspecialcharsbx($find_cookie) ?>"><?= ShowExactMatchCheckbox("find_cookie") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
