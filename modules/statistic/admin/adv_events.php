    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="3">
        ...
        while ($events->NavNext(true, "f_")) :
            ...
            <tr align="left" valign="top">
                ...
                <?endif; ?>
                <? if ($find_group == "NOT_REF" || $find_group == "event1") : ?>
                    <td class="tablebody<?= $bs ?>" <? if ($find_group != "NOT_REF") echo "width='100%'" ?>><font
                                class="tablebodytext">&nbsp;<? echo $f_EVENT1 ?></font></td>
                <?endif; ?>
                <? if ($find_group == "NOT_REF" || $find_group == "event2") : ?>
                    <td class="tablebody<?= $bs ?>" <? if ($find_group != "NOT_REF") echo "width='100%'" ?>><font
                                class="tablebodytext">&nbsp;<? echo $f_EVENT2 ?></font></td>
                <?endif; ?>
                <? if ($find_group == "NOT_REF") : ?>
                ...
                <?endif; ?>
                <td align="right" class="tablebody2"><font
                            class="tablebodytext">&nbsp;<? echo $f_COUNTER_PERIOD ?></font></td>
                <td align="right" class="tablebody3"><font
                            class="tablebodytext">&nbsp;<? echo $f_COUNTER_BACK_PERIOD ?></font></td>
            </tr>
        <?
        endwhile;
        $s = "colspan=6";
