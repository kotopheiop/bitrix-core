...
<? echo BeginFilter("ADV_EVENTS", $is_filtered); ?>
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        <tr>
            ...
            <td class="tablebody"><input class="typeinput" type="text" name="find_id" size="47"
                                         value="<? echo htmlspecialchars($find_id) ?>"><?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td class="tablebody"><font class="tablefieldtext">event1:</font></td>
            <td class="tablebody"><input class="typeinput" type="text" name="find_event1" size="47"
                                         value="<? echo htmlspecialchars($find_event1) ?>"><?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr>
            <td class="tablebody"><font class="tablefieldtext">event2:</font></td>
            <td class="tablebody"><input class="typeinput" type="text" name="find_event2" size="47"
                                         value="<? echo htmlspecialchars($find_event2) ?>"><?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="right" nowrap class="tablebody">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        <td width="0%"><font class="tablebodytext"><input type="hidden" name="lang"
                                                                          value="<?= LANGUAGE_ID ?>"><input
                                        type="hidden" name="ID" value="<?= $ID ?>"><input type="hidden"
                                                                                          name="set_filter"
                                                                                          value="Y"><input
                                        class="button" type="submit" name="set_filter"
                                        value="<? echo GetMessage("STAT_F_SET_FILTER") ?>"></font></td>
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="3">
        <tr>
            ...
            <? if ($find_group == "NOT_REF") : ?>
                <td valign="top" align="center" nowrap class="tablehead2">
                    <font class="tableheadtext"><?= GetMessage("STAT_SORT") ?><br><? echo SortingEx("s_sort") ?></font>
                </td>
        ...
        while ($events->NavNext(true, "f_")) :
            ...
            <tr align="left" valign="top">
                <?
                if ($find_group == "NOT_REF") : ?>
                    <td align="center" class="tablebody1"><font class="tablebodytext">&nbsp;<?
                            echo $f_ID ?></font></td>
                <?endif; ?>
                <?
                if ($find_group == "NOT_REF" || $find_group == "event1") : ?>
                    <td class="tablebody<?= $bs ?>" <?
                    if ($find_group != "NOT_REF") echo "width='100%'" ?>><font class="tablebodytext">&nbsp;<?
                            echo $f_EVENT1 ?></font></td>
                <?endif; ?>
                <?
                if ($find_group == "NOT_REF" || $find_group == "event2") : ?>
                    <td class="tablebody<?= $bs ?>" <?
                    if ($find_group != "NOT_REF") echo "width='100%'" ?>><font class="tablebodytext">&nbsp;<?
                            echo $f_EVENT2 ?></font></td>
                <?endif; ?>
                <?
                if ($find_group == "NOT_REF") : ?>
                    <td class="tablebody2"><font class="tablebodytext">&nbsp;<?
                            echo $f_C_SORT ?></font></td>
                    <td class="tablebody2"><font class="tablebodytext">&nbsp;<?
                            echo $f_NAME ?></font></td>
                    <td class="tablebody2"><font class="tablebodytext">&nbsp;<?
                            echo $f_DESCRIPTION ?></font></td>
                <?endif; ?>
                <td align="right" class="tablebody2"><font class="tablebodytext">&nbsp;<?
                        echo $f_COUNTER_PERIOD ?></font></td>
                <td align="right" class="tablebody3"><font class="tablebodytext">&nbsp;<?
                        echo $f_COUNTER_BACK_PERIOD ?></font></td>
            </tr>
        <?
        endwhile;
        $s = "colspan=6";
