...
?>
    ...
    <form method="POST" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td width="60%"><input type="text" name="EVENT1" size="20" maxlength="200" value="<? echo $str_EVENT1 ?>">
            </td>
        </tr>
        <tr class="adm-detail-required-field">
            <td>event2:</td>
        ...
        <tr>
            ...
            <td><textarea class="typearea" name="DESCRIPTION" cols="50" rows="6"><? echo $str_DESCRIPTION ?></textarea>
            </td>
        </tr>
        <?
        $tabControl->Buttons(
