...
?>
    ...
    <form method="POST" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td width="60%"><input type="text" name="EVENT1" size="20" maxlength="200" value="<?
                echo $str_EVENT1 ?>"></td>
        </tr>
        <tr class="adm-detail-required-field">
            <td>event2:</td>
            <td><input type="text" name="EVENT2" size="20" maxlength="200" value="<?
                echo $str_EVENT2 ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_ADV_VISIBLE", array("#LANG#" => LANG)); ?></td>
            <td><?
                echo InputType("checkbox", "ADV_VISIBLE", "Y", $str_ADV_VISIBLE, false); ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_PIE_CHART") ?></td>
            <td><?
                echo InputType("checkbox", "DIAGRAM_DEFAULT", "Y", $str_DIAGRAM_DEFAULT, false) ?></td>
        </tr>
        <tr>
            <td><? echo GetMessage("STAT_KEEP_DAYS") ?></td>
            <td><input type="text" name="KEEP_DAYS" size="5" value="<?
                echo $str_KEEP_DAYS ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_DYNAMIC_KEEP_DAYS") ?></td>
            <td><input type="text" name="DYNAMIC_KEEP_DAYS" size="5" value="<?
                echo $str_DYNAMIC_KEEP_DAYS ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_SORT") ?></td>
            <td><input type="text" name="C_SORT" size="5" value="<?
                echo $str_C_SORT ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_NAME") ?></td>
            <td><input type="text" name="NAME" size="50" maxlength="50" value="<?
                echo $str_NAME ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_DESCRIPTION") ?></td>
            <td><textarea class="typearea" name="DESCRIPTION" cols="50" rows="6"><?
