...
?>
    <form name="find_form" method="get" action="<? echo $APPLICATION->GetCurPage(); ?>">
        ...
        <tr>
            ...
            <td>
                <input type="text" size="25" name="find" value="<? echo htmlspecialcharsbx($find) ?>"
                       title="<?= GetMessage("STAT_F_FIND_ENTER") ?>">
                <?
                $arr = array(
                    "reference" => array(
                        "event1",
        ...
        <tr>
            <td>event3:</td>
            <td><input type="text" name="find_event3" size="47"
                       value="<? echo htmlspecialcharsbx($find_event3) ?>"><?= ShowExactMatchCheckbox("find_event3") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="find_adv_id" size="47"
        ...
        <tr>
            ...
            <td><input type="text" name="find_hit_id" size="47"
                       value="<? echo htmlspecialcharsbx($find_hit_id) ?>"><?= ShowExactMatchCheckbox("find_hit_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
