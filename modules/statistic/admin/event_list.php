    ...
    echo $APPLICATION->GetCurPage(); ?>">
        ...
        <tr>
            ...
            <td>
                ...
                echo htmlspecialcharsbx($find) ?>" title="<?= GetMessage("STAT_F_FIND_ENTER") ?>">
                <?
                $arr = array(
                    "reference" => array(
                        "event1",
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_EVENT_ID") ?>:
            </td>
            <td><input type="text" name="find_event_id" size="47" value="<?
                echo htmlspecialcharsbx($find_event_id) ?>"><?= ShowExactMatchCheckbox("find_event_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_EVENT_TYPE_NAME") ?>:
            </td>
            <td><input type="text" name="find_event_name" size="47" value="<?
                echo htmlspecialcharsbx($find_event_name) ?>"><?= ShowExactMatchCheckbox("find_event_name") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td>event1 / event2:</td>
            <td><input type="text" name="find_event1" size="14" value="<?
                echo htmlspecialcharsbx($find_event1) ?>">&nbsp;/&nbsp;<input type="text" name="find_event2" size="14"
                                                                              value="<?
                                                                              echo htmlspecialcharsbx($find_event2) ?>"><?= ShowExactMatchCheckbox("find_event12") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td>event3:</td>
            <td><input type="text" name="find_event3" size="47" value="<?
                echo htmlspecialcharsbx($find_event3) ?>"><?= ShowExactMatchCheckbox("find_event3") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
            ...
            <td><?
                echo CalendarPeriod("find_date1", $find_date1, "find_date2", $find_date2, "find_form", "Y") ?></font></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_SESSION_ID") ?>:
            </td>
            <td><input type="text" name="find_session_id" size="47" value="<?
                echo htmlspecialcharsbx($find_session_id) ?>"><?= ShowExactMatchCheckbox("find_session_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
            ...
            <td><input type="text" name="find_guest_id" size="47" value="<?
        ...
        <tr>
            ...
            <td>[&nbsp;<input type="text" name="find_country_id" size="5" value="<?
                echo htmlspecialcharsbx($find_country_id) ?>">&nbsp;]&nbsp;&nbsp;&nbsp;<input type="text"
                                                                                              name="find_country"
                                                                                              size="34" value="<?
                echo htmlspecialcharsbx($find_country) ?>"><?= ShowExactMatchCheckbox("find_country") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_ADV_ID") ?>:
            </td>
            <td><input type="text" name="find_adv_id" size="47" value="<?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_HIT_ID") ?>:
            </td>
            <td><input type="text" name="find_hit_id" size="47" value="<?
                echo htmlspecialcharsbx($find_hit_id) ?>"><?= ShowExactMatchCheckbox("find_hit_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_REFERER_URL") ?>:
            </td>
            <td><?
                echo SelectBoxFromArray("find_referer_site_id", $arSiteDropdown, $find_referer_site_id, GetMessage("STAT_D_SITE"));
                ?>&nbsp;<input type="text" name="find_referer_url" size="34" value="<?
                echo htmlspecialcharsbx($find_referer_url) ?>"><?= ShowExactMatchCheckbox("find_referer_url") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_URL") ?>:
            </td>
            <td><?
                echo SelectBoxFromArray("find_site_id", $arSiteDropdown, $find_site_id, GetMessage("STAT_D_SITE"));
                ?>&nbsp;<input type="text" name="find_url" size="34" value="<?
        ...
        <tr>
            ...
            <td><input type="text" name="find_redirect_url" size="47" value="<?
                echo htmlspecialcharsbx($find_redirect_url) ?>"><?= ShowExactMatchCheckbox("find_redirect_url") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <?
        if ($STAT_RIGHT > "M"): ?>
            <tr>
                ...
                <td><input type="text" maxlength="10" name="find_money1" value="<?
                    echo htmlspecialcharsbx($find_money1) ?>" size="9"><?
                    echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" maxlength="10"
                                                                                name="find_money2" value="<?
                    echo htmlspecialcharsbx($find_money2) ?>" size="9"></td>
            </tr>
            <?
            if ($currency_module == "Y") : ?>
                <tr>
