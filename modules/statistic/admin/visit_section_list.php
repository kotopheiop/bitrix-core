        ...
        <table cellpadding="0" cellspacing="0" border="0" class="graph" align="center">
            <tr>
                <td>
                    ...
                    <img class="graph" src="<?
                    echo htmlspecialcharsbx("visit_section_diagram.php?lang=" . LANG . "
                        ...
                        foreach ($arrPages as $key => $arVal):
                            ...
                            <tr>
                                ...
                                <td class="number"><a href="<?
                                    echo htmlspecialcharsbx("hit_list.php?lang=" . LANG . "&find_url=" . urlencode($arVal["URL"] . "%") . "&find_url_exact_match=Y&set_filter=Y") ?>"><?
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap><?
                ...
                ?>&nbsp;<input type="text" name="find_section" size="37" value="<?
                echo htmlspecialcharsbx($find_section) ?>"><?= ShowExactMatchCheckbox("find_section") ?>
...
echo BeginNote(); ?>
    <table border="0" width="100%" cellspacing="1" cellpadding="3">
        <tr>
            <td nowrap><?
                echo GetMessage("STAT_ATTENTION") ?>&nbsp;!<br><?
                echo GetMessage("STAT_ATTENTION_GOTO") ?></td>
        </tr>
    </table>
<?
echo EndNote(); ?>
