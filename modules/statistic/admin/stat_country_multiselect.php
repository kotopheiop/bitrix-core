...
?>
    ...
    echo $APPLICATION->GetCurPage(); ?>">
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_COUNTRY_MSEL_ID") ?></td>
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_COUNTRY_MSEL_SHORT_NAME") ?></td>
            <td><input type="text" name="find_id" size="47" value="<?
                echo htmlspecialcharsbx($find_short_name) ?>"><?= ShowExactMatchCheckbox("find_short_name") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_COUNTRY_MSEL_NAME") ?></td>
            <td><input type="text" name="find_id" size="47" value="<?
