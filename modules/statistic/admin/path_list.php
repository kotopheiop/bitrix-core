                    ...
                    if (strlen($page) > 0) :
                        ...
                        <tr>
                            ...
                            <td nowrap><a title="<?= GetMessage("STAT_GO") ?>" href="<?= htmlspecialcharsbx($page) ?>">&raquo;</a>&nbsp;<?
                                ...
                                echo htmlspecialcharsbx($action_js) ?>"><?
                                    if ($err_404 == "Y"):
                                        ?><span class="stat_attention"><?
                                        echo htmlspecialcharsEx(TruncateText($page, 65)) ?></span><?
                                    else:
                            ...
                            <td nowrap align="right" width="15%"><span
                                        title="<?= $alt ?>">&nbsp;<?= ($i > 1) ? $percent_f . "%" : "" ?></span></td>
                        </tr>
                    <?
                    endif;
                endforeach;
...
?>
    ...
    echo $APPLICATION->GetCurPage() ?>">
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_STEPS") ?>:
            </td>
            <td><input type="text" name="find_steps1" size="10" value="<?
                echo htmlspecialcharsbx($find_steps1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_steps2" size="10"
                                                                            value="<?
                                                                            echo htmlspecialcharsbx($find_steps2) ?>">
            </td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_FIRST_PAGE") ?>:
            </td>
            <td width="0%" nowrap><?
                ...
                ?>&nbsp;<input type="text" name="find_first_page" size="37" value="<?
                echo htmlspecialcharsbx($find_first_page) ?>"><?= ShowExactMatchCheckbox("find_first_page") ?>
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap><?
                ...
                ?>&nbsp;<input type="text" name="find_page" size="37" value="<?
                echo htmlspecialcharsbx($find_page) ?>">&nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
            ...
            <td width="0%" nowrap><?
                ...
                ?>&nbsp;<input type="text" name="find_last_page" size="37" value="<?
                echo htmlspecialcharsbx($find_last_page) ?>"><?= ShowExactMatchCheckbox("find_last_page") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="top">
            ...
            <td width="100%" nowrap>
                ...
                <br>
                <input type="button" OnClick="selectEventType('find_form','find_adv[]')"
                       value="<?= GetMessage("MAIN_ADMIN_MENU_ADD") ?>...">&nbsp;
                <input type="button" OnClick="jsSelectUtils.deleteSelectedOptions('find_adv[]');"
                       value="<?= GetMessage("MAIN_ADMIN_MENU_DELETE") ?>">
            </td>
        </tr>
        <tr valign="top">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_ADV_DATA_TYPE") ?>:
            </td>
            <td width="0%" nowrap><?
                $arr = array(
                    "reference" => array(
