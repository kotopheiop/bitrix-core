...
while ($arRes = $rsData->NavNext(true, "f_")) {
    ...
    $txt = "[<a title=\"" . GetMessage(
            "STAT_SRCH_LIST"
        ) . "\" href=\"searcher_list.php?lang=" . LANGUAGE_ID . "&amp;find_id=$f_SEARCHER_ID&amp;find_id_exact_match=Y&amp;set_filter=Y\">$f_SEARCHER_ID</a>]&nbsp;$f_SEARCHER_NAME";
    $row->AddViewField("SEARCHER_ID", $txt);

    $row->AddViewField("USER_AGENT", TxtToHTML($f_USER_AGENT));

    $arr = explode(".", $f_IP);
    $txt = GetWhoisLink($f_IP) . " [<a title=\"" . GetMessage(
            "STAT_ADD_TO_STOPLIST_TITLE"
        ) . "\" href=\"stoplist_edit.php?lang=" . LANGUAGE_ID . "&amp;net1=$arr[0]&amp;net2=$arr[1]&amp;net3=$arr[2]&amp;net4=$arr[3]\">" . GetMessage(
            "STAT_STOP"
        ) . "</a>]";
...
$APPLICATION->SetTitle(
    GetMessage(
        "STAT_RECORDS_LIST",
        array("#STATISTIC_DAYS#" => COption::GetOptionString("statistic", "SEARCHER_HIT_DAYS"))
    )
);
...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td><input type="text" name="find_searcher" size="67"
        ...
        <tr>
            ...
            <td><input type="text" name="find_id" size="67"
        ...
        <tr>
            ...
            <td><input type="text" name="find_user_agent" size="67"
        ...
        <tr>
            ...
            <td><input type="text" name="find_ip" size="67"
