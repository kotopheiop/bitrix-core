    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td><input type="text" name="find_searcher" size="67"
                       value="<? echo htmlspecialcharsbx($find_searcher) ?>"><?= ShowExactMatchCheckbox("find_searcher") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?>
                <br><? echo SelectBox("find_searcher_id", CSearcher::GetDropDownList(), GetMessage("MAIN_ALL"), htmlspecialcharsbx($find_searcher_id)); ?>
            </td>
        </tr>
        <tr>
