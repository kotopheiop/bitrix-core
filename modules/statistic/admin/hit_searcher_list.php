...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td nowrap><b><?
                    echo GetMessage("STAT_F_SEARCH_SYSTEM") ?></b></td>
            <td><input type="text" name="find_searcher" size="67" value="<?
                echo htmlspecialcharsbx($find_searcher) ?>"><?= ShowExactMatchCheckbox("find_searcher") ?>
        ...
        <tr>
            ...
            <td><input type="text" name="find_id" size="67" value="<?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_PAGE") ?></td>
            <td><?
        ...
        <tr>
            ...
            <td><input type="text" name="find_user_agent" size="67" value="<?
                echo htmlspecialcharsbx($find_user_agent) ?>"><?= ShowExactMatchCheckbox("find_user_agent") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_IP") ?></td>
            <td><input type="text" name="find_ip" size="67" value="<?
