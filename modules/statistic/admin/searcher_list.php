...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td width="0%" nowrap><b><?
                    echo GetMessage("STAT_F_NAME") ?></b></td>
            <td width="0%" nowrap><input type="text" name="find_name" value="<?
                echo htmlspecialcharsbx($find_name) ?>" size="47"><?= ShowExactMatchCheckbox("find_name") ?>
        ...
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_STATICS") ?></td>
            <td width="0%" nowrap><?
                $arr = array("reference" => array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id" => array("Y", "N"));
        ...
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_PIE_CHART") ?></td>
            <td width="0%" nowrap><?
                $arr = array("reference" => array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id" => array("Y", "N"));
        ...
        <tr>
            ...
            <td width="0%" nowrap><input type="text" maxlength="10" name="find_hits1" value="<?
                echo htmlspecialcharsbx($find_hits1) ?>" size="9"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" maxlength="10" name="find_hits2"
                                                                            value="<?
        ...
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_LAST_HIT_DATE") . ":" ?></td>
            <td width="0%" nowrap><?
        ...
        <tr>
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_USER_AGENT") ?></td>
