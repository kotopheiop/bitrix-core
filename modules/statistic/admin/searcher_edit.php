...
?>
    ...
    <form method="POST" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr>
            ...
            <td><?
                echo InputType("checkbox", "CHECK_ACTIVITY", "Y", $str_CHECK_ACTIVITY, false) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?
                echo InputType("checkbox", "DIAGRAM_DEFAULT", "Y", $str_DIAGRAM_DEFAULT, false) ?></td>
        </tr>
        <tr>
            <td><? echo GetMessage("STAT_HIT_KEEP_DAYS") ?></td>
            <td><input type="text" name="HIT_KEEP_DAYS" size="5" value="<?
                echo $str_HIT_KEEP_DAYS ?>"></td>
        </tr>
        <tr>
            <td><? echo GetMessage("STAT_DYNAMIC_KEEP_DAYS") ?></td>
            <td><input type="text" name="DYNAMIC_KEEP_DAYS" size="5" value="<?
                echo $str_DYNAMIC_KEEP_DAYS ?>"></td>
        </tr>
        <tr class="adm-detail-required-field">
            <td><? echo GetMessage("STAT_NAME") ?></td>
            <td><input type="text" name="NAME" size="40" maxlength="50" value="<?
                echo $str_NAME ?>"></td>
        </tr>
        <tr>
            <td><? echo GetMessage("STAT_USER_AGENT") ?></td>
            <td><input type="text" name="USER_AGENT" size="40" maxlength="500" value="<?
                echo $str_USER_AGENT ?>"></td>
        </tr>
        <tr>
                ...
                <table border="0" cellspacing="1" cellpadding="0">
                    ...
                    while ($arDomain = $rs->GetNext()):
                        ...
                        <tr>
                            <td><input type="hidden" name="PARAM[]" value="<?
                                echo $i ?>"><input type="hidden" name="PARAM_ID_<?
                                echo $i ?>" value="<?
                                echo $arDomain["ID"] ?>"><input type="text" name="DOMAIN_<?
                                echo $i ?>" value="<?
                                echo $arDomain["DOMAIN"] ?>" size="30"></td>
                            <td><input type="text" name="VARIABLE_<?
                                echo $i ?>" value="<?
                                echo $arDomain["VARIABLE"] ?>" size="10"></td>
                            <td><input type="text" name="CHAR_SET_<?
                                echo $i ?>" value="<?
                                echo $arDomain["CHAR_SET"] ?>" size="20"></td>
                        </tr>
                        <?
                        $i++;
                    endwhile;
                    ...
                    while ($i <= $count) :
                        ...
                        <tr>
                            <td><input type="hidden" name="PARAM[]" value="<?
                                echo $i ?>"><input type="hidden" name="PARAM_ID_<?
                                echo $i ?>" value="0"><input type="text" name="DOMAIN_<?
                                echo $i ?>" size="30" value="<?
                                echo htmlspecialcharsbx(${"DOMAIN_" . $i}) ?>"></td>
                            <td><input type="text" name="VARIABLE_<?
                                echo $i ?>" size="10" value="<?
                                echo htmlspecialcharsbx(${"VARIABLE_" . $i}) ?>"></td>
                            <td><input type="text" name="CHAR_SET_<?
                                echo $i ?>" size="20" value="<?
                                echo htmlspecialcharsbx(${"CHAR_SET_" . $i}) ?>"></td>
                        </tr>
                        <?
                        $i++;
                    endwhile;
