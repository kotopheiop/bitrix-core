                                ...
                                <table border="0" cellspacing="0" cellpadding="0" class="legend">
                                    ...
                                    foreach ($arrLegend as $keyL => $arrL):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                [<a class="stat_link" href="<?
                                                echo htmlspecialcharsbx("/bitrix/admin/event_type_list.php?lang=" . urlencode(LANGUAGE_ID) . "&find_id=" . urlencode($keyL) . "&set_filter=Y") ?>"><?= $keyL ?></a>]&nbsp;<a
                                                        class="stat_link" title="<?
                                                echo GetMessage("STAT_EVENT_DYNAMIC") ?>" href="<?
                                                echo htmlspecialcharsbx("/bitrix/admin/event_dynamic_list.php?lang=" . urlencode(LANGUAGE_ID) . "&find_event_id=" . urlencode($keyL) . "&find_date1=" . urlencode($arFilter["DATE1"]) . "&find_date2=" . urlencode($arFilter["DATE2"]) . "&set_filter=Y") ?>"><?= htmlspecialcharsEx($arrL["NAME"]) ?></a>
                                            </td>
                                        </tr>
                                    <?endforeach; ?>
                                </table>
...
?>
    ...
    <form name="find_form" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="set_filter"
                                          ...
                                          title="<?= GetMessage("STAT_F_FIND_TITLE") ?>" onClick="<?
        ...
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="del_filter"
                                          ...
                                          title="<?= GetMessage("STAT_F_CLEAR_TITLE") ?>" onClick="<?
            echo htmlspecialcharsbx("jsSelectUtils.selectAllOptions('find_events[]');jsSelectUtils.deleteSelectedOptions('find_events[]');" . $oFilter->id . ".OnClear('" . CUtil::JSEscape($sTableID) . "', '" . CUtil::JSEscape($APPLICATION->GetCurPage() . "?lang=" . LANG . "&") . "'); return false;") ?>"></span>
