                        ...
                        foreach ($arrTime as $key):
                            ...
                            <tr>
                                ...
                                <td align="right" nowrap
                                    class="number"><? echo sprintf("%01.2f", $procent) . "%" ?></td>
    ...
    <div class="graph">
        ...
        <table cellspacing="0" cellpadding="0" class="graph" border="0" align="center">
            <tr>
                <td valign="center" class="graph">
                    <img class="graph"
                         src="/bitrix/admin/attentiveness_graph.php?find_date1=<? echo urlencode($find_date1) ?>&find_date2=<?= urlencode($find_date2) ?>&find_site_id=<?= urlencode($find_site_id) ?>&width=<?= $width ?>&height=<?= $height ?>&lang=<?= LANGUAGE_ID ?>"
                         width="<?= $width ?>" height="<?= $height ?>">
                </td>
            </tr>
        </table>
                        ...
                        foreach ($arrHits as $key):
                            ...
                            <tr>
                                ...
                                <td align="right" nowrap class="number">(<a
                                            href="/bitrix/admin/session_list.php?find_hits1=<?= $hits1 ?>&find_hits2=<?= $hits2 ?>&set_filter=Y"><? echo $arSum[$key] ?></a>)
                                </td>
                                <td nowrap><? echo GetMessage("STAT_" . $key); ?></td>
                            </tr>
                        <?endforeach; ?>
...
?>
    <form name="form1" method="GET" action="<? $APPLICATION->GetCurPage(); ?>">
        ...
        <tr valign="center">
            ...
            <td width="0%"
                nowrap><? echo SelectBoxFromArray("find_site_id", $arSiteDropdown, $find_site_id, GetMessage("MAIN_ALL"), ""); ?></td>
        </tr>
