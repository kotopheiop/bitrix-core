...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td><b><?
                    echo GetMessage("STAT_F_ID") ?></b></td>
        ...
        <tr>
            ...
            <td><input type="text" name="find_from" size="47" value="<?
                echo htmlspecialcharsbx($find_from) ?>"><?= ShowExactMatchCheckbox("find_from") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?= GetMessage("STAT_F_PROTOCOL") ?>:</td>
            <td><input type="text" name="find_from_protocol" size="47" value="<?
                echo htmlspecialcharsbx($find_from_protocol) ?>"></td>
        </tr>
        <tr>
            <td><?= GetMessage("STAT_F_DOMAIN") ?>:</td>
            <td><input type="text" name="find_from_domain" size="47" value="<?
                echo htmlspecialcharsbx($find_from_domain) ?>"></td>
        </tr>
        <tr>
            <td><?= GetMessage("STAT_F_PAGE") ?>:</td>
            <td><input type="text" name="find_from_url" size="47" value="<?
                echo htmlspecialcharsbx($find_from_url) ?>"><?= ShowExactMatchCheckbox("find_from_detail") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("STAT_F_TO") ?></td>
            <td><?
                ...
                ?>&nbsp;<input type="text" name="find_to" size="34" value="<?
