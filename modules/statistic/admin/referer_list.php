    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            ...
            <td><input type="text" name="find_from" size="47"
                       value="<? echo htmlspecialcharsbx($find_from) ?>"><?= ShowExactMatchCheckbox("find_from") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?= GetMessage("STAT_F_PROTOCOL") ?>:</td>
            <td><input type="text" name="find_from_protocol" size="47"
                       value="<? echo htmlspecialcharsbx($find_from_protocol) ?>"></td>
        </tr>
        <tr>
            <td><?= GetMessage("STAT_F_DOMAIN") ?>:</td>
            <td><input type="text" name="find_from_domain" size="47"
                       value="<? echo htmlspecialcharsbx($find_from_domain) ?>"></td>
        </tr>
        <tr>
