                ...
                <table cellspacing="0" cellpadding="0" border="0" class="internal">
                    <? if ($arGuest = $guest->ExtractFields("f_")) : ?>
                        ...
                        <tr>
                            ...
                            <td valign="top">&nbsp;<a target="_blank"
                                                      title="<? echo GetMessage("STAT_VIEW_EVENTS_LIST") ?>"
                                                      href="event_list.php?lang=<?= LANGUAGE_ID ?>&find_guest_id=<? echo $f_ID ?>&find_guest_id_exact_match=Y&set_filter=Y"><? echo $f_C_EVENTS ?></a>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" nowrap><? echo GetMessage("STAT_HITS") ?></td>
                            <td valign="top">&nbsp;<a target="_blank"
                                                      title="<? echo GetMessage("STAT_VIEW_HITS_LIST") ?>"
                                                      href="hit_list.php?lang=<?= LANGUAGE_ID ?>&find_guest_id=<? echo $f_ID ?>&find_guest_id_exact_match=Y&set_filter=Y"><? echo $f_HITS ?></a>
                            </td>
                        </tr>
                        <tr class="heading">
                        ...
                        <tr>
                            ...
                            <td valign="top">&nbsp;<a target="_blank"
                                                      href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<? echo $f_FIRST_SESSION_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><? echo $f_FIRST_SESSION_ID ?></a>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" nowrap><? echo GetMessage("STAT_HITS") ?></td>
                            <td valign="top">&nbsp;<a target="_blank"
                                                      href="hit_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_session_id=<? echo $f_FIRST_SESSION_ID ?>&amp;find_session_id_exact_match=Y&amp;set_filter=Y"><? echo $f_FSESSION_HITS ?></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <? if (intval($f_FIRST_ADV_ID) > 0) : ?>
                            <tr>
                                ...
                                <td valign="top">&nbsp;<a target="_blank"
                                                          href="adv_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<? echo $f_FIRST_ADV_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><? echo $f_FIRST_ADV_ID ?></a>
                                    (<a target="_blank"
                                        title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_1") ?>"
                                        href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer1=<? echo $f_FIRST_REFERER1 ?>&amp;find_referer12_exact_match=Y&amp;set_filter=Y"><? echo $f_FIRST_REFERER1 ?></a>
                                    / <a target="_blank"
                                         title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_2") ?>"
                                         href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer2=<? echo $f_FIRST_REFERER2 ?>&amp;find_referer12_exact_match=Y&amp;set_filter=Y"><? echo $f_FIRST_REFERER2 ?></a>
                                    / <a target="_blank"
                                         title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_3") ?>"
                                         href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer3=<? echo $f_FIRST_REFERER3 ?>&amp;find_referer3_exact_match=Y&amp;set_filter=Y"><? echo $f_FIRST_REFERER3 ?></a>
                                    )
                                </td>
                            </tr>
                        <? endif; ?>
                        ...
                        <tr>
                            <td valign="top" nowrap><? echo GetMessage("STAT_SESSION_ID") ?></td>
                            <td valign="top"><a target="_blank"
                                                href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<? echo $f_LAST_SESSION_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><? echo $f_LAST_SESSION_ID ?></a>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" nowrap><? echo GetMessage("STAT_HITS") ?></td>
                            <td valign="top">&nbsp;<a target="_blank"
                                                      href="hit_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_session_id=<? echo $f_LAST_SESSION_ID ?>&amp;find_session_id_exact_match=Y&amp;set_filter=Y"><? echo $f_LSESSION_HITS ?></a>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" nowrap><? echo GetMessage("STAT_TIME") ?></td>
                                ...
                                <? if ($f_LAST_CITY_INFO <> ''): ?>
                                    <table cellpadding="1" cellspacing="1" border="0">
                                        ...
                                        foreach ($arCity as $FIELD_ID => $arField):?>
                                            <tr>
                                                <td><? echo $arField["TITLE"] ?>:</td>
                                                <td>&nbsp;<? echo $arField["VALUE"] ?></td>
                                            </tr>
                                        <? endforeach ?>
                                    </table>
                        ...
                        <? if (intval($f_LAST_ADV_ID) > 0) : ?>
                            <tr>
                                <td valign="top"><? echo GetMessage("STAT_ADV") ?></td>
                                <td valign="top">&nbsp;<a target="_blank"
                                                          href="adv_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<? echo $f_LAST_ADV_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><? echo $f_LAST_ADV_ID ?></a><? if ($f_LAST_ADV_BACK == "Y") echo "<font class=\"star\">*" ?>
                                    (<a target="_blank"
                                        title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_1") ?>"
                                        href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer1=<? echo $f_LAST_REFERER1 ?>&amp;find_referer12_exact_match=Y&amp;set_filter=Y"><? echo $f_LAST_REFERER1 ?></a>
                                    / <a target="_blank"
                                         title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_2") ?>"
                                         href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer2=<? echo $f_LAST_REFERER2 ?>&amp;find_referer12_exact_match=Y&amp;set_filter=Y"><? echo $f_LAST_REFERER2 ?></a>
                                    / <a target="_blank"
                                         title="<? echo GetMessage("STAT_VIEW_SESSIONS_LIST_BY_REF_3") ?>"
                                         href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_referer3=<? echo $f_LAST_REFERER3 ?>&amp;find_referer3_exact_match=Y&amp;set_filter=Y"><? echo $f_LAST_REFERER3 ?></a>
                                    )
                                </td>
                            </tr>
                        <? endif; ?>
