...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_REGISTERED") ?>:
            </td>
            <td><?
        ...
        <tr>
            ...
            <td><input type="text" name="find_user_agent" size="30" value="<?
                echo htmlspecialcharsbx($find_user_agent) ?>"><?= ShowExactMatchCheckbox("find_user_agent") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_LANG") ?>:
            </td>
            <td><input type="text" name="find_lang" size="30" value="<?
                echo htmlspecialcharsbx($find_lang) ?>"><?= ShowExactMatchCheckbox("find_lang") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
        ...
        <tr>
            ...
            <td><input type="text" name="find_region" size="30" value="<?
        ...
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_FIRST_DATE") . ":" ?></td>
            <td width="0%" nowrap><?
        ...
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_PERIOD_DATE") . ":" ?></td>
            <td width="0%" nowrap><?
        ...
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_LAST_DATE") . ":" ?></td>
            <td width="0%" nowrap><?
        ...
        <tr>
            ...
            <td><?
                ...
                ?>&nbsp;<input type="text" name="find_url" size="33" value="<?
                echo htmlspecialcharsbx($find_url) ?>"><?= ShowExactMatchCheckbox("find_url") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_FIRST_ADV") ?>:
            </td>
            <td><?
                $arr = array("reference" => array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id" => array("Y", "N"));
        ...
        <tr>
            ...
            <td><input type="text" name="find_referer1" size="10" value="<?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_EVENTS_1_2") ?>:
            </td>
            <td><input type="text" name="find_events1" size="10" value="<?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_SESS_1_2") ?>:
            </td>
            <td><input type="text" name="find_sess1" size="10" value="<?
                echo htmlspecialcharsbx($find_sess1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_sess2" size="10"
                                                                            value="<?
                                                                            echo htmlspecialcharsbx($find_sess2) ?>">
            </td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_HITS_1_2") ?>:
            </td>
