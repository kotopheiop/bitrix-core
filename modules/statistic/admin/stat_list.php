...
elseif ($_REQUEST["table_id"] == "" || $_REQUEST["table_id"] == $sTableID_tab1):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        <tr class="heading">
            ...
            <? if ($is_filtered):?>
                <td><? echo GetMessage("STAT_PERIOD") ?><br><? echo htmlspecialcharsEx($arFilter["DATE1"]) ?>
        ...
        <tr>
            ...
            <td class="bx-digit-cell"><a href="<? echo hrefHtml(
                    "hit_list.php"
                    ,
                    "lang",
                    LANGUAGE_ID
        ...
        <tr class="heading" valign="top">
            ...
            <? if ($is_filtered):?>
                <td><a href="<? echo hrefHtml(
                        ...
                        "set_filter",
                        "Y"
                    ) ?>"><? echo GetMessage("STAT_PERIOD") ?></a><br><? echo htmlspecialcharsEx($arFilter["DATE1"]) ?>
                    &nbsp;- <? echo htmlspecialcharsEx($arFilter["DATE2"]) ?></td>
            <?endif; ?>
            <td><a href="<? echo hrefHtml(
                    "session_list.php"
                    ...
                    <td>
                        ...
                        if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
                            <a href="<? echo hrefHtml(
                                ...
                                "set_filter",
                                "Y"
                            ) ?>" title="<? echo GetMessage("STAT_EVENT_GRAPH") ?>"><? echo htmlspecialcharsEx(
                                    $ar["EVENT"]
                                ) ?></a>
                        <?
                        else:
                    ...
                    <td>
                        ...
                        if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
                            <a href="<? echo hrefHtml(
                                ...
                                "set_filter",
                                "Y"
                            ) ?>" title="<? echo GetMessage("STAT_SEARCHER_GRAPH") ?>"><? echo htmlspecialcharsEx(
                                    $ar["NAME"]
                                ) ?></a>
                        <? else:?>
...
$aTabs = array(
    ...
    array(
        ...
        "ICON" => "",
        "TITLE" => GetMessage("STAT_ADV") . ' (' . GetMessage(
                "STAT_DIRECT_SESSIONS"
            ) . ') (Top ' . COption::GetOptionInt("statistic", "STAT_LIST_TOP_SIZE") . ')',
    ...
    array(
        ...
        "ICON" => "",
        "TITLE" => GetMessage("STAT_EVENTS_2") . ' (Top ' . COption::GetOptionInt(
                "statistic",
                "STAT_LIST_TOP_SIZE"
            ) . ')',
    ...
    array(
        ...
        "ICON" => "",
        "TITLE" => GetMessage("STAT_REFERERS") . ' (Top ' . COption::GetOptionInt(
                "statistic",
                "STAT_LIST_TOP_SIZE"
            ) . ')',
    ...
    array(
        ...
        "ICON" => "",
        "TITLE" => GetMessage("STAT_PHRASES") . ' (Top ' . COption::GetOptionInt(
                "statistic",
                "STAT_LIST_TOP_SIZE"
            ) . ')',
    ...
    array(
        ...
        "ICON" => "",
        "TITLE" => GetMessage("STAT_SITE_INDEXING") . ' (Top ' . COption::GetOptionInt(
                "statistic",
                "STAT_LIST_TOP_SIZE"
            ) . ')',
...
?>
    ...
    <form name="form1" method="GET" action="<? echo $APPLICATION->GetCurPage() ?>?">
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap><? echo SelectBoxFromArray(
                    "find_site_id",
                    $arSiteDropdown,
                    $find_site_id,
                    GetMessage("MAIN_ALL")
        ...
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="set_filter"
                                          value="<? echo GetMessage("STAT_F_FIND") ?>"
                                          title="<? echo GetMessage("STAT_F_FIND_TITLE") ?>"
                                          onClick="BX.adminPanel.showWait(this); applyFilter(<? echo $sFilterID ?>, 'stat_list.php?lang=<? echo LANG ?>'); return false;"></span>
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="del_filter"
                                          value="<? echo GetMessage("STAT_F_CLEAR") ?>"
                                          title="<? echo GetMessage("STAT_F_CLEAR_TITLE") ?>"
                                          onClick="BX.adminPanel.showWait(this); clearFilter(<? echo $sFilterID ?>, 'stat_list.php?lang=<? echo LANG ?>'); return false;"></span>
        <?
        $oFilter->End();
        ?>
    </form>
...
?>
    <div class="adm-detail-content-wrap">
        <div class="adm-detail-content">
            ...
            <? $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/adv_list.php?lang=<? echo LANG ?>"><? echo GetMessage(
                    "STAT_VIEW_ALL_CAPMPAIGNS"
                ) ?></a><br><br>
            <? $lAdmin_tab2->DisplayList(); ?>

            <? $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/event_type_list.php?lang=<? echo LANG ?>"><? echo GetMessage(
                    "STAT_VIEW_ALL_EVENTS"
                ) ?></a><br><br>
            <? $lAdmin_tab3->DisplayList(); ?>

            <? $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/referer_list.php?lang=<? echo LANG ?>&amp;group_by=none&amp;del_filter=Y"><? echo GetMessage(
                    "STAT_VIEW_ALL_REFERERS"
                ) ?></a><br><br>
            <? $lAdmin_tab4->DisplayList(); ?>

            <? $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/phrase_list.php?lang=<? echo LANG ?>&amp;set_default=Y&amp;group_by=none&amp;menu_item_id=1"><? echo GetMessage(
                    "STAT_VIEW_ALL_PHRASES"
                ) ?></a><br><br>
            <? $lAdmin_tab5->DisplayList(); ?>

            <? $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/searcher_list.php?lang=<? echo LANG ?>"><? echo GetMessage(
                    "STAT_VIEW_ALL_SEACHERS"
                ) ?></a><br><br>
