...
elseif ($_REQUEST["table_id"] == "" || $_REQUEST["table_id"] == $sTableID_tab1):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        <tr class="heading">
            <td width="30%">&nbsp;</td>
            <td><?
                echo GetMessage("STAT_TODAY") ?><br><?
                echo $now_date ?></td>
            <td><?
                echo GetMessage("STAT_YESTERDAY") ?><br><?
                echo $yesterday_date ?></td>
            <td><?
                echo GetMessage("STAT_BEFORE_YESTERDAY") ?><br><?
                echo $bef_yesterday_date ?></td>
            <?
            if ($is_filtered):?>
                <td><?
                    echo GetMessage("STAT_PERIOD") ?><br><?
                    echo htmlspecialcharsEx($arFilter["DATE1"]) ?>&nbsp;- <?
                    echo htmlspecialcharsEx($arFilter["DATE2"]) ?></td>
            <?endif; ?>
            <td><?
                echo GetMessage("STAT_TOTAL_1") ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_HITS") ?></td>
            <td class="bx-digit-cell"><a href="<?
                echo hrefHtml("hit_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "set_filter", "Y"
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_HOSTS") ?></td>
            <td class="bx-digit-cell"><?
                echo htmlspecialcharsEx($arComm["TODAY_HOSTS"]) ?></td>
            <td class="bx-digit-cell"><?
                echo htmlspecialcharsEx($arComm["YESTERDAY_HOSTS"]) ?></td>
            <td class="bx-digit-cell"><?
                echo htmlspecialcharsEx($arComm["B_YESTERDAY_HOSTS"]) ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell">&nbsp;</td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo htmlspecialcharsEx($arComm["TOTAL_HOSTS"]) ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_SESSIONS") ?></td>
            <td class="bx-digit-cell"><a href="<?
                echo hrefHtml("session_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "set_filter", "Y"
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_C_EVENTS") ?></td>
            <td class="bx-digit-cell"><a href="<?
                echo hrefHtml("event_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "set_filter", "Y"
        ...
        if ($site_filter != "Y"):?>
            <tr class="heading">
                <td colspan="<?
                echo($is_filtered ? "6" : "5") ?>"><?
                    echo GetMessage("STAT_GUESTS") ?></td>
            </tr>
            <tr>
                <td><?
                    echo GetMessage("STAT_TOTAL") ?></td>
                <td class="bx-digit-cell"><a href="<?
                    echo hrefHtml("guest_list.php"
                        , "lang", LANGUAGE_ID
            ...
            <tr>
                <td><?
                    echo GetMessage("STAT_ONLINE") ?></td>
                <td class="bx-digit-cell"><a href="<?
                    echo hrefHtml("users_online.php"
                        , "lang", LANGUAGE_ID
                    ) ?>"><?
...
elseif ($_REQUEST["table_id"] == $sTableID_tab2):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        <tr class="heading" valign="top">
            <td><?
                echo GetMessage("STAT_ADV_NAME") ?></td>
            <td><a href="<?
                echo hrefHtml("session_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    ...
                    echo GetMessage("STAT_TODAY") ?></a><br><?
                echo $now_date ?></td>
            <td><a href="<?
                echo hrefHtml("session_list.php"
                    , "lang", LANGUAGE_ID
                    ...
                    echo GetMessage("STAT_YESTERDAY") ?></a><br><?
                echo $yesterday_date ?></td>
            <td><a href="<?
                echo hrefHtml("session_list.php"
                    , "lang", LANGUAGE_ID
                    ...
                    echo GetMessage("STAT_BEFORE_YESTERDAY") ?></a><br><?
                echo $bef_yesterday_date ?></td>
            <?
            if ($is_filtered):?>
                <td><a href="<?
                    echo hrefHtml("session_list.php"
                        ...
                        echo GetMessage("STAT_PERIOD") ?></a><br><?
                    echo htmlspecialcharsEx($arFilter["DATE1"]) ?>&nbsp;- <?
                    echo htmlspecialcharsEx($arFilter["DATE2"]) ?></td>
            <?endif; ?>
            <td><a href="<?
        ...
        while ($ar = $adv->Fetch()) {
            ...
            if ($i <= COption::GetOptionInt("statistic", "STAT_LIST_TOP_SIZE")) {
                ...
                <tr valign="top">
                    <td>[<a href="<?
                        echo hrefHtml("adv_list.php"
                            , "lang", LANGUAGE_ID
                            , "find_id", $ar["ID"]
                            , "find_id_exact_match", "Y"
                            , "set_filter", "Y"
                        ) ?>"><?
                            echo htmlspecialcharsEx($ar["ID"]) ?></a>]&nbsp;<?
                        echo htmlspecialcharsEx($ar["REFERER1"]) ?>&nbsp;/&nbsp;<?
                        echo htmlspecialcharsEx($ar["REFERER2"]) ?></td>
                    <td class="bx-digit-cell">
                        <?
        ...
        <tr>
            <td class="bx-digit-cell"><?
                echo GetMessage("STAT_TOTAL") ?></td>
            <td class="bx-digit-cell"><?
                echo($total_SESSIONS_TODAY > 0 ? $total_SESSIONS_TODAY : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_SESSIONS_YESTERDAY > 0 ? $total_SESSIONS_YESTERDAY : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_SESSIONS_BEF_YESTERDAY > 0 ? $total_SESSIONS_BEF_YESTERDAY : '&nbsp;') ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell"><?
                    echo($total_SESSIONS_PERIOD > 0 ? $total_SESSIONS_PERIOD : '&nbsp;') ?></td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo($total_SESSIONS > 0 ? $total_SESSIONS : '&nbsp;') ?></td>
        </tr>
    </table>
<?
endif;
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
                ...
                <tr>
                    <td>
                        ...
                        if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
                            <a href="<?
                            echo hrefHtml("event_graph_list.php"
                                , "lang", LANGUAGE_ID
                                , "find_events[]", $ar["ID"]
                                , "set_filter", "Y"
                            ) ?>" title="<?
                            echo GetMessage("STAT_EVENT_GRAPH") ?>"><?
                                echo htmlspecialcharsEx($ar["EVENT"]) ?></a>
                        <?
                        else:
        ...
        <tr>
            <td class="bx-digit-cell"><?
                echo GetMessage("STAT_TOTAL") ?></td>
            <td class="bx-digit-cell"><?
                echo($total_TODAY_COUNTER > 0 ? $total_TODAY_COUNTER : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_YESTERDAY_COUNTER > 0 ? $total_YESTERDAY_COUNTER : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_B_YESTERDAY_COUNTER > 0 ? $total_B_YESTERDAY_COUNTER : '&nbsp;') ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell"><?
                    echo($total_PERIOD_COUNTER > 0 ? $total_PERIOD_COUNTER : '&nbsp;') ?></td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo($total_TOTAL_COUNTER > 0 ? $total_TOTAL_COUNTER : '&nbsp;') ?></td>
        </tr>
    </table>
<?
endif;
...
elseif ($_REQUEST["table_id"] == $sTableID_tab4):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        ...
        <tr class="heading" valign="top">
            <td><?
                echo GetMessage("STAT_SERVER") ?></td>
            <td><a href="<?
                echo hrefHtml("referer_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "group_by", "none"
        ...
        <tr>
            <td class="bx-digit-cell"><?
                echo GetMessage("STAT_TOTAL") ?></td>
            <td class="bx-digit-cell"><?
                echo($total_TODAY_REFERERS > 0 ? $total_TODAY_REFERERS : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_YESTERDAY_REFERERS > 0 ? $total_YESTERDAY_REFERERS : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_B_YESTERDAY_REFERERS > 0 ? $total_B_YESTERDAY_REFERERS : '&nbsp;') ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell"><?
                    echo($total_PERIOD_REFERERS > 0 ? $total_PERIOD_REFERERS : '&nbsp;') ?></td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo($total_TOTAL_REFERERS > 0 ? $total_TOTAL_REFERERS : '&nbsp;') ?></td>
        </tr>
    </table>
<?
endif;
...
elseif ($_REQUEST["table_id"] == $sTableID_tab5):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        <tr class="heading" valign="top">
            <td><?
                echo GetMessage("STAT_PHRASE") ?></td>
            <td><a href="<?
                echo hrefHtml("phrase_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "set_filter", "Y"
                ...
                <tr>
                    <td><a href="<?
                        echo hrefHtml("phrase_list.php"
                            ...
                            echo htmlspecialcharsEx(TruncateText($ar["PHRASE"], 50)) ?></a>&nbsp;
                    </td>
                    <td class="bx-digit-cell">
                        <?
        ...
        <tr>
            <td class="bx-digit-cell"><?
                echo GetMessage("STAT_TOTAL") ?></td>
            <td class="bx-digit-cell"><?
                echo($total_TODAY_PHRASES > 0 ? $total_TODAY_PHRASES : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_YESTERDAY_PHRASES > 0 ? $total_YESTERDAY_PHRASES : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_B_YESTERDAY_PHRASES > 0 ? $total_B_YESTERDAY_PHRASES : '&nbsp;') ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell"><?
                    echo($total_PERIOD_PHRASES > 0 ? $total_PERIOD_PHRASES : '&nbsp;') ?></td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo($total_TOTAL_PHRASES > 0 ? $total_TOTAL_PHRASES : '&nbsp;') ?></td>
        </tr>
    </table>
<?
endif;
...
elseif ($_REQUEST["table_id"] == $sTableID_tab6):
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="list-table">
        <tr class="heading" valign="top">
            <td><?
                echo GetMessage("STAT_SEARCHER") ?></td>
            <td><a href="<?
                echo hrefHtml("hit_searcher_list.php"
                    , "lang", LANGUAGE_ID
                    , "find_date1", $now_date
                    , "find_date2", $now_date
                    , "set_filter", "Y"
            ...
            if ($i <= COption::GetOptionInt("statistic", "STAT_LIST_TOP_SIZE")) {
                ...
                <tr>
                    <td>
                        ...
                        if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
                            <a href="<?
                            echo hrefHtml("searcher_graph_list.php"
                                , "lang", LANGUAGE_ID
                                , "find_searchers[]", $ar["ID"]
                                , "set_filter", "Y"
                            ) ?>" title="<?
                            echo GetMessage("STAT_SEARCHER_GRAPH") ?>"><?
                                echo htmlspecialcharsEx($ar["NAME"]) ?></a>
                        <? else:?>
                            <?
        ...
        <tr>
            <td class="bx-digit-cell"><?
                echo GetMessage("STAT_TOTAL") ?></td>
            <td class="bx-digit-cell"><?
                echo($total_TODAY_HITS > 0 ? $total_TODAY_HITS : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_YESTERDAY_HITS > 0 ? $total_YESTERDAY_HITS : '&nbsp;') ?></td>
            <td class="bx-digit-cell"><?
                echo($total_B_YESTERDAY_HITS > 0 ? $total_B_YESTERDAY_HITS : '&nbsp;') ?></td>
            <?
            if ($is_filtered):?>
                <td class="bx-digit-cell"><?
                    echo($total_PERIOD_HITS > 0 ? $total_PERIOD_HITS : '&nbsp;') ?></td>
            <?endif; ?>
            <td class="bx-digit-cell"><?
                echo($total_TOTAL_HITS > 0 ? $total_TOTAL_HITS : '&nbsp;') ?></td>
        </tr>
    </table>
<?
endif;
...
?>
    ...
    <p><?
        echo GetMessage("STAT_SERVER_TIME") . "&nbsp;&nbsp;" . GetTime(time(), "FULL") ?></p>
    ...
    echo $APPLICATION->GetCurPage() ?>?">
        ...
        $oFilter->Begin(); ?>
        <tr valign="center">
            <td class="bx-digit-cell" width="0%" nowrap><?
                echo GetMessage("STAT_F_PERIOD") . ":" ?></td>
            <td width="0%" nowrap><?
                echo CalendarPeriod("find_date1", $find_date1, "find_date2", $find_date2, "form1", "Y") ?></td>
        </tr>

        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_SERVER") ?>:
            </td>
            <td width="0%" nowrap><?
                echo SelectBoxFromArray("find_site_id", $arSiteDropdown, $find_site_id, GetMessage("MAIN_ALL")); ?></td>
        </tr>
        <?
        $oFilter->Buttons() ?>
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="set_filter" value="<?
            echo GetMessage("STAT_F_FIND") ?>" title="<?
            echo GetMessage("STAT_F_FIND_TITLE") ?>" onClick="BX.adminPanel.showWait(this); applyFilter(<?
            echo $sFilterID ?>, 'stat_list.php?lang=<?
            echo LANG ?>'); return false;"></span>
        <span class="adm-btn-wrap"><input type="submit" class="adm-btn" name="del_filter" value="<?
            echo GetMessage("STAT_F_CLEAR") ?>" title="<?
            echo GetMessage("STAT_F_CLEAR_TITLE") ?>" onClick="BX.adminPanel.showWait(this); clearFilter(<?
            echo $sFilterID ?>, 'stat_list.php?lang=<?
            echo LANG ?>'); return false;"></span>
        <?
        $oFilter->End();
...
?>
    <div class="adm-detail-content-wrap">
        <div class="adm-detail-content">
            ...
            <?
            $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/adv_list.php?lang=<?
            echo LANG ?>"><?
                echo GetMessage("STAT_VIEW_ALL_CAPMPAIGNS") ?></a><br><br>
            <?
            $lAdmin_tab2->DisplayList(); ?>

            <?
            $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/event_type_list.php?lang=<?
            echo LANG ?>"><?
                echo GetMessage("STAT_VIEW_ALL_EVENTS") ?></a><br><br>
            <?
            ...
            echo LANG ?>&amp;group_by=none&amp;del_filter=Y"><?
                echo GetMessage("STAT_VIEW_ALL_REFERERS") ?></a><br><br>
            <?
            ...
            echo LANG ?>&amp;set_default=Y&amp;group_by=none&amp;menu_item_id=1"><?
                echo GetMessage("STAT_VIEW_ALL_PHRASES") ?></a><br><br>
            <?
            $lAdmin_tab5->DisplayList(); ?>

            <?
            $tabControl->BeginNextTab(); ?>
            <a href="/bitrix/admin/searcher_list.php?lang=<?
            echo LANG ?>"><?
                echo GetMessage("STAT_VIEW_ALL_SEACHERS") ?></a><br><br>
            <?
