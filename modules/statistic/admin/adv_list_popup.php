...
<?
if ($list_mode != "period"): ?>
    <table cellspacing="0" cellpadding="0" width="100%" border="0" class="edit-table">
        <tr>
            <td>
                <table border="0" width="100%" cellspacing="1" cellpadding="3" class="internal">
                    <tr class="heading">
                        <td width="50%" nowrap>
                            ...
                            ?><b><?
                                echo $f_REFERER1 ?><?
                                if (strlen($f_REFERER2) > 0) echo "&nbsp;/&nbsp;"; ?><?
                                echo $f_REFERER2 ?></b><?
                            if ($GROUP == "Y") echo "&nbsp;(" . GetMessage("STAT_EVENTS_GROUP_BY") . "&nbsp;\"" . $find_group . "\")" ?>
                        </td>
                        <td width="50%" nowrap><?
                            echo $f_DATE_FIRST ?><?
                            echo strlen($f_DATE_LAST) > 0 ? "&nbsp;-&nbsp;" . $f_DATE_LAST : "&nbsp;" ?>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <td>
            <table border="0" width="100%" cellspacing="1" cellpadding="3" class="internal">
                <tr class="heading">
                    ...
                    if ((strlen($find_date1_period) > 0 || strlen($find_date2_period) > 0) && $is_filtered): ?>
                        <td width="15%" colspan="2"><?
                            echo GetMessage("STAT_PERIOD") ?><br><?= htmlspecialcharsEx($arFilter["DATE1_PERIOD"]) ?>
                            &nbsp;- <?= htmlspecialcharsEx($arFilter["DATE2_PERIOD"]) ?></td>
                    <?endif; ?>
                ...
                <tr>
                    ...
                    <td align="right"><?
                        ...
                        echo GetMessage("STAT_SESSIONS_LIST") ?>"
                                 href="session_list.php?lang=<?= LANG ?>&amp;find_date1=<?
                    ...
                    <td align="right"><?
                        ...
                        echo GetMessage("STAT_SESSIONS_LIST") ?>"
                            ...
                            echo intval($f_SESSIONS_BACK_TODAY) ?></a>*<?
                        else:
                            ?>&nbsp;<?
                        endif;
                        ?></td>
                    ...
                    <td align="right"><?
                        ...
                        echo GetMessage("STAT_SESSIONS_LIST") ?>"
                                 ...
                                 ?>&amp;find_adv_back=Y&amp;set_filter=Y"><?
                            echo intval($f_SESSIONS_BACK_YESTERDAY) ?></a>*<?
                        else :
                            ?>&nbsp;<?
                        endif;
                        ?></td>
                    ...
                    <td align="right"><?
                        ...
                        echo GetMessage("STAT_SESSIONS_LIST") ?>"
                            ...
                            echo intval($f_SESSIONS_BACK_BEF_YESTERDAY) ?></a>*<?
                        else :
                            ?>&nbsp;<?
                        endif;
                        ?></td>
                    ...
                    if ((strlen($find_date1_period) > 0 || strlen($find_date2_period) > 0) && $is_filtered): ?>
                        ...
                        <td align="right"><?
                            ...
                            echo GetMessage("STAT_SESSIONS_LIST") ?>"
                                     ...
                                     ?>&amp;find_adv_back=Y&amp;set_filter=Y"><?
                                echo intval($f_SESSIONS_BACK_PERIOD) ?></a>*<?
                            else :
                                ?>&nbsp;<?
                            endif;
                            ?></td>
                    ...
                    <td align="right">
                        ...
                        ?>&amp;find_adv_back=Y&amp;set_filter=Y"><b><?
                                echo intval($f_SESSIONS_BACK) ?></b></a>*
                    </td>
                </tr>
                <tr>
                    <td><?
                    ...
                    <td align="right"><?
                        echo(intval($f_GUESTS_BACK_TODAY) > 0 ? intval($f_GUESTS_BACK_TODAY) . "*" : "&nbsp;") ?></td>
                    <td align="right"><?
                        echo intval($f_GUESTS_YESTERDAY) > 0 ? intval($f_GUESTS_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_GUESTS_BACK_YESTERDAY) > 0 ? intval($f_GUESTS_BACK_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_GUESTS_BEF_YESTERDAY) > 0 ? intval($f_GUESTS_BEF_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_GUESTS_BACK_BEF_YESTERDAY) > 0 ? intval($f_GUESTS_BACK_BEF_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <?
                    if ((strlen($find_date1_period) > 0 || strlen($find_date2_period) > 0) && $is_filtered): ?>
                        <td align="right"><?
                            echo intval($f_GUESTS_PERIOD) > 0 ? intval($f_GUESTS_PERIOD) : "&nbsp;" ?></td>
                        <td align="right"><?
                            echo intval($f_GUESTS_BACK_PERIOD) > 0 ? intval($f_GUESTS_BACK_PERIOD) . "*" : "&nbsp;" ?></td>
                    <?endif; ?>
                    <td align="right"><b><?
                            echo intval($f_GUESTS) ?></b></td>
                    <td align="right"><b><?
                            echo intval($f_GUESTS_BACK) ?></b>*
                    </td>
                </tr>
                <tr>
                    <td><?
                ...
                <tr>
                    ...
                    <td align="right"><?
                        echo(intval($f_HOSTS_BACK_TODAY) > 0 ? intval($f_HOSTS_BACK_TODAY) . "*" : "&nbsp;") ?></td>
                    <td align="right"><?
                        echo intval($f_C_HOSTS_YESTERDAY) > 0 ? intval($f_C_HOSTS_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_HOSTS_BACK_YESTERDAY) > 0 ? intval($f_HOSTS_BACK_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_C_HOSTS_BEF_YESTERDAY) > 0 ? intval($f_C_HOSTS_BEF_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_HOSTS_BACK_BEF_YESTERDAY) > 0 ? intval($f_HOSTS_BACK_BEF_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <?
                    if ((strlen($find_date1_period) > 0 || strlen($find_date2_period) > 0) && $is_filtered): ?>
                        <td align="right"><?
                            echo intval($f_C_HOSTS_PERIOD) ? intval($f_C_HOSTS_PERIOD) : "&nbsp;" ?></td>
                        <td align="right"><?
                            echo intval($f_HOSTS_BACK_PERIOD) ? intval($f_HOSTS_BACK_PERIOD) . "*" : "&nbsp;" ?></td>
                    <?endif; ?>
                    <td align="right"><b><?
                            echo intval($f_C_HOSTS) ?></b></td>
                    <td align="right"><b><?
                            echo intval($f_HOSTS_BACK) ?></b>*
                    </td>
                </tr>
                <tr>
                    <td><?
                    ...
                    <td align="right"><?
                        echo(intval($f_HITS_BACK_TODAY) > 0 ? intval($f_HITS_BACK_TODAY) . "*" : "&nbsp;") ?></td>
                    <td align="right"><?
                        echo intval($f_HITS_YESTERDAY) > 0 ? intval($f_HITS_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_HITS_BACK_YESTERDAY) > 0 ? intval($f_HITS_BACK_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_HITS_BEF_YESTERDAY) > 0 ? intval($f_HITS_BEF_YESTERDAY) : "&nbsp;" ?></td>
                    <td align="right"><?
                        echo intval($f_HITS_BACK_BEF_YESTERDAY) > 0 ? intval($f_HITS_BACK_BEF_YESTERDAY) . "*" : "&nbsp;" ?></td>
                    <?
                    if ((strlen($find_date1_period) > 0 || strlen($find_date2_period) > 0) && $is_filtered): ?>
                        <td align="right"><?
                            echo intval($f_HITS_PERIOD) > 0 ? intval($f_HITS_PERIOD) : "&nbsp;" ?></td>
                        <td align="right"><?
                            echo intval($f_HITS_BACK_PERIOD) > 0 ? intval($f_HITS_BACK_PERIOD) . "*" : "&nbsp;" ?></td>
                    <?endif; ?>
                    <td align="right"><b><?
                            echo intval($f_HITS) ?></b></td>
                    <td align="right"><b><?
                            echo intval($f_HITS_BACK) ?></b>*
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td>&nbsp;<?
            ...
            echo $f_ATTENT_BACK < 0 ? "-" : $f_ATTENT_BACK ?>*)
        </td>
    </tr>
    <tr>
    ...
    if ($STAT_RIGHT >= "M"):
        ...
        ?>
        <tr>
            <td width="50%"><span title="<?= GetMessage("STAT_INPUTS_ALT") ?>"><?
                    echo GetMessage("STAT_INPUTS") ?>:</span></td>
            <td width="50%"><?
                echo str_replace(" ", $thousand_sep, number_format($f_COST, 2, ".", " ")); ?></td>
        </tr>
        <tr>
            <td><span title="<?= GetMessage("STAT_OUTPUTS_ALT") ?>"><?
                    echo GetMessage("STAT_OUTPUTS") ?>:</span></td>
            <td><?
                echo str_replace(" ", $thousand_sep, number_format($f_REVENUE, 2, ".", " ")); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?
                echo str_replace(" ", $thousand_sep, number_format($f_SESSION_COST, 2, ".", " ")); ?></td>
        </tr>
        <tr>
            <td><span title="<?= GetMessage("STAT_VISITOR_COST_ALT") ?>"><?
                    echo GetMessage("STAT_VISITOR_COST") ?>:</span></td>
            <td><?
                echo str_replace(" ", $thousand_sep, number_format($f_VISITOR_COST, 2, ".", " ")); ?></td>
        </tr>
    <?
    endif;
