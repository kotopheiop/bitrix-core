        ...
        <tr>
            ...
            <td align="right"><?
                if (intval($f_SESSIONS_BACK_TODAY) > 0):
                    ?><a target="_blank" title="<? echo GetMessage("STAT_SESSIONS_LIST") ?>"
                         ...
                         ?>&amp;find_adv_back=Y&amp;set_filter=Y"><? echo intval($f_SESSIONS_BACK_TODAY) ?></a><span
                        class="required">*</span><?
                else:
                    ?>&nbsp;<?
                endif;
            ...
            <td align="right"><?
                if (intval($f_SESSIONS_BACK_YESTERDAY) > 0) :
                    ?><a target="_blank" title="<? echo GetMessage("STAT_SESSIONS_LIST") ?>"
                         ...
                         ?>&amp;find_adv_back=Y&amp;set_filter=Y"><? echo intval($f_SESSIONS_BACK_YESTERDAY) ?></a><span
                        class="required">*</span><?
                else :
                    ?>&nbsp;<?
                endif;
            ...
            <td align="right">
                &nbsp;<a target="_blank" title="<? echo GetMessage("STAT_SESSIONS_LIST") ?>"
                         ...
                         ?>&amp;find_adv_back=Y&amp;set_filter=Y"><b><? echo intval($f_SESSIONS_BACK) ?></b></a><span
                        class="required">*</span>
            </td>
        </tr>
        <tr>
...
if ($STAT_RIGHT > "M"):
    ...
    elseif ($_REQUEST["table_id"] == $sTableID_tab2):
        ...
        <table border="0" cellspacing="1" cellpadding="3" class="list-table">
                ...
                <td width="50%">
                    <? if ($GROUP == "N"):?>
                        <a href="adv_edit.php?lang=<?= LANG ?>&amp;ID=<?= $f_ID ?>"
                           title="<?= GetMessage("STAT_INPUTS_ALT") ?>"><? echo GetMessage("STAT_INPUTS") ?>:</a>
                    <? else:?>
            ...
            <tr>
                <td><span title="<?= GetMessage("STAT_OUTPUTS_ALT") ?>"><? echo GetMessage("STAT_OUTPUTS") ?>:</span>
                </td>
                <td><? echo str_replace(" ", "&nbsp;", number_format($f_REVENUE, 2, ".", " ")); ?></td>
            </tr>
            <tr>
                <td><span title="<?= GetMessage("STAT_BENEFIT_ALT") ?>"><? echo GetMessage("STAT_BENEFIT") ?>:</span>
                </td>
                <td><?
                    if ($f_BENEFIT < 0) :
                        ?><span class="required"><?
