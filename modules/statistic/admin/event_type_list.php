...
?>
    ...
    echo $APPLICATION->GetCurPage(); ?>">
        ...
        <tr>
            <td>event1:</td>
            <td><input type="text" name="find_event1" size="47" value="<?
                echo htmlspecialcharsbx($find_event1) ?>"><?= ShowExactMatchCheckbox("find_event1") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td>event2:</td>
            <td><input type="text" name="find_event2" size="47" value="<?
                echo htmlspecialcharsbx($find_event2) ?>"><?= ShowExactMatchCheckbox("find_event2") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_NAME") ?></td>
            <td><input type="text" name="find_name" size="47" value="<?
                echo htmlspecialcharsbx($find_name) ?>"><?= ShowExactMatchCheckbox("find_name") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_DESCRIPTION") ?></td>
            <td><input type="text" name="find_description" size="47" value="<?
                echo htmlspecialcharsbx($find_description) ?>"><?= ShowExactMatchCheckbox("find_description") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_DATE_ENTER") . " (" . FORMAT_DATE . "):" ?></td>
            <td><?
                echo CalendarPeriod("find_date_enter_1", $find_date_enter_1, "find_date_enter_2", $find_date_enter_2, "find_form", "Y") ?></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_DATE_LAST") . " (" . FORMAT_DATE . "):" ?></td>
            <td><?
                echo CalendarPeriod("find_date_last_1", $find_date_last_1, "find_date_last_2", $find_date_last_2, "find_form", "Y") ?></td>
        </tr>
        <tr>
            <td><?
        ...
        <tr>
            ...
            <td><input type="text" name="find_counter1" size="9" value="<?
                echo htmlspecialcharsbx($find_counter1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_counter2" size="9"
                                                                            value="<?
                                                                            echo htmlspecialcharsbx($find_counter2) ?>">
            </td>
        </tr>
        <?
        if ($STAT_RIGHT > "M"): ?>
            <tr>
                <td><?
                    echo GetMessage("STAT_F_MONEY") ?></td>
                <td><input type="text" name="find_money1" size="9" value="<?
                    echo htmlspecialcharsbx($find_money1) ?>"><?
                    echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_money2" size="9"
                                                                                value="<?
                                                                                echo htmlspecialcharsbx($find_money2) ?>">
                </td>
            </tr>
            <?
            if ($currency_module == "Y"): ?>
                <tr valign="center">
                    <td><?
                        echo GetMessage("STAT_F_CURRENCY") ?></td>
                    <td><?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_KEEP_DAYS") ?></td>
            <td><input type="text" name="find_keep_days1" size="9" value="<?
                echo htmlspecialcharsbx($find_keep_days1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_keep_days2" size="9"
                                                                            value="<?
                                                                            echo htmlspecialcharsbx($find_keep_days2) ?>">
            </td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_DYNAMIC_KEEP_DAYS") ?></td>
            <td><input type="text" name="find_dynamic_keep_days1" size="9" value="<?
                echo htmlspecialcharsbx($find_dynamic_keep_days1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_dynamic_keep_days2"
                                                                            size="9" value="<?
                echo htmlspecialcharsbx($find_dynamic_keep_days2) ?>"></td>
        </tr>
        <tr>
            <td><?
                echo GetMessage("STAT_F_ADV_VISIBLE") ?></td>
            <td><?
        ...
        <tr>
            <td><?
                echo GetMessage("STAT_F_DIAGRAM_DEFAULT") ?></td>
