    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr valign=top>
            ...
            <td><?
                ...
                <input type="text" name="find_searcher" size="40"
                       value="<? echo htmlspecialcharsbx($find_searcher) ?>"><?= ShowExactMatchCheckbox("find_searcher") ?> <?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="find_referer_id" size="47"
                       value="<? echo htmlspecialcharsbx($find_referer_id) ?>"><?= ShowExactMatchCheckbox("find_referer_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
