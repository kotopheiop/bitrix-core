...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr>
            <td nowrap><b><?
                    echo GetMessage("STAT_F_SEARCH_PHRASE") ?></b></td>
            <td><input type="text" name="find_phrase" size="47" value="<?
                echo htmlspecialcharsbx($find_phrase) ?>"><?= ShowExactMatchCheckbox("find_phrase") ?>
        ...
        <tr valign=top>
            <td nowrap><?
                echo GetMessage("STAT_F_SEARCH_SYSTEM") ?></td>
            <td><?
                $z = CSearcher::GetDropDownList();
                echo SelectBox("find_searcher_id", $z, GetMessage("MAIN_ALL"), htmlspecialcharsbx($find_searcher_id));
                ?><br>
                ID: <input type="text" name="find_searcher_id_str" size="20" value="<?
                echo htmlspecialcharsbx($find_searcher_id_str) ?>"> <?= GetMessage("STAT_NAME") ?>: <input type="text"
                                                                                                           name="find_searcher"
                                                                                                           size="40"
                                                                                                           value="<?
                                                                                                           echo htmlspecialcharsbx($find_searcher) ?>"><?= ShowExactMatchCheckbox("find_searcher") ?> <?= ShowFilterLogicHelp() ?>
            </td>
        </tr>
        <tr>
            <td width="0%" nowrap><?
        ...
        <tr>
            <td nowrap><?
                echo GetMessage("STAT_F_PAGE_TO") ?></td>
            <td><?
                ...
                ?>&nbsp;<input type="text" name="find_to" size="33" value="<?
                echo htmlspecialcharsbx($find_to) ?>"><?= ShowExactMatchCheckbox("find_to") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("STAT_F_REFERER") ?></td>
            <td><input type="text" name="find_referer_id" size="47" value="<?
                echo htmlspecialcharsbx($find_referer_id) ?>"><?= ShowExactMatchCheckbox("find_referer_id") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr>
            <td nowrap><?
                echo GetMessage("STAT_F_SESSION") ?></td>
