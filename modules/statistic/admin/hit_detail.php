                ...
                <table cellspacing="0" cellpadding="0" border="0" class="internal">
                    <? if ($arRes = $hit->ExtractFields("f_")) : ?>
                                ...
                                if (intval($f_STOP_LIST_ID) > 0) :
                                    ?>&nbsp;[&nbsp;<a target="_blank"
                                                      href="stoplist_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<?= intval(
                                                          $f_STOP_LIST_ID
                                                      ) ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><span
                                            class="stat_attention"><b><?= GetMessage(
                                                "STAT_STOPED"
                                            ) ?></b></span></a>&nbsp;]<?
                                endif;
                                ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a target="_blank"
                                   href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<? echo $f_SESSION_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><? echo $f_SESSION_ID ?></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><? if ($f_SITE_ID <> ''): ?>[<a title="<?= GetMessage("STAT_SITE") ?>"
                                                                href="/bitrix/admin/site_edit.php?LID=<?= $f_SITE_ID ?>&amp;lang=<?= LANGUAGE_ID ?>"><?= $f_SITE_ID ?></a>]&nbsp;<?endif; ?><? echo StatAdminListFormatURL(
                                    $arRes["URL"],
                                    array(
                                        "new_window" => true,
                        ...
                        <tr>
                            ...
                            <td><?
                                ...
                                ?>&nbsp;<? echo ($f_NEW_GUEST == "Y") ? "<font class=\"newguest\">" . GetMessage(
                                        "STAT_NEW_GUEST"
                                    ) . "&nbsp;" : "<span class=\"stat_oldguest\">" . GetMessage(
                                        "STAT_OLD_GUEST"
                                    ) . "</span>&nbsp;";
                                echo "[<a title=\"" . GetMessage(
                                        "STAT_VIEW_SESSION_LIST"
                                    ) . "\" target=\"_blank\" href=\"session_list.php?lang=" . LANG . "&amp;find_guest_id=" . $f_GUEST_ID . "&amp;find_guest_id_exact_match=Y&amp;set_filter=Y\">" . $f_GUEST_ID . "</a>]";
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <? $arr = explode(".", $f_IP) ?><?= GetWhoisLink($f_IP) ?>&nbsp;[<a target="_blank"
                                                                                                    title="<? echo GetMessage(
                                                                                                        "STAT_ADD_TO_STOPLIST_TITLE"
                                                                                                    ) ?>"
