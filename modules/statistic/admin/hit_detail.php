                ...
                <table cellspacing="0" cellpadding="0" border="0" class="internal">
                    <? if ($arRes = $hit->ExtractFields("f_")) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                if (intval($f_STOP_LIST_ID) > 0) :
                                    ?>&nbsp;[&nbsp;<a target="_blank"
                                                      href="stoplist_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<?= intval($f_STOP_LIST_ID) ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><span
                                            class="stat_attention"><b><?= GetMessage("STAT_STOPED") ?></b></span></a>&nbsp;]<?
                                endif;
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="session_list.php?lang=<?= LANGUAGE_ID ?>&amp;find_id=<?
                                echo $f_SESSION_ID ?>&amp;find_id_exact_match=Y&amp;set_filter=Y"><?
                                    echo $f_SESSION_ID ?></a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?
                                echo StatAdminListFormatURL($arRes["URL_FROM"], array(
                                    "new_window" => true,
                                    "chars_per_line" => 40,
                                    "line_delimiter" => "<wbr>",
                        ...
                        <tr>
                            ...
                            <td><?
                                if (strlen($f_SITE_ID) > 0): ?>[<a title="<?= GetMessage("STAT_SITE") ?>"
                                                                   href="/bitrix/admin/site_edit.php?LID=<?= $f_SITE_ID ?>&amp;lang=<?= LANGUAGE_ID ?>"><?= $f_SITE_ID ?></a>]&nbsp;<?endif; ?><?
                                echo StatAdminListFormatURL($arRes["URL"], array(
                                    "new_window" => true,
                        ...
                        <tr>
                            ...
                            <td>
                                <? $arr = explode(".", $f_IP) ?><?= GetWhoisLink($f_IP) ?>&nbsp;[<a target="_blank"
                                                                                                    ...
                                                                                                    href="stoplist_edit.php?lang=<?= LANGUAGE_ID ?>&amp;net1=<?
                                                                                                    echo $arr[0] ?>&amp;net2=<?
                                                                                                    echo $arr[1] ?>&amp;net3=<?
                                                                                                    echo $arr[2] ?>&amp;net4=<?
                                                                                                    echo $arr[3] ?>"><?
                                    echo GetMessage("STAT_STOP") ?></a>]
                            </td>
                        </tr>
                        <tr>
                            <td nowrap><?
                                echo GetMessage("STAT_COUNTRY") ?></td>
                            <td><?
