                ...
                <table cellspacing="0" cellpadding="0" border="0" class="internal">
                    <? if ($arRes = $hit->ExtractFields("f_")) : ?>
                        ...
                        <tr>
                            ...
                            <td><? if (strlen($f_SITE_ID) > 0): ?>[<a title="<?= GetMessage("STAT_SITE") ?>"
                                                                      href="/bitrix/admin/site_edit.php?LID=<?= $f_SITE_ID ?>&amp;lang=<?= LANGUAGE_ID ?>"><?= $f_SITE_ID ?></a>]&nbsp;<?endif; ?><? echo StatAdminListFormatURL($arRes["URL"], array(
                                    "new_window" => true,
                        ...
                        <tr>
                            ...
                            <td>
                                <? $arr = explode(".", $f_IP) ?><?= GetWhoisLink($f_IP) ?>&nbsp;[<a target="_blank"
                                                                                                    title="<? echo GetMessage("STAT_ADD_TO_STOPLIST_TITLE") ?>"
