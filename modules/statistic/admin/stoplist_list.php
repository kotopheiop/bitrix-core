    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap>
                ...
                <input type="text" name="find_ip_4" value="<? echo htmlspecialcharsbx($find_ip_4) ?>"
                       size="7"><?= ShowExactMatchCheckbox("find_ip") ?>&nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap><input type="text" name="find_url_from"
                                         value="<? echo htmlspecialcharsbx($find_url_from) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_url_from") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><? echo GetMessage("STAT_F_TO") ?>:</td>
            <td width="0%" nowrap><input type="text" name="find_url_to"
                                         value="<? echo htmlspecialcharsbx($find_url_to) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_url_to") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><? echo GetMessage("STAT_F_REDIRECT") ?>:</td>
            <td width="0%" nowrap><input type="text" name="find_url_redirect"
                                         value="<? echo htmlspecialcharsbx($find_url_redirect) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_url_redirect") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><? echo GetMessage("STAT_F_MESSAGE") ?>:</td>
            <td width="0%" nowrap><input type="text" name="find_message"
                                         value="<? echo htmlspecialcharsbx($find_message) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_message") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><? echo GetMessage("STAT_F_COMMENTS") ?>:</td>
            <td width="0%" nowrap><input type="text" name="find_comments"
                                         value="<? echo htmlspecialcharsbx($find_comments) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_comments") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <?= ShowLogicRadioBtn() ?>
