...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr valign="top">
            <td valign="top"><?= GetMessage("STAT_F_SITE") ?>:<br><img src="/bitrix/images/statistic/mouse.gif"
        ...
        <tr valign="center">
            <td width="0%" nowrap>
                <?
                echo GetMessage("STAT_F_STATISTIC") ?>:
            </td>
            <td width="0%" nowrap>
                <?
                $arr = array("reference" => array(GetMessage("STAT_YES"), GetMessage("STAT_NO")), "reference_id" => array("Y", "N"));
        ...
        <tr valign="center">
            ...
            <td width="0%" nowrap>
                <input type="text" name="find_ip_1" value="<?
                echo htmlspecialcharsbx($find_ip_1) ?>" size="6">
                <input type="text" name="find_ip_2" value="<?
                echo htmlspecialcharsbx($find_ip_2) ?>" size="6">
                <input type="text" name="find_ip_3" value="<?
                echo htmlspecialcharsbx($find_ip_3) ?>" size="6">
                <input type="text" name="find_ip_4" value="<?
                echo htmlspecialcharsbx($find_ip_4) ?>" size="7"><?= ShowExactMatchCheckbox("find_ip") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
            ...
            <td width="0%" nowrap><input type="text" name="find_user_agent" value="<?
                echo htmlspecialcharsbx($find_user_agent) ?>" size="47"><?= ShowExactMatchCheckbox("find_user_agent") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_FROM") ?>:
            </td>
            <td width="0%" nowrap><input type="text" name="find_url_from" value="<?
                echo htmlspecialcharsbx($find_url_from) ?>" size="47"><?= ShowExactMatchCheckbox("find_url_from") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
            ...
            <td width="0%" nowrap><input type="text" name="find_url_to" value="<?
                echo htmlspecialcharsbx($find_url_to) ?>" size="47"><?= ShowExactMatchCheckbox("find_url_to") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_REDIRECT") ?>:
            </td>
            <td width="0%" nowrap><input type="text" name="find_url_redirect" value="<?
                echo htmlspecialcharsbx($find_url_redirect) ?>"
                                         size="47"><?= ShowExactMatchCheckbox("find_url_redirect") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
                echo GetMessage("STAT_F_MESSAGE") ?>:
            </td>
            <td width="0%" nowrap><input type="text" name="find_message" value="<?
                echo htmlspecialcharsbx($find_message) ?>" size="47"><?= ShowExactMatchCheckbox("find_message") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <tr valign="center">
            <td width="0%" nowrap><?
            ...
            <td width="0%" nowrap><input type="text" name="find_comments" value="<?
                echo htmlspecialcharsbx($find_comments) ?>" size="47"><?= ShowExactMatchCheckbox("find_comments") ?>
                &nbsp;<?= ShowFilterLogicHelp() ?></td>
        </tr>
        <?= ShowLogicRadioBtn() ?>
        <?
...
echo BeginNote(); ?>
    <table border="0" width="100%" cellspacing="3" cellpadding="0">
        <tr valign="center" nowrap>
            ...
            <td width="100%">- <?
                echo GetMessage("STAT_GREEN_LAMP") ?></td>
        </tr>
        <tr valign="center" nowrap>
            <td width="0%">
            ...
            <td width="100%">- <?
                echo GetMessage("STAT_RED_LAMP") ?></td>
        </tr>
    </table>
<?
echo EndNote(); ?>
