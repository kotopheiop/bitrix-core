...
?>
    ...
    <form name="form1" method="GET" action="<?= $APPLICATION->GetCurPage() ?>?">
        ...
        <tr>
            <td nowrap><b><?
                    echo GetMessage("STAT_F_USER_AGENT") ?></b></td>
            <td><input type="text" name="find_user_agent" size="28" value="<?
        ...
        <tr>
            ...
            <td>
                <input type="text" name="find_counter1" size="10" value="<?
                echo htmlspecialcharsbx($find_counter1) ?>"><?
                echo "&nbsp;" . GetMessage("STAT_TILL") . "&nbsp;" ?><input type="text" name="find_counter2" size="10"
                                                                            value="<?
