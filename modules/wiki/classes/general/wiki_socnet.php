...
class CWikiSocnet
{
    ...
    public static function OnFillSocNetMenu(&$arResult, $arParams = array())
    {
        ...
        $arResult['CanView']['wiki'] = ((array_key_exists('ActiveFeatures', $arResult) ? array_key_exists(
                'wiki',
        ...
        $arResult['Title']['wiki'] = (array_key_exists('ActiveFeatures', $arResult) && array_key_exists(
            'wiki',
            $arResult['ActiveFeatures']
        ) && $arResult['ActiveFeatures']['wiki'] <> '' ? $arResult['ActiveFeatures']['wiki'] : GetMessage(
            'WIKI_SOCNET_TAB'
        ));
    ...
    public static function FormatEvent_Wiki($arFields, $arParams, $bMail = false)
    {
        ...
        if ($arFields['EVENT_ID'] == 'wiki') {
            ...
            $title_tmp = ($bMail ? Loc::getMessage('WIKI_DEL_SOCNET_LOG_TITLE_MAIL') : Loc::getMessage(
                'WIKI_DEL_SOCNET_LOG_TITLE'
            ));
            $title_tmp_24 = Loc::getMessage(
        ...
        $arResult['EVENT_FORMATTED']['MESSAGE'] = $sanitizer->SanitizeHtml(
        ...
        if ($bMail) {
            ...
            $arResult["EVENT_FORMATTED"]["MESSAGE"] = $arFields["TEXT_MESSAGE"] ? $arFields["TEXT_MESSAGE"] : HTMLToTxt(
            ...
            if ($arParams["MOBILE"] != "Y") {
                $GLOBALS['APPLICATION']->SetAdditionalCSS(
    ...
    public static function FormatComment_Wiki($arFields, $arParams, $bMail = false, $arLog = array())
    {
        ...
        $arResult["EVENT_FORMATTED"] = array(
            "TITLE" => $title,
            "MESSAGE" => ($bMail ? CSocNetTextParser::killAllTags($arFields['MESSAGE']) : htmlspecialcharsBack(
                $arFields['MESSAGE']
            ))
        );
                        ...
                        if (
                            ...
                            if (!$arUnFollower) {
                                ...
                                $arTmp = CSocNetLogTools::ProcessPath(
                                    array("ELEMENT_URL" => $arLog["URL"]),
                                    $arElement["CREATED_BY"]
                                );
                                ...
                                $arMessageFields["NOTIFY_MESSAGE"] = GetMessage(
                                    "WIKI_SONET_FROM_LOG_IM_COMMENT",
                                    Array(
                                        "#title#" => (
                                        $url <> ''
