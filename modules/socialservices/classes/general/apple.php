...
class CSocServApple extends CSocServAuth
{
    ...
    public function GetFormHtml($arParams)
    {
        ...
        return $arParams['FOR_INTRANET']
            ...
            : '<a href="javascript:void(0)" onclick="' . \CSocServApple::GetOnClickJs(
                $arParams
            ) . '" class="bx-ss-button apple-button"></a><span class="bx-spacer"></span><span>' . $phrase . '</span>';
    }
    ...
    public function GetOnClickJs($arParams): string
    {
        ...
        $controllerUrl = \Bitrix\Main\Engine\UrlManager::getInstance()->create(
            'socialservices.authflow.signinapple',
            []
        )->getUri();
