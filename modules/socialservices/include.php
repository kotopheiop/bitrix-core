...
class CSocServEventHandlers
{
    ...
    public static function FormatEvent_Data($arFields, $arParams, $bMail = false)
    {
        ...
        $title = str_replace(
            ...
            ($bMail ? GetMessage("LFP_SOCNET_LOG_DATA_" . $arFields["ENTITY_TYPE"] . "_TITLE_MAIL") : GetMessage(
                "LFP_SOCNET_LOG_DATA_TITLE"
            ))
        );
        ...
        $arResult["EVENT_FORMATTED"] = array(
            ...
            "TITLE_24" => "",
            "MESSAGE" => "<a  target=\"_blank\" style=\"text-decoration: none; color: #5C6470; font-weight: bold; font-size: 12px\" href=\"https://twitter.com/" . $twitInfo['SCREEN_NAME'] . "/status/" . $twitInfo['TWIT_ID'] . "\">" . $arFields["TITLE"] . "</a><p>" . ($bMail ? CSocNetTextParser::killAllTags(
                    $message
                ) : $message),
            "IS_IMPORTANT" => false,
            "STYLE" => "",
        ...
        if (
            ...
            $arResult["EVENT_FORMATTED"]["LOG_DATE_FORMAT"] = ConvertTimeStamp(
                $arEventParams["SOURCE_TIMESTAMP"],
                "FULL"
            );
        }
    ...
    public static function FormatComment_Data($arFields, $arParams, $bMail = false, $arLog = array())
    {
        ...
        $title_tmp = ($bMail ? GetMessage(
            "LFP_SOCNET_LOG_DATA_COMMENT_" . $arLog["ENTITY_TYPE"] . "_TITLE_MAIL"
        ) : GetMessage("LFP_SOCNET_LOG_DATA_COMMENT_TITLE"));
