        ...
        <td colspan="2" style="padding-bottom: 20px;">
            ...
            foreach ($arSiteList as $site):
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="edit-table">
                    <tr>
                        <td width="50%" class="field-name"><label
                                    for="use_on_sites<?= $suffix ?>"><? echo GetMessage("socserv_sett_site_apply") ?>
                        </td>
            ...
            <?endif ?>
                <table cellpadding="0" cellspacing="0" border="0" class="edit-table" width="100%"
                       id="site_settings<?= $suffix ?>"<? if ($site <> '' && $arUseOnSites[$site] <> "Y") echo ' style="display:none"'; ?>>
                    <? if ($site == ''):?>
                            ...
                            <table cellpadding="0" style="width:45%;" cellspacing="3" border="0" width=""
                                ...
                                foreach ($arServices as $id => $service):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label for="AUTH_SERVICES<?= $suffix ?><?= htmlspecialcharsbx($id) ?>"><?= htmlspecialcharsbx($service["NAME"]) ?></label>
                                        </td>
                                        <td>&nbsp;</td>
