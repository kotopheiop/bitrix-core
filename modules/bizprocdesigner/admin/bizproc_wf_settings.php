...
?>
    <script type="text/javascript">
        ...
        function WFSFSave() {
            ...
            var t = document.getElementById('WFSListGC');
            if (t && WFSAllData['GC']) {
                var consts = {};
                for (var i = 1; i < t.rows.length; i++) {
                    consts[t.rows[i].paramId] = WFSAllData['GC'][t.rows[i].paramId];
                }

                ajaxData += '&arWorkflowGlobalConstants=' + encodeURIComponent(JSON.stringify(consts, function (i, v) {
                    if (typeof (v) == 'boolean') {
                        return v ? '1' : '0';
                    }
                    return v;
        ...
        function WFSSwitchSubTypeControlGC(newSubtype) {
    ...
    <form id="bizprocform" name="bizprocform" method="post">
        ...
        <tr>
            ...
            <td><input type="text" id="WFStemplate_name"
                       value="<?= htmlspecialcharsbx($_POST['workflowTemplateName']) ?>" size="40"></td>
        </tr>
        <tr>
        ...
        <? if ($_POST['workflowTemplateAutostart'] < 8): ?>
            <tr>
                <td valign="top"><?
                    echo GetMessage("BIZPROC_WFS_PAR_AUTO") ?></td>
                <td>
                    <input type="checkbox" id="WFStemplate_autostart1" value="Y"><label for="WFStemplate_autostart1"><?
                        echo GetMessage("BIZPROC_WFS_PAR_AUTO_ADD") ?></label><br>
                    <input type="checkbox" id="WFStemplate_autostart2" value="Y"><label for="WFStemplate_autostart2"><?
                        echo GetMessage("BIZPROC_WFS_PAR_AUTO_UPD") ?></label>
                </td>
            </tr>
        <?
        endif;
                ...
                <td colspan="2">
                    <div id="dparamlistP" class="bizproc-valign-top">
                        <table width="100%" class="internal" id="WFSListP">
                            <tr class="heading">
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAM_NAME") ?></td>
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAMID") ?></td>
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAM_TYPE") ?></td>
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAM_REQUIRED") ?></td>
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAM_MULT") ?></td>
                                <!--td><?
                                echo GetMessage("BIZPROC_WFS_PARAM_DEF") ?></td-->
                                <td><?
                                    echo GetMessage("BIZPROC_WFS_PARAM_ACT") ?></td>
                            </tr>
                        </table>
                        <br>
                        <span class="bizproc-wf-settings-tab-add-button" style="padding: 10px;"><a
                                    href="javascript:void(0);" onclick="WFSParamNewParam('P')"><?
                                echo GetMessage("BIZPROC_WFS_ADD_PARAM") ?></a></span>
                    </div>
                    <div id="dparamformP" class="bizproc-valign-top" style="display: none">
                        <table class="internal">
                            ...
                            <tr id="WFSFormOptionsRowP" style="display: none;">
                                <td id="tdWFSFormOptionsPromtP"><?
                                    echo GetMessage("BIZPROC_WFS_PARAMLIST") ?>:
                                </td>
                            ...
                            <tr>
                                <td colspan="2" align="center"><input type="button" id="dpsavebuttonformP" value="OK"
                                            ...
                                            onclick="WFSParamEditForm(false, 'P')" value="<?
                                    echo GetMessage("BIZPROC_WFS_BUTTON_CANCEL") ?>"></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <td colspan="2">
                ...
                <div id="dparamformV" class="bizproc-valign-top" style="display: none">
                    <table class="internal">
                        ...
                        <tr>
                            <td><?= GetMessage("BIZPROC_WFS_PARAM_REQUIRED") ?>:</td>
                            <td><input type="checkbox" id="WFSFormReqV" value="Y"
                                       onchange="WFSSwitchTypeControl(null, 'V', {Required: this.checked});"></td>
                        </tr>
                        <tr>
                            <td><?= GetMessage("BIZPROC_WFS_PARAM_MULT") ?>:</td>
                            <td><input type="checkbox" id="WFSFormMultV" value="Y"
                                       onchange="WFSSwitchTypeControl(null, 'V', {Multiple: this.checked});"></td>
                        </tr>
                        <tr id="WFSFormOptionsRowV" style="display: none;">
                            <td id="tdWFSFormOptionsPromtV"><? echo GetMessage("BIZPROC_WFS_PARAMLIST") ?>:</td>
                            <td id="tdWFSFormOptionsV"><textarea id="WFSFormOptionsV" rows="5" cols="30"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td><?= GetMessage("BIZPROC_WFS_PARAMDEF") ?>:</td>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="button" id="dpsavebuttonformV" value="OK"
            ...
            <td colspan="2">
                ...
                <div id="dparamformC" class="bizproc-valign-top" style="display: none">
                    <table class="internal">
                        ...
                        <tr>
                            <td><?= GetMessage("BIZPROC_WFS_PARAM_REQUIRED") ?>:</td>
                            <td><input type="checkbox" id="WFSFormReqC" value="Y"
                                       onchange="WFSSwitchTypeControl(null, 'C', {Required: this.checked});"></td>
                        </tr>
                        <tr>
                            <td><?= GetMessage("BIZPROC_WFS_PARAM_MULT") ?>:</td>
                            <td><input type="checkbox" id="WFSFormMultC" value="Y"
                                       onchange="WFSSwitchTypeControl(null, 'C', {Multiple: this.checked});"></td>
                        </tr>
                        <tr id="WFSFormOptionsRowC" style="display: none;">
                            <td id="tdWFSFormOptionsPromtC"><? echo GetMessage("BIZPROC_WFS_PARAMLIST") ?>:</td>
                            <td id="tdWFSFormOptionsC"><textarea id="WFSFormOptionsC" rows="5" cols="30"></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="button" id="dpsavebuttonformC" value="OK"
        ...
        <tr>
            <td colspan="2">
                <? if ($isAdmin): ?>
                    <div id="dparamlistGC" class="bizproc-valign-top">
                        <table width="100%" class="internal" id="WFSListGC">
                            <tr class="heading">
                                <td><? echo GetMessage("BIZPROC_WFS_PARAM_NAME") ?></td>
                                <td><? echo GetMessage("BIZPROC_WFS_PARAMID") ?></td>
                                <td><? echo GetMessage("BIZPROC_WFS_PARAM_TYPE") ?></td>
                    ...
                    <div id="dparamformGC" class="bizproc-valign-top" style="display: none">
                        <table class="internal">
                            <tr>
                                <td><span style="color: #FF0000">*</span><?= GetMessage("BIZPROC_WFS_PARAMID") ?>:</td>
                                <td>
                                    <input type="text" size="20" id="WFSFormIdGC" readonly=readonly>
                                    <input type="hidden" id="WFSFormIdOldGC">
                                </td>
                            </tr>
                            <tr>
                                <td><span style="color: #FF0000">*</span><?= GetMessage("BIZPROC_WFS_PARAM_NAME") ?>:
                                </td>
                                <td><input type="text" size="30" id="WFSFormNameGC"></td>
                            </tr>
                            <tr>
                                <td><?= GetMessage("BIZPROC_WFS_PARAMDESC") ?>:</td>
                                <td><textarea id="WFSFormDescGC" rows="2" cols="30"></textarea></td>
                            </tr>
                            <tr>
                                <td><?= GetMessage("BIZPROC_WFS_PARAM_TYPE") ?>:</td>
                                <td>
                                    ...
                                    <span id="WFSAdditionalTypeInfoGC"></span>
                                </td>
                            </tr>
                            <tr>
                                <td><?= GetMessage("BIZPROC_WFS_PARAM_REQUIRED") ?>:</td>
                                <td><input type="checkbox" id="WFSFormReqGC" value="Y"
                                           onchange="WFSSwitchTypeControl(null, 'GC', {Required: this.checked});"></td>
                            </tr>
                            <tr>
                                <td><?= GetMessage("BIZPROC_WFS_PARAM_MULT") ?>:</td>
                                <td><input type="checkbox" id="WFSFormMultGC" value="Y"
                                           onchange="WFSSwitchTypeControl(null, 'GC', {Multiple: this.checked});"></td>
                            </tr>
                            <tr id="WFSFormOptionsRowGC" style="display: none;">
                                <td id="tdWFSFormOptionsPromtGC"><? echo GetMessage("BIZPROC_WFS_PARAMLIST") ?>:</td>
                                <td id="tdWFSFormOptionsGC"><textarea id="WFSFormOptionsGC" rows="5"
                                                                      cols="30"></textarea></td>
                            </tr>
                            <tr>
                                <td><?= GetMessage("BIZPROC_WFS_CONSTANTDEF") ?>:</td>
                                <td id="tdWFSFormDefaultGC">
                                    <input id="id_WFSFormDefaultGC">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center"><input type="button" id="dpsavebuttonformGC" value="OK"
                                                                      onclick="WFSParamSaveForm('GC')"><input
                                            type="button" id="dpcancelbuttonformGC"
                                            onclick="WFSParamEditForm(false, 'GC')"
                ...
                <tr>
                    ...
                    <td valign="top"><?
                        ...
                        <input type="button" value="..."
                               onclick="BPAShowSelector('id_<?= $parameterKeyExt ?>', 'user', 'all', {'arWorkflowParameters': WFSAllData['P'], 'arWorkflowVariables': WFSAllData['V'], 'arWorkflowConstants': WFSAllData['C']});"
                               style="vertical-align: top; margin-left: 2px"
                               data-role="bp-selector-button"
                               data-bp-selector-props="<?= htmlspecialcharsbx($selectorProps) ?>"/>
                    </td>
                </tr>
            <?
            endforeach;
