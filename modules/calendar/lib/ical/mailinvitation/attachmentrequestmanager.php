...
class AttachmentRequestManager extends AttachmentManager
{
    ...
    public function getContent(): string
    {
        ...
        return Calendar::createInstance()
            ...
            ->setTimezones(
                Timezone::createInstance()
                    ->setTimezoneId(Helper::getTimezoneObject($event['TZ_FROM']))
                    ->setObservance(
                        StandardObservances::createInstance()
            ...
            ->addEvent(
                Event::createInstance($this->uid)
                    ...
                    ->setTransparent(
                        Dictionary::TRANSPARENT[$event['ACCESSIBILITY']] ?? Dictionary::TRANSPARENT['busy']
                    )
