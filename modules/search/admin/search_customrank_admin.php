...
if (strlen($Rebuild) > 0) {
    ...
    echo $APPLICATION->GetCurPage(); ?>">
        ...
        <tr>
            ...
            <td>
                ...
                echo htmlspecialcharsbx($find) ?>" title="<?= GetMessage("customrank_find_title") ?>">
                <?
                $arr = array(
                    "reference" => array(
                        GetMessage("customrank_site"),
        ...
        <tr>
            ...
            <td><?
                echo CLang::SelectBox("find_site_id", $find_site_id, GetMessage("customrank_all")); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="find_param1" size="47" value="<?
                echo htmlspecialcharsbx($find_param1) ?>"></td>
        </tr>
        <?
    ...
    <p>
        ...
        echo GetMessage("customrank_update") ?>" OnClick="StartRebuild();">
