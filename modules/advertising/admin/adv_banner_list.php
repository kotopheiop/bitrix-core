...
<form name="form1" action="<?= $APPLICATION->GetCurPage() ?>">
    ...
    <tr>
        ...
        <td><input type="text" name="find_group" size="47"
                   value="<? echo htmlspecialcharsbx($find_group) ?>"><?= InputType("checkbox", "find_group_exact_match", "Y", $find_group_exact_match, false, "", "title='" . GetMessage("AD_EXACT_MATCH") . "'") ?>
            &nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td valign="top"><?= GetMessage("AD_F_CONTRACT") ?>:</td>
        <td><input type="text" name="find_contract" size="47"
                   value="<? echo htmlspecialcharsbx($find_contract) ?>"><?= InputType("checkbox", "find_contract_exact_match", "Y", $find_contract_exact_match, false, "", "title='" . GetMessage("AD_EXACT_MATCH") . "'") ?>
            &nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="find_type" size="47"
                   value="<? echo htmlspecialcharsbx($find_type) ?>"><?= InputType("checkbox", "find_type_exact_match", "Y", $find_type_exact_match, false, "", "title='" . GetMessage("AD_EXACT_MATCH") . "'") ?>
            &nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="find_code" size="47"
                   value="<? echo htmlspecialcharsbx($find_code) ?>"><?= InputType("checkbox", "find_code_exact_match", "Y", $find_code_exact_match, false, "", "title='" . GetMessage("AD_EXACT_MATCH") . "'") ?>
            &nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <tr>
        <td><? echo GetMessage("AD_F_COMMENTS") ?>:</td>
        <td><input type="text" name="find_comments" size="47"
                   value="<? echo htmlspecialcharsbx($find_comments) ?>"><?= InputType("checkbox", "find_comments_exact_match", "Y", $find_comments_exact_match, false, "", "title='" . GetMessage("AD_EXACT_MATCH") . "'") ?>
            &nbsp;<?= ShowFilterLogicHelp() ?></td>
    </tr>
    <?
