                            ...
                            <table cellspacing=0 cellpadding=2 class="graph">
                                <tr>
                                    <td valign="top"><img class="graph"
                                                          src="/bitrix/admin/adv_diagram.php?<?= GetFilterParams($FilterArr) ?>&diagram_type=<?
                                                          echo $diagram_type ?>&counter_type=<?
                                                          echo $counter_type ?>" width="<?
                                        echo $diameter ?>" height="<?
                                        echo $diameter ?>">
                                    </td>
                                    <td valign="top">
                                            ...
                                            while (list($keyL, $arrS) = each($arrLegend)) :
                                                if ($arrS["COUNTER_TYPE"] == "DETAIL" && $arrS["TYPE"] == $diagram_type):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td nowrap><?
                                                            echo "[<a href='/bitrix/admin/adv_contract_edit.php?find_id=" . $arrS["ID"] . "&lang=" . LANGUAGE_ID . "&action=view' title='" . GetMessage("AD_CONTRACT_VIEW") . "'>" . $arrS["ID"] . "</a>] " . $arrS["NAME"]; ?></td>
                                                    </tr>
                                                <?
                                                endif;
                                            endwhile;
