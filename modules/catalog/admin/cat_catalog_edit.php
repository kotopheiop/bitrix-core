...
if (is_array($arCatalog)) {
    ...
    <tr colspan="2" class="heading">
        <td style="text-align: center;"><?
            echo GetMessage("CAT_CEDIT_PROP_SKU_SECTION"); ?></td>
    </tr>
    <tr colspan="2">
        <td style="text-align: center;">
            <table class="internal" id="table_SKU_SECTION_PROPERTY">
                <tr class="heading">
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_NAME"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_TYPE"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_SMART_FILTER"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_DISPLAY_TYPE"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_DISPLAY_EXPANDED"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_FILTER_HINT"); ?></td>
                    <td><?
                        echo GetMessage("CAT_CEDIT_PROP_TABLE_ACTION"); ?></td>
                </tr>
                <?
            ...
            echo GetMessage("CAT_CEDIT_PROP_TABLE_ACTION_ADD") ?>" onclick="addSectionProperty(<?
