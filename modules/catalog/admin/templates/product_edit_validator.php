            ...
            for ($i = 0, $cnt = $intCount; $i < $cnt; $i++) {
                if ($i != 0 && $arCatalogBasePrices[$i]["QUANTITY_FROM"] <= 0
                    ...
                    $strWarning .= str_replace(
                            ...
                            Loc::getMessage("C2IT_ERROR_BOUND_LEFT")
                        ) . "<br>";
                }
                ...
                if ($i != $cnt - 1 && $arCatalogBasePrices[$i]["QUANTITY_TO"] <= 0
                    ...
                    $strWarning .= str_replace(
                            ...
                            Loc::getMessage("C2IT_ERROR_BOUND_RIGHT")
                        ) . "<br>";
                }
                ...
                if ($arCatalogBasePrices[$i]["QUANTITY_FROM"] > $arCatalogBasePrices[$i]["QUANTITY_TO"]
                    ...
                    $strWarning .= str_replace(
                            "#DIAP#",
                            $arCatalogBasePrices[$i]["QUANTITY_FROM"] . "-" . $arCatalogBasePrices[$i]["QUANTITY_TO"],
                            Loc::getMessage("C2IT_ERROR_BOUND")
                        ) . "<br>";
                }
                ...
                if ($i < $cnt - 1 && $arCatalogBasePrices[$i]["QUANTITY_TO"] >= $arCatalogBasePrices[$i + 1]["QUANTITY_FROM"]) {
                    $strWarning .= str_replace(
                            ...
                            str_replace(
                                "#DIAP2#",
                                $arCatalogBasePrices[$i + 1]["QUANTITY_FROM"] . "-" . $arCatalogBasePrices[$i + 1]["QUANTITY_TO"],
                                Loc::getMessage("C2IT_ERROR_BOUND_CROSS")
                            )
                        ) . "<br>";
                }
                ...
                if ($i < $cnt - 1
                    ...
                    $strWarning .= str_replace(
                            "#DIAP1#",
                            ($arCatalogBasePrices[$i]["QUANTITY_TO"] + 1) . "-" . ($arCatalogBasePrices[$i + 1]["QUANTITY_FROM"] - 1),
                            Loc::getMessage("C2IT_ERROR_BOUND_MISS")
                        ) . "<br>";
                }
                ...
                if ($i >= $cnt - 1
                    ...
                    $strWarning .= str_replace(
                            "#BORDER#",
                            $arCatalogBasePrices[$i]["QUANTITY_TO"],
                            Loc::getMessage("C2IT_ERROR_BOUND_MISS_TOP")
                        ) . "<br>";
                }
                ...
                if ($arCatalogBasePrices[$i]['CAT_PRICE_EXIST'] != 'Y') {
                    $strWarning .= str_replace(
                            "#DIAP#",
                            $arCatalogBasePrices[$i]["QUANTITY_FROM"] . "-" . $arCatalogBasePrices[$i]["QUANTITY_TO"],
                            Loc::getMessage("C2IT_ERROR_BOUND_PRICE")
                        ) . "<br>";
                }
            }
        }
