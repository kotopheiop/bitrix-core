        ...
        <td valign="top" colspan="2">
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="internal">
                    ...
                    if ($bReadOnly) echo "disabled" ?>>
                        <td valign="top" align="left">
                            ...
                            <?
                            if ($arPrice):?>
                                <input type="hidden" name="SUBCAT_ID_<?
                        ...
                        <td valign="top" align="center">
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="SUBCAT_PRICE_<?
                            echo $arCatalogGroup["ID"] ?>" name="SUBCAT_PRICE_<?
                            echo $arCatalogGroup["ID"] ?>" value="<?
                                    ...
                                    <tr id="submodel3">
                                        <td valign="top" align="center">
                                            ...
                                            if ($bReadOnly) echo "disabled readonly" ?>
                                                   name="SUBCAT_BASE_QUANTITY_FROM_<?= $ind ?>" value="<?
                                        ...
                                        <td valign="top" align="center">
                                            <input type="text" <?
                                            if ($bReadOnly) echo "disabled readonly" ?>
                                                   name="SUBCAT_BASE_QUANTITY_TO_<?= $ind ?>" value="<?
                                            ...
                                            <tr id="submodel3_<?= $arCatalogGroup["ID"] ?>">
                                                ...
                                                <td valign="top" align="center">
                                                    ...
                                                    if ($bReadOnly) echo "disabled readonly" ?>
                                                           ...
                                                           OnChange="ptSubPriceChangeEx(this)">
                ...
                if ($bEnableReservation) {
                    ...
                    <td width="60%">
                        ...
                        <input type="hidden" id="SUBCAT_BASE_QUANTITY_RESERVED_hidden"
                               name="SUBCAT_BASE_QUANTITY_RESERVED" value="<?
                ...
                <tr>
                    ...
                    <td width="60%">
                        ...
                        <select id="SUBCAT_BASE_QUANTITY_TRACE"
                            ...
                            <option value="D" <? if ("D" == $str_CAT_BASE_QUANTITY_TRACE) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><? echo $availQuantityTrace == 'Y' ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                )
                            </option>
                ...
                <tr>
                    ...
                    <td width="60%">
                        ...
                        <select id="SUBUSE_STORE"
                            ...
                            <option value="D" <? if ("D" == $str_CAT_BASE_CAN_BUY_ZERO) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><? echo $availCanBuyZero == 'Y' ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                )
                            </option>
                ...
                <tr>
                    ...
                    <td width="60%">
                        ...
                        <select id="SUBSUBSCRIBE" name="SUBSUBSCRIBE" <? if ($bReadOnly) echo "disabled readonly" ?>>
                            <option value="D" <? if ("D" == $str_CAT_SUBSCRIBE) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><? echo 'Y' == $strGlobalSubscribe ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                )
                            </option>
                ...
                if ($arCatalog["SUBSCRIPTION"] == "Y") {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="SUBCAT_RECUR_SCHEME_LENGTH"
                                   name="SUBCAT_RECUR_SCHEME_LENGTH" value="<?
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <input type="checkbox" <?
                            if ($bReadOnly) echo "disabled readonly" ?> name="SUBCAT_WITHOUT_ORDER" value="Y" <?
                    ...
                    while ($arGroup = $dbGroups->Fetch()) {
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <input type="checkbox" name="SUBCAT_USER_GROUP_ID_<?= $arGroup["ID"] ?>" value="Y"<?
            ...
            if ($storeCount > 0) {
                ...
                if ($bStore) {
                    ...
                    ?><b><? echo GetMessage("C2IT_STORE_NO_STORE"); ?> <a target="_top"
                                                                          href="<?= $storeListUrl ?>"><?= GetMessage("C2IT_STORE"); ?></a>
                    </b><br><?
                }
            }
            if (!$bUseStoreControl)
            ...
            if ($bUseStoreControl) {
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="edit-table"
                    ...
                    <tr>
                        <td width="40%"><label
                                    for="SUBCAT_BARCODE_MULTIPLY"><? echo GetMessage('C2IT_BARCODE_MULTIPLY'); ?>
                                :</label></td>
                        <td width="60%">
            ...
            if ($activitySubscribeTab) {
                ...
                <div id="subscription-data">
                    ...
                    <table border="0" cellspacing="0" cellpadding="5" width="100%" class="edit-table"
                        ...
                        <tr>
                            <td width="40%"
                                style="text-align:right;"><?= GetMessage('C2IT_NUMBER_SUBSCRIPTIONS') ?></td>
                            <td width="60%" id="bx-catalog-subscribe-total-count"></td>
                        </tr>
                        <tr>
                            <td width="40%"
                                style="text-align:right;"><?= GetMessage('C2IT_NUMBER_ACTIVE_SUBSCRIPTIONS') ?></td>
