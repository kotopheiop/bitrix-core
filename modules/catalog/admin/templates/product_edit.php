                ...
                <? if ($USER->CanDoOperation('catalog_purchas_info')):?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <? $isDisabled = '';
                            if ($bUseStoreControl) $isDisabled = " disabled";
		...
		<? echo GetMessage("C2IT_BOUND_RECOUNT"); ?>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="internal">
                    ...
                    if ($bReadOnly) echo "disabled readonly" ?>>
                        ...
                        <td valign="top" align="center">
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_PRICE_<?
                            echo $arCatalogGroup["ID"] ?>" name="CAT_PRICE_<?
                            echo $arCatalogGroup["ID"] ?>" value="<?
                            echo htmlspecialcharsbx($str_CAT_PRICE) ?>" size="8"
        ...
        echo GetMessage("C2IT_BOUND_RECOUNT") ?>
                                ...
                                for ($i = 0, $intCount = count($arPriceBoundaries); $i < $intCount; $i++) {
                                    ...
                                    <tr id="model3">
                                        <td valign="top" align="center">
                                            <input type="text" <?
                                            if ($bReadOnly) echo "disabled readonly" ?>
                                                   name="CAT_BASE_QUANTITY_FROM_<?= $ind ?>" value="<?
                                            echo($str_CAT_BASE_QUANTITY_FROM != 0 ? htmlspecialcharsbx($str_CAT_BASE_QUANTITY_FROM) : "") ?>"
                                        ...
                                        <td valign="top" align="center">
                                            <input type="text" <?
                                            if ($bReadOnly) echo "disabled readonly" ?>
                                                   name="CAT_BASE_QUANTITY_TO_<?= $ind ?>" value="<?
                                            echo($str_CAT_BASE_QUANTITY_TO != 0 ? htmlspecialcharsbx($str_CAT_BASE_QUANTITY_TO) : "") ?>"
                                                   size="3" OnChange="ChangeBaseQuantityEx(this)">
                                        </td>
                                        <td valign="top" align="center">
                                            <input type="text" <?
                                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_BASE_PRICE_<?= $ind ?>"
                                                   name="CAT_BASE_PRICE_<?= $ind ?>" value="<?
                                            echo htmlspecialcharsbx($str_CAT_BASE_PRICE) ?>" size="15"
                                                   OnBlur="ChangeBasePriceEx(this)">
                                        </td>
                                        <td valign="top" align="center">
                                            <select id="CAT_BASE_CURRENCY_<?= $ind ?>"
                                                    name="CAT_BASE_CURRENCY_<?= $ind ?>" <?
                                            if ($bReadOnly) echo "disabled readonly" ?>
                                ...
                                if ($ind == -1) {
                                    ...
                                    <tr id="model3">
                                        ...
                                        <td valign="top" align="center">
                                            <input type="text" <?
                                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_BASE_PRICE_<?= $ind ?>"
                                                   name="CAT_BASE_PRICE_<?= $ind ?>" value="" size="15"
                                                   OnBlur="ChangeBasePriceEx(this)">
                                        </td>
                                        <td valign="top" align="center">
                                            <select id="CAT_BASE_CURRENCY_<?= $ind ?>"
                            ...
                            <tr>
                                ...
                                <td valign="top" align="left">
                                    <table border="0" cellspacing="1" cellpadding="3"
                                        ...
                                        <tr>
                                            <td align="center"><?
                                                echo GetMessage("C2IT_FROM") ?></td>
                                            <td align="center"><?
                                                echo GetMessage("C2IT_TO") ?></td>
                                            <td align="center"><?
                                                echo GetMessage("C2IT_NAC_TYPE") ?></td>
                                            <td align="center"><?
                                                echo GetMessage("C2IT_PRICE") ?></td>
                                            <td align="center"><?
                                                echo GetMessage("C2IT_CURRENCY") ?></td>
                                        </tr>
                                        </thead>
                                            ...
                                            <tr id="model3_<?= $arCatalogGroup["ID"] ?>">
                                                <td valign="top" align="center">
                                                    <input type="text" disabled readonly
                                                           ...
                                                           value="<?
                                                           echo($str_CAT_QUANTITY_FROM != 0 ? htmlspecialcharsbx($str_CAT_QUANTITY_FROM) : "") ?>"
                                                           size="3">
                                                    <input type="hidden"
                                                ...
                                                <td valign="top" align="center">
                                                    <input type="text" disabled readonly
                                                           ...
                                                           value="<?
                                                           echo($str_CAT_QUANTITY_TO != 0 ? htmlspecialcharsbx($str_CAT_QUANTITY_TO) : "") ?>"
                                                           size="3">
                                                ...
                                                <td valign="top" align="center">
                                                    ...
                                                    if ($bReadOnly) echo "disabled readonly" ?>
                                                           ...
                                                           value="<?
                                                           echo htmlspecialcharsbx($str_CAT_PRICE) ?>" size="10"
                                                           OnChange="ptPriceChangeEx(this)">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="edit-table"
                    ...
                    <tr id="CAT_BASE_QUANTITY_RESERV">
                        ...
                        <td width="60%"><?
                            ...
                            <input type="hidden" id="CAT_BASE_QUANTITY_RESERVED_hidden"
                                   name="CAT_BASE_QUANTITY_RESERVED" value="<?
                            echo htmlspecialcharsbx($str_CAT_BASE_QUANTITY_RESERVED) ?>">
                            <input type="text" id="CAT_BASE_QUANTITY_RESERVED" name="CAT_BASE_QUANTITY_RESERVED" <?
                            if ($bReadOnly || $bUseStoreControl) echo "disabled readonly" ?> onfocus="ShowNotice()"
                                   onblur="HideNotice()" value="<?
                            echo htmlspecialcharsbx($str_CAT_BASE_QUANTITY_RESERVED) ?>" size="30"><span
                                    id="CAT_QUANTITY_RESERVED_DIV"
                                    style="color: #af2d49; margin-left: 10px; display: none;">	<?
                                echo GetMessage("QUANTITY_RESERVED_NOTICE") ?></span>
                        </td>
                    </tr>
                    <?
                }
                ...
                if ($arMainCatalog['SUBSCRIPTION'] != 'Y') {
                    ...
                    <tr>
                        ...
                        <td width="60%"><?
                            ...
                            if (!empty($arAllMeasure)):?>
                                <select style="max-width:220px" id="CAT_MEASURE" name="CAT_MEASURE" <?
                                if ($bReadOnly || $productIsSet) echo "disabled readonly"; ?>>
                                    <?
                                    foreach ($arAllMeasure as $arMeasure):?>
                                        <option <?
                                        if ($str_CAT_MEASURE == $arMeasure["ID"] || ($str_CAT_MEASURE == '' && $arMeasure["IS_DEFAULT"] == 'Y')) echo " selected"; ?>
                                                value="<?= $arMeasure["ID"] ?>"><?= htmlspecialcharsbx($arMeasure["MEASURE_TITLE"]) ?></option>
                                    <?endforeach;
                                    unset($arMeasure);
                                    ?>
                                </select>
                            <?
                                ...
                                echo GetMessage("C2IT_MEASURE_NO_MEASURE"); ?> <a target="_top"
                                                                                  href="<?= $measureListUrl ?>"><?= GetMessage("C2IT_MEASURES"); ?></a>
                                <br><?
                            endif; ?>
                        </td>
                    </tr>
                    ...
                    if (!empty($arAllMeasure)) {
                        ...
                        <tr>
                            ...
                            <td width="60%"><?
                                ...
                                ?>
                                <input type="text" <?
                                if ($bReadOnly || $productIsSet) echo "disabled readonly" ?> id="CAT_MEASURE_RATIO"
                                       name="CAT_MEASURE_RATIO" value="<?
                                echo htmlspecialcharsbx($str_CAT_MEASURE_RATIO) ?>" size="30">
                                <input type="hidden" id="CAT_MEASURE_RATIO_ID" name="CAT_MEASURE_RATIO_ID" value="<?
                                echo htmlspecialcharsbx($CAT_MEASURE_RATIO_ID) ?>">
                            </td>
                        </tr>
                        <?
                    }
                    ...
                    <tr class="heading">
                        <td colspan="2"><?
                            echo GetMessage("C2IT_PARAMS") ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                        ...
                        <td width="60%"><?
                            ...
                            ?>
                            <select id="CAT_BASE_QUANTITY_TRACE" name="CAT_BASE_QUANTITY_TRACE" <?
                            if ($bReadOnly || $productIsSet) echo "disabled readonly" ?>>
                                <option value="D" <?
                                if ("D" == $str_CAT_BASE_QUANTITY_TRACE) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><?
                                    echo $availQuantityTrace == 'Y' ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                    )
                                </option>
                                <option value="Y" <?
                                if ("Y" == $str_CAT_BASE_QUANTITY_TRACE) echo " selected" ?>><?= GetMessage("C2IT_YES_NEGATIVE") ?></option>
                                <option value="N" <?
                                if ("N" == $str_CAT_BASE_QUANTITY_TRACE) echo " selected" ?>><?= GetMessage("C2IT_NO_NEGATIVE") ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="60%"><?
                            ...
                            <select id="USE_STORE"
                                ...
                                <option value="D" <?
                                if ("D" == $str_CAT_BASE_CAN_BUY_ZERO) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><?
                                    echo $availCanBuyZero == 'Y' ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                    )
                                </option>
                                <option value="Y" <?
                                if ("Y" == $str_CAT_BASE_CAN_BUY_ZERO) echo " selected" ?>><?= GetMessage("C2IT_YES_NEGATIVE") ?></option>
                                <option value="N" <?
                                if ("N" == $str_CAT_BASE_CAN_BUY_ZERO) echo " selected" ?>><?= GetMessage("C2IT_NO_NEGATIVE") ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="60%"><?
                            ...
                            if ($bReadOnly) echo "disabled readonly" ?>>
                                <option value="D" <?
                                if ("D" == $str_CAT_SUBSCRIBE) echo " selected" ?>><?= GetMessage("C2IT_DEFAULT_NEGATIVE") . " (" ?><?
                                    echo 'Y' == $strGlobalSubscribe ? GetMessage("C2IT_YES_NEGATIVE") : GetMessage("C2IT_NO_NEGATIVE") ?>
                                    )
                                </option>
                                <option value="Y" <?
                                if ("Y" == $str_CAT_SUBSCRIBE) echo " selected" ?>><?= GetMessage("C2IT_YES_NEGATIVE") ?></option>
                                <option value="N" <?
                                if ("N" == $str_CAT_SUBSCRIBE) echo " selected" ?>><?= GetMessage("C2IT_NO_NEGATIVE") ?></option>
                            </select>
                        </td>
                    </tr>
                    <?
                    ...
                    <tr class="heading">
                        <td colspan="2"><?
                            echo GetMessage("C2IT_MEASUREMENTS_EXT") ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                        ...
                        <td width="60%"><?
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly || $productIsSet) echo "disabled readonly" ?> id="CAT_BASE_WEIGHT"
                                   name="CAT_BASE_WEIGHT" value="<?
                            echo htmlspecialcharsbx($str_CAT_BASE_WEIGHT) ?>" size="30">
                        </td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                        ...
                        <td width="60%"><?
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_BASE_LENGTH" name="CAT_BASE_LENGTH"
                                   value="<?
                                   echo htmlspecialcharsbx($str_CAT_BASE_LENGTH) ?>" size="30">
                        </td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                        ...
                        <td width="60%"><?
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_BASE_WIDTH" name="CAT_BASE_WIDTH"
                                   value="<?
                                   echo htmlspecialcharsbx($str_CAT_BASE_WIDTH) ?>" size="30">
                        </td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                        ...
                        <td width="60%"><?
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_BASE_HEIGHT" name="CAT_BASE_HEIGHT"
                                   value="<?
                                   echo htmlspecialcharsbx($str_CAT_BASE_HEIGHT) ?>" size="30">
                        </td>
                    </tr>
                    <?
                    if ($productIsSet) {
                ...
                if ($arMainCatalog['SUBSCRIPTION'] == 'Y') {
                    ...
                    <tr class="heading">
                        <td colspan="2"><?
                            echo GetMessage("C2IT_SUBSCR_PARAMS") ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                            echo GetMessage("C2IT_PAY_TYPE") ?></td>
                        <td width="60%">
                            <script type="text/javascript">
                            ...
                            <select id="CAT_PRICE_TYPE" name="CAT_PRICE_TYPE" onchange="ChangePriceType()">
                                <option value="S"<?
                                if ($str_CAT_PRICE_TYPE == "S") echo " selected"; ?>><?
                                    echo GetMessage("C2IT_SINGLE") ?></option>
                                <option value="R"<?
                                if ($str_CAT_PRICE_TYPE == "R") echo " selected"; ?>><?
                                    echo GetMessage("C2IT_REGULAR") ?></option>
                                <option value="T"<?
                                if ($str_CAT_PRICE_TYPE == "T") echo " selected"; ?>><?
                    ...
                    <tr>
                        <td width="40%"><?
                            echo GetMessage("C2IT_PERIOD_LENGTH") ?></td>
                        <td width="60%"><?
                            ...
                            ?>
                            <input type="text" <?
                            if ($bReadOnly) echo "disabled readonly" ?> id="CAT_RECUR_SCHEME_LENGTH"
                                   name="CAT_RECUR_SCHEME_LENGTH" value="<?
                            echo htmlspecialcharsbx($str_CAT_RECUR_SCHEME_LENGTH) ?>" size="10">
                        </td>
                    </tr>
                    <tr>
                        <td width="40%"><?
                            echo GetMessage("C2IT_PERIOD_TIME") ?></td>
                        <td width="60%"><?
                            ...
                            <select id="CAT_RECUR_SCHEME_TYPE" name="CAT_RECUR_SCHEME_TYPE">
                                ...
                                foreach ($periodTimeTypes as $key => $value) {
                                    ?>
                                    <option value="<?= $key ?>"<?
                                    if ($str_CAT_RECUR_SCHEME_TYPE == $key) echo " selected"; ?>><?= $value ?></option><?
                                }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td width="40%"><?
                            echo GetMessage("C2IT_TRIAL_FOR") ?></td>
                        <td width="60%"><?
                    ...
                    <tr>
                        <td width="40%"><?
                            echo GetMessage("C2IT_WITHOUT_ORDER") ?></td>
                        <td width="60%"><?
                            $str_CAT_WITHOUT_ORDER = $arBaseProduct["WITHOUT_ORDER"];
                            if ($bVarsFromForm) $str_CAT_WITHOUT_ORDER = $CAT_WITHOUT_ORDER;
                            ?>
                            <input type="checkbox" <?
                            if ($bReadOnly) echo "disabled readonly" ?> name="CAT_WITHOUT_ORDER" value="Y" <?
                            if ($str_CAT_WITHOUT_ORDER == "Y") echo "checked" ?>>
                        </td>
                    </tr>
                    <?
                }
                ...
                if (!empty($arUserFields)) {
                    ...
                    <tr class="heading">
                    <td colspan="2"><?
                        echo GetMessage("C2IT_UF_FIELDS") ?></td>
                    </tr><?
            ...
            if ('Y' == $arMainCatalog['SUBSCRIPTION']):
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="internal">
                    <tr class="heading">
                        <td><?
                            echo GetMessage("C2IT_VKL") ?></td>
                        <td><?
                            echo GetMessage("C2IT_USERS_GROUP") ?></td>
                        <td><?
                            echo GetMessage("C2IT_ACTIVE_TIME") ?> <sup>1)</sup></td>
                    </tr>
                    <?
                    ...
                    while ($arGroup = $dbGroups->Fetch()) {
                        ...
                        <tr>
                            <td align="center">
                                <input type="checkbox" name="CAT_USER_GROUP_ID_<?= $arGroup["ID"] ?>" value="Y"<?
                                if (isset($arCurProductGroups[$arGroup["ID"]])) echo " checked"; ?>
                            ...
                            <td align="center">
                                ...
                                ?>>
                                    ...
                                    foreach ($periodTimeTypes as $key => $value) {
                                        ?>
                                        <option value="<?= $key ?>"<?
                                        if ($arCurProductGroups[$arGroup["ID"]][1] == $key) echo " selected"; ?>><?= $value ?></option><?
                                    }
                                    ?>
                                </select>
                            </td>
            ...
            if (empty($arDiscountList)) {
                ?><b><?
                echo GetMessage("C2IT_NO_ACTIVE_DISCOUNTS") ?></b><br><?
            } else {
                ...
                <td>ID</td>
                <td><?
                    echo GetMessage("C2IT_SITE") ?></td>
                <td><?
                    echo GetMessage("C2IT_ACTIVITY") ?></td>
                <td><?
                    echo GetMessage("C2IT_NAME") ?></td>
                <td><?
                    echo GetMessage("C2IT_AMOUNT") ?></td>
                <? if ($showDiscountUrl) {
                    ?>
                    <td><?
                    echo GetMessage("C2IT_ACTIONS") ?></td><?
                }
                ?>
                </tr><?
            ...
            if (!$productIsSet) {
                ...
                if ($storeCount > 0) {
                    ...
                    <tr class="heading">
                        <td><?
                            echo GetMessage("C2IT_STORE_NUMBER"); ?></td>
                        <td><? echo GetMessage('C2IT_STORE_ID'); ?></td>
                        <td><?
                            echo GetMessage("C2IT_NAME"); ?></td>
                        <td><?
                            echo GetMessage("C2IT_STORE_ADDR"); ?></td>
                        <td><?
                            echo GetMessage("C2IT_PROD_AMOUNT"); ?></td>
                    </tr>
                    <?
                    foreach ($stores as $storeIndex => $row) {
                        ...
                        <td style="text-align:center;"><input type="text" id="AR_AMOUNT_<?= $row['ID']; ?>"
                                                              ...
                                                              value="<?= htmlspecialcharsbx($row['PRODUCT_AMOUNT']); ?>" <? echo((!$bStore || $bUseStoreControl) ? 'disabled readonly' : ''); ?>><?
                            if ($bStore) {
                    ...
                    if ($bStore) {
                        ...
                        ?><b><? echo GetMessage("C2IT_STORE_NO_STORE"); ?> <a target="_top"
                                                                              href="<?= $storeListUrl ?>"><? echo GetMessage("C2IT_STORE"); ?></a>
                        </b><br><?
                    }
                }
                if (!$bUseStoreControl)
                ...
                if ($bUseStoreControl) {
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="edit-table"
                        ...
                        <tr>
                            <td width="40%"><label
                                        for="CAT_BARCODE_MULTIPLY"><? echo GetMessage('C2IT_BARCODE_MULTIPLY'); ?>
                                    :</label></td>
                            <td width="60%">
                        ...
                        <tr id="tr_CAT_BARCODE"
                            ...
                            <td>
                                ...
                                echo GetMessage("C2IT_MORE") ?>" OnClick="CloneBarcodeField()">
                            </td>
                        </tr>
                        <?
                        if (!empty($arBarcodes)) {
            ...
            if ($activitySubscribeTab) {
                ...
                <div id="subscription-data">
                    ...
                    <table border="0" cellspacing="0" cellpadding="5" width="100%" class="edit-table"
                        ...
                        <tr>
                            <td width="40%"
                                class="field-name"><?= GetMessage('C2IT_NUMBER_ACTIVE_SUBSCRIPTIONS') ?></td>
