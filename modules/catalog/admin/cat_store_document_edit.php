...
?>
    <form enctype="multipart/form-data" method="POST" action="<?= $actionUrl ?>" id="form_b_catalog_store_docs"
          name="form_b_catalog_store_docs" onsubmit="return checkBarcodeSearch();">
        ...
        if ($adminSidePanelHelper->isSidePanelFrame()) {
            if (!$bReadOnly && !$isDocumentConduct) {
                ...
                <input type="button" class="adm-btn-save" name="save_and_conduct"
                       value="<? echo GetMessage("CAT_DOC_ADD_CONDUCT") ?>">
                ...
                <input type="button" class="adm-btn" name="cancellation"
            ...
            if (!$bReadOnly && !$isDocumentConduct) {
                ?>
                <span style="display:inline-block; width:20px; height: 22px;"></span>
                <input type="submit" class="adm-btn-save" name="save_and_conduct"
                       value="<? echo GetMessage("CAT_DOC_ADD_CONDUCT") ?>">
            ...
            ?>
            <input type="submit" class="adm-btn" name="dontsave" id="dontsave"
                   value="<? echo GetMessage("CAT_DOC_CANCEL") ?>">
            <?
        }
