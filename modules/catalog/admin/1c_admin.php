    ...
    if (Loader::includeModule('iblock')):
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    if ($type[0] == "checkbox"):?>
                        ...
                        echo $strOptionName; ?>" id="<?
                        echo $strOptionName; ?>_N" value="N">
                        <input type="checkbox" name="<?
                        echo $strOptionName; ?>" id="<?
                        echo $strOptionName; ?>" value="Y"<?
                        if ($val == "Y") echo " checked"; ?> onclick="Check(this.id);">
                    <? elseif ($type[0] == "text"):?>
                    ...
                    elseif ($type[0] == "mlist"):
                        ...
                        echo $strOptionName; ?>">
                            ...
                            foreach ($type[2] as $key => $value):?>
                                <option value="<?
                                echo htmlspecialcharsbx($key) ?>" <?
                                if (in_array($key, $val)) echo "selected" ?>><?
                                    echo htmlspecialcharsbx($value) ?></option>
                            <?endforeach ?>
                        </select>
                    <?endif ?>
        ...
        <tr class="heading">
            <td id="td_extended_options" colspan="2">
                ...
                <? else:?>
                    <a class="bx-action-href" href="javascript:showExtOptions()"><?
                        echo Loc::getMessage("CAT_1C_EXTENDED_SETTINGS") ?></a>
                <?endif; ?>
            </td>
        </tr>
        <?
