    ...
    <form enctype="multipart/form-data" method="POST" action="<?= $actionUrl ?>" name="catalog_measure_edit">
        ...
        <? if ($classifierMode): ?>
            <tr class="adm-detail-required-field" id="classifier-main-section">
                ...
                <td>
                    <select id="CLASSIFIER_MAIN_SECTION" name="CLASSIFIER_MAIN_SECTION"
                            onchange="makeMeasureTable()"<?= ($bReadOnly) ? " disabled" : "" ?>>
            ...
            <tr class="adm-detail-required-field" id="classifier-sub-section">
                ...
                <td>
                    <select id="CLASSIFIER_SUB_SECTION" name="CLASSIFIER_SUB_SECTION"
                            onchange="makeMeasureTable()" <?= ($bReadOnly) ? " disabled" : "" ?>>
        ...
        <? else: ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" style="width:100px" name="SYMBOL_INTL" value="<?= $str_SYMBOL_INTL ?>"
                           size="45"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" style="width:100px" name="SYMBOL_LETTER_INTL"
                           value="<?= $str_SYMBOL_LETTER_INTL ?>" size="15"/>
                </td>
            </tr>
        <? endif; ?>
        <?
