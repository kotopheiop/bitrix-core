            ...
            <td>
                <select name="IBLOCK_ID">
                    ...
                    while ($db_iblocks->ExtractFields("str_iblock_")) {
                        ...
                        if ($IBLOCK_ID == $str_iblock_ID) echo " selected" ?>><?= $str_iblock_NAME ?>
            ...
            <td>
                <nobr>
                    <input type="text" name="filter_id_start" size="10"
                           value="<? echo htmlspecialcharsex($filter_id_start) ?>">
                    ...
                    <input type="text" name="filter_id_end" size="10"
                           value="<? echo htmlspecialcharsex($filter_id_end) ?>">
                </nobr>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td nowrap>
                    <select name="filter_section">
                        ...
                        <option value="0"<?
                        if ($filter_section == "0") echo " selected" ?>><?= GetMessage("SPS_TOP_LEVEL") ?></option>
                        <?
                        ...
                        while ($bsections->ExtractFields("s_")):
                            ...
                            <option value="<?
                            echo $s_ID ?>"<?
                            if ($s_ID == $filter_section) echo " selected" ?>><?
                            echo str_repeat("&nbsp;.&nbsp;", $s_DEPTH_LEVEL) ?><?
                            echo $s_NAME ?></option><?
                        endwhile;
                        ?>
                    </select><br>
                    <input type="checkbox" name="filter_subsections" value="Y"<?
                    if ($filter_subsections == "Y") echo " checked" ?>> <?= GetMessage("SPS_INCLUDING_SUBS") ?>
                </td>
            </tr>
        <?
        endif;
