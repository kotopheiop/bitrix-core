...
<form method="POST" action="<? echo $APPLICATION->GetCurPage() . $actionParams; ?>" ENCTYPE="multipart/form-data"
    ...
    if ($STEP == 1) {
        ...
        <tr>
            ...
            <td valign="top" width="60%">
                ...
                <input type="button" value="<? echo GetMessage("CICML_F_BUTTON_CHOOSE"); ?>"
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="outFileAction" id="outFileAction_D" value="D" <?
                if ($outFileAction == "D") echo "checked"; ?>> <label for="outFileAction_D"><?
                    echo GetMessage("CICML_OF_DEL") ?></label><br>
                <input type="radio" name="outFileAction" id="outFileAction_H" value="H" <?
                if ($outFileAction == "H") echo "checked"; ?>> <label for="outFileAction_H"><?
                    echo GetMessage("CICML_OF_DEACT") ?></label><br>
                <input type="radio" name="outFileAction" id="outFileAction_F" value="F" <?
                if ($outFileAction == "F") echo "checked"; ?>> <label for="outFileAction_F"><?
        ...
        <tr>
            ...
            <td valign="top" width="60%">
                ...
                <input type="checkbox" name="keepExistingProperties" id="keepExistingProperties_Y" value="Y" <?
                if (isset($keepExistingProperties) && $keepExistingProperties == "Y") echo "checked"; ?>>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="CONVERT_UTF8" id="CONVERT_UTF8_N" value="N" <?
                if ($CONVERT_UTF8 == "N") echo "checked"; ?>> <label for="CONVERT_UTF8_N"><?
                    echo GetMessage("CICML_CONVERT_NO"); ?></label><br>
                <input type="radio" name="CONVERT_UTF8" id="CONVERT_UTF8_Y" value="Y" <?
                if ($CONVERT_UTF8 == "Y") echo "checked"; ?>> <label for="CONVERT_UTF8_Y"><?
                    echo GetMessage("CICML_CONVERT_YES"); ?></label>
            </td>
        </tr>
        <tr>
    ...
    if ($STEP < 2) {
        ...
        echo (($ACTION == "IMPORT") ? GetMessage("CICML_NEXT_STEP_F") : GetMessage("CICML_SAVE")) . " &gt;&gt;" ?>"
               name="submit_btn"><?
    }
    $tabControl->End();
