    ...
    if ($STEP == 3) {
        ...
        <tr>
            ...
            <td width="60%">
                ...
                <small><?
                    echo GetMessage("CATI_IMG_PATH_DESCR") ?></small>
            </td>
        </tr>
        <tr>
            ...
            <td width="60%">
                ...
                <input type="checkbox" name="IMAGE_RESIZE" id="IMAGE_RESIZE_Y"
                       value="Y" <? echo(isset($IMAGE_RESIZE) && 'Y' == $IMAGE_RESIZE ? "checked" : ""); ?>>
            </td>
        </tr>
        <?
        ...
        <tr id="tr_USE_UPDATE_TRANSLIT" style="display: <?= ($USE_TRANSLIT == 'Y' ? 'table-row' : 'none'); ?>;">
            ...
            <td width="60%">
                ...
                <input type="checkbox" name="USE_UPDATE_TRANSLIT" id="USE_UPDATE_TRANSLIT_Y"
                       value="Y"<?= ($USE_UPDATE_TRANSLIT == 'Y' ? ' checked' : ''); ?>>
            </td>
            </tr><?
        }
        ?>
        <tr>
            ...
            <td valign="top" width="60%"><?
                if (!isset($outFileAction) || empty($outFileAction) || !in_array($outFileAction, array('H', 'D', 'M', 'F')))
                    $outFileAction = 'F';
                ?><input type="radio" name="outFileAction" value="H" <?
                if ($outFileAction == "H") echo "checked"; ?>> <? echo GetMessage("CATI_OF_DEACT"); ?><br>
                <input type="radio" name="outFileAction" value="D" <?
                if ($outFileAction == "D") echo "checked"; ?>> <? echo GetMessage("CATI_OF_DEL"); ?><br>
                <input type="radio" name="outFileAction" value="M" <?
                if ($outFileAction == "M") echo "checked"; ?>> <? echo GetMessage("CATI_OF_CAN_BUY"); ?> <span
                        class="required">*</span><br>
                <input type="radio" name="outFileAction" value="F" <?
                if ($outFileAction == "F") echo "checked"; ?>> <? echo GetMessage("CATI_OF_KEEP"); ?>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top" width="60%"><?
                if (!isset($inFileAction) || 'A' != $inFileAction)
                    $inFileAction = 'F';
                ?><input type="radio" name="inFileAction" value="F" <?
                if ($inFileAction == "F") echo "checked"; ?>> <?
                echo GetMessage("CATI_KEEP_AS_IS"); ?><br>
                <input type="radio" name="inFileAction" value="A" <?
                if ($inFileAction == "A") echo "checked"; ?>> <?
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    <input type="checkbox" name="CML2_LINK_IS_XML"
                           value="Y" <? echo('Y' == $CML2_LINK_IS_XML ? 'checked' : ''); ?>>
                </td>
            </tr>
            <?
        }
        ...
        <td width="60%">
            ...
            <small><?
                echo GetMessage("CATI_AUTO_STEP_TIME_NOTE"); ?></small>
        </td>
        </tr>
        <?
    ...
    if ($STEP < 4) {
        ...
        if ($STEP > 2) {
            ...
            if ($fields_type == "R") {
                ...
                <input type="hidden" name="delimiter_other_r"
                       value="<? echo htmlspecialcharsbx($delimiter_other_r); ?>">
