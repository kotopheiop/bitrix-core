    ...
    if ($STEP == 1) {
        ...
        <tr>
            ...
            <td valign="top" width="60%">
                <select name="IBLOCK_TYPE_ID" class="adm-detail-iblock-types"><?
                    ...
                    ?>
                    <option value="">- <?
                        echo GetMessage("CICML_F_IBLOCK_SELECT") ?> -
                    </option><?
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="keepExistingProperties" id="keepExistingProperties_N" value="N" <?
                if ($keepExistingProperties == "N") echo "checked"; ?>> <label
                        for="keepExistingProperties_N"><? echo GetMessage("CML_S_NO"); ?></label><br>
                <input type="radio" name="keepExistingProperties" id="keepExistingProperties_Y" value="Y" <?
                if ($keepExistingProperties == "Y") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="keepExistingData" id="keepExistingData_N" value="N" <?
                if ($keepExistingData == "N") echo "checked"; ?>> <label
                        for="keepExistingData_N"><? echo GetMessage("CML_S_NO"); ?></label><br>
                <input type="radio" name="keepExistingData" id="keepExistingData_Y" value="Y" <?
                if ($keepExistingData == "Y") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="activateFileData" id="activateFileData_Y" value="Y" <?
                if ($activateFileData == "Y") echo "checked"; ?>> <label
                        for="activateFileData_Y"><? echo GetMessage("CML_S_YES"); ?></label><br>
                <input type="radio" name="activateFileData" id="activateFileData_N" value="N" <?
                if ($activateFileData == "N") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="deleteComments" id="deleteComments_N" value="N" <?
                if ($deleteComments == "N") echo "checked"; ?>> <label
                        for="deleteComments_N"><? echo GetMessage("CML_S_NO"); ?></label><br>
                <input type="radio" name="deleteComments" id="deleteComments_Y" value="Y" <?
                if ($deleteComments == "Y") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="cmlDebug" id="cmlDebug_N" value="N" <?
                if ($cmlDebug == "N") echo "checked"; ?>> <label
                        for="cmlDebug_N"><? echo GetMessage("CML_S_NO"); ?></label><br>
                <input type="radio" name="cmlDebug" id="cmlDebug_Y" value="Y" <?
                if ($cmlDebug == "Y") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                ?><input type="radio" name="cmlMemoryDebug" id="cmlMemoryDebug_N" value="N" <?
                if ($cmlMemoryDebug == "N") echo "checked"; ?>> <label
                        for="cmlMemoryDebug_N"><? echo GetMessage("CML_S_NO"); ?></label><br>
                <input type="radio" name="cmlMemoryDebug" id="cmlMemoryDebug_Y" value="Y" <?
                if ($cmlMemoryDebug == "Y") echo "checked"; ?>> <label
        ...
        <tr>
            ...
            <td valign="top" width="60%">
                ...
                <input type="checkbox" name="USE_TRANSLIT" id="USE_TRANSLIT_Y"
                       value="Y" <? echo(isset($USE_TRANSLIT) && 'Y' == $USE_TRANSLIT ? ' checked' : ''); ?>>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top" width="60%">
                ...
                <input type="checkbox" name="ADD_TRANSLIT" id="ADD_TRANSLIT_Y"
                       value="Y" <? echo(isset($ADD_TRANSLIT) && 'Y' == $ADD_TRANSLIT ? ' checked' : ''); ?>>
            </td>
        </tr>
        <?
        if ($ACTION == "IMPORT_SETUP" || $ACTION == 'IMPORT_EDIT' || $ACTION == 'IMPORT_COPY') {
            ...
            <td valign="top" width="60%">
                <input type="text" name="SETUP_PROFILE_NAME" size="40" value="<?
