...
?>
<form method="post" action="<? echo $APPLICATION->GetCurPage() . $actionParams; ?>" name="froogle_setup_form"
      id="froogle_setup_form">
    <?
    ...
    if ($STEP == 1) {
        ...
        <tr>
            ...
            <td width="60%"><b><? echo htmlspecialcharsex($strCatalogDefaultFolder); ?></b>
                ...
                echo htmlspecialcharsbx(strlen($SETUP_FILE_NAME) > 0 ? str_replace($strCatalogDefaultFolder, '', $SETUP_FILE_NAME) : "froogle_" . mt_rand(0, 999999) . ".txt"); ?>"
                       size="50">
            </td>
        </tr>
        <?
