    ...
    if ($STEP == 2) {
        ...
        <tr>
            ...
            <td valign="top" width="60%"><?
                ...
                if ($delimiter_r == "TZP") echo "checked"; ?>><? echo GetMessage("CATI_TZP"); ?><br>
    ...
    if ($STEP < 3) {
        ...
        if ($STEP > 1) {
            ...
            <input type="hidden" name="SETUP_FIELDS_LIST"
                   value="IBLOCK_ID,SETUP_FILE_NAME,fields_type,delimiter_r,delimiter_other_r,first_names_r,first_line_names,field_needed,field_num,field_code"><?
        }
        if ($STEP > 1) {
