...
class CAllCatalogDocs
{
    ...
    public static function OnIBlockElementDelete($productID)
    {
        ...
        if ($productID > 0) {
            $dbDeleteElements = CCatalogStoreDocsElement::getList(
                array(),
                array("ELEMENT_ID" => $productID),
                false,
                false,
                array('ID')
            );
    ...
    public static function OnBeforeIBlockElementDelete($productID)
    {
        ...
        $productID = (int)$productID;
        if ($productID > 0) {
            $dbStoreDocs = CCatalogDocs::getList(
                array(),
                array("PRODUCTS_ELEMENT_ID" => $productID, "STATUS" => "Y"),
                false,
                false,
                array('ID')
            );
