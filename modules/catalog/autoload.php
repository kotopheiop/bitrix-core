...
Loader::registerAutoLoadClasses(
    ...
    array(
        ...
        'CCatalogMeasure' => $DBType . '/measure.php',
        'CCatalogMeasureResult' => $DBType . '/measure.php',
        ...
        'CCatalogMeasureRatio' => $DBType . '/measure_ratio.php',
        'CCatalogProductSet' => $DBType . '/product_set.php',
