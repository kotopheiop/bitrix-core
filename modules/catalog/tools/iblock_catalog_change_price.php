    ...
    <form method="post" id="form_SetValue">
        ...
        <table style="width:100%;padding-bottom: 15px;">
            <tr>
				...
				<span class="adm-select-wrap">
					<select id="initialPriceTypeSelect" class="adm-select inactive-element" style="width: 169px;"
                            disabled>
        ...
        <table class="internal" id="generator_price_table" style="width:auto;margin-bottom:10px;">
            ...
            <tr id="IB_SEG_0">
                ...
                <td width="25%">
                    <input type="text" name="tableValueChangingPriceInput" id="tableValueChangingPriceInput"
                           class="adm-input" placeholder="0.00">
                </td>
                <td width="25%">
					<span class="adm-select-wrap">
                ...
                <td>
                    <table>
                        <tr>
							...
							<span class="adm-select-wrap">
								<select id="resultMaskSelect" class="adm-select inactive-element" style="width: 70px;"
                                        disabled>
