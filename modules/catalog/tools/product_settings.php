...
if (
    ...
    <form name="product_settings_form" id="product_settings_form" action="<? echo $APPLICATION->GetCurPage(); ?>"
          method="GET"><?
        $tabControl->Begin();
        ...
        <tr>
            ...
            <td width="60%"><input type="text" name="max_execution_time" id="max_execution_time" size="3"
                                   value="<? echo $oneStepTime; ?>"></td>
        </tr>
        <?
        $tabControl->Buttons();
        ?>
        <input type="button" id="product_settings_start_button"
               value="<? echo Loc::getMessage('BX_CATALOG_PRODUCT_SETTINGS_UPDATE_BTN') ?>">
        <input type="button" id="product_settings_stop_button"
               value="<? echo Loc::getMessage('BX_CATALOG_PRODUCT_SETTINGS_STOP_BTN') ?>" disabled>
