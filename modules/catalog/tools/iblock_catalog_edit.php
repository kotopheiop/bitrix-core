    ...
    <tr id="tr_SKU">
        ...
        <td style="width: 60%;"><?
            ...
            if ($catalog['CATALOG_TYPE'] == CCatalogSKU::TYPE_OFFERS) {
                ...
                ?><input type="hidden" name="USE_SKU" value="N" id="USE_SKU_N">
                <input data-checkbox="Y" type="checkbox" name="USE_SKU" value="Y"
                       id="USE_SKU_Y"<? echo($showSku ? ' checked' : ''); ?>>
...
<tr id="tr_SUBSCRIPTION" style="display: <? echo $rowDisplay; ?>;">
    ...
    <td style="width: 60%;"><?
        if ($enableSaleRecurring) {
            ...
            ?><input data-checkbox="Y" type="checkbox" name="SUBSCRIPTION" value="Y" id="SUBSCRIPTION_Y" checked
                     disabled>
    ...
    <tr id="tr_YANDEX_EXPORT" style="display: <? echo $rowDisplay; ?>;">
        ...
        <td style="width: 60%;">
            ...
            <input type="checkbox" id="YANDEX_EXPORT_Y" name="YANDEX_EXPORT"
                   value="Y"<? echo($catalog['YANDEX_EXPORT'] == 'Y' ? ' checked' : ''); ?>>
        </td>
    </tr><?
