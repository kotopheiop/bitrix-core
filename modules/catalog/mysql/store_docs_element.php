    ...
    extends CCatalogStoreDocsElementAll
{
    ...
    public static function getList(
        ...
        $arFields = array(
            ...
            "IS_MULTIPLY_BARCODE" => array(
                "FIELD" => "CP.BARCODE_MULTI",
                "TYPE" => "char",
                "FROM" => "INNER JOIN b_catalog_product CP ON (DE.ELEMENT_ID = CP.ID)"
            ),
            "RESERVED" => array(
                "FIELD" => "CP.QUANTITY_RESERVED",
                "TYPE" => "double",
                "FROM" => "INNER JOIN b_catalog_product CP ON (DE.ELEMENT_ID = CP.ID)"
            ),
            ...
            "ELEMENT_IBLOCK_ID" => array(
                "FIELD" => "IE.IBLOCK_ID",
                "TYPE" => "int",
                "FROM" => "INNER JOIN b_iblock_element IE ON (DE.ELEMENT_ID = IE.ID)"
            ),
            "ELEMENT_NAME" => array(
                "FIELD" => "IE.NAME",
                "TYPE" => "string",
