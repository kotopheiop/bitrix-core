...
class CatalogViewedProductTable extends Main\Entity\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'FUSER_ID' => new Main\Entity\IntegerField(
                'FUSER_ID', array(
                'title' => Loc::getMessage('VIEWED_PRODUCT_ENTITY_FUSER_ID_FIELD')
            )
            ),
            'DATE_VISIT' => new Main\Entity\DatetimeField(
                'DATE_VISIT', array(
            ...
            'ELEMENT_ID' => new Main\Entity\IntegerField(
                'ELEMENT_ID', array(
            ...
            'VIEW_COUNT' => new Main\Entity\IntegerField(
                'VIEW_COUNT', array(
                'title' => Loc::getMessage('VIEWED_PRODUCT_ENTITY_VIEW_COUNT_FIELD')
            )
            ),
            'RECOMMENDATION' => new Main\Entity\StringField(
        ...
        if ($elementId > 0) {
            ...
            if (!empty($productInfo)) {
                ...
                $skus = \CIBlockElement::getList(
                    array(),
                    array(
                        'IBLOCK_ID' => $productInfo['OFFER_IBLOCK_ID'],
                        '=PROPERTY_' . $productInfo['SKU_PROPERTY_ID'] => $productInfo['ID']
                    ),
                    false,
                    false,
                    array('ID', 'IBLOCK_ID')
     ...
     * @return array
     */
    public static function getProductSkuMap(
        $iblockId,
        $sectionId,
        $fuserId,
        $excludeProductId,
