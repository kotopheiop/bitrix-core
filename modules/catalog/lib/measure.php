...
class MeasureTable extends Main\Entity\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'IS_DEFAULT' => new Main\Entity\BooleanField(
                'IS_DEFAULT', array(
                'values' => array('N', 'Y'),
                'default_value' => 'N',
