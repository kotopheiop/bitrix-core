...
class CatalogIblockTable extends ORM\Data\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'YANDEX_EXPORT' => new ORM\Fields\BooleanField(
                'YANDEX_EXPORT', array(
                'values' => array('N', 'Y'),
                'default_value' => 'N',
            ...
            'SUBSCRIPTION' => new ORM\Fields\BooleanField(
                'SUBSCRIPTION', array(
                'values' => array('N', 'Y'),
                'default_value' => 'N',
