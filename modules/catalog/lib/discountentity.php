...
class DiscountEntityTable extends ORM\Data\DataManager
{
    ...
    public static function getMap()
    {
        return [
            ...
            'DISCOUNT_ID' => new ORM\Fields\IntegerField(
                'DISCOUNT_ID', [
                'required' => true,
            ...
            'ENTITY' => new ORM\Fields\StringField(
                'ENTITY', [
                'required' => true,
            ...
            'FIELD_TABLE' => new ORM\Fields\StringField(
                'FIELD_TABLE', [
                'required' => true,
