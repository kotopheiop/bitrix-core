                ...
                <ul class="adm-promo-https-content-list">
                    <li class="adm-promo-https-content-list-item">
                        ...
                        <div class="adm-promo-https-content-info">
                            <div class="adm-promo-https-content-info-description"><?= Loc::getMessage("HTTPS_PROMO__CERTIFICATES_FEATURES") ?>
                                :
                            </div>
                            ...
                            <div class="adm-promo-https-content-info-description"><?= Loc::getMessage("HTTPS_PROMO__CERTIFICATE_VENDORS") ?>
                                :
                            </div>
