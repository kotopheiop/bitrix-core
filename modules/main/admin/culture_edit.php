...
?>
    <form method="POST" action="<?= htmlspecialcharsbx($request->getRequestedPage()) ?>" name="form1">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <select name="" onchange="if(this.value != ''){this.form.FORMAT_NAME.value = this.value;}">
                    <option value=""><?
                        echo Loc::getMessage("culture_edit_other") ?></option>
                    <?
        ...
        <tr>
            <td><?
                echo Loc::getMessage('DIRECTION') ?></td>
            <td><select name="DIRECTION">
                    <option value="Y"><?= Loc::getMessage('DIRECTION_LTR') ?></option>
                    <option value="N"<?
                    if ($culture["DIRECTION"] == "N") echo " selected" ?>><?= Loc::getMessage('DIRECTION_RTL') ?></option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr class="heading">
            <td colspan="2"><?
                echo Loc::getMessage("main_culture_edit_date_formats") ?></td>
        <tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_short_date") ?></td>
            <td><input type="text" name="SHORT_DATE_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["SHORT_DATE_FORMAT"] ?>">
                <?
                if ($cultureField["SHORT_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["SHORT_DATE_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_medium_date") ?></td>
            <td><input type="text" name="MEDIUM_DATE_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["MEDIUM_DATE_FORMAT"] ?>">
                <?
                if ($cultureField["MEDIUM_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["MEDIUM_DATE_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_long_date") ?></td>
            <td><input type="text" name="LONG_DATE_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["LONG_DATE_FORMAT"] ?>">
                <?
                if ($cultureField["LONG_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["LONG_DATE_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_full_date") ?></td>
            <td><input type="text" name="FULL_DATE_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["FULL_DATE_FORMAT"] ?>">
                <?
                if ($cultureField["FULL_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["FULL_DATE_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_day_month") ?></td>
            <td><input type="text" name="DAY_MONTH_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["DAY_MONTH_FORMAT"] ?>">
                <?
                if ($cultureField["DAY_MONTH_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["DAY_MONTH_FORMAT"])) ?>
            </td>
        </tr>
        <tr class="heading">
            <td colspan="2"><?
                echo Loc::getMessage("main_culture_edit_time_formats") ?></td>
        <tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_short_time") ?></td>
            <td><input type="text" name="SHORT_TIME_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["SHORT_TIME_FORMAT"] ?>">
                <?
                if ($cultureField["SHORT_TIME_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["SHORT_TIME_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_long_time") ?></td>
            <td><input type="text" name="LONG_TIME_FORMAT" size="20" maxlength="255"
                       value="<?= $cultureField["LONG_TIME_FORMAT"] ?>">
                <?
                if ($cultureField["LONG_TIME_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["LONG_TIME_FORMAT"])) ?>
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_am") ?></td>
            <td><input type="text" name="AM_VALUE" size="10" maxlength="255" value="<?= $cultureField["AM_VALUE"] ?>">
            </td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_edit_pm") ?></td>
            <td><input type="text" name="PM_VALUE" size="10" maxlength="255" value="<?= $cultureField["PM_VALUE"] ?>">
            </td>
        </tr>
        <tr>
            <td colspan="2"
                align="center"><?= BeginNote() ?><?= Loc::getMessage("main_culture_edit_note") ?><?= EndNote() ?></td>
        <tr>
        <tr class="heading">
            <td colspan="2"><?
                echo Loc::getMessage("main_culture_numbers_format") ?></td>
        <tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_numbers_thousands_sep") ?></td>
            <td><input type="text" name="NUMBER_THOUSANDS_SEPARATOR" size="10" maxlength="255"
                       value="<?= $cultureField["NUMBER_THOUSANDS_SEPARATOR"] ?>"></td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_numbers_decimal_sep") ?></td>
            <td><input type="text" name="NUMBER_DECIMAL_SEPARATOR" size="10" maxlength="255"
                       value="<?= $cultureField["NUMBER_DECIMAL_SEPARATOR"] ?>"></td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_numbers_decimals") ?></td>
            <td><input type="text" name="NUMBER_DECIMALS" size="10" maxlength="255"
                       value="<?= $cultureField["NUMBER_DECIMALS"] ?>"></td>
        </tr>
        <tr>
            <td><?
                echo Loc::getMessage("main_culture_numbers_example") ?></td>
        ...
        <tr>
            <td colspan="2"
                align="center"><?= BeginNote() ?><?= Loc::getMessage("main_culture_edit_note_currencies", ["#LANG#" => LANGUAGE_ID]); ?><?= EndNote() ?></td>
        <tr>
            <?
            endif ?>
            <?
