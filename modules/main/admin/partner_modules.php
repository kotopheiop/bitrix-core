...
if (!empty($_SESSION["MP_MOD_DELETED"]) && in_array(LANGUAGE_ID, array("ru", "ua"))) {
    ...
    <form action="" method="POST">
        ...
        <input type="radio" name="reason" value="1" id="r1">&nbsp;<label
                for="r1"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON1") ?></label><br/>
        <input type="radio" name="reason" value="2" id="r2">&nbsp;<label
                for="r2"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON2") ?></label><br/>
        <input type="radio" name="reason" value="3" id="r3">&nbsp;<label
                for="r3"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON3") ?></label><br/>
        <input type="radio" name="reason" value="4" id="r4">&nbsp;<label
                for="r4"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON4") ?></label><br/>
        <input type="radio" name="reason" value="5" id="r5">&nbsp;<label
                for="r5"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON5") ?></label><br/>
        <input type="radio" name="reason" value="6" id="r6" checked>&nbsp;<label
                for="r6"><?= GetMessage("MOD_SMP_DELETE_OPINION_REASON6") ?></label><br/><br/>
