    ...
    <? if ($arPoints[$arTestID]["STATE"]["COMMENTS"]["SYSTEM"]["PREVIEW"]):?>
        <div class="checklist-popup-test">
            ...
            <div class="checklist-popup-test-text">
                ...
                <a style="display:<?= $display ?>" id="show_detail_link"
                   onclick="ShowDetailComment('<?= htmlspecialcharsbx(CUtil::JSEscape($arTestID)) ?>')"
            ...
            <div class="checklist-top-info">
                ...
                <div class="checklist-top-info-result">
                    ...
                    <div class="checklist-top-info-result-right">
                        <div class="checklist-top-info-left-item"><?= GetMessage("CL_TEST_TOTAL") ?>:<span
                                    class="checklist-top-info-left-item-qt"><?= $arSectionStat["TOTAL"] ?></span></div>
                        <div class="checklist-top-info-left-item"><?= GetMessage("CL_TEST_CHECKED") ?>:<span
                                    class="checklist-test-successfully"><?= $arSectionStat["CHECK"] ?></span></div>
                        <div class="checklist-top-info-left-item"><?= GetMessage("CL_TEST_FAILED") ?>:<span
                                    class="checklist-test-unsuccessful"><?= $arSectionStat["FAILED"] ?></span></div>
                        <div class="checklist-top-info-left-item"><?= GetMessage("CL_TEST_SKIP_REQUIRE") ?>:<span
                                    class="checklist-top-info-left-item-qt"><?= $arSectionStat["REQUIRE_SKIP"] ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <ul class="checklist-testlist">
                <? foreach ($arReport["STRUCTURE"] as $rkey => $rFields):$num = 1; ?>
                    <li class="checklist-testlist-level1">
                        <div id="<?= $rkey ?>_name" class="checklist-testlist-text"><?= $rFields["NAME"]; ?><span
                            ...
                            <? foreach ($rFields["CATEGORIES"] as $skey => $sFields): $num = 1; ?>
                                <li class="checklist-testlist-level2">
                                    <div class="checklist-testlist-text" id="<?= $skey ?>_name">
                                        <?= $sFields["NAME"]; ?><span id="<?= $skey; ?>_stat"
                                                                      class="checklist-testlist-amount-test"></span>
                                        <span class="checklist-testlist-marker-list"></span>
                                    </div>
