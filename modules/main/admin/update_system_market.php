    ...
    <div class="adm-detail-content-wrap">
        <div class="adm-detail-content">
            <div class="adm-detail-title"
                 style="border-bottom: 1px solid #f9eaea; padding-right: 0px;"><?= htmlspecialcharsbx($sectionName) ?>
                        ...
                        if (strlen($moduleCode) <= 0) {
                            ...
                            <td valign="top" width="33%" style="padding: 0 13px 10px 0;">
                                <div class="mp-over" onmouseover="mp_hl(this, true)" onmouseout="mp_hl(this, false)">
                                    <div class="mp-over-inner">
                                        <div class="mp-name"><a href="<?= $arM["url"] ?>"
                                                                title="<?= $arM["name"] ?>"><?= $arM["name"] ?></a>
                                        </div>
                                        <a href="<?= $arM["url"] ?>" title="<?= $arM["name"] ?>"><span
                                                    class="mp-list-slide-block-image"
                                                    style="background: url('<?= $arM["logo"]["src"] ?>') center center no-repeat; width:<?= $arM["logo"]["width"] ?>px; height:<?= $arM["logo"]["height"] ?>px; display:block; border: 1px solid #c0c0c0; float: left;">
												<?
                                                if (!empty($arM["icons"]) > 0) {
                                                    foreach ($arM["icons"] as $v) {
                                                        ?>
                                                        <img src="<?= $v["src"] ?>" border="0"
                                                             style="<?= $v["styles"] ?>" width="<?= $v["width"] ?>"
                                                             height="<?= $v["height"] ?>"/>
                                                        <?
                                                    }
                                                }
                                            ...
                                            <div>
                                                ...
                                                if ($arM["freeModule"] == "Y") {
                                                    ...
                                                    if (intval($arM["oldPrice"]) > 0) {
                                                        ?>
                                                        <div class="mp-price"><s><?= intval($arM["oldPrice"]) ?></s>&nbsp;&nbsp;<span
                                                                style="color:red;"><?= $arM["price"] ?></span></div><?
                                                    } else {
                                                        ?>
                            ...
                            <div style="float:left; width:190px; padding-right: 15px;">
                                <div style="display: inline-block;"><span
                                            title="<?= htmlspecialcharsbx($arM["name"]) ?>"
                                            class="mp-list-slide-block-image"
                                            style="background: url('<?= $arM["logo"]["src"] ?>') center center no-repeat; width:<?= $arM["logo"]["width"] ?>px; height:<?= $arM["logo"]["height"] ?>px; display:block; border: 1px solid #c0c0c0; float: left;">
										<?
                                        if (!empty($arM["icons"]) > 0) {
                                            foreach ($arM["icons"] as $v) {
                                                ?>
                                                <img src="<?= $v["src"] ?>" border="0" style="<?= $v["styles"] ?>"
                                ...
                                <div id="mp-price-bar">
                                    <div style="float:left;">
                                        ...
                                        if ($arM["freeModule"] == "Y") {
                                            ...
                                            <?
                                            if (intval($arM["oldPrice"]) > 0) {
                                                ?><s><?= intval($arM["oldPrice"]) ?></s>&nbsp;&nbsp;<span
                                                        style="color:red;"><?= $arM["price"] ?></span><?
                                            } else {
                                                ?><?= $arM["price"]; ?><?
                                            }
                                            ?></div><?
                                    ...
                                    <div class="mp-buttons">
                                        ...
                                        if ($arM["freeModule"] == "Y") {
                                            ...
                                            if ($arM["installedDemo"] != "Y") {
                                                ?><a href="<?= $arM["url2basket"] ?>" target="_blank"
                                                     class="adm-btn adm-btn-green"><?= GetMessage("USM_BUY") ?></a><?
                                            }
                                            if ($arM["canDemo"] == "Y") {
                                                ?><a href="<?= $arM["urlInstall"] ?>" target="_blank"
                                ...
                                <div class="mp-tabs">
                                    ...
                                    ?>
                                        <div class="screenshot-block">
                                            ...
                                            <div id="scrollable-screenshot" class="scrollable"
                                                 style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 507px;">
                                                <ul style="margin: 0pt; padding: 0pt; position: relative; list-style-type: none; z-index: 1; width: 676px; left: 0px;">
                                                    <? foreach ($arM["images"]["image"] as $val) {
                                                        if ($val["video"] == "Y") {
                                                            ?>
                                                            <li
                                                            style="overflow: hidden; float: left; width: <?= $val["width"] ?>px; height: <?= $val["height"] ?>px; border: 1px solid #cfcfcf;">
                                                            <div style="display:none; width:645px; height:490px;"
                                                                 id="module-video"><? $APPLICATION->IncludeComponent(
                                                                    "bitrix:player",
                                                                    "",
                                                                    array(
                                                                        "PLAYER_TYPE" => "auto",
                                                            ...
                                                            <a class="screenshot-video"><img
                                                                        width="<?= $val["width"] ?>"
                                                                        height="<?= $val["height"] ?>" alt=""
                                                                        src="<?= $val["small"] ?>"></a>
                                                            </li>
                                                            <?
                                                        } else {
                                                            ...
                                                            <li
                                                            style="overflow: hidden; float: left; width: <?= $val["width"] ?>px; height: <?= $val["height"] ?>px; border: 1px solid #cfcfcf;">
                                                            <a rel="module_screenshots" href="<?= $val["big"] ?>"
                                                               class="screenshot-image"><img
                                                                        width="<?= $val["width"] ?>"
                                                                        height="<?= $val["height"] ?>" alt=""
                                                                        src="<?= $val["small"] ?>"></a>
                                                            </li><?
                                    ...
                                    if (!empty($arM["updates"])) {
                                        ...
                                        foreach ($arM["updates"]["version"] as $arVersion) {
                                            ?>
                                            <tr>
                                            <td valign="top" style="padding-right:10px;"><b><?= $arVersion["id"] ?></b>
                                            </td>
                                            <td valign="top"
                                                style="padding-bottom:10px;padding-left:10px;"><?= $arVersion["descr"] ?></td>
                                            </tr><?
                                        }
                                        ?></table><?
                                    }
                                                            ...
                                                            <ul style="margin: 0pt; padding: 0pt; position: relative; list-style-type: none; z-index: 1; width: 1470px; left: -490px;">
                                                                <? foreach ($arM["moreItems"]["item"] as $moreItem) {
                                                                    ...
                                                                    <li style="overflow: hidden; float: left; width: 225px; height: 114px;">
                                                                        <div class="mp-name"><a
                                                                                    href="<?= $moreItem["url"] ?>"
                                                                                    title="<?= $moreItem["name"] ?>"><?= $moreItem["name"] ?></a>
                                                                        </div>
                                                                        <a href="<?= $moreItem["url"] ?>"
                                                                           title="<?= $moreItem["name"] ?>"><span
                                                                                    class="mp-list-slide-block-image"
                                                                                    style="background: url('<?= $moreItem["logo"]["src"] ?>') center center no-repeat; width:<?= $moreItem["logo"]["width"] ?>px; height:<?= $moreItem["logo"]["height"] ?>px; display:block; border: 1px solid #c0c0c0; float: left;">
																				<?
                                    ...
                                    if (!empty($arM["comments"]) > 0) {
                                        ...
                                        foreach ($arM["comments"]["comment"] as $v) {
                                            ...
                                            <hr class="comments-delimiter" noshade>
                                            <div>
                                                <div class="mp-comment-title"><b><?= $v["author"] ?></b> <span
                                                            class="mp-grey comment-created"><?= $v["date"] ?></span>
                                                </div>
                                                <?= $v["text"] ?>
                                            </div>
                                            <?
