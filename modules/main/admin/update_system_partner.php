                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <br>
                                                <input TYPE="button" id="id_register_btn" NAME="register_btn"
                                                       value="<?= GetMessage("SUPP_SUBR_BUTTON") ?>"
                            ...
                            <tr>
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="icon-new">
                                                <div class="icon icon-main-partner"></div>
                                            </td>
                                            <td>
                                                ...
                                                <input TYPE="button" ID="install_updates_button"
                                                       NAME="install_updates"<?= (($countModuleUpdates <= 0 || $bLockControls) ? " disabled" : "") ?>
                    ...
                    <tr>
                        <td valign="top">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="icon-new">
                                        <div class="icon icon-update-partner"></div>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input TYPE="button" ID="install_updates_sel_button"
                                   NAME="install_updates"<?= (($countModuleUpdates <= 0) ? " disabled" : "") ?>
                    ...
                    <SCRIPT LANGUAGE="JavaScript">
                        ...
                        function ShowLicence() {
                            ...
                            agrDialog = new BX.CDialog({
                                ...
                                'width': '650',
                                'height': '485',
                                'title': '<?=GetMessageJS("SUP_SUBT_LICENCE")?>',
                                buttons: [{
                                    name: '<?= GetMessageJS("SUP_APPLY") ?>',
                                    value: '<?= GetMessageJS("SUP_APPLY") ?>',
                                    id: 'licence_agree_button',
                                    onclick: 'AgreeLicence()'
                                }]
                            });
                            agrDialog.Show();
                        }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input TYPE="button" ID="id_coupon_btn" NAME="coupon_btn"
                                           value="<?= GetMessage("SUP_SUAC_ADD") ?>" onclick="ActivateCoupon()">
                                </td>
                            </tr>
                        </table>
                    </div>
