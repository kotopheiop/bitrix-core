...
?>
    ...
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>?" name="form1">
        ...
        <tr class="adm-detail-required-field">
            ...
            <td width="60%"><input type="text" name="NAME" size="40" maxlength="100"
                                   value="<? echo CTask::GetLangTitle($str_NAME, $str_MODULE_ID); ?>"></td>
        </tr>
        <tr class="adm-detail-required-field">
                ...
                <table border="0" cellpadding="5" cellspacing="0" align="center">
                    ...
                    <tr>
                        <td align="center" colSpan="2">
                            <div id='__noneopermess' style="display: none;"></div>
                        </td>
                    </tr>
                </table>
                <script>
