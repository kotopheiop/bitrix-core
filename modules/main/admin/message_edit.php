...
?>
    <form method="POST" action="<? echo $APPLICATION->GetCurPage() ?>" name="form1" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td><?
                ...
                if ($ID > 0 && $COPY_ID <= 0) {
                    ...
                    ?><input type="hidden" name="EVENT_NAME" value="<? echo $str_EVENT_NAME ?>"><a
                            href="type_edit.php?EVENT_NAME=<? echo $str_EVENT_NAME ?>"><?
                        echo $type_NAME ?></a> [<? echo $str_EVENT_NAME ?>]<?
                } else {
                    $id_1st = false;
                    ?>
                    <select name="EVENT_NAME" style="width:370px"
        ...
        <tr>
            ...
            <td><input type="checkbox" name="ACTIVE" id="active" value="Y"<? if ($str_ACTIVE == "Y") echo " checked" ?>>
            </td>
        </tr>
        ...
        <tr class="adm-detail-required-field">
            ...
            <td><input type="text" name="EMAIL_FROM" size="50" maxlength="255" value="<? echo $str_EMAIL_FROM ?>"
                       onfocus="t=this">
            </td>
        </tr>
        <tr class="adm-detail-required-field">
            <td><? echo GetMessage('MSG_EMAIL_TO') ?></td>
            <td><input type="text" name="EMAIL_TO" size="50" maxlength="255" value="<? echo $str_EMAIL_TO ?>"
                       onfocus="t=this"></td>
        </tr>
        ...
        if (!$show_ext):
            ...
            <tr id="msg_ext0">
                <td></td>
                <td><a href="javascript:void(0)" onclick="return ShowExtH()"><?
                        echo GetMessage("MSG_EXT") ?></a></td>
            </tr>
        <?
        endif;
        ?>
        ...
        <tr id="msg_ext3" <?= $str_show_ext ?>>
            ...
            <td><input type="text" name="REPLY_TO" size="50" maxlength="255" value="<? echo $str_REPLY_TO ?>"
                       onfocus="t=this">
            </td>
        </tr>
        ...
        <tr id="msg_ext4" <?= $str_show_ext ?>>
            ...
            <td><input type="text" name="IN_REPLY_TO" size="50" maxlength="255" value="<? echo $str_IN_REPLY_TO ?>"
                       onfocus="t=this">
            </td>
        </tr>
        ...
        <tr id="msg_ext5" <?= $str_show_ext ?>>
            ...
            <td>
                <input type="text" name="PRIORITY" id="MSG_PRIORITY" size="10" maxlength="255"
        ...
        <? foreach ($arADDITIONAL_FIELD as $additionalField): ?>
            <tr id="msg_ext<?= ++$msg_ext ?>" <?= $str_show_ext ?>>
                <td>
                    <input type="text" name="ADDITIONAL_FIELD[NAME][]" size="20" maxlength="255"
                           value="<? echo htmlspecialcharsbx($additionalField['NAME']) ?>" onfocus="t=this">:
                </td>
                <td>
                    <input type="text" name="ADDITIONAL_FIELD[VALUE][]" size="55" maxlength="255"
                           value="<? echo htmlspecialcharsbx($additionalField['VALUE']) ?>" onfocus="t=this">
                </td>
            </tr>
        <? endforeach; ?>
        ...
        <tr>
            ...
            <td><input type="text" name="SUBJECT" size="50" maxlength="255" value="<? echo $str_SUBJECT ?>"
                       onfocus="t=this"></td>
        </tr>
        <tr class="heading">
            ...
            <td>
                <select name="SITE_TEMPLATE_ID">
                    ...
                    <? foreach ($arMailSiteTemplate as $mailTemplate): ?>
                        <option value="<?= $mailTemplate['ID'] ?>" <?= ($mailTemplate['ID'] == $str_SITE_TEMPLATE_ID ? 'selected' : '') ?>>
                            [<?= $mailTemplate['ID'] ?>] <?= $mailTemplate['NAME'] ?></option>
                    <? endforeach; ?>
                </select>
            </td>
        </tr>
