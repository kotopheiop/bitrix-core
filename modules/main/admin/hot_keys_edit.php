...
<form method="POST" action="<?= $APPLICATION->GetCurPage() ?>" name="hkform">
    ...
    <tr class="adm-detail-required-field">
        ...
        <td><textarea name="CODE" rows="5" cols="50"
                      maxlength="255" <?= $str_IS_CUSTOM ? '' : 'disabled' ?>><?= $str_CODE ?></textarea></td>
    </tr>
    <tr>
        <td><?= GetMessage("HK_CLASS_NAME") ?>:</td>
        <td><input type="text" name="CLASS_NAME" size="45" maxlength="255"
                   value="<?= $str_CLASS_NAME ?>" <?= $str_IS_CUSTOM ? '' : 'disabled' ?>></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="TITLE_OBJ" size="45" maxlength="255"
                   value="<?= $str_TITLE_OBJ ?>" <?= $str_IS_CUSTOM ? '' : 'disabled' ?>></td>
    </tr>

    <tr>
        <td><?= GetMessage("HK_URL") ?>:</td>
        <td><input type="text" name="URL" size="45" maxlength="255"
                   value="<?= $str_URL ?>" <?= $str_IS_CUSTOM ? '' : 'disabled' ?>></td>
    </tr>
