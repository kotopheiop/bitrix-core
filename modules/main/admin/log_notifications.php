...
$notifyList = LogNotificationTable::getList(
    array(
...
$adminList->AddHeaders(
    array(
        ...
        array(
            "id" => "ACTIVE",
            "content" => Loc::getMessage("log_notifications_active"),
            "sort" => "ACTIVE",
            "default" => true
        ),
        array(
            "id" => "NAME",
            "content" => Loc::getMessage("log_notifications_name"),
            "sort" => "NAME",
            "default" => true
        ),
        array(
            "id" => "AUDIT_TYPE_ID",
            "content" => Loc::getMessage("log_notifications_type"),
            "sort" => "AUDIT_TYPE_ID",
            "default" => true
        ),
        array(
            "id" => "ITEM_ID",
            "content" => Loc::getMessage("log_notifications_object"),
            "sort" => "ITEM_ID",
            "default" => true
        ),
        array(
            "id" => "USER_ID",
            "content" => Loc::getMessage("log_notifications_user"),
            "sort" => "USER_ID",
            "default" => true
        ),
        array(
            "id" => "CHECK_INTERVAL",
            "content" => Loc::getMessage("log_notifications_interval"),
            "sort" => "CHECK_INTERVAL",
            "default" => true
        ),
        array(
            "id" => "ALERT_COUNT",
            "content" => Loc::getMessage("log_notifications_count"),
            "sort" => "ALERT_COUNT",
            "default" => true
        ),
        array(
            "id" => "DATE_CHECKED",
            "content" => Loc::getMessage("log_notifications_date_last"),
            "sort" => "DATE_CHECKED",
            "default" => true
        ),
        array(
            "id" => "REMOTE_ADDR",
            "content" => Loc::getMessage("log_notifications_ip"),
            "sort" => "REMOTE_ADDR",
            "default" => false
        ),
        array(
            "id" => "USER_AGENT",
            "content" => Loc::getMessage("log_notifications_browser"),
            "sort" => "USER_AGENT",
            "default" => false
        ),
        array(
            "id" => "REQUEST_URI",
            "content" => Loc::getMessage("log_notifications_page"),
            "sort" => "REQUEST_URI",
            "default" => false
        ),
    )
...
while ($notification = $notifyList->fetch()) {
    ...
    $row = &$adminList->AddRow(
        $id,
        $notification,
        "log_notification_edit.php?ID=" . $id . "&lang=" . LANGUAGE_ID,
        Loc::getMessage("log_notifications_edit")
    );
    ...
    $row->AddViewField(
        "AUDIT_TYPE_ID",
        '<a href="log_notification_edit.php?ID=' . $id . '&amp;lang=' . LANGUAGE_ID . '" title="' . Loc::getMessage(
            "log_notifications_edit"
        ) . '">' . htmlspecialcharsbx($types[$notification["AUDIT_TYPE_ID"]]) . '</a>'
    );
    ...
    $arActions[] = array(
        "ICON" => "edit",
        "TEXT" => Loc::getMessage("log_notifications_edit1"),
        "ACTION" => $adminList->ActionRedirect("log_notification_edit.php?ID=" . $id)
    );
    $arActions[] = array(
        "ICON" => "copy",
        "TEXT" => Loc::getMessage("log_notifications_copy"),
        "ACTION" => $adminList->ActionRedirect("log_notification_edit.php?COPY_ID=" . $id)
    );
    $arActions[] = array("SEPARATOR" => true);
    $arActions[] = array(
        "ICON" => "delete",
        "TEXT" => Loc::getMessage("log_notifications_delete"),
        "ACTION" => "if(confirm('" . Loc::getMessage(
                "log_notifications_delete_conf"
