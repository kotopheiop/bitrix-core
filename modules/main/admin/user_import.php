...
<form method="post" enctype="multipart/form-data" action="<?= $APPLICATION->GetCurPage() ?>" name="import_user_form">
    ...
    if ($tabStep == 1):
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <input type="radio" name="dataSource" id="source-csv"
                       value="csv"<? if ($dataSource == "csv"):?> checked<?endif ?>/><label
    ...
    if ($tabStep == 2 && $dataSource == "csv"):
        ...
        <tr class="adm-detail-required-field">
            ...
            <td>
                <input type="radio" name="delimeter" id="delimeter-semicolon"
                       value="semicolon"<? if ($delimeter == "semicolon"):?> checked<?endif ?>/><label
                        for="delimeter-semicolon"><?= GetMessage("USER_IMPORT_DELIMETER_SEMICOLON") ?></label><br/>

                <input type="radio" name="delimeter" id="delimeter-comma"
                       value="comma"<? if ($delimeter == "comma"):?> checked<?endif ?>/><label
                        for="delimeter-comma"><?= GetMessage("USER_IMPORT_DELIMETER_COMMA") ?></label><br/>

                <input type="radio" name="delimeter" id="delimeter-tabulation"
                       value="tabulation"<? if ($delimeter == "tabulation"):?> checked<?endif ?>/><label
                        for="delimeter-tabulation"><?= GetMessage("USER_IMPORT_DELIMETER_TABULATION") ?></label><br/>

                <input type="radio" name="delimeter" id="delimeter-space"
                       value="space"<? if ($delimeter == "space"):?> checked<?endif ?>/><label
    ...
    <?endif ?>
        ...
        <tr>
            <td></td>
            <td>
                <input type="checkbox" name="ignoreDuplicate" id="ignore-duplicate"
                       value="Y"<? if ($ignoreDuplicate == "Y"):?> checked<?endif ?>/> <label
