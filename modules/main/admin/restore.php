...
$mArr_ru = array(
    ...
    "BEGIN" => "
			...
			<b>������������:</b> <a href='https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2031' target='_blank'>https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2031</a>
			</p>
			",
    "ARC_DOWN" => "������� ��������� ����� � �������� �����",
...
function html($ar)
{
    ...
    <div class="wrap <?= LANG ?>">
        <form name="restore" id="restore" action="restore.php" enctype="multipart/form-data" method="POST"
              onsubmit="this.action='restore.php?lang=<?= LANG ?>&'+strAdditionalParams">
            ...
            <section class="content">
                <div class="content-container">
                    <table class="content-table">
                        ...
                        <tr>
                            <td style="padding:10px;font-size:10pt"
                                valign="<?= $ar['TEXT_ALIGN'] ? $ar['TEXT_ALIGN'] : 'top' ?>">
                                <?= $ar['TEXT'] ?>
                            </td>
                        </tr>
                        <tr>
