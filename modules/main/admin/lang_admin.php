...
while ($arRes = $rsData->NavNext(true, "f_")) {
    $row =& $lAdmin->AddRow(
        $f_ID,
        $arRes,
        "lang_edit.php?LID=" . $f_ID . "&lang=" . LANGUAGE_ID,
        GetMessage("LANG_EDIT_TITLE")
    );
    $row->AddViewField(
        "ID",
        '<a href="lang_edit.php?lang=' . LANGUAGE_ID . '&amp;LID=' . $f_ID . '" title="' . GetMessage(
            "LANG_EDIT_TITLE"
        ) . '">' . $f_ID . '</a>'
    );
    ...
    $arActions[] = array(
        ...
        "ACTION" => $lAdmin->ActionRedirect("lang_edit.php?LID=" . $f_ID)
    );
    ...
    if ($isAdmin) {
        $arActions[] = array(
            ...
            "ACTION" => $lAdmin->ActionRedirect("lang_edit.php?COPY_ID=" . $f_ID)
        );
