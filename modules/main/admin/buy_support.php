                            ...
                            if (em.length > 0 || pn.length > 0) {
                                BX.ajax.post(
                                    'https://www.1c-bitrix.ru/buy_tmp/key_update.php',
                                    {
                                        ...
                                        "email": em,
                                        "name": nm,
                                        "license_key": "<?=CUtil::JSEscape($lkeySign)?>",
                                        "site": "<?=CUtil::JSEscape($_SERVER["HTTP_HOST"])?>"
                                    }
                                );
                                BX.show(BX('ok'));
                                BX.hide(BX('req'));
                    ...
                    <div id="req">
                        ...
                        <table style="border-bottom: 1px solid #dbdbda;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px 0 5px 15px;"><input type="text" name="phone" value=""
                                                                            id="phone"></td>
                            </tr>
                            <tr>
                        ...
                        <br/>
                        <a href="javascript:void(0)" onclick="sendRequest();"
                           class="adm-btn adm-btn-save"><?= GetMessage("BUY_SUP_BUTTON") ?></a>
                    </div>
                </div>
                <br/><br/>
