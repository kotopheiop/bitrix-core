...
if ($_REQUEST["TEST_ID"] && $arPoints[$_REQUEST["TEST_ID"]]) {
        ...
        <div class="checklist-popup-tes-status-wrap" id="checklist-popup-tes-status">
            ...
            <span
                    class="checklist-popup-tes-status"><span
                        ...
                        class="checklist-popup-tes-successfully-r"></span><input name="checklist-form-radio"
                                                                                 type="radio" value="A" id="A_status"/></span>
            <span
                    class="checklist-popup-tes-status"><span
                        class="checklist-popup-tes-fails-l"></span><span
                        class="checklist-popup-tes-fails-c"><?= GetMessage("CL_F_STATUS"); ?></span><span
                        class="checklist-popup-tes-fails-r"></span><input name="checklist-form-radio" value="F"
                                                                          id="F_status" name="checklist-form-radio"
                    ...
                    class="checklist-popup-tes-status"><span
                        ...
                        class="checklist-popup-tes-not-necessarily-r"></span><input name="checklist-form-radio"
                                                                                    type="radio" value="S"
                                                                                    id="S_status"/></span>
        </div>
    </div>
    ...
    <script>
        ...
        function ShowDetailComment() {
            ...
            BX.onCustomEvent(this, "onAfterDetailReportShow", [{
                reportNode: content,
                id: testID,
                parent: DetailWindow
            }]);
        ...
        function ShowStatusAlert(bindElement, text, hide, class_name) {
            ...
            if (hide == true)
                BX(bindElement).onmouseout = function () {
                    bx_alert.close();
                };
            BX.addCustomEvent(Dialog, "OnWindowClose", function () {
                if (bx_alert) bx_alert.close();
            });
            bx_alert.show();
        }
