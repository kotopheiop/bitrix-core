    ...
    <div class="settings-form">
        <form name="list_settings">
            ...
            <table cellspacing="0" width="100%">
                ...
                <tr>
                    <td width="0">
                        <select class="select" name="all_columns" id="list_settings_all_columns" size="10" multiple
                                onchange="document.list_settings.add.disabled=(this.selectedIndex == -1);">
                            <?
                            $bNeedSort = false;
                    ...
                    <td align="center" width="50%"><input type="button" name="add" value="&nbsp; &gt; &nbsp;"
                                                          title="<?= GetMessage("admin_lib_sett_sel_title") ?>" disabled
                                                          onclick="BX.selectUtils.addSelectedOptions(document.list_settings.all_columns, 'list_settings_selected_columns');">
                    </td>
                    <td width="0">
                        <select class="select" name="selected_columns" id="list_settings_selected_columns" size="10"
                                multiple
                                onchange="var frm=document.list_settings; frm.up.disabled=frm.down.disabled=frm.del.disabled=(this.selectedIndex == -1);">
                            <?
                    ...
                    <td align="center" width="50%">
                        <input type="button" name="up" class="button" value="<?= GetMessage("admin_lib_sett_up") ?>"
                               title="<?= GetMessage("admin_lib_sett_up_title") ?>" disabled="disabled"
                               onclick="BX.selectUtils.moveOptionsUp(document.list_settings.selected_columns);"/><br/>
                        <input type="button" name="down" class="button" value="<?= GetMessage("admin_lib_sett_down") ?>"
                               title="<?= GetMessage("admin_lib_sett_down_title") ?>" disabled="disabled"
                               onclick="BX.selectUtils.moveOptionsDown(document.list_settings.selected_columns);"/><br/>
                        <input type="button" name="del" class="button" value="<?= GetMessage("admin_lib_sett_del") ?>"
                               title="<?= GetMessage("admin_lib_sett_del_title") ?>" disabled="disbled"
                               onclick="BX.selectUtils.deleteSelectedOptions('list_settings_selected_columns'); document.list_settings.selected_columns.onchange();"/><br/>
                    </td>
                </tr>
            </table>
...
?>
    <input class="adm-btn-save" type="button" value="<?= GetMessage("admin_lib_sett_save") ?>"
