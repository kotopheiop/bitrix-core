            ...
            <? foreach ($arResult["CATEGORIES"] as $category_id => $arCategory):
                ...
                <tr onclick="window.location='<?= CUtil::JSEscape($arItem["URL"]); ?>';">
                    ...
                    <? else:?>
                        <th>&nbsp;</th>
                    <?endif ?>
                    <td class="adm-search-item"
                        <? if ($arItem["TITLE"] != '' && $arItem["TITLE"] != $arItem["NAME"]): ?>title="<?= $arItem["TITLE"] ?>"<?endif ?>>
                        <a href="<?= $arItem["URL"] ?>"><? if ($arItem["ICON"] != ''):?><span
                                class="adm-submenu-item-link-icon <?= $arItem["ICON"] ?>"></span><?endif ?><span
                                    class="adm-submenu-item-name-link-text"><?= $arItem["NAME"] ?></span></a>
                    </td>
                </tr>
            <?endforeach; ?>
            <?endforeach; ?>
