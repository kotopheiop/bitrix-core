...
<script>
    ...
    window.BXAuthForm = function () {
        ...
        if (window != top) {
            ...
            top.obForm.onsubmit = function () {
                top.ShowWaitWindow();
                top.jsPopup.form_name = top.originalName;
                return true;
            };
        ...
        } else if (editorDialogDiv) // Handle authorization lost in editor dialogs
        {
            ...
            form.onsubmit = function () {
                ...
                r.Action = function () {
                    jsUtils.onCustomEvent('onEditorLostSession');
                };
            ...
            form.onsubmit = function () {
                jsPopup.PostParameters("login=yes");
                jsPopup.form_name = originaName;
                return false;
            };
        }
    }
