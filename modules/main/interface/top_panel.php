...
<div id="bx-panel" class="adm-header">
    <div class="adm-header-left">
        <div class="adm-header-btn-wrap">
            <a hidefocus="true" href="<?= $defaultServerName . $sPubUrl ?>" id="bx-panel-view-tab"
        ...
        if ($USER->IsAuthorized() && $informerItemsCount > 0):
            ...
            ?><span class="adm-header-notif-block" id="adm-header-notif-block" onclick="BX.adminInformer.Toggle(this);"
        ...
        <div class="adm-header-right-block"><?
            ...
            if ($USER->IsAuthorized()):
                ...
                ?><a hidefocus="true" href="javascript:void(0)" id="bx-panel-pin" class="adm-header-pin"
                     ...
                     title="<?= GetMessage('top_panel_pin_' . ($aUserOpt['fix'] == 'on' ? 'off' : 'on')) ?>"></a><?
            ...
            ?>
                ...
                if (!isset($helperHeroOption["show"])): ?>onclick="BX.userOptions.save('main', 'helper_hero_admin',  'show', 'Y');"<?
                endif ?>>
