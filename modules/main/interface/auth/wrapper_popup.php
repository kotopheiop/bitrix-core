    ...
    case 'core_window_cauthdialog':
        ...
        <form name="form_auth" method="post" action="" novalidate>
            ...
            <div class="bx-core-popup-auth-field">
                ...
                <div class="bx-core-popup-auth-field"><input type="text" name="USER_LOGIN"
                                                             value="<? echo htmlspecialcharsbx($last_login) ?>"></div>
            </div>
            <div class="bx-core-popup-auth-field">
            ...
            if ($bNeedCaptcha):
                ...
                <div class="bx-core-popup-auth-field">
                    <div class="bx-core-popup-auth-field-caption">
                        ...
                        <img src="/bitrix/tools/captcha.php?captcha_sid=<?= $CAPTCHA_CODE ?>" width="180" height="40"
                             alt="CAPTCHA"/>
                    </div>
