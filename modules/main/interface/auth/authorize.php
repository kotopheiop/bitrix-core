...
<div class="login-main-popup-wrap login-popup-wrap<?= $bNeedCaptcha ? " login-captcha-popup-wrap" : "" ?>"
     id="authorize">
    ...
    <div class="login-popup">
        ...
        <div class="login-popup-field">
            ...
            <div class="login-input-wrap">
                <input type="text" class="login-input" onfocus="BX.addClass(this.parentNode, 'login-input-active')"
                       onblur="BX.removeClass(this.parentNode, 'login-input-active')" name="USER_LOGIN"
                       value="<? echo htmlspecialcharsbx($last_login) ?>" tabindex="1">
        ...
        <div class="login-popup-field" id="authorize_password">
            ...
            <div class="login-input-wrap">
                <input type="password" class="login-input" onfocus="BX.addClass(this.parentNode, 'login-input-active')"
                       onblur="BX.removeClass(this.parentNode, 'login-input-active')" name="USER_PASSWORD" tabindex="2">
                <div class="login-inp-border"></div>
            </div>
            <input type="submit" value="" class="login-btn-green" name="Login" tabindex="4"
        ...
        <div class="login-popup-field login-captcha-field">
            ...
            <div class="login-input-wrap">
                <span class="login-captcha-wrap" id="captcha_image"><? if ($bNeedCaptcha): ?><img
                        src="/bitrix/tools/captcha.php?captcha_sid=<?= $CAPTCHA_CODE ?>" width="180" height="40"
                        alt="CAPTCHA" /><? endif; ?></span><input type="text"
                                                                  onfocus="BX.addClass(this.parentNode, 'login-input-active')"
                                                                  onblur="BX.removeClass(this.parentNode, 'login-input-active')"
                                                                  name="captcha_word" class="login-input" tabindex="5"
                                                                  autocomplete="off">
                <div class="login-inp-border"></div>
            </div>
        </div>
        ...
        if ($not_show_links != "Y"):
            ...
            <a class="login-popup-link login-popup-forget-pas" href="javascript:void(0)"
               onclick="BX.adminLogin.toggleAuthForm('forgot_password')"><?= GetMessage("AUTH_FORGOT_PASSWORD_2") ?></a>
        <?
        endif;
        ?>
        ...
        if ($authLink):
            ...
            <div class="login-popup-network-block">
                ...
                <span class="login-popup-network-btn login-popup-network-btn-<?= $lang ?>"
                      onclick="BX.util.popup('<?= CUtil::JSEscape($authLink) ?>', 800, 600);"></span>
            </div>
        <?
        endif;
        ?>
