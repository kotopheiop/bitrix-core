...
<? if (!$isSidePanel): ?>
    <tr class="adm-footer-wrap">
        ...
        <td class="adm-workarea-wrap">
            ...
            $sLinks = '<a href="' . $copyright->getVendorUrl() . '">' . $copyright->getVendorName(
                ) . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="' . $copyright->getSupportUrl(
                ) . '" class="adm-main-support-link">' . GetMessage("epilog_support_link") . '</a>';
            ?>
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td><? echo $sCopyright ?></td>
                    <td align="right"><a href="/bitrix/admin/copyright.php"><? echo GetMessage(
                                "epilog_admin_copyrights"
                            ) ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<? if (($siteSupport = getLocalPath(
    ...
    <div class="adm-favorites-alignment">
        <div class="adm-favorites-center" id="fav_dest_item">
            ...
            <div id="fav_text_finish_item" style="display: none;">
                ...
                <div class="adm-favorites-description"><a class="adm-favorites-description_link"
                                                          href="javascript:void(0);"
                                                          onclick="BX.adminMenu.showFavorites(this);"><?= GetMessage(
                            'ADMIN_FAV_GOTO'
                        ) ?></a></div>
            </div>
