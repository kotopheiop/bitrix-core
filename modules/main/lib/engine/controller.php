...
class Controller implements Errorable, Controllerable
{
    ...
    /**
     * Returns module id.
     * Tries to guess module id by file path and function @return string
     * @see getModuleId().
     *
     */
     ...
     * then we use default filters @param array|null $config
     *
     * @return array|null
     * @see \Bitrix\Main\Engine\Controller::getDefaultPreFilters() and
