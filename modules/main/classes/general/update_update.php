    ...
    <font class="text">
            ...
            <table align="right" style="border: 1px solid #DBE9F3; background-color: #F3F3F3;">
                <tr>
                    <td>
                        <font class="text">
                            <b><?
                                echo $arTypesUpdates["CLIENT"]["@"]["NAME"] ?></b><br>
                            <?= GetMessage("SUP_LICENSE_KEY") ?>: <?
                            echo ($MAIN_RIGHT == "W") ? CUpdateSystem::GetLicenseKey() : "XXX-XX-XXXXXXXXXXX" ?><br>
                            <?
                            echo GetMessage("SUP_EDITION") ?> <?
                            echo $arTypesUpdates["CLIENT"]["@"]["LICENSE"] ?><br>
                            <?
                            echo GetMessage("SUP_SITES") ?> <?
        ...
        if ($arTypesUpdates !== false
            ...
            <form method="POST" action="sysupdate.php" name="activate_key_form">
                <center>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="3" class="edittable">
                        <tr>
                            <td valign="top" align="right" width="50%" class="tablebody">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACTIVATE_NAME") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%" class="tablebody">
                                <font class="tablebodytext">
                                    <input type="text" name="NAME" value="<?= htmlspecialchars($NAME) ?>" size="50"
                                           class="typeinput"><br>
                        ...
                        <tr>
                            <td valign="top" align="right" width="50%" class="tablebody">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACTIVATE_EMAIL") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%" class="tablebody">
                                <input type="text" name="EMAIL" value="<?= htmlspecialchars($EMAIL) ?>" size="50"
                                       class="typeinput">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top" align="right" width="50%" class="tablebody">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACTIVATE_URL") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%" class="tablebody">
                                <input type="text" name="SITE_URL" value="<?= htmlspecialchars($SITE_URL) ?>" size="50"
                                       class="typeinput">
                            </td>
                        </tr>
                        <tr>
                                ...
                                <font class="tablebodytext">
                                    ...
                                    <script language="JavaScript">
                                        ...
                                        function EnableDisableUser(activateUserName) {
                                            ...
                                            if (activateUserName)
                                                try {
                                                    document.activate_key_form.USER_NAME.focus();
                                                } catch (e) {
                                                }
                                        }
                        ...
                        <tr>
                            ...
                            <td valign="top" align="left" width="50%">
                                <input type="checkbox" name="GENERATE_USER" OnClick="EnableDisableUser(true)"
                                       value="Y"<?
                                if ($GENERATE_USER == "Y" || !isset($GENERATE_USER)) echo " checked"; ?>>
                            </td>
                        </tr>
                        <tr id="tr_user_name">
                            <td valign="top" align="right" width="50%">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACT_F_USER_NAME") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%">
                                <input type="text" name="USER_NAME" value="<?= htmlspecialchars($USER_NAME) ?>"
                                       size="50" class="typeinput">
                            </td>
                        </tr>
                        <tr id="tr_user_last_name">
                            <td valign="top" align="right" width="50%">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACT_F_USER_LAST_NAME") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%">
                                <input type="text" name="USER_LAST_NAME"
                                       value="<?= htmlspecialchars($USER_LAST_NAME) ?>" size="50" class="typeinput">
                            </td>
                        </tr>
                        <tr id="tr_user_login">
                            <td valign="top" align="right" width="50%">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACT_F_USER_LOGIN") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%">
                                <input type="text" name="USER_LOGIN" value="<?= htmlspecialchars($USER_LOGIN) ?>"
                                       size="50" class="typeinput">
                            </td>
                        </tr>
                        <tr id="tr_user_password">
                            <td valign="top" align="right" width="50%">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACT_F_USER_PASSWORD") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%">
                        ...
                        <tr id="tr_user_password_confirm">
                            <td valign="top" align="right" width="50%">
                                <font class="tablefieldtext"><?= GetMessage("SUP_ACT_F_USER_PASSWORD_CONFIRM") ?>:<font
                                            color="#FF0000"><b>*</b></font></font>
                            </td>
                            <td valign="top" align="left" width="50%">
                                <input type="password" name="USER_PASSWORD_CONFIRM" value="" size="50"
                                       class="typeinput">
                            </td>
                        </tr>
                    </table>
                    <br>
                    <input <?
                    if ($MAIN_RIGHT < "W") echo "disabled" ?> class="button" type="submit"
        ...
        if (!$bLockUpdateSystemKernel && (strlen($strLicenseKey_tmp) <= 0
            ...
            if (defined("DEMO") && DEMO == "Y") {
                ...
                <a href="http://<?= (($lang == "ru") ? "www.bitrixsoft.ru/ru" : "www.bitrixsoft.com") ?>/bsm_register.php?dt=<?
                echo UrlEncode($SiteExpireDate) ?>" target="_blank"><img src="/bitrix/images/main/icon2.gif" width="15"
                                                                         height="15" border="0"
            ...
            <form method="POST" action="sysupdate.php">
                <center>
                    <input type="text" name="NEW_LICENSE_KEY" class="typeinput"
                           VALUE="<?= (($MAIN_RIGHT < "W") ? "XXXXXXX" : htmlspecialchars($strLicenseKey_tmp)) ?>"
                           size="30">
        ...
        if (!$bLockUpdateSystemKernel && $newLicense == "Y") {
            ...
            if ($arTypesUpdates !== false
                ...
                <a href="sysupdate.php?TYPE=REGVER&STEP=1&lang=<?= htmlspecialchars($lang) ?>"><img
                            src="/bitrix/images/main/icon2.gif" width="15" height="15" border="0"
                            alt="<?= GetMessage("SUP_REG_ACT_ALT") ?>"> <?= GetMessage("SUP_REG_ACT") ?> &gt;&gt;</a>
                <br><br><br>
                <?
            }
            ?>
            ...
            if ($arTypesUpdates !== false
                ...
                <a href="sysupdate.php?STEP=2&TYPE=UPDATE&lang=<?= htmlspecialchars($lang) ?>"><img
                            src="/bitrix/images/main/icon2.gif" width="15" height="15" border="0"
                            alt="<?= GetMessage("SUP_MUPD_ACT_ALT") ?>"> <?= GetMessage("SUP_MUPD_ACT") ?> &gt;&gt;</a>
                <br><br><br>
                <?
            } else {
                ?>
            ...
            if ($arTypesUpdates !== false
                ...
                <a href="sysupdate.php?STEP=2&TYPE=LANGS&lang=<?= htmlspecialchars($lang) ?>"><img
                            src="/bitrix/images/main/icon2.gif" width="15" height="15" border="0"
                            alt="<?= GetMessage("SUP_LUPD_ACT_ALT") ?>"> <?= GetMessage("SUP_LUPD_ACT") ?> &gt;&gt;</a>
                <br><br><br>
                <?
            }
            ?>
            ...
            if ($arTypesUpdates !== false
                ...
                <a href="sysupdate.php?STEP=2&TYPE=HELP&lang=<?= htmlspecialchars($lang) ?>"><img
                            src="/bitrix/images/main/icon2.gif" width="15" height="15" border="0"
                            alt="<?= GetMessage("SUP_HUPD_ACT_ALT") ?>"> <?= GetMessage("SUP_HUPD_ACT") ?> &gt;&gt;</a>
                <br><br><br>
                <?
            }
            ?>
                ...
                <font class="text">
                    ...
                    <script language="JavaScript">
                        ...
                        function AgreeLicenseChecked(obj) {
                            ...
                            obj1.disabled = <?if ($MAIN_RIGHT < "W"):?>true
                            <?else:?>!obj.checked<?endif;?>;
                        }
                    ...
                    <input class="typeinput" type="checkbox" name="agree_license" value="Y" id="agree_license_id"
                           OnClick="AgreeLicenseChecked(this)">
                    ...
                    <input type="hidden" name="STEP" VALUE="1">
                    <input type="hidden" name="lang" VALUE="<?= htmlspecialchars($lang) ?>">
                    <input disabled id="SUP_LICENSE_ENTER_DO" name="SUP_LICENSE_ENTER_DON" class="button" type="submit"
        ...
        if (!$bLockUpdateSystemKernel) {
            ...
            <form method="POST" action="sysupdate.php">
                ...
                if (isset($arTypesUpdates["CLIENT"]["@"]["SUBSCR_EMAIL"]) && strlen($arTypesUpdates["CLIENT"]["@"]["SUBSCR_EMAIL"]) > 0):?>
                    ...
                    <input <?
                    if ($MAIN_RIGHT < "W") echo "disabled" ?> class="button" type="submit" name="SUBSCR_DELETE"
...
if ($TYPE == "UPDATE" && $STEP == 2 && $MAIN_RIGHT == "W") {
    ...
    if (!$arModulesUpdates
        ...
        <p>
        <center><font class="errortext"><?= GetMessage("SUP_STEP2_NO_MODULES") ?></font></center>
    <?endif; ?>
    ...
    <table border="0" align="center" width="95%">
        <tr>
            ...
            <td align="right">
                <font class="text">
                    <input type="text" name="total_size" id="total_size" size="20"
                           style="font-size:11px;font-family:verdana,arial;border: 0 solid;" readonly value="">
                </font>
            </td>
        </tr>
    </table>
...
if ($TYPE == "UPDATE" && $STEP == 3 && $MAIN_RIGHT == "W") {
    ...
    if (!$arModulesUpdates
        ...
        || count($arModulesUpdates["MODULES"]["#"]["MODULE"]) <= 0):?>
        <p>
        <center><font class="errortext"><?= GetMessage("SUP_STEP3_NO_MODULES") ?></font></center>
    <?endif; ?>
...
if ($TYPE == "UPDATE" && ($STEP == 2 || $STEP == 3) && $MAIN_RIGHT == "W") {
    ...
    echo LANG ?>" width="100%" height="100%"></iframe>
    <!--</div>-->
...
if ($TYPE == "LANGS" && $STEP == 2 && $MAIN_RIGHT == "W") {
    ...
    if (!$arLangsUpdates
        ...
        <p>
        <center><font class="errortext"><?= GetMessage("SUP_LSTEP2_NO_LANGS") ?></font></center>
    <?endif; ?>
    ...
    <table border="0" align="center" width="95%">
        <tr>
            <td align="left">
                <form method="post" action="sysupdate.php" onsubmit="return ValidateForm(this);">
                    <input type="submit" name="load_button" id="load_button"
                           value="<?= GetMessage("SUP_LSTEP2_LOAD_BTN") ?>" disabled>
...
if ($TYPE == "HELP" && $STEP == 2 && $MAIN_RIGHT == "W") {
    ...
    if (!$arHelpUpdates
        ...
        <p>
        <center><font class="errortext"><?= GetMessage("SUP_HSTEP2_NO_UPDS") ?></font></center>
    <?endif; ?>
    ...
    <table border="0" align="center" width="95%">
        <tr>
            <td align="left">
                <form method="post" action="sysupdate.php" onsubmit="return ValidateForm(this);">
                    <input type="submit" name="load_button" id="load_button"
                           value="<?= GetMessage("SUP_HSTEP2_LOAD_BTN") ?>" disabled>
...
<font class="text">
    ...
    wnd.document.write('
    <body bgcolor="#FFFFFF" text="#000000" onKeyPress="KeyPress()">\n');
    ...
    = "tablehead1" > < font
    class
    = "tableheadtext" ><?= GetMessage("SUP_HIST_DATE") ?>< /font></
    td >
    < td
    align = "center"
    class
    = "tablehead2" > < font
    class
    = "tableheadtext" ><?= GetMessage("SUP_HIST_DESCR") ?>< /font></
    td >
    < td
    align = "center"
    class
    = "tablehead3" > < font
    class
    = "tableheadtext" ><?= GetMessage("SUP_HIST_STATUS") ?>< /font></
    td >
    < /tr>
    <?
    for ($i = 0; $i < count($arLogRecs); $i++)
    ...
    = "tablebody1" >
        < font
    class
    = "tablebodytext" ><?= $arLogRecs[$i][1] ?>< /font>
        < /td>
        < td
    align = "left"
    class
    ...
    onClick = "DescrDetListWindow('<?echo $i ?>')"
    title = "<?echo GetMessage("HINT_WIND_EXEC_ALT")?>" ><?echo GetMessage("HINT_WIND_EXEC")?>< /a>
        <?endif;?>
        < /font>
        < /td>
        < td
    ...
    = "tablebodytext" ><?
        ...
        ?>< font
    class
    = "errortext" ><?= $strErrorMessage ?>< /font><br><br><?
        }
        ?>
        < font
    class
    = "text" >
        < a
    href = "sysupdate.php?STEP=1&TYPE=UPDATE&lang=<?= LANG ?>" > &lt;&lt; & nbsp;<?= GetMessage("SUP_MAIN_PAGE") ?><
    /a><br><br>
    ...
    = "button"
    type = "submit"
    value = "<?= GetMessage("SUP_AD_CHECK_DO") ?>" >
        < /center>
        < /form>
