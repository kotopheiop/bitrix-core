...
class CImageUploader
{
    public static function ShowScript($Params = array())
    {
        ...
        <script>
            ...
            <?if($Params['showAddFileButton']):?>
            function addFiles() {
                $au.uploader('<?= CUtil::JSEscape($id)?>').uploadPane().addFiles();
            }
            <?endif;?>
            <?if($Params['showAddFolderButton']):?>
            function addFolder() {
                $au.uploader('<?= CUtil::JSEscape($id)?>').uploadPane().addFolders();
            }
            <?endif;?>
            BX.ready(function () {
                BX('bxiu_<?= CUtil::JSEscape($id)?>').innerHTML = BXIU_<?= CUtil::JSEscape($id)?>.getHtml();
            })
        </script>
...
class CFlashUploader extends CImageUploader
{
    public static function ShowScript($Params = array())
    {
        ...
        ?>
        <script>
            var oBXUploaderHandler_<?= CUtil::JSEscape($id)?> = new window.BXUploader({
                id: '<?= CUtil::JSEscape($id)?>',
                type: 'flash'
            });
            ...
            BX.ready(function () {
                BX('bxiu_<?= CUtil::JSEscape($id)?>').innerHTML = BXFIU_<?= CUtil::JSEscape($id)?>.getHtml();
            });
