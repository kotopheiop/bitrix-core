...
class CAdminFileDialog
{
                ...
                window.<?= CUtil::JSEscape($arConfig['event'])?> = function (bLoadJS, Params) {
                    ...
                    if (!window.BXFileDialog) {
                        ...
                        return setTimeout(function () {
                            window['<?= CUtil::JSEscape($arConfig['event'])?>'](false, Params)
                        }, 50);
                    }
                            ...
                            <table class="bx-fd-top-contr-tbl">
                                <tr>
                                    ...
                                    <td nowrap style="width:170px !important; padding: 0 2px 0 2px !important;">
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit go_button"
                                             id="__bx_dir_path_go" title="<?= GetMessage("FD_GO_TO") ?>"/>
                                        <img src="/bitrix/images/1.gif" __bx_disable="Y"
                                             class="fd_iconkit path_back_dis" title="<?= GetMessage("FD_GO_BACK") ?>"
                                             id="__bx_dir_path_back"/>
                                        <img src="/bitrix/images/1.gif" __bx_disable="Y"
                                             class="fd_iconkit path_forward_dis"
                                             title="<?= GetMessage("FD_GO_FORWARD") ?>" id="__bx_dir_path_forward"/>
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit dir_path_up"
                                             title="<?= GetMessage("FD_GO_UP") ?>" id="__bx_dir_path_up"/>
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit dir_path_root"
                                             title="<?= GetMessage("FD_GO_TO_ROOT") ?>" id="__bx_dir_path_root"/>
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit new_dir"
                                             title="<?= GetMessage("FD_NEW_FOLDER") ?>" id="__bx_new_dir"/>
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit refresh"
                                             title="<?= GetMessage("FD_REFRESH") ?>"
                                        ...
                                        <img onclick="oBXDialogControls.ViewSelector.OnClick();"
                                             src="/bitrix/images/1.gif" id="__bx_view_selector"
                                             class="fd_iconkit view_selector"
                                             title="<?= GetMessage("FD_SELECT_VIEW") ?>"/>
                                    </td>
                                    <td nowrap
                                        style="width:180px !important; padding: 0 6px 0 3px !important; text-align:right !important;"
                                        align="right">
                                        <?= GetMessage("FD_SORT_BY") ?>:
                                        <select class="fd_select" id="__bx_sort_selector"
                                                title="<?= GetMessage("FD_SORT_BY") ?>"
                                    ...
                                    <td style="width:20px !important; padding: 0 6px 0 3px !important;">
                                        <img src="/bitrix/images/1.gif" class="fd_iconkit sort_up"
                                             title="<?= GetMessage("FD_CHANGE_SORT_ORDER") ?>" __bx_value="asc"
                                             id="__bx_sort_order"/>
                                    </td>
                                </tr>
                            </table>
                ...
                <tr>
                    <td style="vertical-align:top !important; height:398px !important;">
                            ...
                            <table style="width:743px !important; height:250px !important;">
                                <tr>
                                    ...
                                    <td class="bxfd-window-cont">
                                        <div class="fd_window">
                                            <div id="__bx_windowContainer" class="bxfd-win-cont"></div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div id="__bx_fd_preview_and_panel" style="display:block;">
                            <table style="width:100% !important;height:132px !important; padding:0 !important;"
                                   border="0">
                                <tr>
                                    <td style="width:25% !important; height: 100% !important;">
                                        <div style="margin: 3px 8px 3px 5px;border:1px solid #C6C6C6">
                                            ...
                                            <table>
                                                <tr>
                                                    <td class="bxfd-sc-cell" colspan="2">
                                                        <input type="text"
                                                               style="width:98% !important;margin-bottom:5px !important;"
                                                               id="__bx_file_path_bar">
                                                        <select style="width:98% !important; display:none; margin-bottom:5px !important;"
                                                                id="__bx_file_filter"></select>
                                                ...
                                                <tr>
                                                    <td class="bxfd-sc-cell2">
                                                        <table id="add2menu_cont" style="display:none">
                                                            <tr>
                                                    ...
                                                    <td class="bxfd-sc-cell3">
                                                        <input style="width:100px !important;" type="button"
                                                               id="__bx_fd_submit_but" value="">
                                                        <input style="width:100px !important;" type="button"
                                                               onclick="oBXFileDialog.Close()"
                                                               value="<?= GetMessage("FD_BUT_CANCEL"); ?>">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                        ...
                        <div id="__bx_fd_load" style="display:none;">
                            <div id="bxfd_upload_container">
                                <iframe id="bxfd_iframe_upload" src="javascript:''" frameborder="0"></iframe>
                            </div>
                        </div>
                        <div id="__bx_fd_container_add2menu"
                             class="bxfd-add-2-menu-tab"><? if ($Params['bAddToMenu']) : ?>
                                <table class="bx-fd-add-2-menu-tbl">
                                <tr>
                                    <td style="height:30px">
                                        <table class="fd_tab_title">
                                            <tr>
                                                <td class="icon"><img class="bxfd-add-to-menu-icon"
                                                                      src="/bitrix/images/1.gif" width="32"
                                                                      height="32"/></td>
                                ...
                                <tr>
                                    <td class="bx-fd-buttons-cont">
                                        ...
                                        <input type="button" onclick="oBXFileDialog.Close()"
                                               value="<?= GetMessage("FD_BUT_CANCEL"); ?>">
                                    </td>
                                </tr>
                                </table><?endif; ?></div>
    ...
    public static function PreviewFlash($Params)
    {
        if (CModule::IncludeModule("fileman")) {
            ...
            <embed id="__flash_preview" pluginspage="http://www.macromedia.com/go/getflashplayer"
                   type="application/x-shockwave-flash" name="__flash_preview" quality="high"
                   width="<?= $Params['width'] ?>" height="<?= $Params['height'] ?>"
                   src="<?= htmlspecialcharsex($path) ?>"></embed>
            </BODY>
            </HTML>
            <?
            die();
    ...
    public static function ShowUploadForm($Params)
    {
        ...
        <form name="frmLoad"
              action="file_dialog.php?action=uploader&lang=<?= $lang ?>&site=<?= $site ?>&<?= bitrix_sessid_get() ?>"
              onsubmit="return parent.oBXDialogControls.Uploader.OnSubmit();" method="post"
            ...
            <table style="width: 540px; height: 123px; font-size:70%">
                ...
                <tr height="0%">
                    <td style="width:100%; padding:0 8px 5px 0" valign="bottom" align="right" colSpan="2">
                        ...
                        <input style="width:100px;" type="button" onclick="parent.oBXFileDialog.Close()"
                               value="<?= GetMessage("FD_BUT_CANCEL"); ?>">
                    </td>
                </tr>
            </table>
