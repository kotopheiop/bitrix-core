...
class CControllerClient
{
    ...
    public static function OnExternalLogin(&$arParams)
    {
        ...
        if (
            ...
            $arGroupsMap = unserialize(
                COption::GetOptionString("controller", "auth_controller", serialize(array())),
    ...
    public static function JoinToControllerEx(
        $controller_url,
        $controller_login,
        $controller_password,
    ...
    public static function JoinToController(
        $controller_url,
        $controller_login,
        $controller_password,
        $site_url = false,
        ...
        return CControllerClient::JoinToControllerEx(
            $controller_url,
            $controller_login,
            $controller_password,
            $arMemberParams
    ...
    public static function ExecuteEvent($eventName, $arParams = array())
    {
        ...
        if (COption::GetOptionString("main", "controller_member", "N") != "Y") {
            ...
            $oRequest = new CControllerClientRequestTo(
                "execute_event", array(
    ...
    public static function GetBackup($bRefresh = false)
    {
        ...
        if (!isset($arCachedData) || $bRefresh) {
            $arCachedData = unserialize(
                COption::GetOptionString("main", "~controller_backup", ""),
                ['allowed_classes' => false]
            );
        }
    ...
    {
        $ID = 0;
        $dbr_task = CTask::GetList(
            Array(),
            Array('NAME' => $task_id, 'MODULE_ID' => $module_id, "BINDING" => 'module')
        );
...
class __CControllerPacket
{
    ...
    public function Debug($sText)
    {
        ...
        file_put_contents(
            $filename,
            date("Y-m-d H:i:s") . " - " . (is_array($sText) ? print_r(
                $sText,
                true
            ) : $sText) . "\n----------\n",
            FILE_APPEND | LOCK_EX
    ...
    public function Check()
    {
        ...
        if ($md5hash != $this->hash) {
            if (is_object($APPLICATION)) {
                $e = new CApplicationException(
                    "Hash check failed: hash(" . $hash . ")=" . $md5hash . " != " . $this->hash
                );
                $APPLICATION->ThrowException($e);
            }
            return false;
...
//
// ��� ������������� �� �����������:
// CControllerServerRequestTo - ����� ��� �������� ������� �������
// CControllerServerRequestFrom - ����� ��� ��������� ������� �� �������
//
// ��� ������������� �� �������:
// CControllerClientRequestTo - ����� ��� �������� ������� �� ������
// CControllerClientRequestFrom - ����� ��� ��������� ������� �� �������
///////////////////////////////////////////////////////////////////////////////////////////
class __CControllerPacketRequest extends __CControllerPacket
{
    ...
    ///////////////////////////////////
    //��� ������ � ������� ���������� ���������� (CControllerClientRequestFrom, CControllerServerRequestFrom):
    ///////////////////////////////////
    ...
    public function InitFromRequest()
    {
        ...
        if (isset($_REQUEST['parameters'])) {
            ...
            $arParameters = $this->unpackParameters(
                $this->strParameters,
                isset($_REQUEST['encoding']) ? $_REQUEST['encoding'] : ''
            );
            if ($arParameters) {
    ...
    ///////////////////////////////////////
    // ��� ������ � ������� ������������ ������� (CControllerClientRequestTo, CControllerServerRequestTo):
    ///////////////////////////////////////
...
//
// ��� ������������� �� �����������:
// CControllerServerResponseFrom - ����� ��� ��������� ������ ������� �� �������
// CControllerServerResponseTo - ����� ��� �������� ����������� ���������� ������� ����� �� �������
//
// ��� ������������� �� �������:
// CControllerClientResponseFrom - ����� ��� ��������� ������ ����������� �� �������
// CControllerClientResponseTo - ����� ��� �������� ����������� ���������� ������� ����� �� ����������
//////////////////////////////////////////////////////////
class __CControllerPacketResponse extends __CControllerPacket
{
    ...
    //////////////////////////////////////////////
    // ������ ��� ������ � ������� ����������� ��������� (CControllerServerResponseFrom, CControllerClientResponseFrom):
    //////////////////////////////////////////////
    ...
    function ParseResult($result)
    {
        ...
        if ($arParameters) {
            ...
            if (isset($ar_result['encoding'])) {
                if ($this->text) {
                    $this->text = \Bitrix\Main\Text\Encoding::convertEncoding(
                        $this->text,
                        $this->encoding,
                        SITE_CHARSET
                    );
    ...
    ///////////////////////////////////////
    // ������� ������ ��� ������������� � ������� ������������ ��������� (CControllerServerResponseTo, CControllerClientResponseTo):
    ///////////////////////////////////////
