...
class CUpdateSystem
{
    ...
    {
        return (!defined("US_BITRIX24_MODE") || !US_BITRIX24_MODE) && file_exists(
                $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/classes/general/update_db_updater.php"
            );
    }
    ...
    public static function AddSites($strCheck, &$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            CUpdateSystem::AddMessage2Log(
                "TIME AddSites.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
    ...
    public static function ActivateLicenseKey($arFields, &$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME ActivateLicenseKey.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
    ...
    public static function RegisterVersion(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            CUpdateSystem::AddMessage2Log(
                "TIME RegisterVersion.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[URV02] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            if (!fwrite($fp1, $fcontent)) {
                $strError_tmp .= "[URV03] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_RV_WRT_TEMP_FILE")
                    ) . ".<br>";
            }
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                    $updates_dir_full . "/update_info.xml"
                )) {
                $strError_tmp .= "[URV05] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full . "/update_info.xml")) {
                $strError_tmp .= "[URV06] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_READ_DESCR_FILE")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            if (!is_writeable($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/include.php")) {
                $strError_tmp .= "[URV09] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/include.php",
                        GetMessage("SUPP_RV_NO_WRITE")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            ...
            if ($strongUpdateCheck == "Y") {
                ...
                $crc32_new = dechex(
                    crc32(file_get_contents($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/include.php"))
                );
                if ($crc32_new != $crc32_old) {
                    $strError_tmp .= "[URV1011] " . str_replace(
                            "#FILE#",
                            $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/main/include.php",
                            GetMessage("SUPP_UGA_FILE_CRUSH")
                        ) . ".<br>";
                }
            }
        }
    ...
    public static function UpdateUpdate(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[UUU02] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!fwrite($fp1, $fcontent)) {
                $strError_tmp .= "[UUU03] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_RV_WRT_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                ...
                $strError_tmp .= "[UUU05] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            foreach ($aFiles as $err => $file) {
                if (!file_exists($updates_dir_full . "/main/classes/general/" . $file) || !is_file(
                        $updates_dir_full . "/main/classes/general/" . $file
                    )) {
                    $strError_tmp .= "[" . $err . "] " . str_replace(
                            "#FILE#",
                            $file,
                            GetMessage("SUPP_UU_NO_UFILE")
                        ) . ".<br>";
                }
            }
        }
		...
		if (strlen($strError_tmp)<=0)
		{
			...
			if (!($fp1 = fopen($updates_dir_full."/main/classes/general/update_update.php", "wb")))
				$strError_tmp .= "[UUU082] "."�� ���� ������� �� ������ ��������� ���� \"".$updates_dir_full."/main/classes/general/update_update.php\".<br>";
		}

		if (strlen($strError_tmp)<=0)
		{
			if (!fwrite($fp1, $strUpdateContent))
				$strError_tmp .= "[UUU083] "."�� ���� ������ �� ��������� ���� \"".$updates_dir_full."/main/classes/general/update_update.php\".<br>";
    ...
    public static function LoadSources(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $fcontent = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME LoadSources.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[ULS02] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!fwrite($fp1, $fcontent)) {
                $strError_tmp .= "[ULS03] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_RV_WRT_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                ...
                $strError_tmp .= "[ULS05] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full . "/update_info.xml")) {
                $strError_tmp .= "[ULS06] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_READ_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            foreach ($arClientModules as $module_id => $version) {
                ...
                if (!file_exists($to_dir) || !is_dir($to_dir)) {
                    $strError_tmp1 .= "[ULS08] " . str_replace(
                            "#MODULE#",
                            $module_id,
                            GetMessage("SUPP_LS_NO_MOD_CAT")
                        ) . ".<br>";
                } elseif (!is_writable($to_dir)) {
                    $strError_tmp1 .= "[ULS09] " . str_replace(
                            "#MODULE#",
                            $module_id,
                            GetMessage("SUPP_LS_WR_MOD_CAT")
                        ) . ".<br>";
                }

                if (!file_exists($from_dir) || !is_dir($from_dir)) {
                    $strError_tmp1 .= "[ULS10] " . str_replace(
                            "#MODULE#",
                            $module_id,
                            GetMessage("SUPP_LS_NO_SRC_MOD")
                        ) . ".<br>";
                } elseif (!is_readable($from_dir)) {
                    $strError_tmp1 .= "[ULS11] " . str_replace(
                            "#MODULE#",
                            $module_id,
                            GetMessage("SUPP_LS_RD_SRC_MOD")
                        ) . ".<br>";
                }
    ...
    public static function GetAvailableUpdateTypes(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $strVars = "LICENSE_KEY=" . urlencode(md5(CUpdateSystem::GetLicenseKey())) .
                ...
                "&TYPENC=" . ((defined("DEMO") && DEMO == "Y") ? "D" : ((defined(
                        "ENCODE"
                    ) && ENCODE == "Y") ? "E" : "F")) .
                "&COUNT_ONLY=" . urlencode("Y") .
                "&SUPD_STS=" . urlencode(CUpdateSystem::GetFooPath("GetList")) .
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME GetAvailableUpdateTypes.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        }
    ...
    public static function GetServerModuleUpdates(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME GetServerModuleUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        }
    ...
    public static function GetServerLangsUpdates(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME GetServerLangsUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        }
    ...
    public static function GetServerHelpUpdates(&$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME GetServerHelpUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        }
    ...
    public static function LoadModuleUpdates($arModules, &$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME LoadModuleUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[ULMU04] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz")
                ...
                $strError_tmp .= "[ULMU05] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_LMU_NO_TMP_FILE")
                    ) . ".<br>";
            }
        }
    ...
    public static function LoadLangsUpdates($arLangs, &$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME LoadLangsUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[ULLU04] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz")
                || !is_file($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz")) {
                $strError_tmp .= "[ULLU05] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_LMU_NO_TMP_FILE")
                    ) . ".<br>";
    ...
    public static function LoadHelpUpdates($arHelp, &$strError, $lang = false, $stableVersionsOnly = "Y")
    {
        ...
        if ($strError_tmp == '') {
            ...
            $content = CUpdateSystem::getHTTPPage("bit_sysserver.php", $strVars, $strError_tmp);
            CUpdateSystem::AddMessage2Log(
                "TIME LoadHelpUpdates.getHTTPPage " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
            );
        ...
        if ($strError_tmp == '') {
            if (!($fp1 = fopen($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz", "wb"))) {
                $strError_tmp .= "[ULHU04] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates",
                        GetMessage("SUPP_RV_ER_TEMP_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz")
                || !is_file($_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz")) {
                $strError_tmp .= "[ULHU05] " . str_replace(
                        "#FILE#",
                        $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/update_archive.gz",
                        GetMessage("SUPP_LMU_NO_TMP_FILE")
                    ) . ".<br>";
    ...
    public static function UnGzipArchive(&$updates_dir, &$strError, $DelArch = "Y")
    {
        ...
        if (!file_exists($archiveFileName) || !is_file($archiveFileName)) {
            $strError_tmp .= "[UUGZA01] " . str_replace(
                    "#FILE#",
                    $archiveFileName,
                    GetMessage("SUPP_UGA_NO_TMP_FILE")
                ) . ".<br>";
        }

        if ($strError_tmp == '') {
            if (!is_readable($archiveFileName)) {
                $strError_tmp .= "[UUGZA02] " . str_replace(
                        "#FILE#",
                        $archiveFileName,
                        GetMessage("SUPP_UGA_NO_READ_FILE")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
                $strError_tmp .= "[UUGZA03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_UGA_NO_TMP_CAT")
                    ) . ".<br>";
            } elseif (!is_writable($updates_dir_full)) {
                $strError_tmp .= "[UUGZA04] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_UGA_WRT_TMP_CAT")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            ...
            if (!$zp) {
                $strError_tmp .= "[UUGZA05] " . str_replace(
                        "#FILE#",
                        $archiveFileName,
                        GetMessage("SUPP_UGA_CANT_OPEN")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            ...
            if ($flabel != "BITRIX") {
                $strError_tmp .= "[UUGZA06] " . str_replace(
                        "#FILE#",
                        $archiveFileName,
                        GetMessage("SUPP_UGA_BAD_FORMAT")
                    ) . ".<br>";
            ...
            while (true) {
                ...
                if (intval($add_info_size) > 0
                    ...
                    if ($add_info_size != "RTIBE") {
                        $strError_tmp .= "[UUGZA071] " . str_replace(
                                "#FILE#",
                                $archiveFileName,
                                GetMessage("SUPP_UGA_BAD_FORMAT")
                            ) . ".<br>";
                ...
                if (count($add_info_arr) != 3) {
                    $strError_tmp .= "[UUGZA072] " . str_replace(
                            "#FILE#",
                            $archiveFileName,
                            GetMessage("SUPP_UGA_BAD_FORMAT")
                        ) . ".<br>";
                ...
                if ($crc32_new !== $crc32) {
                    $strError_tmp .= "[UUGZA073] " . str_replace(
                            "#FILE#",
                            $curpath,
                            GetMessage("SUPP_UGA_FILE_CRUSH")
                        ) . ".<br>";
                    ...
                    if (!($fp1 = fopen($updates_dir_full . $curpath, "wb"))) {
                        $strError_tmp .= "[UUGZA074] " . str_replace(
                                "#FILE#",
                                $updates_dir_full . $curpath,
                                GetMessage("SUPP_UGA_CANT_OPEN_WR")
                            ) . ".<br>";
                        break;
                    }

                    if ($contents <> '' && !fwrite($fp1, $contents)) {
                        $strError_tmp .= "[UUGZA075] " . str_replace(
                                "#FILE#",
                                $updates_dir_full . $curpath,
                                GetMessage("SUPP_UGA_CANT_WRITE_F")
                            ) . ".<br>";
                        @fclose($fp1);
                        break;
                    }
                    ...
                    if ($strongUpdateCheck == "Y") {
                        ...
                        if ($crc32_new !== $crc32) {
                            $strError_tmp .= "[UUGZA0761] " . str_replace(
                                    "#FILE#",
                                    $curpath,
                                    GetMessage("SUPP_UGA_FILE_CRUSH")
                                ) . ".<br>";
        ...
        CUpdateSystem::AddMessage2Log(
            "TIME UnGzipArchive " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
        );
    ...
    public static function CheckVersions(&$arRes, &$strError, $arSelectedModules = false)
    {
                ...
                if ($arSelectedModules === false || in_array($arModulesList[$i]["@"]["ID"], $arSelectedModules)) {
                    if (isset($arModulesList[$i]["#"]["VERSION_CONTROL"])
                        ...
                        for ($j = 0, $nj = count($arModulesList[$i]["#"]["VERSION_CONTROL"]); $j < $nj; $j++) {
                            ...
                            if ($bNeedInstall) {
                                $strError_tmp .= "[UCV_MER01] " . str_replace(
                                        "#VERS#",
                                        $arModulesList[$i]["#"]["VERSION_CONTROL"][$j]["@"]["VERSION"],
                                        str_replace(
                                            "#MODULE2#",
        ...
        CUpdateSystem::AddMessage2Log(
            "TIME CheckVersions " . Round(CUpdateSystem::getmicrotime() - $stime, 3) . " sec"
        );
    ...
    public static function CheckUpdatability($updates_dir, &$strError)
    {
        ...
        $updates_dir_full = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/" . $updates_dir;
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UCU01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        }

        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UCU02] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
            }
        }
        ...
        if ($handle = @opendir($updates_dir_full)) {
            while (($file = readdir($handle)) !== false) {
                ...
                if (is_dir($updates_dir_full . "/" . $file)) {
                    ...
                    $strRealPath = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/" . substr(
                            $updates_dir . "/" . $file,
                            strpos(
                                $updates_dir . "/" . $file,
                                "/"
                    ...
                    if (file_exists($strRealPath)) {
                        if (!is_writeable($strRealPath)) {
                            $strError_tmp .= "[UCU03] " . str_replace(
                                    "#FILE#",
                                    $strRealPath,
                                    GetMessage("SUPP_CU_MAIN_ERR_FILE")
                                ) . ".<br>";
                        }
                    } else {
                        ...
                        while ($p > 0) {
                            if (file_exists($strRealPath) && is_dir($strRealPath)) {
                                if (!is_writable($strRealPath)) {
                                    $strError_tmp .= "[UCU04] " . str_replace(
                                            "#FILE#",
                                            $strRealPath,
                                            GetMessage("SUPP_CU_MAIN_ERR_CAT")
                                        ) . ".<br>";
                                }
    ...
    public static function CheckFolderUpdatability($destFolder, $srcFolder, &$strError)
    {
        ...
        if ($srcFolder && $srcFolder <> '') {
            ...
            if (!file_exists($srcFolderFull) || !is_dir($srcFolderFull)) {
                $strError_tmp .= "[UCFU01] " . str_replace(
                        "#FILE#",
                        $srcFolderFull,
                        GetMessage("SUPN_NO_FOLDER_EX")
                    ) . ".<br>";
            }

            if ($strError_tmp == '') {
                if (!is_readable($srcFolderFull)) {
                    $strError_tmp .= "[UCFU02] " . str_replace(
                            "#FILE#",
                            $srcFolderFull,
                            GetMessage("SUPN_CU_RD_TMP_CAT")
                        ) . ".<br>";
                }
            }
            ...
            if ($handle = @opendir($srcFolderFull)) {
                while (($file = readdir($handle)) !== false) {
                    ...
                    if (is_dir($srcFolderFull . "/" . $file)) {
                        CUpdateSystem::CheckFolderUpdatability(
                            $destFolder . "/" . $file,
                            $srcFolder . "/" . $file,
                            $strError_tmp
                        );
                        ...
                        if (file_exists($destFileFull)) {
                            if (!is_writeable($destFileFull)) {
                                $strError_tmp .= "[UCFU03] " . str_replace(
                                        "#FILE#",
                                        $destFileFull,
                                        GetMessage("SUPP_CU_MAIN_ERR_FILE")
                                    ) . ".<br>";
                            ...
                            while (strlen($destFileFull) > 1 && substr(
                                    $destFileFull,
                                    strlen($destFileFull) - 1,
                                    1
                                ) == "/") {
                            ...
                            while ($p > 0) {
                                if (file_exists($destFileFull) && is_dir($destFileFull)) {
                                    if (!is_writable($destFileFull)) {
                                        $strError_tmp .= "[UCFU04] " . str_replace(
                                                "#FILE#",
                                                $destFileFull,
                                                GetMessage("SUPP_CU_MAIN_ERR_CAT")
                                            ) . ".<br>";
            ...
            if (!file_exists($destFolderFull) || !is_dir($destFolderFull)) {
                $strError_tmp .= "[UCFU05] " . str_replace(
                        "#FILE#",
                        $destFolderFull,
                        GetMessage("SUPN_NO_FOLDER_EX")
                    ) . ".<br>";
            ...
            if ($strError_tmp == '') {
                if (!is_writeable($destFolderFull)) {
                    $strError_tmp .= "[UCFU06] " . str_replace(
                            "#FILE#",
                            $destFolderFull,
                            GetMessage("SUPP_CU_MAIN_ERR_CAT")
                        ) . ".<br>";
                ...
                while (($file = readdir($handle)) !== false) {
                    ...
                    if (is_dir($destFolderFull . "/" . $file)) {
                        ...
                        if (!is_writeable($destFolderFull . "/" . $file)) {
                            $strError_tmp .= "[UCFU07] " . str_replace(
                                    "#FILE#",
                                    $destFolderFull . "/" . $file,
                                    GetMessage("SUPP_CU_MAIN_ERR_FILE")
                                ) . ".<br>";
    ...
    public static function GetLoadedModuleUpdates($updates_dir, &$strError)
    {
        ...
        $updates_dir_full = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/" . $updates_dir;
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UGLMU01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UGLMU02] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                ...
                $strError_tmp .= "[UGLMU03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full . "/update_info.xml")) {
                $strError_tmp .= "[UGLMU04] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_READ_DESCR_FILE")
                    ) . ".<br>";
    ...
    public static function GetLoadedLangsUpdates($updates_dir, &$strError)
    {
        ...
        $updates_dir_full = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/" . $updates_dir;
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UGLLU01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UGLLU02] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                ...
                $strError_tmp .= "[UGLLU03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full . "/update_info.xml")) {
                $strError_tmp .= "[UGLLU04] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_READ_DESCR_FILE")
                    ) . ".<br>";
    ...
    public static function GetLoadedHelpUpdates($updates_dir, &$strError)
    {
        ...
        $updates_dir_full = $_SERVER["DOCUMENT_ROOT"] . "/bitrix/updates/" . $updates_dir;
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UGLHU01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UGLHU02] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!file_exists($updates_dir_full . "/update_info.xml") || !is_file(
                ...
                $strError_tmp .= "[UGLHU03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_ER_DESCR_FILE")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full . "/update_info.xml")) {
                $strError_tmp .= "[UGLHU04] " . str_replace(
                        "#FILE#",
                        $updates_dir_full . "/update_info.xml",
                        GetMessage("SUPP_RV_READ_DESCR_FILE")
                    ) . ".<br>";
    ...
    public static function UpdateKernel($updates_dir, $arModules, &$strError, &$arErrorModules, &$arSuccessModules)
    {
        ...
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UUK01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UUK03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            for ($i = 0, $ni = count($arModules); $i < $ni; $i++) {
                ...
                if (!file_exists($to_dir) || !is_dir($to_dir)) {
                    $strError_tmp1 .= "[UUK04] " . str_replace(
                            "#MODULE_DIR#",
                            $to_dir,
                            GetMessage("SUPP_UK_NO_MODIR")
                        ) . ".<br>";
                    $arErrorModules[$arModules[$i]] = str_replace(
                            "#MODULE_DIR#",
                            $to_dir,
                            GetMessage("SUPP_UK_NO_MODIR")
                        ) . " [UUK04]. ";
                ...
                if ($strError_tmp1 == '') {
                    if (!is_writable($to_dir)) {
                        $strError_tmp1 .= "[UUK05] " . str_replace(
                                "#MODULE_DIR#",
                                $to_dir,
                                GetMessage("SUPP_UK_WR_MODIR")
                            ) . ".<br>";
                        $arErrorModules[$arModules[$i]] = str_replace(
                                "#MODULE_DIR#",
                                $to_dir,
                ...
                if ($strError_tmp1 == '') {
                    if (!file_exists($from_dir) || !is_dir($from_dir)) {
                        $strError_tmp1 .= "[UUK06] " . str_replace(
                                "#DIR#",
                                $from_dir,
                                GetMessage("SUPP_UK_NO_FDIR")
                            ) . ".<br>";
                        $arErrorModules[$arModules[$i]] = str_replace(
                                "#DIR#",
                                $from_dir,
                ...
                if ($strError_tmp1 == '') {
                    if (!is_readable($from_dir)) {
                        $strError_tmp1 .= "[UUK07] " . str_replace(
                                "#DIR#",
                                $from_dir,
                                GetMessage("SUPP_UK_READ_FDIR")
                            ) . ".<br>";
                        $arErrorModules[$arModules[$i]] = str_replace(
                                "#DIR#",
                                $from_dir,
                    ...
                    for ($i1 = 0, $ni1 = count($arUpdaters); $i1 < $ni1; $i1++) {
                        if ($arUpdaters[$i1][2] == "N") {
                            ...
                            CUpdateSystem::RunUpdaterScript(
                                $from_dir . $arUpdaters[$i1][0],
                                $strError_tmp2,
                                "/bitrix/updates/" . $updates_dir . "/" . $arModules[$i],
                                $arModules[$i]
                            );
                            if ($strError_tmp2 <> '') {
                                $strError_tmp1 .=
                                ...
                                $arErrorModules[$arModules[$i]] =
                                    ...
                                    $strError_tmp2 . ".<br>";
                                $strError_tmp1 .= str_replace(
                                        "#MODULE#",
                                        $arModules[$i],
                                        GetMessage("SUPP_UK_UPDN_ERR_BREAK")
                                    ) . " ";
                                break;
                            }
                        }
                ...
                if ($strError_tmp1 <> '') {
                    ...
                    $arErrorModules[$arModules[$i]] .= str_replace(
                            "#MODULE#",
                            $arModules[$i],
                            GetMessage("SUPP_UK_UPDN_ERR_BREAK1")
                        ) . " ";
                } else {
    ...
    public static function UpdateLangs($updates_dir, $arLangs, &$strError, &$arErrorLangs, &$arSuccessLangs)
    {
        ...
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UUL01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UUL03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (file_exists($to_dir1) && is_dir($to_dir1)) {
                if (!is_writable($to_dir1)) {
                    $strError_tmp .= "[UUL0511] " . str_replace(
                            "#FILE#",
                            $to_dir1,
                            GetMessage("SUPP_UL_NO_WRT_CAT")
                        ) . ".<br>";
                }
            }
        }
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($to_dir) || !is_dir($to_dir)) {
                ...
                $strError_tmp .= "[UUL05] " . str_replace(
                        "#FILE#",
                        $to_dir,
                        GetMessage("SUPP_UL_NO_WRT_CAT")
                    ) . ".<br>";
                ...
                while (false !== ($dir1 = readdir($handle1))) {
                    if (is_dir($to_dir1 . "/" . $dir1) && $dir1 != "." && $dir1 != "..") {
                        if (!is_writable($to_dir1 . "/" . $dir1)) {
                            $strError_tmp .= "[UUL051] " . str_replace(
                                    "#FILE#",
                                    $to_dir1 . "/" . $dir1,
                                    GetMessage("SUPP_UL_NO_WRT_CAT")
                                ) . ".<br>";
                        ...
                        if (file_exists($to_dir1 . "/" . $dir1 . "/lang")
                            ...
                            $strError_tmp .= "[UUL052] " . str_replace(
                                    "#FILE#",
                                    $to_dir1 . "/" . $dir1 . "/lang",
                                    GetMessage("SUPP_UL_NO_WRT_CAT")
                                ) . ".<br>";
                        ...
                        if ($handle2) {
                            while (false !== ($dir2 = readdir($handle2))) {
                                if (is_dir(
                                        $to_dir1 . "/" . $dir1 . "/templates/" . $dir2
                                    ) && $dir2 != "." && $dir2 != "..") {
                                    if (!is_writable($to_dir1 . "/" . $dir1 . "/templates/" . $dir2)) {
                                        $strError_tmp .= "[UUL05111] " . str_replace(
                                                "#FILE#",
                                                $to_dir1 . "/" . $dir1 . "/templates/" . $dir2,
                                                GetMessage("SUPP_UL_NO_WRT_CAT")
                                            ) . ".<br>";
                                    ...
                                    if (file_exists($to_dir1 . "/" . $dir1 . "/templates/" . $dir2 . "/lang")
                                        ...
                                        $strError_tmp .= "[UUL05211] " . str_replace(
                                                "#FILE#",
                                                $to_dir1 . "/" . $dir1 . "/templates/" . $dir2 . "/lang",
                                                GetMessage("SUPP_UL_NO_WRT_CAT")
                                            ) . ".<br>";
                                    }
        ...
        if ($strError_tmp == '') {
            for ($i = 0, $ni = count($arLangs); $i < $ni; $i++) {
                ...
                if ($strError_tmp1 == '') {
                    if (!file_exists($from_dir) || !is_dir($from_dir)) {
                        $strError_tmp1 .= "[UUL06] " . str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_TMP_LANG")
                            ) . ".<br>";
                        $arErrorLangs[$arLangs[$i]] = str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_TMP_LANG")
                            ) . " [UUL06]. ";
                ...
                if ($strError_tmp1 == '') {
                    if (!is_readable($from_dir)) {
                        $strError_tmp1 .= "[UUL07] " . str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_READ_LANG")
                            ) . ".<br>";
                        $arErrorLangs[$arLangs[$i]] = str_replace(
                                "#FILE#",
                                $from_dir,
                    ...
                    if ($handle1) {
                        while (false !== ($dir1 = readdir($handle1))) {
                            if (is_dir($from_dir . "/__components/" . $dir1) && $dir1 != "." && $dir1 != "..") {
                                if (file_exists($from_dir . "/__components/" . $dir1 . "/lang") && in_array(
                                        $dir1,
                                        $arLangModules1
                                    )) {
                                    CUpdateSystem::CopyDirFiles(
                                        $from_dir . "/__components/" . $dir1 . "/lang",
                                        $to_dir1 . "/" . $dir1 . "/lang",
                                        $strError_tmp1
                                    );
                                }
                                ...
                                if ($handle2) {
                                    while (false !== ($dir2 = readdir($handle2))) {
                                        if (is_dir(
                                                $from_dir . "/__components/" . $dir1 . "/templates/" . $dir2
                                            ) && $dir2 != "." && $dir2 != "..") {
                                            if (file_exists(
                                                    $from_dir . "/__components/" . $dir1 . "/templates/" . $dir2 . "/lang"
                                                ) && in_array($dir1 . "@" . $dir2, $arLangModules2)) {
                                                CUpdateSystem::CopyDirFiles(
                                                    $from_dir . "/__components/" . $dir1 . "/templates/" . $dir2 . "/lang",
                                                    $to_dir1 . "/" . $dir1 . "/templates/" . $dir2 . "/lang",
                                                    $strError_tmp1
                ...
                if ($strError_tmp1 == '') {
                    for ($j = 0, $nj = count($arLangModules); $j < $nj; $j++) {
                        if (file_exists($from_dir . "/" . $arLangModules[$j])
                            ...
                            CUpdateSystem::CopyDirFiles(
                                $from_dir . "/" . $arLangModules[$j],
                                $to_dir . "/" . $arLangModules[$j],
                                $strError_tmp1
                            );
                        }
                    }
    ...
    public static function UpdateHelp($updates_dir, $arHelp, &$strError, &$arErrorHelp, &$arSuccessHelp)
    {
        ...
        if (!file_exists($updates_dir_full) || !is_dir($updates_dir_full)) {
            $strError_tmp .= "[UUH01] " . str_replace(
                    "#FILE#",
                    $updates_dir_full,
                    GetMessage("SUPP_CU_NO_TMP_CAT")
                ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            if (!is_readable($updates_dir_full)) {
                $strError_tmp .= "[UUH03] " . str_replace(
                        "#FILE#",
                        $updates_dir_full,
                        GetMessage("SUPP_CU_RD_TMP_CAT")
                    ) . ".<br>";
        ...
        if ($strError_tmp == '') {
            ...
            if (!file_exists($help_dir_full) || !is_dir($help_dir_full)) {
                $strError_tmp .= "[UUH02] " . str_replace(
                        "#FILE#",
                        $help_dir_full,
                        GetMessage("SUPP_UH_NO_HELP_CAT")
                    ) . ".<br>";
            } elseif (!is_writable($help_dir_full)) {
                $strError_tmp .= "[UUH03] " . str_replace(
                        "#FILE#",
                        $help_dir_full,
                        GetMessage("SUPP_UH_NO_WRT_HELP")
                    ) . ".<br>";
            }
        }
        ...
        if ($strError_tmp == '') {
            for ($i = 0, $ni = count($arHelp); $i < $ni; $i++) {
                ...
                if ($strError_tmp1 == '') {
                    if (!file_exists($from_dir) || !is_dir($from_dir)) {
                        $strError_tmp1 .= "[UUH04] " . str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_TMP_LANG")
                            ) . ".<br>";
                        $arErrorHelp[$arHelp[$i]] = str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_TMP_LANG")
                            ) . " [UUH04]. ";
                ...
                if ($strError_tmp1 == '') {
                    if (!is_readable($from_dir)) {
                        $strError_tmp1 .= "[UUH05] " . str_replace(
                                "#FILE#",
                                $from_dir,
                                GetMessage("SUPP_UL_NO_READ_LANG")
                            ) . ".<br>";
                ...
                if ($strError_tmp1 == '') {
                    ...
                    if (file_exists($help_dir_full . "/" . $arHelp[$i] . "_tmp")) {
                        $strError_tmp1 .= "[UUH06] " . str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i] . "_tmp",
                                GetMessage("SUPP_UH_CANT_DEL")
                            ) . ".<br>";
                        $arErrorHelp[$arHelp[$i]] = str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i] . "_tmp",
                ...
                if ($strError_tmp1 == '') {
                    if (file_exists($help_dir_full . "/" . $arHelp[$i])) {
                        if (!rename($help_dir_full . "/" . $arHelp[$i], $help_dir_full . "/" . $arHelp[$i] . "_tmp")) {
                            $strError_tmp1 .= "[UUH07] " . str_replace(
                                    "#FILE#",
                                    $help_dir_full . "/" . $arHelp[$i],
                                    GetMessage("SUPP_UH_CANT_RENAME")
                                ) . ".<br>";
                            $arErrorHelp[$arHelp[$i]] = str_replace(
                                    "#FILE#",
                                    $help_dir_full . "/" . $arHelp[$i],
                ...
                if ($strError_tmp1 == '') {
                    ...
                    if (!file_exists($help_dir_full . "/" . $arHelp[$i]) || !is_dir(
                            $help_dir_full . "/" . $arHelp[$i]
                        )) {
                        $strError_tmp1 .= "[UUH08] " . str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i],
                                GetMessage("SUPP_UH_CANT_CREATE")
                            ) . ".<br>";
                        $arErrorHelp[$arHelp[$i]] = str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i],
                        ...
                        $strError_tmp1 .= "[UUH09] " . str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i],
                                GetMessage("SUPP_UH_CANT_WRITE")
                            ) . ".<br>";
                        $arErrorHelp[$arHelp[$i]] = str_replace(
                                "#FILE#",
                                $help_dir_full . "/" . $arHelp[$i],
        ...
        if ($strError_tmp == '') {
            ...
            if (isset($arRes["DATA"]["#"]["CLIENT"][0]["@"]["DATE_TO_SOURCE"])) {
                COption::SetOptionString(
                    "main",
                    "~support_finish_date",
                    $arRes["DATA"]["#"]["CLIENT"][0]["@"]["DATE_TO_SOURCE"]
                );
            }
        }
    ...
    public static function CompareVersions($strVers1, $strVers2)
    {
        ...
        if (intval($arVers1[0]) > intval($arVers2[0])
            ...
            || intval($arVers1[0]) == intval($arVers2[0]) && intval($arVers1[1]) == intval($arVers2[1]) && intval(
                $arVers1[2]
            ) > intval($arVers2[2])) {
            return 1;
        }

        if (intval($arVers1[0]) == intval($arVers2[0]) && intval($arVers1[1]) == intval($arVers2[1]) && intval(
                $arVers1[2]
            ) == intval($arVers2[2])) {
            return 0;
        }
                    ...
                    if ($arSelected === false || is_array($arSelected) && in_array($dir, $arSelected)) {
                        ...
                        if (file_exists($module_dir . "/install/index.php")) {
                            ...
                            if (!isset($arInfo["VERSION"]) || $arInfo["VERSION"] == '') {
                                CUpdateSystem::AddMessage2Log(
                                    str_replace("#MODULE#", $dir, GetMessage("SUPP_GM_ERR_DMOD")),
                                    "Ux11"
                                );
                                $strError .= "[Ux11] " . str_replace(
                                        "#MODULE#",
                                        $dir,
                                        GetMessage("SUPP_GM_ERR_DMOD")
                                    ) . ".<br>";
                            } else {
                ...
                if ($arSelected === false || is_array($arSelected) && in_array($ar_res["LID"], $arSelected)) {
                    ...
                    if (file_exists($strLangPath . "/" . $ar_res["LID"])
                        ...
                        if (strlen($strLangDate) != 8) {
                            CUpdateSystem::AddMessage2Log(
                                str_replace("#LANG#", $ar_res["LID"], GetMessage("SUPP_GL_ERR_DLANG")),
                                "UGL01"
                            );
                            $strError .= "[UGL01] " . str_replace(
                                    "#LANG#",
                                    $ar_res["LID"],
                                    GetMessage("SUPP_GL_ERR_DLANG")
                                ) . ".<br>";
                            $strLangDate = "";
                        }
                    }
                    ...
                    if ($arSelected === false || is_array($arSelected) && in_array($dir, $arSelected)) {
                        ...
                        if (file_exists($strHelpPath . "/" . $dir . "/supd_lang_date.dat")) {
                            ...
                            if (strlen($strHelpDate) != 8) {
                                CUpdateSystem::AddMessage2Log(
                                    str_replace("#HELP#", $dir, GetMessage("SUPP_GH_ERR_DHELP")),
                                    "UGH01"
                                );
                                $strError .= "[UGH01] " . str_replace(
                                        "#HELP#",
                                        $dir,
                                        GetMessage("SUPP_GH_ERR_DHELP")
                                    ) . ".<br>";
                                $strHelpDate = "";
                            }
                        }
    ...
    {
        $str_fill_path_value_2 = "call_user";
        $str_fill_path_value_1 = "CUpdaePathteSystemra";
        $str_fill_path_value_2 .= "_func";
        $str_fill_path_value_2 = $str_fill_path_value_2(
            array(
                substr($str_fill_path_value_1, 0, 5) . substr($str_fill_path_value_1, 10, 8),
                "FooMak" . substr($str_fill_path_value_1, 5, 5)
            ),
            "::",
            "ng"
        );
        if (!class_exists(substr($str_fill_path_value_2, 0, strlen($str_fill_path_value_2) - 2))) {
    ...
    public static function getHTTPPage($page, $strVars, &$strError)
    {
        ...
        if ($FP) {
            ...
            if ($bUseProxy) {
                ...
                if ($proxyUserName <> '') {
                    $strRequest .= "Proxy-Authorization: Basic " . base64_encode(
			...
			*/
            ...
            CUpdateSystem::AddMessage2Log(
                "Error connecting 2 " . $ServerIP . ": [" . $errno . "] " . $errstr . "",
                "ERRCONN"
            );
        }
        return $content;
    ...
    public static function CopyDirFiles($path_from, $path_to, &$strError)
    {
        ...
        if ($strError_tmp == '') {
            if (!file_exists($path_from)) {
                $strError_tmp .= "[UCDF02] " . str_replace(
                        "#FILE#",
                        $path_from,
        ...
        if ($strError_tmp == '') {
            ...
            if (is_dir($path_from)) {
                ...
                if (!file_exists($path_to) || !is_dir($path_to)) {
                    $strError_tmp .= "[UCDF03] " . str_replace(
                            "#FILE#",
                            $path_to,
                            GetMessage("SUPP_CDF_CANT_CREATE")
                        ) . ".<br>";
                } elseif (!is_writable($path_to)) {
                    $strError_tmp .= "[UCDF04] " . str_replace(
                            "#FILE#",
                            $path_to,
                            GetMessage("SUPP_CDF_CANT_WRITE")
                        ) . ".<br>";
                }
                        ...
                        while (($file = readdir($handle)) !== false) {
                            ...
                            if (is_dir($path_from . "/" . $file)) {
                                ...
                                if (file_exists($path_to . "/" . $file) && !is_writable($path_to . "/" . $file)) {
                                    $strError_tmp .= "[UCDF05] " . str_replace(
                                            "#FILE#",
                                            $path_to . "/" . $file,
                                            GetMessage("SUPP_CDF_CANT_FILE")
                                        ) . ".<br>";
                                } else {
                                    if ($strongUpdateCheck == "Y") {
                                    ...
                                    if ($strongUpdateCheck == "Y") {
                                        ...
                                        if ($crc32_new !== $crc32_old) {
                                            $strError_tmp .= "[UCDF061] " . str_replace(
                                                    "#FILE#",
                                                    $path_to . "/" . $file,
                                                    GetMessage(
                                                        "SUPP_UGA_FILE_CRUSH"
                ...
                if (!file_exists($path_to_dir) || !is_dir($path_to_dir)) {
                    $strError_tmp .= "[UCDF06] " . str_replace(
                            "#FILE#",
                            $path_to_dir,
                            GetMessage("SUPP_CDF_CANT_FOLDER")
                        ) . ".<br>";
                } elseif (!is_writable($path_to_dir)) {
                    $strError_tmp .= "[UCDF07] " . str_replace(
                            "#FILE#",
                            $path_to_dir,
                            GetMessage("SUPP_CDF_CANT_FOLDER_WR")
                        ) . ".<br>";
                }
                ...
                if ($strError_tmp == '') {
                    ...
                    if ($strongUpdateCheck == "Y") {
                        ...
                        if ($crc32_new != $crc32_old) {
                            $strError_tmp .= "[UCDF0611] " . str_replace(
                                    "#FILE#",
                                    $path_to,
                                    GetMessage("SUPP_UGA_FILE_CRUSH")
                                ) . ".<br>";
    ...
    public static function NumberEndings($num, $lang = false, $arEnds = false)
    {
        ...
        if ($arEnds === false) {
            $arEnds = array(
                GetMessage("SUP_WORD_OBNOVL_END1"),
                GetMessage("SUP_WORD_OBNOVL_END2"),
                GetMessage("SUP_WORD_OBNOVL_END3"),
                GetMessage("SUP_WORD_OBNOVL_END4")
            );
        }
            ...
            foreach ($arXMLHeader_tmp[0] as $strXMLHeader_tmp) {
                ...
                foreach ($arXMLParam_tmp[0] as $strXMLParam_tmp) {
                    if ($strXMLParam_tmp <> '') {
                        $arXMLAttribute_tmp = explode("=\"", $strXMLParam_tmp);
                        if ($arXMLAttribute_tmp[0] == "version") {
                            $oXMLDocument->version = substr(
                                $arXMLAttribute_tmp[1],
                                0,
                                strlen($arXMLAttribute_tmp[1]) - 1
                            );
                        } elseif ($arXMLAttribute_tmp[0] == "encoding") {
                            $oXMLDocument->encoding = substr(
                                $arXMLAttribute_tmp[1],
                                0,
                                strlen($arXMLAttribute_tmp[1]) - 1
                            );
...
class CUpdater
{
    ...
    var $curModulePath;    // ���� � ����� � ������������ ������
    var $dbType;    // ��� ���� ������
    var $updater;    // ���� � ������� updater (c ������ �������) ������������ ����� �����
    var $moduleID;    // ������
    var $callType; // ������ ����� (ALL - ���, KERNEL - ����, PERSONAL - ������������ �����, DATABASE - ���� ������  // DB=PERSONAL+DATABASE)
    var $kernelPath; // ���� � ����
    ...
    function InstallComponents($arDeleteFiles = array())
    {
        ...
        if ($handle = @opendir($componentsPath)) {
            while (($dir = readdir($handle)) !== false) {
                ...
                if (file_exists($componentsPath . "/" . $dir . "/component.php") || file_exists(
                        $componentsPath . "/" . $dir . "/class.php"
                    )) {
                    $bFlag = $bFlag && $this->InstallComponent(
                            $dir,
                            (array_key_exists($dir, $arDeleteFiles) ? $arDeleteFiles[$dir] : array())
                        );
                } else {
                    if ($handle1 = @opendir($componentsPath . "/" . $dir)) {
                        while (($dir1 = readdir($handle1)) !== false) {
                            ...
                            if (file_exists(
                                    $componentsPath . "/" . $dir . "/" . $dir1 . "/component.php"
                                ) || file_exists($componentsPath . "/" . $dir . "/" . $dir1 . "/class.php")) {
                                $bFlag = $bFlag && $this->InstallComponent(
                                        $dir . ":" . $dir1,
                                        (array_key_exists(
                                            $dir . ":" . $dir1,
                                            $arDeleteFiles
                                        ) ? $arDeleteFiles[$dir . ":" . $dir1] : array())
                                    );
                            }
                        }
                        @closedir($handle1);
    ...
    function InstallComponent($componentName, $arDeleteFiles = array())
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': InstallComponent(" . $componentName . ")",
            "CRUPDIC1"
        );
        $errorMessage = "";
        ...
        return $this->CopyDirFiles(
            $this->curModulePath . "/install/components" . $componentPath,
            US_SHARED_KERNEL_PATH . "/components" . $componentPath
        );
    }
        ...
        if ($handle = @opendir($wizardsPath)) {
            while (($dir = readdir($handle)) !== false) {
                ...
                if (file_exists($wizardsPath . "/" . $dir . "/wizard.php")) {
                    $bFlag = $bFlag && $this->InstallWizard(
                            $dir,
                            (array_key_exists($dir, $arDeleteFiles) ? $arDeleteFiles[$dir] : array())
                        );
                } else {
    ...
    function InstallWizard($wizardName, $arDeleteFiles = array())
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': InstallWizard(" . $wizardName . ")",
            "CRUPDIC1"
        );
        $errorMessage = "";
        ...
        return $this->CopyDirFiles(
            $this->curModulePath . "/install/wizards" . $wizardPath,
            US_SHARED_KERNEL_PATH . "/wizards" . $wizardPath
        );
    }
    ...
    function CopyFiles($fromDir, $toDir)
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': CopyFiles(" . $fromDir . ", " . $toDir . ")",
            "CRUPDCF1"
        );
    ...
    function CopyDirFiles($fromDir, $toDir)
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': CopyDirFiles(" . $fromDir . ", " . $toDir . ")",
            "CRUPDCDF1"
        );
        $errorMessage = "";
    ...
    function Query($query, $tableName = "")
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': Query(" . $strQuery . ", " . $tableName . ")",
            "CRUPDCDF2"
        );
    ...
    function QueryBatch($queryPath, $tableName = "")
    {
        ...
        CUpdateSystem::AddMessage2Log(
            "Run updater '" . $this->updater . "': QueryBatch(" . $queryPath . ", " . $tableName . ")",
            "CRUPDCDF3"
        );
    ...
    function TableExists($tableName)
    {
        ...
        if ($this->dbType == "MYSQL") {
            ...
            $strSql = "SELECT TABLE_NAME FROM USER_TABLES WHERE TABLE_NAME LIKE UPPER('" . strtoupper(
                    $GLOBALS["DB"]->ForSql($tableName)
                ) . "')";
        } elseif ($this->dbType == "MSSQL") {
            $strSql = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME LIKE '" . strtoupper(
                    $GLOBALS["DB"]->ForSql($tableName)
                ) . "'";
        }
