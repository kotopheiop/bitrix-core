...
final class ChatMessageCount extends Stepper
{
    private const OPTION_NAME = "im_chat_message_count";
        ...
        if ($params["count"] > 0) {
            ...
            if ($idsCount > 0) {
                ...
                $DB->Query(
                    "
					UPDATE b_im_chat C
					SET C.MESSAGE_COUNT = (SELECT COUNT(1) FROM b_im_message M WHERE M.CHAT_ID = C.ID)
