...
class CallLog
{
    ...
    public static function get($params = [])
    {
        ...
        while ($row = $result->fetch()) {
            ...
            $endDate = $call['END_DATE'] instanceof DateTime ? $call['END_DATE']->getTimestamp() : (new DateTime(
            ))->getTimestamp();

            $call['DURATION'] = $endDate - $startDate;
            $call['DURATION_TEXT'] = \CModule::includeModule('voximplant') ? \CVoxImplantHistory::convertDurationToText(
                $call['DURATION']
            ) : $call['DURATION'];
