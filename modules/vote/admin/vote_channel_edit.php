            ...
            <div class="adm-list">
                ...
                while (list($sid, $arrS) = each($arrSites)):
                    ...
                    <div class="adm-list-item">
                        <div class="adm-list-control"><input type="checkbox" name="SITE[]"
                        ...
                        <div class="adm-list-label"><label for="<?= htmlspecialcharsbx($sid) ?>"><?
                                echo '[<a title="' . GetMessage("VOTE_SITE_EDIT") . '" href="/bitrix/admin/site_edit.php?LID=' . htmlspecialcharsbx($sid) . '&lang=' . LANGUAGE_ID . '">' . htmlspecialcharsbx($sid) . '</a>]&nbsp;' . htmlspecialcharsex($arrS["NAME"]) ?></label>
                        </div>
                    </div>
                <?
                endwhile;
