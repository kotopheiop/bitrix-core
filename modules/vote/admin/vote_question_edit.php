...
<div id="ColorPick" style="visibility:hidden;position:absolute;top:0;left:0 ">
    <table cellspacing="0" cellpadding="1" border="0" bgcolor="#666666">
            ...
            <td colspan=2>
                <table cellspacing="1" cellpadding="0" border="0" bgcolor="#FFFFFF">
                    ...
                    for ($i = 0; $i < 216; $i++) {
                        ...
                        print ($i % 18 == 0) ? "<tr>" : "";
                        ?>
                        <td bgcolor='<?= $t_curCOL ?>'><a href='javascript:void(0)'
                                                          onmousedown='javascript:col_set("<?= $t_curCOL ?>")' <?
                                                          ?>onmouseover='javascript:col_show("<?= $t_curCOL ?>")'><img
                                        src=/bitrix/images/1.gif border="0" width="10" height="10"></a></td>
                        <?
                    }
                    ?>
                </table>
        ...
        <tr>
            <td width=50% style="border:1px solid black" id="t_fillCOL"><img src=/bitrix/images/1.gif
                                                                             style="width:100%;height:5px"></td>
...
<form name="form1" method="POST" action="" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td>[<a href="vote_edit.php?lang=<?= LANGUAGE_ID ?>&ID=<?= $vote["ID"] ?>"
    ...
    <tr>
        ...
        <td><input type="text" id="C_SORT" name="C_SORT" size="5" maxlength="18"
                   value="<?= intval($arQuestion["C_SORT"]) ?>"/></td>
    </tr>
    <tr>
                    ...
                    BX.adjust(node1, {
                        ...
                        "events": {
                            "click": function () {
                                ...
                                col_set(this.value, this);
                            }
                        }
                    });
                    BX.findChild(node, {attr: {id: 'COLB' + num}}, true).setAttribute('id', 'COLB' + newnum);
                    BX.adjust(BX.findChild(node, {property: {name: 'ACTIVE_' + num}}, true), {
                        "attrs": {
                            "name": 'ACTIVE_' + newnum,
                            "id": 'ACTIVE_' + newnum
                        }
                    });
                    BX.bind(BX.findChild(node, {property: {name: 'FIELD_TYPE_' + newnum}}, true), 'change', function () {
                        FIELD_TYPE_CHANGE(newnum);
                    });
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="internal" id='answerlist'>
                ...
                foreach ($arAnswers as $i => $arAnswer) {
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="FIELD_PARAM_<?= $i ?>"
                                   value="<?= htmlspecialcharsbx($arAnswer["FIELD_PARAM"]) ?>" size="10"/></td>
                        ...
                        <td id="COLB<?= $i ?>" style="background:<?= htmlspecialcharsbx($arAnswer["COLOR"]) ?>;">
                            <input id="COLOR_<?= $i ?>" name="COLOR_<?= $i ?>" onchange="col_set(this.value, this)"
                ...
                for ($ii = 1; $ii <= 10; $ii++) {
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="FIELD_HEIGHT_<?= $i ?>" name="FIELD_HEIGHT_<?= $i ?>" value=""
