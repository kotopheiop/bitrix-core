                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bxBlockInn bxBlockInnText">
                                                            <table align="left" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                <tr>
                                                                    <td valign="top" class="bxBlockContentText">
                                                                        <span style="font-size: 18pt;"><b>%COMPANY%</b></span>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <table align="left" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td valign="top" class="">
                                                                        <table align="left" border="0" cellpadding="0"
                                                                               cellspacing="0" width="100%"
                                                                               class="bxBlockContentEdge"
                                                                               style="background-color: rgb(231, 236, 242);"
                                                                               bgcolor="#e7ecf2">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td valign="top"
                                                                                    ...
                                                                                    <p style="text-align: center;">
                                                                                        <br>
                                                                                        <a href="tel:%PHONE%">
																				<span style="font-size: 28pt; color: #464646;">
																					%PHONE_FORMATTED%
																				</span>
                                                                                        </a>
                                                                                        <br>
