                                ...
                                <tr>
                                    <td valign="top" class="bxBlockInn bxBlockInnText">
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" class="bxBlockPadding bxBlockContentText">
                                                    <img style="margin-right: 18px;" align="left" width="200"
                                                         src="/bitrix/images/sender/preset/blocked1/choco.jpg"
                                                         class="bxImage">
                                                    %TEXT3%
                                                </td>
                                            </tr>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" class="bxBlockPadding bxBlockContentImage"
                                                    ...
                                                    <a href="#">
                                                        <img align="center" data-bx-editor-def-image="0"
                                                             src="/bitrix/images/sender/preset/blocked1/ocean.jpg"
                                                             class="bxImage">
                                                    </a>
                                                </td>
                                            </tr>
