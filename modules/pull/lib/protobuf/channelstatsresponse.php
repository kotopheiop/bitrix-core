...
class ChannelStatsResponse extends \Protobuf\AbstractMessage
{
     ...
     * @internal param $ \Protobuf\Collection<\Bitrix\Pull\Protobuf\ChannelStats> $value
     */
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $innerMessage = new \Bitrix\Pull\Protobuf\ChannelStats();
    ...
    {
        if ( ! $message instanceof \Bitrix\Pull\Protobuf\ChannelStatsResponse) {
