...
class Panel
{
    ...
    public static function showLoadedFiles()
    {
        ...
        if (!defined('BX_PUBLIC_MODE')) {
            ?>
            <p>
                <input type="text" size="50" class="typeinput" name="srchlngfil"
                       value="<?= htmlspecialcharsbx($searchString) ?>">
        ...
        <div id="BX_TRANSLATE_FILES">
            ...
            <table class="bx-translate-files-table">
                ...
                foreach ($includedLangFiles as $langFile) {
                    ...
                    if (Localization\Translation::useTranslationRepository() && in_array(
                            LANGUAGE_ID,
                    ...
                    if (
                        ...
                        (mb_strpos($_SERVER["REQUEST_URI"], "/iblock_") === false && mb_strpos(
                                $langFile,
                                "/modules/iblock/lang/"
                            ) !== false)
                    ) {
                ...
                foreach ($includedLangFiles as $langFile) {
                    ...
                    if ($searchString !== null) {
                        ...
                        $filePath = Localization\Translation::convertLangPath(
                            $_SERVER["DOCUMENT_ROOT"] . $langFile,
                            LANGUAGE_ID
                        );
                    ...
                    <tr>
                        <td>
                            <a href="/bitrix/admin/translate_edit.php?lang=<?= LANGUAGE_ID ?>&file=<?= $langFile ?>"><?= $langFile ?></a>
                        </td>
                        <td><?= $stf ?></td>
                    </tr>
                    <?
        ...
        if ($searchString !== null) {
            ?>
            <script type="text/javascript">BX.ready(function () { <?= self::DIALOG_ID ?>.
                    Show();
                });</script>
            <?
        }
        ...
        <div class="bx-component-debug bx-debug-summary bx-translate-debug-summary">
            ...
            <a title="<?= Loc::getMessage("TRANSLATE_SHOW_LOADED_LANG_FILES_TITLE") ?>"
