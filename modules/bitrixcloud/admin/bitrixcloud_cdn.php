    ...
    <form method="POST"
        ...
        <tr>
            ...
            <td width="60%">
                ...
                <input type="checkbox" id="cdn_active" name="cdn_active"
                       value="Y" <? echo $active ? 'checked="checked"' : '' ?>>
            </td>
        </tr>
        <tr>
            <td width="40%">
            ...
            <td width="60%">
                ...
                <input type="checkbox" id="optimize" name="optimize"
                       value="y" <? echo $optimize ? 'checked="checked"' : '' ?>>
            </td>
        </tr>
        <?
        $tabControl->BeginNextTab();
        ...
        <tr>
            ...
            <td width="60%">
                ...
                <input type="checkbox" id="kernel_folder" name="kernel_folder"
                       value="y" <? echo($kernel_folder ? 'checked="checked"' : '') ?>>
        ...
        <tr>
            ...
            <td width="60%">
                ...
                <input type="checkbox" id="content_folders" name="content_folders"
                       value="y" <? echo($content_folders ? 'checked="checked"' : '') ?>>
        ...
        <tr>
            ...
            <td width="60%">
                <input type="checkbox" id="site_admin" name="site[admin]"
                       value="y" <? echo (!$savedOnce || isset($sites["admin"])) ? 'checked="checked"' : '' ?>>
            </td>
        </tr>
        <?
        $by = 'sort';
        ...
        while ($arSite = $rsSites->Fetch()) {
            ...
            <tr>
                <td>
                    <label for="site_<?
                    echo htmlspecialcharsbx($arSite["LID"]); ?>"><?
                        echo htmlspecialcharsEx($arSite["NAME"] . " [" . $arSite["LID"] . "]"); ?>:</label>
                </td>
                <td>
                    <input type="checkbox" id="site_<?
                    echo htmlspecialcharsbx($arSite["LID"]); ?>" name="site[<?
                    echo htmlspecialcharsbx($arSite["LID"]); ?>]" value="y" <?
                    echo (!$savedOnce || isset($sites[$arSite["LID"]])) ? 'checked="checked"' : '' ?>>
                </td>
            </tr>
            <?
        }
        ...
        <tr class="adm-detail-required-field">
            ...
            <td width="60%">
                <input type="text" id="server_name" name="server_name"
                       value="<? echo htmlspecialcharsbx($server_name); ?>">
            </td>
        </tr>
        <tr>
            <td width="40%">
