...
class CBitrixCloudCDNLocation
{
    private $name = "";
    private $proto = "";
    private $prefixes = /*.(array[int]string).*/
        array();
    /** @var array[int]CBitrixCloudCDNClass $classes */
    private $classes = /*.(array[int]CBitrixCloudCDNClass).*/
        array();
    /** @var array[int]CBitrixCloudCDNServerGroup $server_groups */
    private $server_groups = /*.(array[int]CBitrixCloudCDNServerGroup).*/
        array();
    ...
    {
        $this->prefixes = /*.(array[int]string).*/
            array();
...
{
    private $locations = /*.(array[string]CBitrixCloudCDNLocation).*/
        array();
